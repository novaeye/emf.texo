...
public class MusicModelPackage extends ModelPackage {
	...
	public EAttribute getArtist_Id() {
		return (EAttribute) getArtistEClass().getEAllStructuralFeatures().get(
				ARTIST_ID_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Artist.version</b></em>'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return an instance of the {@link EStructuralFeature}: '
	 *         <em><b>Artist.version</b></em>'.
	 * @generated
	 */
	public EAttribute getArtist_Version() {
		return (EAttribute) getArtistEClass().getEAllStructuralFeatures().get(
				ARTIST_VERSION_FEATURE_ID);
	}
	...
	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Country.version</b></em>'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return an instance of the {@link EStructuralFeature}: '
	 *         <em><b>Country.version</b></em>'.
	 * @generated
	 */
	public EAttribute getCountry_Version() {
		return (EAttribute) getCountryEClass().getEAllStructuralFeatures().get(
				COUNTRY_VERSION_FEATURE_ID);
	}
	...
	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Genre.version</b></em>'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return an instance of the {@link EStructuralFeature}: '
	 *         <em><b>Genre.version</b></em>'.
	 * @generated
	 */
	public EAttribute getGenre_Version() {
		return (EAttribute) getGenreEClass().getEAllStructuralFeatures().get(
				GENRE_VERSION_FEATURE_ID);
	}
	...
	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Album.version</b></em>'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return an instance of the {@link EStructuralFeature}: '
	 *         <em><b>Album.version</b></em>'.
	 * @generated
	 */
	public EAttribute getAlbum_Version() {
		return (EAttribute) getAlbumEClass().getEAllStructuralFeatures().get(
				ALBUM_VERSION_FEATURE_ID);
	}
	...
	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Song.version</b></em>'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return an instance of the {@link EStructuralFeature}: '
	 *         <em><b>Song.version</b></em>'.
	 * @generated
	 */
	public EAttribute getSong_Version() {
		return (EAttribute) getSongEClass().getEAllStructuralFeatures().get(
				SONG_VERSION_FEATURE_ID);
	}
