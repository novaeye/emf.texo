...
/**
 * A representation for the Feature Group '<em><b>SceneType.group</b></em>'.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class SceneTypeGroupFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<SceneTypeGroupFeatureGroup> featureGroup,
	...
	public static void setSingleFeatureMapValue(
			List<SceneTypeGroupFeatureGroup> featureGroup, Feature feature,
			Object value) {
		for (final SceneTypeGroupFeatureGroup group : featureGroup) {
	 ...
	 * @generated
	 */
	public static List<SceneTypeGroupFeatureGroup> createFeatureGroupList(
