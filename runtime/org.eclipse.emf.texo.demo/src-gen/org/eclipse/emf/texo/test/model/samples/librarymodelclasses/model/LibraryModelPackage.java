...
public class LibraryModelPackage extends ModelPackage {
	 ...
	 * @generated
	 */
	public static final int BOOKCATEGORY_CLASSIFIER_ID = 4;
	 ...
	 * @generated
	 */
	public static final int ASDAD_CLASSIFIER_ID = 3;
	...
	public static LibraryModelPackage initialize() {
		...
		ModelResolver.getInstance().registerClassModelMapping(Asdad.class,
				modelPackage.getAsdadEClass(), modelPackage);
	...
	/**
	 * Returns the {@link EClass} '<em><b>asdad</b></em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @return an instance of the {@link EClass} '<em><b>asdad</b></em>'
	 * @generated
	 */
	public EClass getAsdadEClass() {
		return (EClass) getEPackage().getEClassifiers()
				.get(ASDAD_CLASSIFIER_ID);
	}
