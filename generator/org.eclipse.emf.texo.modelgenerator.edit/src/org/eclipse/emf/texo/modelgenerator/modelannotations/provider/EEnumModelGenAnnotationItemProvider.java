 ...
 * </copyright>
 *
 * $Id: EEnumModelGenAnnotationItemProvider.java,v 1.7 2011/09/21 14:33:13 mtaal Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EEnumModelGenAnnotationItemProvider extends EEnumAnnotationItemProvider implements
   ...
   * @generated
   */
  public EEnumModelGenAnnotationItemProvider(AdapterFactory adapterFactory) {
  ...
  /**
   * This returns EEnumModelGenAnnotation.gif.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @generated
   */
  @Override
  public Object getImage(Object object) {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/EEnumModelGenAnnotation")); //$NON-NLS-1$
  }
  ...
  public String getText(Object object) {
    String label = ((EEnumModelGenAnnotation)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_EEnumModelGenAnnotation_type") : //$NON-NLS-1$
      getString("_UI_EEnumModelGenAnnotation_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
