 ...
 * </copyright>
 *
 * $Id: InheritanceItemProvider.java,v 1.4 2011/08/25 15:03:09 mtaal Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.texo.orm.annotations.model.orm.Inheritance} object.
...
public class InheritanceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  protected void addStrategyPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_Inheritance_strategy_feature"),
        getString("_UI_PropertyDescriptor_description", "_UI_Inheritance_strategy_feature", "_UI_Inheritance_type"),
        OrmPackage.eINSTANCE.getInheritance_Strategy(), true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
        null, null));
  }
  ...
  public String getText(Object object) {
    InheritanceType labelValue = ((Inheritance) object).getStrategy();
    String label = labelValue == null ? null : labelValue.toString();
    return label == null || label.length() == 0 ? getString("_UI_Inheritance_type") : getString("_UI_Inheritance_type")
        + " " + label;
  }
