...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.texo.orm.annotations.model.orm.PrimaryKeyJoinColumn}
...
public class PrimaryKeyJoinColumnItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  protected void addColumnDefinitionPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_PrimaryKeyJoinColumn_columnDefinition_feature",
            "_UI_PrimaryKeyJoinColumn_type"), OrmPackage.eINSTANCE.getPrimaryKeyJoinColumn_ColumnDefinition(), true,
  ...
  protected void addNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_PrimaryKeyJoinColumn_name_feature",
            "_UI_PrimaryKeyJoinColumn_type"), OrmPackage.eINSTANCE.getPrimaryKeyJoinColumn_Name(), true, false, false,
  ...
  protected void addReferencedColumnNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_PrimaryKeyJoinColumn_referencedColumnName_feature",
            "_UI_PrimaryKeyJoinColumn_type"), OrmPackage.eINSTANCE.getPrimaryKeyJoinColumn_ReferencedColumnName(),
        true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }

  /**
   * This returns PrimaryKeyJoinColumn.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_PrimaryKeyJoinColumn_type")
