...
public class EClassORMAnnotationItemProvider extends EClassAnnotationItemProvider implements
  ...
  /**
   * This returns EClassORMAnnotation.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(OrmannotationsPackage.Literals.ECLASS_ORM_ANNOTATION__ENTITY,
        OrmFactory.eINSTANCE.createEntity()));

    newChildDescriptors.add(createChildParameter(OrmannotationsPackage.Literals.ECLASS_ORM_ANNOTATION__EMBEDDABLE,
