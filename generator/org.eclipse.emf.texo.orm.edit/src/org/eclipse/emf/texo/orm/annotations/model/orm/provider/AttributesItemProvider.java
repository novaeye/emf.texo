...
public class AttributesItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  protected void addDescriptionPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        OrmPackage.eINSTANCE.getAttributes_Description(), true, false, false,
  ...
  /**
   * This returns Attributes.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_Attributes_type") : getString("_UI_Attributes_type")
        + " " + label;
  }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_Id(),
        OrmFactory.eINSTANCE.createId()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_EmbeddedId(),
        OrmFactory.eINSTANCE.createEmbeddedId()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_Basic(),
        OrmFactory.eINSTANCE.createBasic()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_BasicCollection(),
        OrmFactory.eINSTANCE.createBasicCollection()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_BasicMap(),
        OrmFactory.eINSTANCE.createBasicMap()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_Version(),
        OrmFactory.eINSTANCE.createVersion()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_ManyToOne(),
        OrmFactory.eINSTANCE.createManyToOne()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_OneToMany(),
        OrmFactory.eINSTANCE.createOneToMany()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_OneToOne(),
        OrmFactory.eINSTANCE.createOneToOne()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_VariableOneToOne(),
        OrmFactory.eINSTANCE.createVariableOneToOne()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_ManyToMany(),
        OrmFactory.eINSTANCE.createManyToMany()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_ElementCollection(),
        OrmFactory.eINSTANCE.createElementCollection()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_Embedded(),
        OrmFactory.eINSTANCE.createEmbedded()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_Transformation(),
        OrmFactory.eINSTANCE.createTransformation()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getAttributes_Transient(),
