...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.texo.orm.annotations.model.orm.MapKeyJoinColumn}
...
public class MapKeyJoinColumnItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  protected void addColumnDefinitionPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_MapKeyJoinColumn_columnDefinition_feature",
            "_UI_MapKeyJoinColumn_type"), OrmPackage.eINSTANCE.getMapKeyJoinColumn_ColumnDefinition(), true, false,
  ...
  protected void addInsertablePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_MapKeyJoinColumn_insertable_feature",
            "_UI_MapKeyJoinColumn_type"), OrmPackage.eINSTANCE.getMapKeyJoinColumn_Insertable(), true, false, false,
  ...
  protected void addNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_MapKeyJoinColumn_name_feature",
            "_UI_MapKeyJoinColumn_type"), OrmPackage.eINSTANCE.getMapKeyJoinColumn_Name(), true, false, false,
  ...
  protected void addNullablePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_MapKeyJoinColumn_nullable_feature",
            "_UI_MapKeyJoinColumn_type"), OrmPackage.eINSTANCE.getMapKeyJoinColumn_Nullable(), true, false, false,
        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
  }
  ...
  protected void addReferencedColumnNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_MapKeyJoinColumn_referencedColumnName_feature",
            "_UI_MapKeyJoinColumn_type"), OrmPackage.eINSTANCE.getMapKeyJoinColumn_ReferencedColumnName(), true, false,
        false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  protected void addTablePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_MapKeyJoinColumn_table_feature",
            "_UI_MapKeyJoinColumn_type"), OrmPackage.eINSTANCE.getMapKeyJoinColumn_Table(), true, false, false,
        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  protected void addUniquePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_MapKeyJoinColumn_unique_feature",
            "_UI_MapKeyJoinColumn_type"), OrmPackage.eINSTANCE.getMapKeyJoinColumn_Unique(), true, false, false,
        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
  }
  ...
  protected void addUpdatablePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_MapKeyJoinColumn_updatable_feature",
            "_UI_MapKeyJoinColumn_type"), OrmPackage.eINSTANCE.getMapKeyJoinColumn_Updatable(), true, false, false,
        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
  }

  /**
   * This returns MapKeyJoinColumn.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_MapKeyJoinColumn_type")
