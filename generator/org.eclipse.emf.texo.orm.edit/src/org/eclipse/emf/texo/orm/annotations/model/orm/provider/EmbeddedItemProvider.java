	...
	protected void addAttributeTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Embedded_attributeType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Embedded_attributeType_feature", "_UI_Embedded_type"),
				 OrmPackage.eINSTANCE.getEmbedded_AttributeType(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
