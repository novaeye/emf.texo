...
public class VersionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  protected void addTemporalPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        OrmPackage.eINSTANCE.getVersion_Temporal(), true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
        null, null));
  }
  ...
  protected void addConvertPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        OrmPackage.eINSTANCE.getVersion_Convert(), true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
        null, null));
  }
  ...
  protected void addAccessPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        OrmPackage.eINSTANCE.getVersion_Access(), true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
        null));
  }
  ...
  protected void addMutablePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        OrmPackage.eINSTANCE.getVersion_Mutable(), true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
        null, null));
  }
  ...
  protected void addNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        OrmPackage.eINSTANCE.getVersion_Name(), true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
        null));
  }
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_Version_type") : getString("_UI_Version_type") + " "
        + label;
  }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getVersion_Column(),
        OrmFactory.eINSTANCE.createColumn()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getVersion_Converter(),
        OrmFactory.eINSTANCE.createConverter()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getVersion_TypeConverter(),
        OrmFactory.eINSTANCE.createTypeConverter()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getVersion_ObjectTypeConverter(),
        OrmFactory.eINSTANCE.createObjectTypeConverter()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getVersion_StructConverter(),
        OrmFactory.eINSTANCE.createStructConverter()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getVersion_Property(),
        OrmFactory.eINSTANCE.createProperty()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getVersion_AccessMethods(),
