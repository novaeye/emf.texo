 ...
 * </copyright>
 *
 * $Id: CustomizerItemProvider.java,v 1.4 2011/08/25 15:03:10 mtaal Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.texo.orm.annotations.model.orm.Customizer} object.
...
public class CustomizerItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  protected void addClassPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_Customizer_class_feature"),
        getString("_UI_PropertyDescriptor_description", "_UI_Customizer_class_feature", "_UI_Customizer_type"),
        OrmPackage.eINSTANCE.getCustomizer_Class(), true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
        null, null));
  }
  ...
  public String getText(Object object) {
    String label = ((Customizer) object).getClass_();
    return label == null || label.length() == 0 ? getString("_UI_Customizer_type") : getString("_UI_Customizer_type")
        + " " + label;
  }
