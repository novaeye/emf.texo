...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.texo.orm.annotations.model.orm.WriteTransformer} object.
...
public class WriteTransformerItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_WriteTransformer_method_feature", "_UI_WriteTransformer_type"),
				 OrmPackage.eINSTANCE.getWriteTransformer_Method(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_WriteTransformer_transformerClass_feature", "_UI_WriteTransformer_type"),
				 OrmPackage.eINSTANCE.getWriteTransformer_TransformerClass(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  /**
	 * This returns WriteTransformer.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
  @Override
  ...
  public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_WriteTransformer_type") :
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OrmPackage.eINSTANCE.getWriteTransformer_Column(),
