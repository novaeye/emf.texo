...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.texo.orm.annotations.model.orm.DiscriminatorColumn} object.
...
public class DiscriminatorColumnItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DiscriminatorColumn_columnDefinition_feature", "_UI_DiscriminatorColumn_type"),
				 OrmPackage.eINSTANCE.getDiscriminatorColumn_ColumnDefinition(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DiscriminatorColumn_discriminatorType_feature", "_UI_DiscriminatorColumn_type"),
				 OrmPackage.eINSTANCE.getDiscriminatorColumn_DiscriminatorType(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DiscriminatorColumn_length_feature", "_UI_DiscriminatorColumn_type"),
				 OrmPackage.eINSTANCE.getDiscriminatorColumn_Length(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DiscriminatorColumn_name_feature", "_UI_DiscriminatorColumn_type"),
				 OrmPackage.eINSTANCE.getDiscriminatorColumn_Name(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  /**
	 * This returns DiscriminatorColumn.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
  @Override
  ...
  public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_DiscriminatorColumn_type") :
