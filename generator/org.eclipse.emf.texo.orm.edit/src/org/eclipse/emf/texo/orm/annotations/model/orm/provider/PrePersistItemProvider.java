...
public class PrePersistItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  protected void addDescriptionPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        OrmPackage.eINSTANCE.getPrePersist_Description(), true, false, false,
  ...
  protected void addMethodNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        OrmPackage.eINSTANCE.getPrePersist_MethodName(), true, false, false,
        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }

  /**
   * This returns PrePersist.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_PrePersist_type") : getString("_UI_PrePersist_type")
        + " " + label;
  }
