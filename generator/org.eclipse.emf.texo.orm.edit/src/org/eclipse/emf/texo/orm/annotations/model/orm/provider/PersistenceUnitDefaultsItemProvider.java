 ...
 * {@link org.eclipse.emf.texo.orm.annotations.model.orm.PersistenceUnitDefaults} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class PersistenceUnitDefaultsItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  protected void addDescriptionPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_PersistenceUnitDefaults_description_feature",
            "_UI_PersistenceUnitDefaults_type"), OrmPackage.eINSTANCE.getPersistenceUnitDefaults_Description(), true,
  ...
  protected void addSchemaPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_PersistenceUnitDefaults_schema_feature",
            "_UI_PersistenceUnitDefaults_type"), OrmPackage.eINSTANCE.getPersistenceUnitDefaults_Schema(), true, false,
  ...
  protected void addCatalogPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_PersistenceUnitDefaults_catalog_feature",
            "_UI_PersistenceUnitDefaults_type"), OrmPackage.eINSTANCE.getPersistenceUnitDefaults_Catalog(), true,
        false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  protected void addAccessPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_PersistenceUnitDefaults_access_feature",
            "_UI_PersistenceUnitDefaults_type"), OrmPackage.eINSTANCE.getPersistenceUnitDefaults_Access(), true, false,
        false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  /**
   * This returns PersistenceUnitDefaults.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_PersistenceUnitDefaults_type")
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors
        .add(createChildParameter(OrmPackage.eINSTANCE.getPersistenceUnitDefaults_DelimitedIdentifiers(),
            OrmFactory.eINSTANCE.createEmptyType()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getPersistenceUnitDefaults_CascadePersist(),
        OrmFactory.eINSTANCE.createEmptyType()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getPersistenceUnitDefaults_EntityListeners(),
  ...
  public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
    ...
    boolean qualify = childFeature == OrmPackage.eINSTANCE.getPersistenceUnitDefaults_DelimitedIdentifiers()
