 ...
 * {@link org.eclipse.emf.texo.orm.annotations.model.orm.EclipselinkCollectionTable} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class EclipselinkCollectionTableItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  protected void addCatalogPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_EclipselinkCollectionTable_catalog_feature",
            "_UI_EclipselinkCollectionTable_type"), OrmPackage.eINSTANCE.getEclipselinkCollectionTable_Catalog(), true,
  ...
  protected void addNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_EclipselinkCollectionTable_name_feature",
            "_UI_EclipselinkCollectionTable_type"), OrmPackage.eINSTANCE.getEclipselinkCollectionTable_Name(), true,
        false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  protected void addSchemaPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_EclipselinkCollectionTable_schema_feature",
            "_UI_EclipselinkCollectionTable_type"), OrmPackage.eINSTANCE.getEclipselinkCollectionTable_Schema(), true,
        false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  /**
   * This returns EclipselinkCollectionTable.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_EclipselinkCollectionTable_type")
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getEclipselinkCollectionTable_UniqueConstraint(),
