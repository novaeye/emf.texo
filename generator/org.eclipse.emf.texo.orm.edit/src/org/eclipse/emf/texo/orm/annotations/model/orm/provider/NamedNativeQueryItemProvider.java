...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.texo.orm.annotations.model.orm.NamedNativeQuery}
...
public class NamedNativeQueryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  protected void addDescriptionPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_NamedNativeQuery_description_feature",
            "_UI_NamedNativeQuery_type"), OrmPackage.eINSTANCE.getNamedNativeQuery_Description(), true, false, false,
  ...
  protected void addQueryPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_NamedNativeQuery_query_feature",
            "_UI_NamedNativeQuery_type"), OrmPackage.eINSTANCE.getNamedNativeQuery_Query(), true, false, false,
        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  protected void addNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_NamedNativeQuery_name_feature",
            "_UI_NamedNativeQuery_type"), OrmPackage.eINSTANCE.getNamedNativeQuery_Name(), true, false, false,
        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  protected void addResultClassPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_NamedNativeQuery_resultClass_feature",
            "_UI_NamedNativeQuery_type"), OrmPackage.eINSTANCE.getNamedNativeQuery_ResultClass(), true, false, false,
        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  protected void addResultSetMappingPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_NamedNativeQuery_resultSetMapping_feature",
            "_UI_NamedNativeQuery_type"), OrmPackage.eINSTANCE.getNamedNativeQuery_ResultSetMapping(), true, false,
  ...
  /**
   * This returns NamedNativeQuery.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_NamedNativeQuery_type")
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getNamedNativeQuery_Hint(),
