...
public class EPackageORMAnnotationItemProvider extends EPackageAnnotationItemProvider implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EPackageORMAnnotation_generateFullDbSchemaNames_feature", "_UI_EPackageORMAnnotation_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EPackageORMAnnotation_nameDictionaryPropertyFile_feature", "_UI_EPackageORMAnnotation_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EPackageORMAnnotation_tableNamePrefix_feature", "_UI_EPackageORMAnnotation_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EPackageORMAnnotation_columnNamePrefix_feature", "_UI_EPackageORMAnnotation_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EPackageORMAnnotation_maximumSqlNameLength_feature", "_UI_EPackageORMAnnotation_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EPackageORMAnnotation_lowerCasedNames_feature", "_UI_EPackageORMAnnotation_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EPackageORMAnnotation_upperCasedNames_feature", "_UI_EPackageORMAnnotation_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EPackageORMAnnotation_enforceUniqueNames_feature", "_UI_EPackageORMAnnotation_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EPackageORMAnnotation_useJoinTablesForContainment_feature", "_UI_EPackageORMAnnotation_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EPackageORMAnnotation_useJoinTablesForNonContainment_feature", "_UI_EPackageORMAnnotation_type"),
  ...
  /**
	 * This adds a property descriptor for the Generate Java Annotations feature.
	 * <!-- begin-user-doc --> <!--
   * end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EPackageORMAnnotation_generateJavaAnnotations_feature", "_UI_EPackageORMAnnotation_type"),
				 OrmannotationsPackage.Literals.EPACKAGE_ORM_ANNOTATION__GENERATE_JAVA_ANNOTATIONS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EPackageORMAnnotation_renameSQLReservedNames_feature", "_UI_EPackageORMAnnotation_type"),
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OrmannotationsPackage.Literals.EPACKAGE_ORM_ANNOTATION__INHERITANCE);
		}
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_EPackageORMAnnotation_type")
        : getString("_UI_EPackageORMAnnotation_type") + " " + label;
  }
