...
public class TypeConverterItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_TypeConverter_dataType_feature", "_UI_TypeConverter_type"),
				 OrmPackage.eINSTANCE.getTypeConverter_DataType(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OrmPackage.eINSTANCE.getTypeConverter_Name(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_TypeConverter_objectType_feature", "_UI_TypeConverter_type"),
				 OrmPackage.eINSTANCE.getTypeConverter_ObjectType(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  /**
	 * This returns TypeConverter.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
  @Override
  ...
  public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_TypeConverter_type") :
