 ...
 * {@link org.eclipse.emf.texo.orm.annotations.model.orm.NamedStoredProcedureQuery} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class NamedStoredProcedureQueryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  protected void addNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_NamedStoredProcedureQuery_name_feature",
            "_UI_NamedStoredProcedureQuery_type"), OrmPackage.eINSTANCE.getNamedStoredProcedureQuery_Name(), true,
        false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }

  /**
   * This adds a property descriptor for the Procedure Name feature. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  protected void addProcedureNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_NamedStoredProcedureQuery_procedureName_feature",
            "_UI_NamedStoredProcedureQuery_type"), OrmPackage.eINSTANCE.getNamedStoredProcedureQuery_ProcedureName(),
        true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }

  /**
   * This adds a property descriptor for the Result Class feature. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  protected void addResultClassPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_NamedStoredProcedureQuery_resultClass_feature",
            "_UI_NamedStoredProcedureQuery_type"), OrmPackage.eINSTANCE.getNamedStoredProcedureQuery_ResultClass(),
        true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }

  /**
   * This adds a property descriptor for the Result Set Mapping feature. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  protected void addResultSetMappingPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_NamedStoredProcedureQuery_resultSetMapping_feature",
            "_UI_NamedStoredProcedureQuery_type"),
        OrmPackage.eINSTANCE.getNamedStoredProcedureQuery_ResultSetMapping(), true, false, false,
        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }

  /**
   * This adds a property descriptor for the Returns Result Set feature. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  protected void addReturnsResultSetPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_NamedStoredProcedureQuery_returnsResultSet_feature",
            "_UI_NamedStoredProcedureQuery_type"),
        OrmPackage.eINSTANCE.getNamedStoredProcedureQuery_ReturnsResultSet(), true, false, false,
  ...
  /**
   * This returns NamedStoredProcedureQuery.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_NamedStoredProcedureQuery_type")
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getNamedStoredProcedureQuery_Hint(),
        OrmFactory.eINSTANCE.createQueryHint()));

    newChildDescriptors.add(createChildParameter(OrmPackage.eINSTANCE.getNamedStoredProcedureQuery_Parameter(),
