...
public class TransformationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
  ...
  /**
	 * This adds a property descriptor for the Access1 feature.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Transformation_access1_feature", "_UI_Transformation_type"),
				 OrmPackage.eINSTANCE.getTransformation_Access1(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
