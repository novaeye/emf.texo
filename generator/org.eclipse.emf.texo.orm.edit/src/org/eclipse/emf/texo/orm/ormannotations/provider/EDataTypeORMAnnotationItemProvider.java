...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.texo.orm.ormannotations.EDataTypeORMAnnotation}
...
public class EDataTypeORMAnnotationItemProvider extends EDataTypeAnnotationItemProvider implements
  ...
  protected void addVersionPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_EDataTypeORMAnnotation_version_feature",
            "_UI_EDataTypeORMAnnotation_type"), OrmannotationsPackage.Literals.EDATA_TYPE_ORM_ANNOTATION__VERSION,
  ...
  /**
   * This returns EDataTypeORMAnnotation.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_EDataTypeORMAnnotation_type")
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(OrmannotationsPackage.Literals.EDATA_TYPE_ORM_ANNOTATION__BASIC,
        OrmFactory.eINSTANCE.createBasic()));

    newChildDescriptors.add(createChildParameter(OrmannotationsPackage.Literals.EDATA_TYPE_ORM_ANNOTATION__ID,
