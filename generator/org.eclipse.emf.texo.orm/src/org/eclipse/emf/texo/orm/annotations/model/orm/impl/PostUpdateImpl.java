 ...
 * </copyright>
 *
 * $Id: PostUpdateImpl.java,v 1.7 2011/10/26 05:48:11 mtaal Exp $
 */
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Post Update</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.PostUpdateImpl#getDescription <em>Description</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.PostUpdateImpl#getMethodName <em>Method Name</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class PostUpdateImpl extends BaseOrmAnnotationImpl implements PostUpdate {
  /**
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.POST_UPDATE__DESCRIPTION, oldDescription,
          description));
    }
  }
  ...
  public void setMethodName(String newMethodName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.POST_UPDATE__METHOD_NAME, oldMethodName,
          methodName));
    }
  }
