 ...
 * 
 * 
 * @Target({ ) @Retention(RUNTIME) public @interface ColumnResult { String name(); }
 * 
 * 
 *           <!-- end-model-doc -->
 * 
...
public interface ColumnResult extends BaseOrmAnnotation {
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.ColumnResult#getName <em>Name</em>}'
