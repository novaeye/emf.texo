 ...
 * <ul>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.EmbeddedImpl#getAttributeOverride <em>Attribute
 * Override</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.EmbeddedImpl#getAssociationOverride <em>Association
 * Override</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.EmbeddedImpl#getProperty <em>Property</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.EmbeddedImpl#getAccessMethods <em>Access Methods</em>}
 * </li>
...
public class EmbeddedImpl extends BaseOrmAnnotationImpl implements Embedded {
  ...
  public EList<AttributeOverride> getAttributeOverride() {
    if (attributeOverride == null) {
      attributeOverride = new EObjectContainmentEList<AttributeOverride>(AttributeOverride.class, this,
          OrmPackage.EMBEDDED__ATTRIBUTE_OVERRIDE);
    }
  ...
  public EList<AssociationOverride> getAssociationOverride() {
    if (associationOverride == null) {
      associationOverride = new EObjectContainmentEList<AssociationOverride>(AssociationOverride.class, this,
          OrmPackage.EMBEDDED__ASSOCIATION_OVERRIDE);
    }
  ...
  public NotificationChain basicSetAccessMethods(AccessMethods newAccessMethods, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          OrmPackage.EMBEDDED__ACCESS_METHODS, oldAccessMethods, newAccessMethods);
      if (msgs == null) {
        msgs = notification;
      } else {
    ...
    if (newAccessMethods != accessMethods) {
      ...
      if (accessMethods != null) {
        msgs = ((InternalEObject) accessMethods).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - OrmPackage.EMBEDDED__ACCESS_METHODS, null, msgs);
      }
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.EMBEDDED__ACCESS_METHODS, newAccessMethods,
          newAccessMethods));
    }
  }
  ...
  public void setAccess(AccessType newAccess) {
    ...
    accessESet = true;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.EMBEDDED__ACCESS, oldAccess, access,
          !oldAccessESet));
    }
  }
  ...
  public void unsetAccess() {
    ...
    accessESet = false;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET, OrmPackage.EMBEDDED__ACCESS, oldAccess, ACCESS_EDEFAULT,
          oldAccessESet));
    }
  }
