...
public interface UniqueConstraint extends BaseOrmAnnotation {
  /**
   * Returns the value of the '<em><b>Column Name</b></em>' attribute list. The list contents are of type
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.UniqueConstraint#getName
