 ...
 * 
 * 
 * @Target({ ) @Retention(RUNTIME) public @interface EntityResult { Class entityClass(); FieldResult[] fields() default
 ...
 *           <ul>
 *           <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityResult#getFieldResult <em>Field Result
 *           </em>}</li>
 *           <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityResult#getDiscriminatorColumn <em>
 *           Discriminator Column</em>}</li>
 *           <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityResult#getEntityClass <em>Entity Class
 *           </em>}</li>
 *           </ul>
 *           </p>
 * 
...
public interface EntityResult extends BaseOrmAnnotation {
  /**
   * Returns the value of the '<em><b>Field Result</b></em>' containment reference list. The list contents are of type
   * {@link org.eclipse.emf.texo.orm.annotations.model.orm.FieldResult}. <!-- begin-user-doc -->
   * <p>
   ...
   * @model containment="true" extendedMetaData="kind='element' name='field-result' namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityResult#getDiscriminatorColumn
   * <em>Discriminator Column</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityResult#getEntityClass
