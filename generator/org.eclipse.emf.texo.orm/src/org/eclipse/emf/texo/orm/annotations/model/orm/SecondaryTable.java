 ...
 * @interface SecondaryTable { String name(); String catalog() default ""; String schema() default "";
 *            PrimaryKeyJoinColumn[] pkJoinColumns() default {}; UniqueConstraint[] uniqueConstraints() default {}; }
 * 
 * 
 *            <!-- end-model-doc -->
 * 
 ...
 *            <ul>
 *            <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.SecondaryTable#getPrimaryKeyJoinColumn <em>
 *            Primary Key Join Column</em>}</li>
 *            <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.SecondaryTable#getUniqueConstraint <em>Unique
 *            Constraint</em>}</li>
...
public interface SecondaryTable extends BaseOrmAnnotation {
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.SecondaryTable#getCatalog
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.SecondaryTable#getName <em>Name</em>}'
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.SecondaryTable#getSchema
