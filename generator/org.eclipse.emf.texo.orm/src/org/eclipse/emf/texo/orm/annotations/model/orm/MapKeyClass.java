 ...
 * 
 * 
 * @Target({METHOD, FIELD}) @Retention(RUNTIME) public @interface MapKeyClass { Class value(); }
 * 
 * 
 *                  <!-- end-model-doc -->
 * 
...
public interface MapKeyClass extends BaseOrmAnnotation {
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.MapKeyClass#getClass_ <em>Class</em>}'
