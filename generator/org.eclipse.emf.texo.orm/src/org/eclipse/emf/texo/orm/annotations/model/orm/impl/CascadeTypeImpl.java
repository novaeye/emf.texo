 ...
 * </copyright>
 *
 * $Id: CascadeTypeImpl.java,v 1.5 2011/10/25 13:25:23 mtaal Exp $
 */
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Cascade Type</b></em>'. <!-- end-user-doc -->
 * <p>
  ...
  public String getJavaAnnotation() {
    ...
    if (getCascadeAll() != null) {
      ...
      if (getCascadePersist() != null) {
        ...
        sb.append("javax.persistence.CascadeType.PERSIST"); //$NON-NLS-1$
        addComma = true;
      }
      if (getCascadeRefresh() != null) {
        ...
        sb.append("javax.persistence.CascadeType.REFRESH"); //$NON-NLS-1$
        addComma = true;
      }
      if (getCascadeRemove() != null) {
        ...
        sb.append("javax.persistence.CascadeType.REMOVE"); //$NON-NLS-1$
        addComma = true;
      }
    }
    if (sb.length() == 1) {
