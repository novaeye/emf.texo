 ...
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.BasicMapImpl#getValueConverter <em>Value Converter
 * </em>}</li>
 ...
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.BasicMapImpl#getTypeConverter <em>Type Converter</em>}
 * </li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.BasicMapImpl#getObjectTypeConverter <em>Object Type
 * Converter</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.BasicMapImpl#getStructConverter <em>Struct Converter
 * </em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.BasicMapImpl#getCollectionTable <em>Collection Table
 * </em>}</li>
 ...
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.BasicMapImpl#getAccessMethods <em>Access Methods</em>}
 * </li>
...
public class BasicMapImpl extends BaseOrmAnnotationImpl implements BasicMap {
  /**
   * The cached value of the '{@link #getKeyColumn() <em>Key Column</em>}' containment reference. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getKeyColumn()
   * @generated
  ...
  /**
   * The default value of the '{@link #getKeyConverter() <em>Key Converter</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getKeyConverter()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getKeyConverter() <em>Key Converter</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getKeyConverter()
   * @generated
  ...
  /**
   * The default value of the '{@link #getValueConverter() <em>Value Converter</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getValueConverter() <em>Value Converter</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getValueConverter()
   * @generated
  ...
  public NotificationChain basicSetKeyColumn(Column newKeyColumn, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OrmPackage.BASIC_MAP__KEY_COLUMN,
          oldKeyColumn, newKeyColumn);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setKeyColumn(Column newKeyColumn) {
    if (newKeyColumn != keyColumn) {
      ...
      if (keyColumn != null)
        msgs = ((InternalEObject) keyColumn).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - OrmPackage.BASIC_MAP__KEY_COLUMN, null, msgs);
      if (newKeyColumn != null)
        msgs = ((InternalEObject) newKeyColumn).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
            - OrmPackage.BASIC_MAP__KEY_COLUMN, null, msgs);
      msgs = basicSetKeyColumn(newKeyColumn, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.BASIC_MAP__KEY_COLUMN, newKeyColumn,
          newKeyColumn));
  }
  ...
  public void setKeyConverter(String newKeyConverter) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.BASIC_MAP__KEY_CONVERTER, oldKeyConverter,
          keyConverter));
  }
  ...
  public NotificationChain basicSetValueColumn(Column newValueColumn, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          OrmPackage.BASIC_MAP__VALUE_COLUMN, oldValueColumn, newValueColumn);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newValueColumn != valueColumn) {
      ...
      if (valueColumn != null)
        msgs = ((InternalEObject) valueColumn).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - OrmPackage.BASIC_MAP__VALUE_COLUMN, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.BASIC_MAP__VALUE_COLUMN, newValueColumn,
          newValueColumn));
  }
  ...
  public void setValueConverter(String newValueConverter) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.BASIC_MAP__VALUE_CONVERTER, oldValueConverter,
          valueConverter));
  }
  ...
  public NotificationChain basicSetCollectionTable(EclipselinkCollectionTable newCollectionTable, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          OrmPackage.BASIC_MAP__COLLECTION_TABLE, oldCollectionTable, newCollectionTable);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newCollectionTable != collectionTable) {
      ...
      if (collectionTable != null)
        msgs = ((InternalEObject) collectionTable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - OrmPackage.BASIC_MAP__COLLECTION_TABLE, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.BASIC_MAP__COLLECTION_TABLE, newCollectionTable,
          newCollectionTable));
  }
  ...
  public void setJoinFetch(JoinFetchType newJoinFetch) {
    ...
    joinFetchESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.BASIC_MAP__JOIN_FETCH, oldJoinFetch, joinFetch,
          !oldJoinFetchESet));
  }
  ...
  public void unsetJoinFetch() {
    ...
    joinFetchESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, OrmPackage.BASIC_MAP__JOIN_FETCH, oldJoinFetch,
  ...
  public NotificationChain basicSetAccessMethods(AccessMethods newAccessMethods, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          OrmPackage.BASIC_MAP__ACCESS_METHODS, oldAccessMethods, newAccessMethods);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newAccessMethods != accessMethods) {
      ...
      if (accessMethods != null)
        msgs = ((InternalEObject) accessMethods).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - OrmPackage.BASIC_MAP__ACCESS_METHODS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.BASIC_MAP__ACCESS_METHODS, newAccessMethods,
          newAccessMethods));
  }
  ...
  public void setAccess(AccessType newAccess) {
    ...
    accessESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.BASIC_MAP__ACCESS, oldAccess, access,
          !oldAccessESet));
  }
  ...
  public void unsetAccess() {
    ...
    accessESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, OrmPackage.BASIC_MAP__ACCESS, oldAccess, ACCESS_EDEFAULT,
          oldAccessESet));
  }
  ...
  public void unsetFetch() {
    ...
    fetchESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, OrmPackage.BASIC_MAP__FETCH, oldFetch, FETCH_EDEFAULT,
          oldFetchESet));
  }
  ...
  public boolean eIsSet(int featureID) {
    ...
    case OrmPackage.BASIC_MAP__VALUE_CONVERTER:
      return VALUE_CONVERTER_EDEFAULT == null ? valueConverter != null : !VALUE_CONVERTER_EDEFAULT
          .equals(valueConverter);
    case OrmPackage.BASIC_MAP__GROUP:
