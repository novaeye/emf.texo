 ...
 * @Retention(RUNTIME) public @interface TypeConverter { * * (Required) Name this converter. The name should be unique *
 ...
 *                     <ul>
 *                     <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.TypeConverter#getDataType <em>Data Type
 *                     </em>}</li>
 *                     <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.TypeConverter#getName <em>Name</em>}</li>
 *                     <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.TypeConverter#getObjectType <em>Object
 *                     Type</em>}</li>
 *                     </ul>
 *                     </p>
 * 
...
public interface TypeConverter extends BaseOrmAnnotation {
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.TypeConverter#getDataType
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.TypeConverter#getName <em>Name</em>}'
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.TypeConverter#getObjectType
