 ...
 * <ul>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.PersistenceUnitMetadata#getDescription <em>Description
 * </em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.PersistenceUnitMetadata#getXmlMappingMetadataComplete <em>
 * Xml Mapping Metadata Complete</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.PersistenceUnitMetadata#getExcludeDefaultMappings <em>
 * Exclude Default Mappings</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.PersistenceUnitMetadata#getPersistenceUnitDefaults <em>
 * Persistence Unit Defaults</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface PersistenceUnitMetadata extends BaseOrmAnnotation {
  ...
  /**
   * Returns the value of the '<em><b>Xml Mapping Metadata Complete</b></em>' containment reference. <!-- begin-user-doc
   * -->
   * <p>
   ...
   * <em>Xml Mapping Metadata Complete</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Xml Mapping Metadata Complete</em>' containment reference.
  ...
  /**
   * Returns the value of the '<em><b>Exclude Default Mappings</b></em>' containment reference. <!-- begin-user-doc -->
   * <p>
   ...
   * <em>Exclude Default Mappings</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Exclude Default Mappings</em>' containment reference.
  ...
  /**
   * Returns the value of the '<em><b>Persistence Unit Defaults</b></em>' containment reference. <!-- begin-user-doc -->
   * <p>
   ...
   * <em>Persistence Unit Defaults</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Persistence Unit Defaults</em>' containment reference.
