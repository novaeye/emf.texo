 ...
 * <ul>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.PersistenceUnitDefaultsImpl#getDescription <em>
 * Description</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.PersistenceUnitDefaultsImpl#getSchema <em>Schema</em>}
 * </li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.PersistenceUnitDefaultsImpl#getCatalog <em>Catalog
 * </em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.PersistenceUnitDefaultsImpl#getDelimitedIdentifiers
 * <em>Delimited Identifiers</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.PersistenceUnitDefaultsImpl#getAccess <em>Access</em>}
 * </li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.PersistenceUnitDefaultsImpl#getCascadePersist <em>
 * Cascade Persist</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.PersistenceUnitDefaultsImpl#getEntityListeners <em>
...
public class PersistenceUnitDefaultsImpl extends BaseOrmAnnotationImpl implements PersistenceUnitDefaults {
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.PERSISTENCE_UNIT_DEFAULTS__DESCRIPTION,
  ...
  public void setSchema(String newSchema) {
    ...
    schema = newSchema;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.PERSISTENCE_UNIT_DEFAULTS__SCHEMA, oldSchema,
          schema));
  }
  ...
  public void setCatalog(String newCatalog) {
    ...
    catalog = newCatalog;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.PERSISTENCE_UNIT_DEFAULTS__CATALOG, oldCatalog,
          catalog));
  }
  ...
  public NotificationChain basicSetDelimitedIdentifiers(EmptyType newDelimitedIdentifiers, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          OrmPackage.PERSISTENCE_UNIT_DEFAULTS__DELIMITED_IDENTIFIERS, oldDelimitedIdentifiers, newDelimitedIdentifiers);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setDelimitedIdentifiers(EmptyType newDelimitedIdentifiers) {
    if (newDelimitedIdentifiers != delimitedIdentifiers) {
      ...
      if (delimitedIdentifiers != null)
        msgs = ((InternalEObject) delimitedIdentifiers).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - OrmPackage.PERSISTENCE_UNIT_DEFAULTS__DELIMITED_IDENTIFIERS, null, msgs);
      if (newDelimitedIdentifiers != null)
        msgs = ((InternalEObject) newDelimitedIdentifiers).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
            - OrmPackage.PERSISTENCE_UNIT_DEFAULTS__DELIMITED_IDENTIFIERS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          OrmPackage.PERSISTENCE_UNIT_DEFAULTS__DELIMITED_IDENTIFIERS, newDelimitedIdentifiers, newDelimitedIdentifiers));
  }
  ...
  public void setAccess(AccessType newAccess) {
    ...
    accessESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.PERSISTENCE_UNIT_DEFAULTS__ACCESS, oldAccess,
  ...
  public void unsetAccess() {
    ...
    accessESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, OrmPackage.PERSISTENCE_UNIT_DEFAULTS__ACCESS, oldAccess,
  ...
  public NotificationChain basicSetCascadePersist(EmptyType newCascadePersist, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          OrmPackage.PERSISTENCE_UNIT_DEFAULTS__CASCADE_PERSIST, oldCascadePersist, newCascadePersist);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newCascadePersist != cascadePersist) {
      ...
      if (cascadePersist != null)
        msgs = ((InternalEObject) cascadePersist).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - OrmPackage.PERSISTENCE_UNIT_DEFAULTS__CASCADE_PERSIST, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.PERSISTENCE_UNIT_DEFAULTS__CASCADE_PERSIST,
  ...
  public NotificationChain basicSetEntityListeners(EntityListeners newEntityListeners, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          OrmPackage.PERSISTENCE_UNIT_DEFAULTS__ENTITY_LISTENERS, oldEntityListeners, newEntityListeners);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newEntityListeners != entityListeners) {
      ...
      if (entityListeners != null)
        msgs = ((InternalEObject) entityListeners).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
            - OrmPackage.PERSISTENCE_UNIT_DEFAULTS__ENTITY_LISTENERS, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.PERSISTENCE_UNIT_DEFAULTS__ENTITY_LISTENERS,
