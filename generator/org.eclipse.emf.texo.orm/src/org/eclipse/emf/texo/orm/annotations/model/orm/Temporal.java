...
public enum Temporal implements Enumerator {
  ...
  /**
   * An array of all the '<em><b>Temporal</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  private static final Temporal[] VALUES_ARRAY = new Temporal[] { DATE, TIME, TIMESTAMP, };

  /**
   * A public read-only list of all the '<em><b>Temporal</b></em>' enumerators. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Temporal</b></em>' literal with the specified literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Temporal</b></em>' literal with the specified integer value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
