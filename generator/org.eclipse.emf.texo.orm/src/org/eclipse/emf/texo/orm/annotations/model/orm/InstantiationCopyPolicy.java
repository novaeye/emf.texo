 ...
 * org.eclipse.persistence.descriptors.copying.InstantiationCopyPolicy * on an Entity. InstantiationCopyPolicy is the
 * default CopyPolicy in * EclipseLink and therefore this configuration option is only used to * override other types of
 * copy policies * * An InstantiationCopyPolicy should be specified on an Entity, * MappedSuperclass or Embeddable. * *
 * Example: * @Entity *
 * 
 * @InstantiationCopyPolicy * public @interface InstantiationCopyPolicy { }
 * 
 *                          <!-- end-model-doc -->
 * 
 * 
