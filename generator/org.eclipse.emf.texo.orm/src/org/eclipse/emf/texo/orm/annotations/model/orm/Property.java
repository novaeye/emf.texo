 ...
 * @Retention(RUNTIME) public @interface Property { * * Property name. * String name();
 * 
 *                     * * String representation of Property value, * converted to an instance of valueType. * String
 *                     value();
 * 
 *                     * * Property value type. * The value converted to valueType by ConversionManager. * If specified
 *                     must be a simple type that could be handled by * ConversionManager: * numerical, boolean,
 *                     temporal. * Class valueType() default String.class; }
 * 
 * 
 *                     <!-- end-model-doc -->
 * 
 ...
 *                     <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.Property#getValueType <em>Value Type
 *                     </em>}</li>
 *                     </ul>
 *                     </p>
 * 
...
public interface Property extends BaseOrmAnnotation {
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.Property#getName <em>Name</em>}'
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.Property#getValue <em>Value</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='attribute' name='value-type'"
   * @generated
   */
  String getValueType();

  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.Property#getValueType
   * <em>Value Type</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
