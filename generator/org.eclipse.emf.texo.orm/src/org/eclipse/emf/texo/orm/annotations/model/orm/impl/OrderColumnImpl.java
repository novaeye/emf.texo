 ...
 * <ul>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.OrderColumnImpl#getColumnDefinition <em>Column
 * Definition</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.OrderColumnImpl#getCorrectionType <em>Correction Type
 * </em>}</li>
...
public class OrderColumnImpl extends BaseOrmAnnotationImpl implements OrderColumn {
  ...
  /**
   * The default value of the '{@link #getCorrectionType() <em>Correction Type</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getCorrectionType() <em>Correction Type</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getCorrectionType()
   * @generated
  ...
  /**
   * This is true if the Correction Type attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
   */
  ...
  public void setColumnDefinition(String newColumnDefinition) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.ORDER_COLUMN__COLUMN_DEFINITION,
  ...
  public void setCorrectionType(OrderColumnCorrectionType newCorrectionType) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.ORDER_COLUMN__CORRECTION_TYPE,
          oldCorrectionType, correctionType, !oldCorrectionTypeESet));
  }
  ...
  public void unsetCorrectionType() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, OrmPackage.ORDER_COLUMN__CORRECTION_TYPE,
          oldCorrectionType, CORRECTION_TYPE_EDEFAULT, oldCorrectionTypeESet));
  }
  ...
  public void setInsertable(boolean newInsertable) {
    ...
    insertableESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.ORDER_COLUMN__INSERTABLE, oldInsertable,
  ...
  public void unsetInsertable() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, OrmPackage.ORDER_COLUMN__INSERTABLE, oldInsertable,
  ...
  public void setNullable(boolean newNullable) {
    ...
    nullableESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.ORDER_COLUMN__NULLABLE, oldNullable, nullable,
          !oldNullableESet));
  }
  ...
  public void unsetNullable() {
    ...
    nullableESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, OrmPackage.ORDER_COLUMN__NULLABLE, oldNullable,
  ...
  public void setUpdatable(boolean newUpdatable) {
    ...
    updatableESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.ORDER_COLUMN__UPDATABLE, oldUpdatable,
  ...
  public void unsetUpdatable() {
    ...
    updatableESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, OrmPackage.ORDER_COLUMN__UPDATABLE, oldUpdatable,
