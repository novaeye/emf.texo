 ...
 * 					of an mapping
 * 					file. It contains the following four types of
 * 					elements:
 * 
 ...
 * 
 * 					3. The sequence-generator,
 * 					table-generator, named-query,
 * 					named-native-query and
 * 					sql-result-set-mapping elements are global
 * 					to the persistence unit.
 * 					It is undefined to have more than one
 * 					sequence-generator or
 * 					table-generator of the same name in the same
 * 					or different mapping
 * 					files in a persistence unit. It is also
 * 					undefined to have more than
 * 					one named-query, named-native-query, or
 * 					result-set-mapping of the
 * 					same name in the same or different
 * 					mapping
 * 					files in a persistence
 * 					unit.
 * 
 * 					4. The entity, mapped-superclass and embeddable elements each
 * 					define
 * 					the mapping information for a managed persistent class. The
 * 					mapping
 * 					information contained in these elements may be complete or
 * 					it may
 * 					be partial.
 * 
 *         
