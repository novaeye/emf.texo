 ...
 * 
 * 
 * The entity-mappings element is the root element of an mapping file. It contains the following four types of elements:
 * 
 ...
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getPersistenceUnitMetadata <em>
 * Persistence Unit Metadata</em>}</li>
 ...
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getTypeConverter <em>Type Converter
 * </em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getObjectTypeConverter <em>Object Type
 * Converter</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getStructConverter <em>Struct Converter
 * </em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getSequenceGenerator <em>Sequence
 * Generator</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getTableGenerator <em>Table Generator
 * </em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getNamedQuery <em>Named Query</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getNamedNativeQuery <em>Named Native
 * Query</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getNamedStoredProcedureQuery <em>Named
 * Stored Procedure Query</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getSqlResultSetMapping <em>Sql Result
 * Set Mapping</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getMappedSuperclass <em>Mapped
 * Superclass</em>}</li>
...
public interface EntityMappingsType extends BaseOrmAnnotation {
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getDescription
  ...
  /**
   * Returns the value of the '<em><b>Persistence Unit Metadata</b></em>' containment reference. <!-- begin-user-doc -->
   * <p>
   ...
   * <em>Persistence Unit Metadata</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Persistence Unit Metadata</em>' containment reference.
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getPackage
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getSchema
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getCatalog
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getAccess
  ...
  /**
   * Unsets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getAccess
   * <em>Access</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetAccess()
   * @see #getAccess()
   ...
   * {@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getAccess <em>Access</em>}' attribute is
  ...
  /**
   * Returns the value of the '<em><b>Sequence Generator</b></em>' containment reference list. The list contents are of
   * type {@link org.eclipse.emf.texo.orm.annotations.model.orm.SequenceGenerator}. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Returns the value of the '<em><b>Table Generator</b></em>' containment reference list. The list contents are of
   * type {@link org.eclipse.emf.texo.orm.annotations.model.orm.TableGenerator}. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Returns the value of the '<em><b>Mapped Superclass</b></em>' containment reference list. The list contents are of
   * type {@link org.eclipse.emf.texo.orm.annotations.model.orm.MappedSuperclass}. <!-- begin-user-doc -->
   * <p>
   ...
   * @model containment="true" extendedMetaData="kind='element' name='mapped-superclass' namespace='##targetNamespace'"
   * @generated
   */
  EList<MappedSuperclass> getMappedSuperclass();

  /**
   * Returns the value of the '<em><b>Entity</b></em>' containment reference list. The list contents are of type
   * {@link org.eclipse.emf.texo.orm.annotations.model.orm.Entity}. <!-- begin-user-doc -->
   * <p>
   ...
   * @model containment="true" extendedMetaData="kind='element' name='entity' namespace='##targetNamespace'"
   * @generated
   */
  EList<Entity> getEntity();

  /**
   * Returns the value of the '<em><b>Embeddable</b></em>' containment reference list. The list contents are of type
   * {@link org.eclipse.emf.texo.orm.annotations.model.orm.Embeddable}. <!-- begin-user-doc -->
   * <p>
   ...
   * @model containment="true" extendedMetaData="kind='element' name='embeddable' namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getVersion
  ...
  /**
   * Unsets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getVersion
   * <em>Version</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetVersion()
   * @see #getVersion()
  ...
  /**
   * Returns whether the value of the '
   * {@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityMappingsType#getVersion <em>Version</em>}' attribute is
   * set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
