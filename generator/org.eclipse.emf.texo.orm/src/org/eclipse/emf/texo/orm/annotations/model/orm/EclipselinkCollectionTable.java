 ...
 * @interface CollectionTable { * * (Optional) The name of the collection table. If it is not * specified, it is
 *            defaulted to the concatenation of the following: * the name of the source entity; "_" ; the name of the
 *            relationship * property or field of the source entity. * String name() default "";
 * 
 *            * * (Optional) The catalog of the table. It defaults to the persistence * unit default catalog. * String
 *            catalog() default "";
 * 
 *            * * (Optional) The schema of the table. It defaults to the persistence * unit default schema. * String
 *            schema() default "";
 * 
 *            * * (Optional) Used to specify a primary key column that is used as a * foreign key to join to another
 *            table. If the source entity uses a * composite primary key, a primary key join column must be specified *
 *            for each field of the composite primary key. In a single primary * key case, a primary key join column may
 *            optionally be specified. * Defaulting will apply otherwise as follows: * name, the same name as the
 *            primary key column of the primary table * of the source entity. referencedColumnName, the same name of *
 *            primary key column of the primary table of the source entity. * PrimaryKeyJoinColumn[]
 *            primaryKeyJoinColumns() default {};
 * 
 *            * * (Optional) Unique constraints that are to be placed on the table. * These are only used if table
 *            generation is in effect. * UniqueConstraint[] uniqueConstraints() default {}; }
 * 
 * 
 *            <!-- end-model-doc -->
 * 
 ...
 *            <em>Primary Key Join Column</em>}</li>
 *            <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EclipselinkCollectionTable#getUniqueConstraint
 *            <em>Unique Constraint</em>}</li>
 *            <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EclipselinkCollectionTable#getCatalog <em>
 *            Catalog</em>}</li>
 *            <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EclipselinkCollectionTable#getName <em>Name
 *            </em>}</li>
 *            <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.EclipselinkCollectionTable#getSchema <em>Schema
 *            </em>}</li>
 *            </ul>
 *            </p>
 * 
...
public interface EclipselinkCollectionTable extends BaseOrmAnnotation {
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.EclipselinkCollectionTable#getCatalog
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.EclipselinkCollectionTable#getName
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.EclipselinkCollectionTable#getSchema
