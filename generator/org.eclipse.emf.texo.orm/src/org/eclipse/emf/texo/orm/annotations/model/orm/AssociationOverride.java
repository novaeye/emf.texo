 ...
 * 
 * 
 * @Target({TYPE, METHOD, FIELD}) @Retention(RUNTIME) public @interface AssociationOverride { String name();
 *                JoinColumn[] joinColumns() default{}; JoinTable joinTable() default @JoinTable; }
 * 
 * 
 *                <!-- end-model-doc -->
 * 
 ...
 *                <ul>
 *                <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.AssociationOverride#getDescription <em>
 *                Description</em>}</li>
 *                <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.AssociationOverride#getJoinColumn <em>Join
 *                Column</em>}</li>
 *                <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.AssociationOverride#getJoinTable <em>Join
 *                Table</em>}</li>
...
public interface AssociationOverride extends BaseOrmAnnotation {
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.AssociationOverride#getDescription
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.AssociationOverride#getJoinTable
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.AssociationOverride#getName
