 ...
 * org.eclipse.persistence.descriptors.changetracking.ObjectChangePolicy * which computes changes sets for EclipseLink's
 * UnitOfWork commit * process. An ObjectChangePolicy is stored on an Entity's descriptor. * * A ChangeTracking
 * annotation may be specified on an Entity, * MappedSuperclass or Embeddable. *
 * 
 * @Target({TYPE )
 * @Retention(RUNTIME) public @interface ChangeTracking { * * (Optional) The type of change tracking to use. *
...
public interface ChangeTracking extends BaseOrmAnnotation {
   ...
   * {@link org.eclipse.emf.texo.orm.annotations.model.orm.ChangeTrackingType}. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.ChangeTracking#getType <em>Type</em>}'
  ...
  /**
   * Unsets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.ChangeTracking#getType
  ...
  /**
   * Returns whether the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.ChangeTracking#getType
