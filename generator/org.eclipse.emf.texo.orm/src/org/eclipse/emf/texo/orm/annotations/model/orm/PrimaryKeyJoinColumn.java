 ...
 * 
 * 
 * @Target({TYPE, METHOD, FIELD}) @Retention(RUNTIME) public @interface PrimaryKeyJoinColumn { String name() default "";
 *                String referencedColumnName() default ""; String columnDefinition() default ""; }
 * 
 * 
 *                <!-- end-model-doc -->
 * 
 ...
 *                <ul>
 *                <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.PrimaryKeyJoinColumn#getColumnDefinition
...
public interface PrimaryKeyJoinColumn extends BaseOrmAnnotation {
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.PrimaryKeyJoinColumn#getName
