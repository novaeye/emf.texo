 ...
 * </copyright>
 *
 * $Id: CollectionTableImpl.java,v 1.5 2011/10/25 13:25:23 mtaal Exp $
 */
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Collection Table</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.CollectionTableImpl#getJoinColumn <em>Join Column
 * </em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.CollectionTableImpl#getUniqueConstraint <em>Unique
 * Constraint</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.CollectionTableImpl#getCatalog <em>Catalog</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.CollectionTableImpl#getName <em>Name</em>}</li>
 * <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.impl.CollectionTableImpl#getSchema <em>Schema</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class CollectionTableImpl extends BaseOrmAnnotationImpl implements CollectionTable {
  /**
  ...
  public EList<JoinColumn> getJoinColumn() {
    if (joinColumn == null) {
      joinColumn = new EObjectContainmentEList<JoinColumn>(JoinColumn.class, this,
          OrmPackage.COLLECTION_TABLE__JOIN_COLUMN);
    }
    return joinColumn;
  }
  ...
  public EList<UniqueConstraint> getUniqueConstraint() {
    if (uniqueConstraint == null) {
      uniqueConstraint = new EObjectContainmentEList<UniqueConstraint>(UniqueConstraint.class, this,
          OrmPackage.COLLECTION_TABLE__UNIQUE_CONSTRAINT);
    }
