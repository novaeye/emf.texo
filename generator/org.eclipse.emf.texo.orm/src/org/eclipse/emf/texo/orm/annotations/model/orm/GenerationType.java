 ...
 * </copyright>
 *
 * $Id: GenerationType.java,v 1.5 2011/10/25 13:21:26 mtaal Exp $
 */
...
/**
 * <!-- begin-user-doc --> A representation of the literals of the enumeration '<em><b>Generation Type</b></em>', and
 ...
 * <!-- end-model-doc -->
 * 
 * @see org.eclipse.emf.texo.orm.annotations.model.orm.OrmPackage#getGenerationType()
...
public enum GenerationType implements Enumerator {
   ...
   * @generated
   */
  private static final GenerationType[] VALUES_ARRAY = new GenerationType[] { TABLE, SEQUENCE, IDENTITY, AUTO, };
  ...
  /**
   * Returns the '<em><b>Generation Type</b></em>' literal with the specified literal value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Generation Type</b></em>' literal with the specified integer value. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   */
