 ...
 * @interface SqlResultSetMapping { String name(); EntityResult[] entities() default {}; ColumnResult[] columns()
 *            default {}; }
 * 
 * 
 *            <!-- end-model-doc -->
 ...
 *            <ul>
 *            <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.SqlResultSetMapping#getDescription <em>
 *            Description</em>}</li>
 *            <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.SqlResultSetMapping#getEntityResult <em>Entity
 *            Result</em>}</li>
 *            <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.SqlResultSetMapping#getColumnResult <em>Column
 *            Result</em>}</li>
...
public interface SqlResultSetMapping extends BaseOrmAnnotation {
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.SqlResultSetMapping#getDescription
  ...
  /**
   * Returns the value of the '<em><b>Entity Result</b></em>' containment reference list. The list contents are of type
   * {@link org.eclipse.emf.texo.orm.annotations.model.orm.EntityResult}. <!-- begin-user-doc -->
   * <p>
   ...
   * @model containment="true" extendedMetaData="kind='element' name='entity-result' namespace='##targetNamespace'"
   * @generated
   */
  EList<EntityResult> getEntityResult();

  /**
   * Returns the value of the '<em><b>Column Result</b></em>' containment reference list. The list contents are of type
   * {@link org.eclipse.emf.texo.orm.annotations.model.orm.ColumnResult}. <!-- begin-user-doc -->
   * <p>
   ...
   * @model containment="true" extendedMetaData="kind='element' name='column-result' namespace='##targetNamespace'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.SqlResultSetMapping#getName
