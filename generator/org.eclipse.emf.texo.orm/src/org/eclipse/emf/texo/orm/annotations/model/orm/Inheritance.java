 ...
 * @interface Inheritance { InheritanceType strategy() default SINGLE_TABLE; }
 * 
 * 
 *            <!-- end-model-doc -->
 * 
...
public interface Inheritance extends BaseOrmAnnotation {
   ...
   * {@link org.eclipse.emf.texo.orm.annotations.model.orm.InheritanceType}. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.Inheritance#getStrategy
  ...
  /**
   * Unsets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.Inheritance#getStrategy
   * <em>Strategy</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetStrategy()
   * @see #getStrategy()
  ...
  /**
   * Returns whether the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.Inheritance#getStrategy
