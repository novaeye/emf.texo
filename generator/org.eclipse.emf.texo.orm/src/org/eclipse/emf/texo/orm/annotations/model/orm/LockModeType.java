...
public enum LockModeType implements Enumerator {
  ...
  /**
   * The '<em><b>OPTIMISTICFORCEINCREMENT</b></em>' literal object. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>PESSIMISTICREAD</b></em>' literal object. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>PESSIMISTICWRITE</b></em>' literal object. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>PESSIMISTICFORCEINCREMENT</b></em>' literal object. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The '<em><b>OPTIMISTIC</b></em>' literal value. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * The '<em><b>OPTIMISTICFORCEINCREMENT</b></em>' literal value. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * The '<em><b>PESSIMISTICREAD</b></em>' literal value. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * The '<em><b>PESSIMISTICWRITE</b></em>' literal value. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * The '<em><b>PESSIMISTICFORCEINCREMENT</b></em>' literal value. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * An array of all the '<em><b>Lock Mode Type</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  private static final LockModeType[] VALUES_ARRAY = new LockModeType[] { READ, WRITE, OPTIMISTIC,
      OPTIMISTICFORCEINCREMENT, PESSIMISTICREAD, PESSIMISTICWRITE, PESSIMISTICFORCEINCREMENT, NONE, };

  /**
   * A public read-only list of all the '<em><b>Lock Mode Type</b></em>' enumerators. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Lock Mode Type</b></em>' literal with the specified literal value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Lock Mode Type</b></em>' literal with the specified name. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Lock Mode Type</b></em>' literal with the specified integer value. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  public static LockModeType get(int value) {
    ...
    case OPTIMISTIC_VALUE:
      return OPTIMISTIC;
    case OPTIMISTICFORCEINCREMENT_VALUE:
      return OPTIMISTICFORCEINCREMENT;
    case PESSIMISTICREAD_VALUE:
      return PESSIMISTICREAD;
    case PESSIMISTICWRITE_VALUE:
      return PESSIMISTICWRITE;
    case PESSIMISTICFORCEINCREMENT_VALUE:
