...
public class PreRemoveImpl extends BaseOrmAnnotationImpl implements PreRemove {
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.PRE_REMOVE__DESCRIPTION, oldDescription,
          description));
    }
  }
  ...
  public void setMethodName(String newMethodName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.PRE_REMOVE__METHOD_NAME, oldMethodName,
          methodName));
    }
  }
