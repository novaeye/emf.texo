 ...
 * 
 * @Target({ )
 * @Retention(RUNTIME) public @interface TimeOfDay { * * (Optional) Hour of the day. * int hour() default 0;
 * 
 *                     * * (Optional) Minute of the day. * int minute() default 0;
 * 
 *                     * * (Optional) Second of the day. * int second() default 0;
 * 
 *                     * * (Optional) Millisecond of the day. * int millisecond() default 0;
 * 
 *                     * * Internal use. Do not modify. * boolean specified() default true; }
 * 
 * 
 *                     <!-- end-model-doc -->
 * 
 ...
 *                     <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.TimeOfDay#getMillisecond <em>
 *                     Millisecond</em>}</li>
...
public interface TimeOfDay extends BaseOrmAnnotation {
  /**
   * Returns the value of the '<em><b>Hour</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.Integer" extendedMetaData="kind='attribute' name='hour'"
   * @generated
   */
  BigInteger getHour();

  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.TimeOfDay#getHour <em>Hour</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Hour</em>' attribute.
   * @see #getHour()
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Millisecond</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.Integer" extendedMetaData="kind='attribute' name='millisecond'"
   * @generated
   */
  BigInteger getMillisecond();

  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.TimeOfDay#getMillisecond
   * <em>Millisecond</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Millisecond</em>' attribute.
   * @see #getMillisecond()
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Minute</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.Integer" extendedMetaData="kind='attribute' name='minute'"
   * @generated
   */
  BigInteger getMinute();

  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.TimeOfDay#getMinute <em>Minute</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
  ...
  /**
   * Returns the value of the '<em><b>Second</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
   ...
   * @model dataType="org.eclipse.emf.ecore.xml.type.Integer" extendedMetaData="kind='attribute' name='second'"
   * @generated
   */
  BigInteger getSecond();

  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.TimeOfDay#getSecond <em>Second</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
