...
public class EReferenceORMAnnotation extends EReferenceAnnotation implements EStructuralFeatureORMAnnotation {
  ...
  /**
   * The cached value of the '{@link #getEmbedded() <em>Embedded</em>}' reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getEmbedded()
   * @generated
  ...
  /**
   * Returns the value of the '<em><b>Embedded</b></em>' reference. <!-- begin-user-doc -->
   * <p>
  ...
  public Embedded getEmbedded() {
    if (embedded != null && embedded.eIsProxy()) {
      ...
      if (embedded != oldEmbedded) {
        if (eNotificationRequired()) {
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              OrmannotationsPackage.EREFERENCE_ORM_ANNOTATION__EMBEDDED, oldEmbedded, embedded));
        }
      }
    }
    return embedded;
   ...
   * <em>Embedded</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Embedded</em>' reference.
   * @see #getEmbedded()
   * @generated
   */
  ...
  public String getJavaAnnotation(AnnotationProvider annotationProvider, String identifier) {
    ...
    return ORMGenerator.generateJavaAnnotations(this);
  }
