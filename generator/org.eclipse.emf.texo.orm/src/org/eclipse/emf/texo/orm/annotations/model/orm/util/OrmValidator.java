...
public class OrmValidator extends EObjectValidator {
   ...
   */
  public static final PatternMatcher[][] VERSION_TYPE__PATTERN__VALUES = new PatternMatcher[][] { new PatternMatcher[] { XMLTypeUtil
      .createPatternMatcher("[0-9]+(\\.[0-9]+)*") } };

  /**
   * Validates the Pattern constraint of '<em>Version Type</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  public boolean validateVersionType_Pattern(String versionType, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    return validatePattern(OrmPackage.eINSTANCE.getVersionType(), versionType, VERSION_TYPE__PATTERN__VALUES,
        diagnostics, context);
  }
