 ...
 * @interface BasicMap { * * (Optional) Defines whether the value of the field or property * should be lazily loaded or
 *            must be eagerly fetched. The EAGER * strategy is a requirement on the persistence provider runtime that *
 *            the value must be eagerly fetched. The LAZY strategy is a hint to * the persistence provider runtime. If
 *            not specified, defaults to * LAZY. * FetchType fetch() default LAZY;
 * 
 *            * * (Optional) The name of the data column that holds the direct map * key. If the name on te key column
 *            is "", the name will default to: * the name of the property or field; "_KEY". * Column keyColumn() default
 *            @Column;
 * 
 *            * * (Optional) Specify the key converter. Default is equivalent to * specifying @Convert("none"), meaning
 *            no converter will be added to * the direct map key. * Convert keyConverter() default
 * @Convert;
 * 
 *           * * (Optional) The name of the data column that holds the direct * collection data. Defaults to the
 *           property or field name. * Column valueColumn() default @Column;
 * 
 *           * * (Optional) Specify the value converter. Default is equivalent to * specifying @Convert("none"), meaning
 *           no converter will be added to * the value column mapping. * Convert valueConverter() default @Convert; }
 * 
 * 
 *           <!-- end-model-doc -->
 * 
 ...
 *           <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getValueConverter <em>Value Converter
 *           </em>}</li>
 ...
 *           <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getTypeConverter <em>Type Converter
 *           </em>}</li>
 *           <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getObjectTypeConverter <em>Object Type
 *           Converter</em>}</li>
 *           <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getStructConverter <em>Struct Converter
 *           </em>}</li>
 *           <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getCollectionTable <em>Collection Table
 *           </em>}</li>
 ...
 *           <li>{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getAccessMethods <em>Access Methods
 *           </em>}</li>
...
public interface BasicMap extends BaseOrmAnnotation {
  /**
   * Returns the value of the '<em><b>Key Column</b></em>' containment reference. <!-- begin-user-doc -->
   * <p>
   ...
   * @model containment="true" extendedMetaData="kind='element' name='key-column' namespace='##targetNamespace'"
   * @generated
   */
  Column getKeyColumn();

  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getKeyColumn
   * <em>Key Column</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Key Column</em>' containment reference.
   * @see #getKeyColumn()
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Key Converter</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getKeyConverter
   * <em>Key Converter</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Key Converter</em>' attribute.
   * @see #getKeyConverter()
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Value Column</b></em>' containment reference. <!-- begin-user-doc -->
   * <p>
   ...
   * @model containment="true" extendedMetaData="kind='element' name='value-column' namespace='##targetNamespace'"
   * @generated
   */
  Column getValueColumn();

  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getValueColumn
   * <em>Value Column</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Value Column</em>' containment reference.
   * @see #getValueColumn()
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Value Converter</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getValueConverter
   * <em>Value Converter</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Value Converter</em>' attribute.
   ...
   * @model containment="true" extendedMetaData="kind='element' name='collection-table' namespace='##targetNamespace'"
   * @generated
   */
  EclipselinkCollectionTable getCollectionTable();

  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getCollectionTable
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getJoinFetch
  ...
  /**
   * Unsets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getJoinFetch
   * <em>Join Fetch</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetJoinFetch()
   * @see #getJoinFetch()
  ...
  /**
   * Returns whether the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getJoinFetch
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getAccessMethods
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getAccess <em>Access</em>}'
  ...
  /**
   * Unsets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getAccess <em>Access</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetAccess()
   * @see #getAccess()
  ...
  /**
   * Returns whether the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getAccess
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getFetch <em>Fetch</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
  ...
  /**
   * Unsets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getFetch <em>Fetch</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetFetch()
   * @see #getFetch()
  ...
  /**
   * Returns whether the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getFetch
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.orm.annotations.model.orm.BasicMap#getName <em>Name</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
