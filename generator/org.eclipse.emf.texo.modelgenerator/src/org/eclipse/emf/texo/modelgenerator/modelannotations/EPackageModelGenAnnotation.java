 ...
 * <ul>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#isAddRuntimeModelBehavior
 * <em>Add Runtime Model Behavior</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#isGenerateInterfaces <em>
 * Generate Interfaces</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getPackagePath <em>Package
 * Path</em>}</li>
 * <li>
 * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getModelClassesPackagePath
 * <em>Model Classes Package Path</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getQualifiedClassName <em>
 * Qualified Class Name</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getSimpleClassName <em>
 * Simple Class Name</em>}</li>
 * <li>
 * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getSimpleModelFactoryClassName
 * <em>Simple Model Factory Class Name</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getDependsOn <em>Depends
 * On</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getEcoreFileContent <em>
 * Ecore File Content</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getEcoreFileName <em>Ecore
 * File Name</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getJavaFileHeader <em>Java
 * File Header</em>}</li>
 * <li>
 * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getEClassModelGenAnnotations
 * <em>EClass Model Gen Annotations</em>}</li>
 * <li>
 * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getEDataTypeModelGenAnnotations
 * <em>EData Type Model Gen Annotations</em>}</li>
 * <li>
 * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getEEnumModelGenAnnotations
 * <em>EEnum Model Gen Annotations</em>}</li>
 * <li>
 * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getEClassifierModelGenAnnotations
 * <em>EClassifier Model Gen Annotations</em>}</li>
 * <li>
 * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getModelPackageClassNamePostFix
 * <em>Model Package Class Name Post Fix</em>}</li>
 * <li>
 * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getModelFactoryClassNamePostFix
 * <em>Model Factory Class Name Post Fix</em>}</li>
 * <li>
 * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getFeatureGroupClassNamePostFix
 * <em>Feature Group Class Name Post Fix</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#isGenerateSafeManyAccess
 * <em>Generate Safe Many Access</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getRootClassExtends <em>
 * Root Class Extends</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getRootInterfaceExtends
 * <em>Root Interface Extends</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getFeatureMapClassExtends
 * <em>Feature Map Class Extends</em>}</li>
 * <li>
 ...
 * <em>Generate Bidirectional Association Support</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#isHandleEcoreFile <em>
 * Handle Ecore File</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getDaoClassesPackagePath
 * <em>Dao Classes Package Path</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getDaoPatternName <em>Dao
 * Pattern Name</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getDaoRootClass <em>Dao
 * Root Class</em>}</li>
 * <li>{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getSubPackageModelGens
 * <em>Sub Package Model Gens</em>}</li>
 * </ul>
 * </p>
 * 
...
public class EPackageModelGenAnnotation extends EPackageAnnotation implements ENamedElementModelGenAnnotation {
  ...
  /**
   * This is true if the Generate Interfaces attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
   */
  ...
  /**
   * The default value of the '{@link #getPackagePath() <em>Package Path</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getPackagePath()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getPackagePath() <em>Package Path</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getPackagePath()
   * @generated
  ...
  /**
   * The default value of the '{@link #getSimpleModelFactoryClassName() <em>Simple Model Factory Class Name</em>}'
  ...
  /**
   * The cached value of the '{@link #getSimpleModelFactoryClassName() <em>Simple Model Factory Class Name</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getSimpleModelFactoryClassName()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getDependsOn() <em>Depends On</em>}' reference list. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getDependsOn()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getEcoreFileContent() <em>Ecore File Content</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getEcoreFileContent()
   * @generated
  ...
  /**
   * The default value of the '{@link #getEcoreFileName() <em>Ecore File Name</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getEcoreFileName() <em>Ecore File Name</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getEcoreFileName()
   * @generated
  ...
  /**
   * The default value of the '{@link #getJavaFileHeader() <em>Java File Header</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getJavaFileHeader() <em>Java File Header</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getJavaFileHeader()
   * @generated
  ...
  /**
   * The default value of the '{@link #getModelPackageClassNamePostFix() <em>Model Package Class Name Post Fix</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getModelPackageClassNamePostFix() <em>Model Package Class Name Post Fix</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getModelPackageClassNamePostFix()
   * @generated
  ...
  /**
   * The default value of the '{@link #getModelFactoryClassNamePostFix() <em>Model Factory Class Name Post Fix</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getModelFactoryClassNamePostFix() <em>Model Factory Class Name Post Fix</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getModelFactoryClassNamePostFix()
   * @generated
  ...
  /**
   * The default value of the '{@link #getFeatureGroupClassNamePostFix() <em>Feature Group Class Name Post Fix</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getFeatureGroupClassNamePostFix() <em>Feature Group Class Name Post Fix</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getFeatureGroupClassNamePostFix()
   * @generated
  ...
  /**
   * This is true if the Generate Safe Many Access attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
   */
  ...
  /**
   * The cached value of the '{@link #getRootClassExtends() <em>Root Class Extends</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getRootClassExtends()
   * @generated
  ...
  /**
   * The default value of the '{@link #isGenerateBidirectionalAssociationSupport()
   * <em>Generate Bidirectional Association Support</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #isGenerateBidirectionalAssociationSupport()
   * <em>Generate Bidirectional Association Support</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isGenerateBidirectionalAssociationSupport()
   * @generated
  ...
  /**
   * This is true if the Generate Bidirectional Association Support attribute has been set. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The default value of the '{@link #isHandleEcoreFile() <em>Handle Ecore File</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #isHandleEcoreFile() <em>Handle Ecore File</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #isHandleEcoreFile()
   * @generated
  ...
  /**
   * This is true if the Handle Ecore File attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
   */
  ...
  /**
   * The default value of the '{@link #getDaoPatternName() <em>Dao Pattern Name</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getDaoPatternName() <em>Dao Pattern Name</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getDaoPatternName()
   * @generated
  ...
  /**
   * The default value of the '{@link #getDaoRootClass() <em>Dao Root Class</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getDaoRootClass()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getDaoRootClass() <em>Dao Root Class</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getDaoRootClass()
   * @generated
   ...
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getDocumentation
  ...
  public void setDocumentation(String newDocumentation) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__DOCUMENTATION, oldDocumentation, documentation));
    }
  }
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getName <em>Name</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__NAME, oldName, name));
    }
  }

  /**
   * Returns the value of the '<em><b>Add Runtime Model Behavior</b></em>' attribute. The default value is
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#isAddRuntimeModelBehavior
   * <em>Add Runtime Model Behavior</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Add Runtime Model Behavior</em>' attribute.
   * @see #isSetAddRuntimeModelBehavior()
   * @see #unsetAddRuntimeModelBehavior()
   * @see #isAddRuntimeModelBehavior()
   * @generated
  ...
  public void setAddRuntimeModelBehavior(boolean newAddRuntimeModelBehavior) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__ADD_RUNTIME_MODEL_BEHAVIOR,
          oldAddRuntimeModelBehavior, addRuntimeModelBehavior, !oldAddRuntimeModelBehaviorESet));
    }
  }
  ...
  public void unsetAddRuntimeModelBehavior() {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__ADD_RUNTIME_MODEL_BEHAVIOR,
          oldAddRuntimeModelBehavior, ADD_RUNTIME_MODEL_BEHAVIOR_EDEFAULT, oldAddRuntimeModelBehaviorESet));
    }
  }
   ...
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#isAddRuntimeModelBehavior
   * <em>Add Runtime Model Behavior</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Generate Interfaces</b></em>' attribute. The default value is <code>"false"</code>
   * . <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#isGenerateInterfaces
   * <em>Generate Interfaces</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Generate Interfaces</em>' attribute.
   * @see #isSetGenerateInterfaces()
   * @see #unsetGenerateInterfaces()
   * @see #isGenerateInterfaces()
   * @generated
  ...
  public void setGenerateInterfaces(boolean newGenerateInterfaces) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__GENERATE_INTERFACES, oldGenerateInterfaces,
          generateInterfaces, !oldGenerateInterfacesESet));
    }
  }
  ...
  public void unsetGenerateInterfaces() {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__GENERATE_INTERFACES, oldGenerateInterfaces,
          GENERATE_INTERFACES_EDEFAULT, oldGenerateInterfacesESet));
    }
  }
   ...
   * Returns whether the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#isGenerateInterfaces
   * <em>Generate Interfaces</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Package Path</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getPackagePath
   * <em>Package Path</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Package Path</em>' attribute.
   * @see #getPackagePath()
   * @generated
   */
  public void setPackagePath(String newPackagePath) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__PACKAGE_PATH, oldPackagePath, packagePath));
    }
  }

  /**
   * Returns the value of the '<em><b>Model Classes Package Path</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
   ...
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getModelClassesPackagePath
   * <em>Model Classes Package Path</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Model Classes Package Path</em>' attribute.
   * @see #getModelClassesPackagePath()
   * @generated
   */
  public void setModelClassesPackagePath(String newModelClassesPackagePath) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__MODEL_CLASSES_PACKAGE_PATH,
          oldModelClassesPackagePath, modelClassesPackagePath));
    }
  }
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getQualifiedClassName
  ...
  public void setQualifiedClassName(String newQualifiedClassName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__QUALIFIED_CLASS_NAME, oldQualifiedClassName,
          qualifiedClassName));
    }
  }
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getSimpleClassName
  ...
  public void setSimpleClassName(String newSimpleClassName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__SIMPLE_CLASS_NAME, oldSimpleClassName,
          simpleClassName));
    }
  }

  /**
   * Returns the value of the '<em><b>Simple Model Factory Class Name</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
   ...
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getSimpleModelFactoryClassName
   * <em>Simple Model Factory Class Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Simple Model Factory Class Name</em>' attribute.
   * @see #getSimpleModelFactoryClassName()
   * @generated
   */
  public void setSimpleModelFactoryClassName(String newSimpleModelFactoryClassName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__SIMPLE_MODEL_FACTORY_CLASS_NAME,
          oldSimpleModelFactoryClassName, simpleModelFactoryClassName));
    }
  }

  /**
   * Returns the value of the '<em><b>Depends On</b></em>' reference list. The list contents are of type
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation}. <!-- begin-user-doc -->
   * <p>
  ...
  public EList<EPackageModelGenAnnotation> getDependsOn() {
    if (dependsOn == null) {
      dependsOn = new EObjectResolvingEList<EPackageModelGenAnnotation>(EPackageModelGenAnnotation.class, this,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__DEPENDS_ON);
    }
    return dependsOn;
  }

  /**
   * Returns the value of the '<em><b>Ecore File Content</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getEcoreFileContent
   * <em>Ecore File Content</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Ecore File Content</em>' attribute.
   * @see #getEcoreFileContent()
   * @generated
   */
  public void setEcoreFileContent(String newEcoreFileContent) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__ECORE_FILE_CONTENT, oldEcoreFileContent,
          ecoreFileContent));
    }
  }

  /**
   * Returns the value of the '<em><b>Ecore File Name</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getEcoreFileName
   * <em>Ecore File Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Ecore File Name</em>' attribute.
   * @see #getEcoreFileName()
   * @generated
   */
  public void setEcoreFileName(String newEcoreFileName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__ECORE_FILE_NAME, oldEcoreFileName, ecoreFileName));
    }
  }

  /**
   * Returns the value of the '<em><b>Java File Header</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getJavaFileHeader
   * <em>Java File Header</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Java File Header</em>' attribute.
   * @see #getJavaFileHeader()
   * @generated
   */
  public void setJavaFileHeader(String newJavaFileHeader) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__JAVA_FILE_HEADER, oldJavaFileHeader, javaFileHeader));
    }
  }
  ...
  /**
   * Returns the value of the '<em><b>Model Package Class Name Post Fix</b></em>' attribute. The default value is
   * <code>"ModelPackage"</code>. <!-- begin-user-doc -->
   * <p>
   ...
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getModelPackageClassNamePostFix
   * <em>Model Package Class Name Post Fix</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Model Package Class Name Post Fix</em>' attribute.
   * @see #getModelPackageClassNamePostFix()
   * @generated
   */
  public void setModelPackageClassNamePostFix(String newModelPackageClassNamePostFix) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__MODEL_PACKAGE_CLASS_NAME_POST_FIX,
          oldModelPackageClassNamePostFix, modelPackageClassNamePostFix));
    }
  }

  /**
   * Returns the value of the '<em><b>Model Factory Class Name Post Fix</b></em>' attribute. The default value is
   * <code>"ModelFactory"</code>. <!-- begin-user-doc -->
   * <p>
   ...
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getModelFactoryClassNamePostFix
   * <em>Model Factory Class Name Post Fix</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Model Factory Class Name Post Fix</em>' attribute.
   * @see #getModelFactoryClassNamePostFix()
   * @generated
   */
  public void setModelFactoryClassNamePostFix(String newModelFactoryClassNamePostFix) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__MODEL_FACTORY_CLASS_NAME_POST_FIX,
          oldModelFactoryClassNamePostFix, modelFactoryClassNamePostFix));
    }
  }

  /**
   * Returns the value of the '<em><b>Feature Group Class Name Post Fix</b></em>' attribute. The default value is
   * <code>"FeatureGroup"</code>. <!-- begin-user-doc -->
   * <p>
   ...
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getFeatureGroupClassNamePostFix
   * <em>Feature Group Class Name Post Fix</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Feature Group Class Name Post Fix</em>' attribute.
   * @see #getFeatureGroupClassNamePostFix()
   * @generated
   */
  public void setFeatureGroupClassNamePostFix(String newFeatureGroupClassNamePostFix) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__FEATURE_GROUP_CLASS_NAME_POST_FIX,
          oldFeatureGroupClassNamePostFix, featureGroupClassNamePostFix));
    }
  }

  /**
   * Returns the value of the '<em><b>Generate Safe Many Access</b></em>' attribute. The default value is
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#isGenerateSafeManyAccess
   * <em>Generate Safe Many Access</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Generate Safe Many Access</em>' attribute.
   * @see #isSetGenerateSafeManyAccess()
   * @see #unsetGenerateSafeManyAccess()
   * @see #isGenerateSafeManyAccess()
   * @generated
  ...
  public void setGenerateSafeManyAccess(boolean newGenerateSafeManyAccess) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__GENERATE_SAFE_MANY_ACCESS,
          oldGenerateSafeManyAccess, generateSafeManyAccess, !oldGenerateSafeManyAccessESet));
    }
  }
  ...
  public void unsetGenerateSafeManyAccess() {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__GENERATE_SAFE_MANY_ACCESS,
          oldGenerateSafeManyAccess, GENERATE_SAFE_MANY_ACCESS_EDEFAULT, oldGenerateSafeManyAccessESet));
    }
  }
   ...
   * Returns whether the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#isGenerateSafeManyAccess
   * <em>Generate Safe Many Access</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Root Class Extends</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getRootClassExtends
   * <em>Root Class Extends</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Root Class Extends</em>' attribute.
   * @see #getRootClassExtends()
   * @generated
   */
  public void setRootClassExtends(String newRootClassExtends) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__ROOT_CLASS_EXTENDS, oldRootClassExtends,
          rootClassExtends));
    }
  }

  /**
   * Returns the value of the '<em><b>Root Interface Extends</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getRootInterfaceExtends
   * <em>Root Interface Extends</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Root Interface Extends</em>' attribute.
   * @see #getRootInterfaceExtends()
   * @generated
   */
  public void setRootInterfaceExtends(String newRootInterfaceExtends) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__ROOT_INTERFACE_EXTENDS, oldRootInterfaceExtends,
          rootInterfaceExtends));
    }
  }

  /**
   * Returns the value of the '<em><b>Feature Map Class Extends</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getFeatureMapClassExtends
   * <em>Feature Map Class Extends</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Feature Map Class Extends</em>' attribute.
   * @see #getFeatureMapClassExtends()
   * @generated
   */
  public void setFeatureMapClassExtends(String newFeatureMapClassExtends) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__FEATURE_MAP_CLASS_EXTENDS,
          oldFeatureMapClassExtends, featureMapClassExtends));
    }
  }

  /**
   * Returns the value of the '<em><b>Generate Bidirectional Association Support</b></em>' attribute. The default value
   ...
   * 
   * @param value
   *          the new value of the '<em>Generate Bidirectional Association Support</em>' attribute.
   * @see #isSetGenerateBidirectionalAssociationSupport()
   * @see #unsetGenerateBidirectionalAssociationSupport()
   * @see #isGenerateBidirectionalAssociationSupport()
   * @generated
  ...
  public void setGenerateBidirectionalAssociationSupport(boolean newGenerateBidirectionalAssociationSupport) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__GENERATE_BIDIRECTIONAL_ASSOCIATION_SUPPORT,
          oldGenerateBidirectionalAssociationSupport, generateBidirectionalAssociationSupport,
          !oldGenerateBidirectionalAssociationSupportESet));
    }
  }
  ...
  public void unsetGenerateBidirectionalAssociationSupport() {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__GENERATE_BIDIRECTIONAL_ASSOCIATION_SUPPORT,
          oldGenerateBidirectionalAssociationSupport, GENERATE_BIDIRECTIONAL_ASSOCIATION_SUPPORT_EDEFAULT,
          oldGenerateBidirectionalAssociationSupportESet));
    }
  }
  ...
  /**
   * Returns the value of the '<em><b>Handle Ecore File</b></em>' attribute. The default value is <code>"true"</code>.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#isHandleEcoreFile
   * <em>Handle Ecore File</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Handle Ecore File</em>' attribute.
   * @see #isSetHandleEcoreFile()
   * @see #unsetHandleEcoreFile()
   * @see #isHandleEcoreFile()
   * @generated
  ...
  public void setHandleEcoreFile(boolean newHandleEcoreFile) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__HANDLE_ECORE_FILE, oldHandleEcoreFile,
          handleEcoreFile, !oldHandleEcoreFileESet));
    }
  }
  ...
  public void unsetHandleEcoreFile() {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__HANDLE_ECORE_FILE, oldHandleEcoreFile,
          HANDLE_ECORE_FILE_EDEFAULT, oldHandleEcoreFileESet));
    }
  }
   ...
   * Returns whether the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#isHandleEcoreFile
   * <em>Handle Ecore File</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Dao Classes Package Path</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getDaoClassesPackagePath
   * <em>Dao Classes Package Path</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Dao Classes Package Path</em>' attribute.
   * @see #getDaoClassesPackagePath()
   * @generated
   */
  public void setDaoClassesPackagePath(String newDaoClassesPackagePath) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__DAO_CLASSES_PACKAGE_PATH, oldDaoClassesPackagePath,
          daoClassesPackagePath));
    }
  }

  /**
   * Returns the value of the '<em><b>Dao Pattern Name</b></em>' attribute. The default value is <code>"dao"</code>.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getDaoPatternName
   * <em>Dao Pattern Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Dao Pattern Name</em>' attribute.
   * @see #getDaoPatternName()
   * @generated
   */
  public void setDaoPatternName(String newDaoPatternName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__DAO_PATTERN_NAME, oldDaoPatternName, daoPatternName));
    }
  }
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation#getDaoRootClass
   * <em>Dao Root Class</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Dao Root Class</em>' attribute.
   * @see #getDaoRootClass()
   * @generated
   */
  public void setDaoRootClass(String newDaoRootClass) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__DAO_ROOT_CLASS, oldDaoRootClass, daoRootClass));
    }
  }

  /**
   * Returns the value of the '<em><b>Sub Package Model Gens</b></em>' reference list. The list contents are of type
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EPackageModelGenAnnotation}. <!-- begin-user-doc -->
   * <p>
  ...
  public EList<EPackageModelGenAnnotation> getSubPackageModelGens() {
    if (subPackageModelGens == null) {
      subPackageModelGens = new EObjectResolvingEList<EPackageModelGenAnnotation>(EPackageModelGenAnnotation.class,
          this, ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__SUB_PACKAGE_MODEL_GENS);
    }
  ...
  public boolean eIsSet(int featureID) {
    ...
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__MODEL_CLASSES_PACKAGE_PATH:
      return MODEL_CLASSES_PACKAGE_PATH_EDEFAULT == null ? modelClassesPackagePath != null
          : !MODEL_CLASSES_PACKAGE_PATH_EDEFAULT.equals(modelClassesPackagePath);
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__QUALIFIED_CLASS_NAME:
    ...
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__SIMPLE_MODEL_FACTORY_CLASS_NAME:
      return SIMPLE_MODEL_FACTORY_CLASS_NAME_EDEFAULT == null ? simpleModelFactoryClassName != null
          : !SIMPLE_MODEL_FACTORY_CLASS_NAME_EDEFAULT.equals(simpleModelFactoryClassName);
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__DEPENDS_ON:
      return dependsOn != null && !dependsOn.isEmpty();
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__ECORE_FILE_CONTENT:
      return ECORE_FILE_CONTENT_EDEFAULT == null ? ecoreFileContent != null : !ECORE_FILE_CONTENT_EDEFAULT
    ...
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__JAVA_FILE_HEADER:
      return JAVA_FILE_HEADER_EDEFAULT == null ? javaFileHeader != null : !JAVA_FILE_HEADER_EDEFAULT
          .equals(javaFileHeader);
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__ECLASS_MODEL_GEN_ANNOTATIONS:
    ...
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__MODEL_PACKAGE_CLASS_NAME_POST_FIX:
      return MODEL_PACKAGE_CLASS_NAME_POST_FIX_EDEFAULT == null ? modelPackageClassNamePostFix != null
          : !MODEL_PACKAGE_CLASS_NAME_POST_FIX_EDEFAULT.equals(modelPackageClassNamePostFix);
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__MODEL_FACTORY_CLASS_NAME_POST_FIX:
      return MODEL_FACTORY_CLASS_NAME_POST_FIX_EDEFAULT == null ? modelFactoryClassNamePostFix != null
          : !MODEL_FACTORY_CLASS_NAME_POST_FIX_EDEFAULT.equals(modelFactoryClassNamePostFix);
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__FEATURE_GROUP_CLASS_NAME_POST_FIX:
      return FEATURE_GROUP_CLASS_NAME_POST_FIX_EDEFAULT == null ? featureGroupClassNamePostFix != null
          : !FEATURE_GROUP_CLASS_NAME_POST_FIX_EDEFAULT.equals(featureGroupClassNamePostFix);
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__GENERATE_SAFE_MANY_ACCESS:
      return isSetGenerateSafeManyAccess();
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__ROOT_CLASS_EXTENDS:
      return ROOT_CLASS_EXTENDS_EDEFAULT == null ? rootClassExtends != null : !ROOT_CLASS_EXTENDS_EDEFAULT
          .equals(rootClassExtends);
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__ROOT_INTERFACE_EXTENDS:
      return ROOT_INTERFACE_EXTENDS_EDEFAULT == null ? rootInterfaceExtends != null : !ROOT_INTERFACE_EXTENDS_EDEFAULT
          .equals(rootInterfaceExtends);
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__FEATURE_MAP_CLASS_EXTENDS:
      return FEATURE_MAP_CLASS_EXTENDS_EDEFAULT == null ? featureMapClassExtends != null
          : !FEATURE_MAP_CLASS_EXTENDS_EDEFAULT.equals(featureMapClassExtends);
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__GENERATE_BIDIRECTIONAL_ASSOCIATION_SUPPORT:
      return isSetGenerateBidirectionalAssociationSupport();
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__HANDLE_ECORE_FILE:
      return isSetHandleEcoreFile();
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__DAO_CLASSES_PACKAGE_PATH:
      return DAO_CLASSES_PACKAGE_PATH_EDEFAULT == null ? daoClassesPackagePath != null
          : !DAO_CLASSES_PACKAGE_PATH_EDEFAULT.equals(daoClassesPackagePath);
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__DAO_PATTERN_NAME:
      return DAO_PATTERN_NAME_EDEFAULT == null ? daoPatternName != null : !DAO_PATTERN_NAME_EDEFAULT
          .equals(daoPatternName);
    case ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__DAO_ROOT_CLASS:
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == ENamedElementModelGenAnnotation.class) {
      ...
      case ModelcodegeneratorPackage.ENAMED_ELEMENT_MODEL_GEN_ANNOTATION__DOCUMENTATION:
        return ModelcodegeneratorPackage.EPACKAGE_MODEL_GEN_ANNOTATION__DOCUMENTATION;
  ...
  public String toString() {
    ...
    if (addRuntimeModelBehaviorESet) {
      result.append(addRuntimeModelBehavior);
    } else {
      result.append("<unset>"); //$NON-NLS-1$
    }
    result.append(", generateInterfaces: "); //$NON-NLS-1$
    if (generateInterfacesESet) {
      result.append(generateInterfaces);
    } else {
      result.append("<unset>"); //$NON-NLS-1$
    }
    ...
    if (generateSafeManyAccessESet) {
      result.append(generateSafeManyAccess);
    } else {
      result.append("<unset>"); //$NON-NLS-1$
    }
    ...
    if (generateBidirectionalAssociationSupportESet) {
      result.append(generateBidirectionalAssociationSupport);
    } else {
      result.append("<unset>"); //$NON-NLS-1$
    }
    result.append(", handleEcoreFile: "); //$NON-NLS-1$
    if (handleEcoreFileESet) {
      result.append(handleEcoreFile);
    } else {
      result.append("<unset>"); //$NON-NLS-1$
    }
