...
public class EEnumModelGenAnnotation extends EEnumAnnotation implements EDataTypeModelGenAnnotationDefinition {
  ...
  /**
   * The default value of the '{@link #getObjectClassName() <em>Object Class Name</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getObjectClassName() <em>Object Class Name</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getObjectClassName()
   * @generated
  ...
  /**
   * The default value of the '{@link #isEnum() <em>Enum</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isEnum()
   * @generated
   * @ordered
  ...
  /**
   * The cached value of the '{@link #isEnum() <em>Enum</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isEnum()
   * @generated
   * @ordered
  ...
  /**
   * This is true if the Enum attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
   */
  ...
  /**
   * The default value of the '{@link #isDateType() <em>Date Type</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #isDateType()
   * @generated
  ...
  /**
   * The cached value of the '{@link #isDateType() <em>Date Type</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #isDateType()
   * @generated
  ...
  /**
   * This is true if the Date Type attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
   */
  ...
  public AnnotatedEDataType getAnnotatedEDataType() {
    if (eContainerFeatureID() != ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__ANNOTATED_EDATA_TYPE) {
      return null;
    }
  ...
  public NotificationChain basicSetAnnotatedEDataType(AnnotatedEDataType newAnnotatedEDataType, NotificationChain msgs) {
    msgs = eBasicSetContainer(newAnnotatedEDataType,
        ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__ANNOTATED_EDATA_TYPE, msgs);
    return msgs;
  }

  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#getAnnotatedEDataType
  ...
  public void setAnnotatedEDataType(AnnotatedEDataType newAnnotatedEDataType) {
    if (newAnnotatedEDataType != eInternalContainer()
        || eContainerFeatureID() != ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__ANNOTATED_EDATA_TYPE
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__ANNOTATED_EDATA_TYPE, newAnnotatedEDataType,
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#getDocumentation
  ...
  public void setDocumentation(String newDocumentation) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__DOCUMENTATION, oldDocumentation, documentation));
    }
  }
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#getName
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__NAME,
          oldName, name));
    }
  }
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#getQualifiedClassName
  ...
  public void setQualifiedClassName(String newQualifiedClassName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__QUALIFIED_CLASS_NAME, oldQualifiedClassName,
          qualifiedClassName));
    }
  }
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#getSimpleClassName
  ...
  public void setSimpleClassName(String newSimpleClassName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__SIMPLE_CLASS_NAME, oldSimpleClassName, simpleClassName));
    }
  }
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#isGenerateCode
  ...
  public void setGenerateCode(boolean newGenerateCode) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__GENERATE_CODE, oldGenerateCode, generateCode,
          !oldGenerateCodeESet));
    }
  }
  ...
  public void unsetGenerateCode() {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__GENERATE_CODE, oldGenerateCode, GENERATE_CODE_EDEFAULT,
          oldGenerateCodeESet));
    }
  }
      ...
      if (ownerEPackageAnnotation != oldOwnerEPackageAnnotation) {
        if (eNotificationRequired()) {
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__OWNER_EPACKAGE_ANNOTATION,
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#getOwnerEPackageAnnotation
  ...
  public void setOwnerEPackageAnnotation(EPackageModelGenAnnotation newOwnerEPackageAnnotation) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__OWNER_EPACKAGE_ANNOTATION, oldOwnerEPackageAnnotation,
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#getInstanceClassName
   * <em>Instance Class Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
  ...
  public void setInstanceClassName(String newInstanceClassName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__INSTANCE_CLASS_NAME, oldInstanceClassName,
          instanceClassName));
    }
  }

  /**
   * Returns the value of the '<em><b>Object Class Name</b></em>' attribute. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#getObjectClassName
   * <em>Object Class Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Object Class Name</em>' attribute.
   * @see #getObjectClassName()
   * @generated
   */
  public void setObjectClassName(String newObjectClassName) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__OBJECT_CLASS_NAME, oldObjectClassName, objectClassName));
    }
  }
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#isEnum
   * <em>Enum</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
  ...
  public void setEnum(boolean newEnum) {
    ...
    enumESet = true;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__ENUM,
          oldEnum, enum_, !oldEnumESet));
    }
  }

  /**
   * Unsets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#isEnum <em>Enum</em>}'
  ...
  public void unsetEnum() {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__ENUM, oldEnum, ENUM_EDEFAULT, oldEnumESet));
    }
  }
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#isDateType <em>Date Type</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Date Type</em>' attribute.
   * @see #isSetDateType()
   * @see #unsetDateType()
   * @see #isDateType()
   * @generated
  ...
  public void setDateType(boolean newDateType) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__DATE_TYPE, oldDateType, dateType, !oldDateTypeESet));
    }
  }
  ...
  public void unsetDateType() {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__DATE_TYPE, oldDateType, DATE_TYPE_EDEFAULT,
          oldDateTypeESet));
    }
  }
  ...
  /**
   * Returns the value of the '<em><b>Automatic String Conversion</b></em>' attribute. The default value is
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#isAutomaticStringConversion
   * <em>Automatic String Conversion</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Automatic String Conversion</em>' attribute.
   * @see #isSetAutomaticStringConversion()
   * @see #unsetAutomaticStringConversion()
   * @see #isAutomaticStringConversion()
   * @generated
  ...
  public void setAutomaticStringConversion(boolean newAutomaticStringConversion) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__AUTOMATIC_STRING_CONVERSION,
          oldAutomaticStringConversion, automaticStringConversion, !oldAutomaticStringConversionESet));
    }
  }
  ...
  public void unsetAutomaticStringConversion() {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__AUTOMATIC_STRING_CONVERSION,
          oldAutomaticStringConversion, AUTOMATIC_STRING_CONVERSION_EDEFAULT, oldAutomaticStringConversionESet));
    }
  }
   ...
   * Returns whether the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#isAutomaticStringConversion
   * <em>Automatic String Conversion</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Base Type Annotation</b></em>' reference. <!-- begin-user-doc -->
   * <p>
  ...
  public EDataTypeModelGenAnnotationDefinition getBaseTypeAnnotation() {
    if (baseTypeAnnotation != null && baseTypeAnnotation.eIsProxy()) {
      ...
      if (baseTypeAnnotation != oldBaseTypeAnnotation) {
        if (eNotificationRequired()) {
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__BASE_TYPE_ANNOTATION, oldBaseTypeAnnotation,
              baseTypeAnnotation));
        }
      }
    }
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#getBaseTypeAnnotation
   * <em>Base Type Annotation</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Base Type Annotation</em>' reference.
   * @see #getBaseTypeAnnotation()
   * @generated
   */
  ...
  /**
   * Sets the value of the '
   * {@link org.eclipse.emf.texo.modelgenerator.modelannotations.EEnumModelGenAnnotation#getItemType <em>Item Type</em>}
   * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
  ...
  public void setItemType(String newItemType) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__ITEM_TYPE, oldItemType, itemType, !oldItemTypeESet));
    }
  }
  ...
  public void unsetItemType() {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.UNSET,
          ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__ITEM_TYPE, oldItemType, ITEM_TYPE_EDEFAULT,
          oldItemTypeESet));
    }
  }
  ...
  public boolean eIsSet(int featureID) {
    ...
    case ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__INSTANCE_CLASS_NAME:
      return INSTANCE_CLASS_NAME_EDEFAULT == null ? instanceClassName != null : !INSTANCE_CLASS_NAME_EDEFAULT
          .equals(instanceClassName);
    case ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__OBJECT_CLASS_NAME:
      return OBJECT_CLASS_NAME_EDEFAULT == null ? objectClassName != null : !OBJECT_CLASS_NAME_EDEFAULT
          .equals(objectClassName);
    case ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__ENUM:
      return isSetEnum();
    case ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__DATE_TYPE:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
    ...
    if (baseClass == EDataTypeModelGenAnnotationDefinition.class) {
      switch (derivedFeatureID) {
      case ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__INSTANCE_CLASS_NAME:
        return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__INSTANCE_CLASS_NAME;
      case ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__OBJECT_CLASS_NAME:
        return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__OBJECT_CLASS_NAME;
      case ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__ENUM:
        return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__ENUM;
      case ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__DATE_TYPE:
        return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__DATE_TYPE;
      case ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__AUTOMATIC_STRING_CONVERSION:
        return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__AUTOMATIC_STRING_CONVERSION;
      case ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__BASE_TYPE_ANNOTATION:
        return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__BASE_TYPE_ANNOTATION;
      case ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__ITEM_TYPE:
        return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__ITEM_TYPE;
      default:
        return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == EDataTypeAnnotation.class) {
      ...
      case AnnotationsmodelPackage.EDATA_TYPE_ANNOTATION__ANNOTATED_EDATA_TYPE:
        return ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__ANNOTATED_EDATA_TYPE;
      case AnnotationsmodelPackage.EDATA_TYPE_ANNOTATION__EDATA_TYPE:
        return ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__EDATA_TYPE;
      default:
        return -1;
      }
    }
    if (baseClass == ENamedElementModelGenAnnotation.class) {
      ...
      case ModelcodegeneratorPackage.ENAMED_ELEMENT_MODEL_GEN_ANNOTATION__DOCUMENTATION:
        return ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__DOCUMENTATION;
    ...
    if (baseClass == EClassifierModelGenAnnotation.class) {
      ...
      case ModelcodegeneratorPackage.ECLASSIFIER_MODEL_GEN_ANNOTATION__SIMPLE_CLASS_NAME:
        return ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__SIMPLE_CLASS_NAME;
      case ModelcodegeneratorPackage.ECLASSIFIER_MODEL_GEN_ANNOTATION__GENERATE_CODE:
        return ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__GENERATE_CODE;
      case ModelcodegeneratorPackage.ECLASSIFIER_MODEL_GEN_ANNOTATION__OWNER_EPACKAGE_ANNOTATION:
        return ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__OWNER_EPACKAGE_ANNOTATION;
      default:
        return -1;
      }
    }
    if (baseClass == EDataTypeModelGenAnnotationDefinition.class) {
      switch (baseFeatureID) {
      case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__INSTANCE_CLASS_NAME:
        return ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__INSTANCE_CLASS_NAME;
      case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__OBJECT_CLASS_NAME:
        return ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__OBJECT_CLASS_NAME;
      case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__ENUM:
        return ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__ENUM;
      case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__DATE_TYPE:
        return ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__DATE_TYPE;
      case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__AUTOMATIC_STRING_CONVERSION:
        return ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__AUTOMATIC_STRING_CONVERSION;
      case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__BASE_TYPE_ANNOTATION:
        return ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__BASE_TYPE_ANNOTATION;
      case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__ITEM_TYPE:
        return ModelcodegeneratorPackage.EENUM_MODEL_GEN_ANNOTATION__ITEM_TYPE;
      default:
        return -1;
      }
    }
  ...
  public String toString() {
    ...
    if (automaticStringConversionESet) {
      result.append(automaticStringConversion);
    } else {
      result.append("<unset>"); //$NON-NLS-1$
    }
