 ...
 * </copyright>
 *
 * $Id: EDataTypeModelGenAnnotation.java,v 1.15 2011/10/25 13:19:30 mtaal Exp $
 */
...
/**
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>EData Type Model Gen Annotation</b></em>'. <!--
 * end-user-doc -->
 *
 *
...
public class EDataTypeModelGenAnnotation extends EDataTypeAnnotation implements EDataTypeModelGenAnnotationDefinition {
  ...
  /**
	 ...
	 * @generated
	 */
  protected EDataTypeModelGenAnnotation() {
		super();
	}
  ...
  /**
	 * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#getDocumentation <em>Documentation</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public void setDocumentation(String newDocumentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__DOCUMENTATION, oldDocumentation, documentation));
	}
  ...
  /**
	 * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__NAME, oldName, name));
	}
  ...
  /**
	 * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#getQualifiedClassName <em>Qualified Class Name</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public void setQualifiedClassName(String newQualifiedClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__QUALIFIED_CLASS_NAME, oldQualifiedClassName, qualifiedClassName));
	}
  ...
  /**
	 * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#getSimpleClassName <em>Simple Class Name</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public void setSimpleClassName(String newSimpleClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__SIMPLE_CLASS_NAME, oldSimpleClassName, simpleClassName));
	}
  ...
  /**
	 * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#isGenerateCode <em>Generate Code</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public void setGenerateCode(boolean newGenerateCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__GENERATE_CODE, oldGenerateCode, generateCode, !oldGenerateCodeESet));
	}

  /**
	 * Unsets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#isGenerateCode <em>Generate Code</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #isSetGenerateCode()
	 * @see #isGenerateCode()
	 * @see #setGenerateCode(boolean)
  ...
  public void unsetGenerateCode() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__GENERATE_CODE, oldGenerateCode, GENERATE_CODE_EDEFAULT, oldGenerateCodeESet));
	}

  /**
	 * Returns whether the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#isGenerateCode <em>Generate Code</em>}' attribute is set.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public EPackageModelGenAnnotation getOwnerEPackageAnnotation() {
		if (ownerEPackageAnnotation != null && ownerEPackageAnnotation.eIsProxy()) {
			...
			if (ownerEPackageAnnotation != oldOwnerEPackageAnnotation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__OWNER_EPACKAGE_ANNOTATION, oldOwnerEPackageAnnotation, ownerEPackageAnnotation));
			}
		}
  ...
  /**
	 * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#getOwnerEPackageAnnotation <em>Owner EPackage Annotation</em>}' reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public void setOwnerEPackageAnnotation(EPackageModelGenAnnotation newOwnerEPackageAnnotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__OWNER_EPACKAGE_ANNOTATION, oldOwnerEPackageAnnotation, ownerEPackageAnnotation));
	}
  ...
  /**
	 * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#getInstanceClassName <em>Instance Class Name</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public void setInstanceClassName(String newInstanceClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__INSTANCE_CLASS_NAME, oldInstanceClassName, instanceClassName));
	}
  ...
  /**
	 * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#getObjectClassName <em>Object Class Name</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public void setObjectClassName(String newObjectClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__OBJECT_CLASS_NAME, oldObjectClassName, objectClassName));
	}
  ...
  /**
	 * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#isEnum <em>Enum</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public void setEnum(boolean newEnum) {
		...
		enumESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__ENUM, oldEnum, enum_, !oldEnumESet));
	}

  /**
	 * Unsets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#isEnum <em>Enum</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #isSetEnum()
	 * @see #isEnum()
	 * @see #setEnum(boolean)
  ...
  public void unsetEnum() {
		...
		enumESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__ENUM, oldEnum, ENUM_EDEFAULT, oldEnumESet));
	}

  /**
	 * Returns whether the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#isEnum <em>Enum</em>}' attribute is set.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  /**
	 * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#isDateType <em>Date Type</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public void setDateType(boolean newDateType) {
		...
		dateTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__DATE_TYPE, oldDateType, dateType, !oldDateTypeESet));
	}

  /**
	 * Unsets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#isDateType <em>Date Type</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #isSetDateType()
	 * @see #isDateType()
	 * @see #setDateType(boolean)
  ...
  public void unsetDateType() {
		...
		dateTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__DATE_TYPE, oldDateType, DATE_TYPE_EDEFAULT, oldDateTypeESet));
	}

  /**
	 * Returns whether the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#isDateType <em>Date Type</em>}' attribute is set.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  /**
	 * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#isAutomaticStringConversion <em>Automatic String Conversion</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public void setAutomaticStringConversion(boolean newAutomaticStringConversion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__AUTOMATIC_STRING_CONVERSION, oldAutomaticStringConversion, automaticStringConversion, !oldAutomaticStringConversionESet));
	}

  /**
	 * Unsets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#isAutomaticStringConversion <em>Automatic String Conversion</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #isSetAutomaticStringConversion()
	 * @see #isAutomaticStringConversion()
	 * @see #setAutomaticStringConversion(boolean)
  ...
  public void unsetAutomaticStringConversion() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__AUTOMATIC_STRING_CONVERSION, oldAutomaticStringConversion, AUTOMATIC_STRING_CONVERSION_EDEFAULT, oldAutomaticStringConversionESet));
	}

  /**
	 * Returns whether the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#isAutomaticStringConversion <em>Automatic String Conversion</em>}' attribute is set.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public EDataTypeModelGenAnnotationDefinition getBaseTypeAnnotation() {
		if (baseTypeAnnotation != null && baseTypeAnnotation.eIsProxy()) {
			...
			if (baseTypeAnnotation != oldBaseTypeAnnotation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__BASE_TYPE_ANNOTATION, oldBaseTypeAnnotation, baseTypeAnnotation));
			}
		}
  ...
  /**
	 * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#getBaseTypeAnnotation <em>Base Type Annotation</em>}' reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public void setBaseTypeAnnotation(EDataTypeModelGenAnnotationDefinition newBaseTypeAnnotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__BASE_TYPE_ANNOTATION, oldBaseTypeAnnotation, baseTypeAnnotation));
	}
  ...
  /**
	 * Sets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#getItemType <em>Item Type</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public void setItemType(String newItemType) {
		...
		itemTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__ITEM_TYPE, oldItemType, itemType, !oldItemTypeESet));
	}

  /**
	 * Unsets the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#getItemType <em>Item Type</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #isSetItemType()
	 * @see #getItemType()
	 * @see #setItemType(String)
  ...
  public void unsetItemType() {
		...
		itemTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__ITEM_TYPE, oldItemType, ITEM_TYPE_EDEFAULT, oldItemTypeESet));
	}

  /**
	 * Returns whether the value of the '{@link org.eclipse.emf.texo.modelgenerator.modelannotations.EDataTypeModelGenAnnotation#getItemType <em>Item Type</em>}' attribute is set.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__OWNER_EPACKAGE_ANNOTATION:
			...
			case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__BASE_TYPE_ANNOTATION:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ENamedElementModelGenAnnotation.class) {
			switch (derivedFeatureID) {
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__DOCUMENTATION: return ModelcodegeneratorPackage.ENAMED_ELEMENT_MODEL_GEN_ANNOTATION__DOCUMENTATION;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__NAME: return ModelcodegeneratorPackage.ENAMED_ELEMENT_MODEL_GEN_ANNOTATION__NAME;
				default: return -1;
			}
		}
		if (baseClass == EClassifierModelGenAnnotation.class) {
			switch (derivedFeatureID) {
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__QUALIFIED_CLASS_NAME: return ModelcodegeneratorPackage.ECLASSIFIER_MODEL_GEN_ANNOTATION__QUALIFIED_CLASS_NAME;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__SIMPLE_CLASS_NAME: return ModelcodegeneratorPackage.ECLASSIFIER_MODEL_GEN_ANNOTATION__SIMPLE_CLASS_NAME;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__GENERATE_CODE: return ModelcodegeneratorPackage.ECLASSIFIER_MODEL_GEN_ANNOTATION__GENERATE_CODE;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__OWNER_EPACKAGE_ANNOTATION: return ModelcodegeneratorPackage.ECLASSIFIER_MODEL_GEN_ANNOTATION__OWNER_EPACKAGE_ANNOTATION;
				default: return -1;
			}
		}
		if (baseClass == EDataTypeModelGenAnnotationDefinition.class) {
			switch (derivedFeatureID) {
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__INSTANCE_CLASS_NAME: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__INSTANCE_CLASS_NAME;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__OBJECT_CLASS_NAME: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__OBJECT_CLASS_NAME;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__ENUM: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__ENUM;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__DATE_TYPE: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__DATE_TYPE;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__AUTOMATIC_STRING_CONVERSION: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__AUTOMATIC_STRING_CONVERSION;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__BASE_TYPE_ANNOTATION: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__BASE_TYPE_ANNOTATION;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__ITEM_TYPE: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__ITEM_TYPE;
				default: return -1;
			}
		}
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ENamedElementModelGenAnnotation.class) {
			switch (baseFeatureID) {
				case ModelcodegeneratorPackage.ENAMED_ELEMENT_MODEL_GEN_ANNOTATION__DOCUMENTATION: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__DOCUMENTATION;
				case ModelcodegeneratorPackage.ENAMED_ELEMENT_MODEL_GEN_ANNOTATION__NAME: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__NAME;
				default: return -1;
			}
		}
		if (baseClass == EClassifierModelGenAnnotation.class) {
			switch (baseFeatureID) {
				case ModelcodegeneratorPackage.ECLASSIFIER_MODEL_GEN_ANNOTATION__QUALIFIED_CLASS_NAME: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__QUALIFIED_CLASS_NAME;
				case ModelcodegeneratorPackage.ECLASSIFIER_MODEL_GEN_ANNOTATION__SIMPLE_CLASS_NAME: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__SIMPLE_CLASS_NAME;
				case ModelcodegeneratorPackage.ECLASSIFIER_MODEL_GEN_ANNOTATION__GENERATE_CODE: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__GENERATE_CODE;
				case ModelcodegeneratorPackage.ECLASSIFIER_MODEL_GEN_ANNOTATION__OWNER_EPACKAGE_ANNOTATION: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__OWNER_EPACKAGE_ANNOTATION;
				default: return -1;
			}
		}
		if (baseClass == EDataTypeModelGenAnnotationDefinition.class) {
			switch (baseFeatureID) {
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__INSTANCE_CLASS_NAME: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__INSTANCE_CLASS_NAME;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__OBJECT_CLASS_NAME: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__OBJECT_CLASS_NAME;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__ENUM: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__ENUM;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__DATE_TYPE: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__DATE_TYPE;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__AUTOMATIC_STRING_CONVERSION: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__AUTOMATIC_STRING_CONVERSION;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__BASE_TYPE_ANNOTATION: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__BASE_TYPE_ANNOTATION;
				case ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION_DEFINITION__ITEM_TYPE: return ModelcodegeneratorPackage.EDATA_TYPE_MODEL_GEN_ANNOTATION__ITEM_TYPE;
				default: return -1;
			}
		}
