 ...
 * </copyright>
 *
 * $Id: AnnotationsmodelActionBarContributor.java,v 1.4 2011/08/25 12:55:03 mtaal Exp $
 */
...
/**
 * This is the action bar contributor for the Annotationsmodel model editor. <!-- begin-user-doc --> <!-- end-user-doc
 * -->
 * 
 * @generated
 */
public class AnnotationsmodelActionBarContributor extends EditingDomainActionBarContributor implements
  ...
  protected IAction showPropertiesViewAction = new Action(
      TexoannotationsmodelEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
    @Override
    public void run() {
      try {
  ...
  protected IAction refreshViewerAction = new Action(
      TexoannotationsmodelEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
    @Override
   ...
   * @generated
   */
  public AnnotationsmodelActionBarContributor() {
  ...
  public void contributeToToolBar(IToolBarManager toolBarManager) {
    toolBarManager.add(new Separator("annotationsmodel-settings"));
    toolBarManager.add(new Separator("annotationsmodel-additions"));
  }
  ...
  public void contributeToMenu(IMenuManager menuManager) {
    ...
    IMenuManager submenuManager = new MenuManager(
        TexoannotationsmodelEditorPlugin.INSTANCE.getString("_UI_AnnotationsmodelEditor_menu"),
        "org.eclipse.emf.texo.annotations.annotationsmodelMenuID");
    ...
    createChildMenuManager = new MenuManager(
        TexoannotationsmodelEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    submenuManager.insertBefore("additions", createChildMenuManager);

    // Prepare for CreateSibling item addition or removal.
    //
    createSiblingMenuManager = new MenuManager(
        TexoannotationsmodelEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
  ...
  public void menuAboutToShow(IMenuManager menuManager) {
    ...
    submenuManager = new MenuManager(TexoannotationsmodelEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    populateManager(submenuManager, createChildActions, null);
    menuManager.insertBefore("edit", submenuManager);

    submenuManager = new MenuManager(TexoannotationsmodelEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
