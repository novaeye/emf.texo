...
public class VolumePayment implements PaymentItem {
	 ...
	 * единицы объема
	 * <!-- end-model-doc -->
	 * @param the new value of the '{@link VolumePayment#getUnit() unit}' feature.
	 * @generated
	 */
	 ...
	 * Цена за единицу
	 * <!-- end-model-doc -->
	 * @param the new value of the '{@link VolumePayment#getPrice() price}' feature.
	 * @generated
	 */
	 ...
	 * Сумма платежа
	 * <!-- end-model-doc -->
	 * @param the new value of the '{@link VolumePayment#getSum() sum}' feature.
	 * @generated
	 */
	 ...
	 * Дата платежа
	 * <!-- end-model-doc -->
	 * @param the new value of the '{@link VolumePayment#getDate() date}' feature.
	 * @generated
	 */
	 ...
	 * Описание
	 * <!-- end-model-doc -->
	 * @param the new value of the '{@link VolumePayment#getDescription() description}' feature.
	 * @generated
	 */
	 ...
	 * Тип платежа
	 * <!-- end-model-doc -->
	 * @param the new value of the '{@link VolumePayment#getPaymentType() paymentType}' feature.
	 * @generated
	 */
	...
	public String toString() {
		return "VolumePayment " + " [volume: " + getVolume() + "]"
				+ " [price: " + getPrice() + "]" + " [sum: " + getSum() + "]"
				+ " [currency: " + getCurrency() + "]" + " [date: " + getDate()
