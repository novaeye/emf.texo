...
public class ModelModelPackage extends ModelPackage {
	 ...
	 * @generated
	 */
	public static final String NS_URI = "http://satseqsys.ru/model";
	 ...
	 * @generated
	 */
	public static final int CURRENCY_CLASSIFIER_ID = 13;
	 ...
	 * @generated
	 */
	public static final int PAYMENTTYPE_CLASSIFIER_ID = 12;
	 ...
	 * @generated
	 */
	public static final int PERIODICITY_CLASSIFIER_ID = 14;
	 ...
	 * @generated
	 */
	public static final int PHONETYPE_CLASSIFIER_ID = 20;
	 ...
	 * @generated
	 */
	public static final int SECRETQUESTIONTYPE_CLASSIFIER_ID = 29;
	 ...
	 * @generated
	 */
	public static final int MESSAGETYPE_CLASSIFIER_ID = 38;
	 ...
	 * @generated
	 */
	public static final int EVENTTYPE_CLASSIFIER_ID = 39;
	 ...
	 * @generated
	 */
	public static final int MESSAGEIOTYPES_CLASSIFIER_ID = 37;
	 ...
	 * @generated
	 */
	public static final int SERVICE_CLASSIFIER_ID = 28;
	 ...
	 * @generated
	 */
	public static final int CARPRODUCER_CLASSIFIER_ID = 15;
	 ...
	 * @generated
	 */
	public static final int CARMODEL_CLASSIFIER_ID = 16;
	 ...
	 * @generated
	 */
	public static final int CARREGINFO_CLASSIFIER_ID = 17;
	 ...
	 * @generated
	 */
	public static final int DOCUMENT_CLASSIFIER_ID = 32;
	 ...
	 * @generated
	 */
	public static final int PERSON_CLASSIFIER_ID = 24;
	 ...
	 * @generated
	 */
	public static final int CAR_CLASSIFIER_ID = 18;
	 ...
	 * @generated
	 */
	public static final int CARPASSPORT_CLASSIFIER_ID = 19;
	 ...
	 * @generated
	 */
	public static final int PHONE_CLASSIFIER_ID = 21;
	 ...
	 * @generated
	 */
	public static final int ADDRESS_CLASSIFIER_ID = 22;
	 ...
	 * @generated
	 */
	public static final int PASSPORT_CLASSIFIER_ID = 23;
	 ...
	 * @generated
	 */
	public static final int DRIVINGLICENSE_CLASSIFIER_ID = 25;
	 ...
	 * @generated
	 */
	public static final int CONTRACT_CLASSIFIER_ID = 26;
	 ...
	 * @generated
	 */
	public static final int SECRETQUESTION_CLASSIFIER_ID = 27;
	 ...
	 * @generated
	 */
	public static final int CLIENTTARIFF_CLASSIFIER_ID = 30;
	 ...
	 * @generated
	 */
	public static final int CONTRACTPACKAGE_CLASSIFIER_ID = 31;
	 ...
	 * @generated
	 */
	public static final int USER_CLASSIFIER_ID = 33;
	 ...
	 * @generated
	 */
	public static final int USERGROUP_CLASSIFIER_ID = 34;
	 ...
	 * @generated
	 */
	public static final int MESSAGE_CLASSIFIER_ID = 35;
	 ...
	 * @generated
	 */
	public static final int EVENT_CLASSIFIER_ID = 36;
	 ...
	 * @generated
	 */
	public static final int COORDINATES_CLASSIFIER_ID = 40;
	...
	public static ModelModelPackage initialize() {
		...
		if (isInitialized) {
			return (ModelModelPackage) ModelResolver.getInstance()
		...
		ModelResolver.getInstance().registerClassModelMapping(SimCard.class,
				modelPackage.getSimCardEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				SimContract.class, modelPackage.getSimContractEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				PaymentInfo.class, modelPackage.getPaymentInfoEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				SimCardXSimContract.class,
				modelPackage.getSimCardXSimContractEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(SimTariff.class,
				modelPackage.getSimTariffEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Tariff.class,
				modelPackage.getTariffEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				PaymentItem.class, modelPackage.getPaymentItemEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				VolumePayment.class, modelPackage.getVolumePaymentEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				PeriodicalPayment.class,
				modelPackage.getPeriodicalPaymentEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				OneTimePayment.class, modelPackage.getOneTimePaymentEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Service.class,
				modelPackage.getServiceEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Units.class,
				modelPackage.getUnitsEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Price.class,
				modelPackage.getPriceEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				CarProducer.class, modelPackage.getCarProducerEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(CarModel.class,
				modelPackage.getCarModelEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(CarRegInfo.class,
				modelPackage.getCarRegInfoEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Document.class,
				modelPackage.getDocumentEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Person.class,
				modelPackage.getPersonEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Car.class,
				modelPackage.getCarEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				CarPassport.class, modelPackage.getCarPassportEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Phone.class,
				modelPackage.getPhoneEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Address.class,
				modelPackage.getAddressEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Passport.class,
				modelPackage.getPassportEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				DrivingLicense.class, modelPackage.getDrivingLicenseEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Contract.class,
				modelPackage.getContractEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				SecretQuestion.class, modelPackage.getSecretQuestionEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				ClientTariff.class, modelPackage.getClientTariffEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				ContractPackage.class, modelPackage.getContractPackageEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(User.class,
				modelPackage.getUserEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(UserGroup.class,
				modelPackage.getUserGroupEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Message.class,
				modelPackage.getMessageEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Event.class,
				modelPackage.getEventEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				Coordinates.class, modelPackage.getCoordinatesEClass(),
				modelPackage);

		ModelResolver.getInstance().registerClassModelMapping(Currency.class,
				modelPackage.getCurrencyEEnum(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				PaymentType.class, modelPackage.getPaymentTypeEEnum(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				Periodicity.class, modelPackage.getPeriodicityEEnum(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(PhoneType.class,
				modelPackage.getPhoneTypeEEnum(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				SecretQuestionType.class,
				modelPackage.getSecretQuestionTypeEEnum(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				MessageType.class, modelPackage.getMessageTypeEEnum(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(EventType.class,
				modelPackage.getEventTypeEEnum(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				MessageIOTypes.class, modelPackage.getMessageIOTypesEEnum(),
				modelPackage);
	...
	public EAttribute getSimCard_PhoneNumber() {
		return (EAttribute) getSimCardEClass().getEAllStructuralFeatures().get(
				SIMCARD_PHONENUMBER_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>SimCard.number</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getSimContract_ContractNumber() {
		return (EAttribute) getSimContractEClass().getEAllStructuralFeatures()
				.get(SIMCONTRACT_CONTRACTNUMBER_FEATURE_ID);
	}
	...
	public EAttribute getSimContract_Name() {
		return (EAttribute) getSimContractEClass().getEAllStructuralFeatures()
				.get(SIMCONTRACT_NAME_FEATURE_ID);
	}
	...
	public EAttribute getSimContract_Descritpion() {
		return (EAttribute) getSimContractEClass().getEAllStructuralFeatures()
				.get(SIMCONTRACT_DESCRITPION_FEATURE_ID);
	}
	...
	public EReference getSimContract_PaymentInfo() {
		return (EReference) getSimContractEClass().getEAllStructuralFeatures()
				.get(SIMCONTRACT_PAYMENTINFO_FEATURE_ID);
	}
	...
	public EReference getPaymentInfo_Tariff() {
		return (EReference) getPaymentInfoEClass().getEAllStructuralFeatures()
				.get(PAYMENTINFO_TARIFF_FEATURE_ID);
	}
	...
	public EReference getPaymentInfo_FactPayments() {
		return (EReference) getPaymentInfoEClass().getEAllStructuralFeatures()
				.get(PAYMENTINFO_FACTPAYMENTS_FEATURE_ID);
	}
	...
	public EClass getSimCardXSimContractEClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				SIMCARDXSIMCONTRACT_CLASSIFIER_ID);
	}
	...
	public EReference getSimCardXSimContract_SimCard() {
		return (EReference) getSimCardXSimContractEClass()
	...
	public EClass getSimTariffEClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				SIMTARIFF_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>SimTariff.name</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getSimTariff_Name() {
		return (EAttribute) getSimTariffEClass().getEAllStructuralFeatures()
				.get(SIMTARIFF_NAME_FEATURE_ID);
	}
	...
	public EAttribute getSimTariff_Active() {
		return (EAttribute) getSimTariffEClass().getEAllStructuralFeatures()
				.get(SIMTARIFF_ACTIVE_FEATURE_ID);
	}
	...
	public EReference getSimTariff_VolumePayments() {
		return (EReference) getSimTariffEClass().getEAllStructuralFeatures()
				.get(SIMTARIFF_VOLUMEPAYMENTS_FEATURE_ID);
	}
	...
	public EReference getSimTariff_PeriodicalPayments() {
		return (EReference) getSimTariffEClass().getEAllStructuralFeatures()
				.get(SIMTARIFF_PERIODICALPAYMENTS_FEATURE_ID);
	}
	...
	public EReference getSimTariff_InitialPayment() {
		return (EReference) getSimTariffEClass().getEAllStructuralFeatures()
				.get(SIMTARIFF_INITIALPAYMENT_FEATURE_ID);
	}
	...
	public EReference getSimTariff_Services() {
		return (EReference) getSimTariffEClass().getEAllStructuralFeatures()
				.get(SIMTARIFF_SERVICES_FEATURE_ID);
	}
	...
	public EAttribute getTariff_Name() {
		return (EAttribute) getTariffEClass().getEAllStructuralFeatures().get(
				TARIFF_NAME_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Tariff.active</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EReference getTariff_VolumePayments() {
		return (EReference) getTariffEClass().getEAllStructuralFeatures().get(
				TARIFF_VOLUMEPAYMENTS_FEATURE_ID);
	}
	...
	public EReference getTariff_PeriodicalPayments() {
		return (EReference) getTariffEClass().getEAllStructuralFeatures().get(
				TARIFF_PERIODICALPAYMENTS_FEATURE_ID);
	}
	...
	public EReference getTariff_InitialPayment() {
		return (EReference) getTariffEClass().getEAllStructuralFeatures().get(
				TARIFF_INITIALPAYMENT_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Tariff.services</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EClass getPaymentItemEClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				PAYMENTITEM_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>PaymentItem.sum</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getPaymentItem_Sum() {
		return (EAttribute) getPaymentItemEClass().getEAllStructuralFeatures()
				.get(PAYMENTITEM_SUM_FEATURE_ID);
	}
	...
	public EAttribute getPaymentItem_Currency() {
		return (EAttribute) getPaymentItemEClass().getEAllStructuralFeatures()
				.get(PAYMENTITEM_CURRENCY_FEATURE_ID);
	}
	...
	public EAttribute getPaymentItem_Date() {
		return (EAttribute) getPaymentItemEClass().getEAllStructuralFeatures()
				.get(PAYMENTITEM_DATE_FEATURE_ID);
	}
	...
	public EAttribute getPaymentItem_Description() {
		return (EAttribute) getPaymentItemEClass().getEAllStructuralFeatures()
				.get(PAYMENTITEM_DESCRIPTION_FEATURE_ID);
	}
	...
	public EAttribute getPaymentItem_PaymentType() {
		return (EAttribute) getPaymentItemEClass().getEAllStructuralFeatures()
				.get(PAYMENTITEM_PAYMENTTYPE_FEATURE_ID);
	}
	...
	public EAttribute getVolumePayment_Volume() {
		return (EAttribute) getVolumePaymentEClass()
				.getEAllStructuralFeatures().get(
						VOLUMEPAYMENT_VOLUME_FEATURE_ID);
	}
	...
	public EReference getVolumePayment_Unit() {
		return (EReference) getVolumePaymentEClass()
				.getEAllStructuralFeatures().get(VOLUMEPAYMENT_UNIT_FEATURE_ID);
	}
	...
	public EAttribute getVolumePayment_Price() {
		return (EAttribute) getVolumePaymentEClass()
				...
				.get(VOLUMEPAYMENT_PRICE_FEATURE_ID);
	}
	...
	public EAttribute getVolumePayment_Sum() {
		return (EAttribute) getVolumePaymentEClass()
				.getEAllStructuralFeatures().get(VOLUMEPAYMENT_SUM_FEATURE_ID);
	}
	...
	public EAttribute getVolumePayment_Currency() {
		return (EAttribute) getVolumePaymentEClass()
				.getEAllStructuralFeatures().get(
						VOLUMEPAYMENT_CURRENCY_FEATURE_ID);
	}
	...
	public EAttribute getVolumePayment_Date() {
		return (EAttribute) getVolumePaymentEClass()
				.getEAllStructuralFeatures().get(VOLUMEPAYMENT_DATE_FEATURE_ID);
	}
	...
	public EAttribute getVolumePayment_Description() {
		return (EAttribute) getVolumePaymentEClass()
				.getEAllStructuralFeatures().get(
						VOLUMEPAYMENT_DESCRIPTION_FEATURE_ID);
	}
	...
	public EAttribute getVolumePayment_PaymentType() {
		return (EAttribute) getVolumePaymentEClass()
				.getEAllStructuralFeatures().get(
						VOLUMEPAYMENT_PAYMENTTYPE_FEATURE_ID);
	}
	...
	public EClass getPeriodicalPaymentEClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				PERIODICALPAYMENT_CLASSIFIER_ID);
	}
	...
	public EAttribute getPeriodicalPayment_Periodicity() {
		return (EAttribute) getPeriodicalPaymentEClass()
				.getEAllStructuralFeatures().get(
	...
	public EAttribute getPeriodicalPayment_Sum() {
		return (EAttribute) getPeriodicalPaymentEClass()
				.getEAllStructuralFeatures().get(
						PERIODICALPAYMENT_SUM_FEATURE_ID);
	}
	...
	public EAttribute getPeriodicalPayment_Date() {
		return (EAttribute) getPeriodicalPaymentEClass()
				.getEAllStructuralFeatures().get(
						PERIODICALPAYMENT_DATE_FEATURE_ID);
	}
	...
	public EAttribute getOneTimePayment_Sum() {
		return (EAttribute) getOneTimePaymentEClass()
				.getEAllStructuralFeatures().get(ONETIMEPAYMENT_SUM_FEATURE_ID);
	}
	...
	public EAttribute getOneTimePayment_Currency() {
		return (EAttribute) getOneTimePaymentEClass()
				.getEAllStructuralFeatures().get(
						ONETIMEPAYMENT_CURRENCY_FEATURE_ID);
	}
	...
	public EAttribute getOneTimePayment_Date() {
		return (EAttribute) getOneTimePaymentEClass()
				.getEAllStructuralFeatures()
				.get(ONETIMEPAYMENT_DATE_FEATURE_ID);
	}
	...
	public EAttribute getOneTimePayment_Description() {
		return (EAttribute) getOneTimePaymentEClass()
				.getEAllStructuralFeatures().get(
						ONETIMEPAYMENT_DESCRIPTION_FEATURE_ID);
	}
	...
	public EAttribute getOneTimePayment_PaymentType() {
		return (EAttribute) getOneTimePaymentEClass()
				.getEAllStructuralFeatures().get(
						ONETIMEPAYMENT_PAYMENTTYPE_FEATURE_ID);
	}
	...
	public EClass getServiceEClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				SERVICE_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Service.name</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getService_Name() {
		return (EAttribute) getServiceEClass().getEAllStructuralFeatures().get(
				SERVICE_NAME_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Service.active</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EReference getService_InitialPayment() {
		return (EReference) getServiceEClass().getEAllStructuralFeatures().get(
				SERVICE_INITIALPAYMENT_FEATURE_ID);
	}
	...
	public EReference getService_PeriodicalPayment() {
		return (EReference) getServiceEClass().getEAllStructuralFeatures().get(
				SERVICE_PERIODICALPAYMENT_FEATURE_ID);
	}
	...
	public EReference getService_VolumePayment() {
		return (EReference) getServiceEClass().getEAllStructuralFeatures().get(
				SERVICE_VOLUMEPAYMENT_FEATURE_ID);
	}
	...
	public EAttribute getUnits_Name() {
		return (EAttribute) getUnitsEClass().getEAllStructuralFeatures().get(
				UNITS_NAME_FEATURE_ID);
	}
	...
	public EAttribute getCarProducer_Name() {
		return (EAttribute) getCarProducerEClass().getEAllStructuralFeatures()
				.get(CARPRODUCER_NAME_FEATURE_ID);
	}
	...
	public EReference getCarModel_Producer() {
		return (EReference) getCarModelEClass().getEAllStructuralFeatures()
				.get(CARMODEL_PRODUCER_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>CarModel.name</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getCarModel_Name() {
		return (EAttribute) getCarModelEClass().getEAllStructuralFeatures()
				.get(CARMODEL_NAME_FEATURE_ID);
	}
	...
	public EReference getCarRegInfo_Owner() {
		return (EReference) getCarRegInfoEClass().getEAllStructuralFeatures()
				.get(CARREGINFO_OWNER_FEATURE_ID);
	}
	...
	public EAttribute getCarRegInfo_RegNumber() {
		return (EAttribute) getCarRegInfoEClass().getEAllStructuralFeatures()
				.get(CARREGINFO_REGNUMBER_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>CarRegInfo.vin</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getCarRegInfo_ReleaseYear() {
		return (EAttribute) getCarRegInfoEClass().getEAllStructuralFeatures()
				.get(CARREGINFO_RELEASEYEAR_FEATURE_ID);
	}
	...
	public EAttribute getCarRegInfo_EngineNumber() {
		return (EAttribute) getCarRegInfoEClass().getEAllStructuralFeatures()
				.get(CARREGINFO_ENGINENUMBER_FEATURE_ID);
	}
	...
	public EAttribute getCarRegInfo_ChassisNumber() {
		return (EAttribute) getCarRegInfoEClass().getEAllStructuralFeatures()
				.get(CARREGINFO_CHASSISNUMBER_FEATURE_ID);
	}
	...
	public EAttribute getCarRegInfo_BodyNumber() {
		return (EAttribute) getCarRegInfoEClass().getEAllStructuralFeatures()
				.get(CARREGINFO_BODYNUMBER_FEATURE_ID);
	}
	...
	public EAttribute getCarRegInfo_Color() {
		return (EAttribute) getCarRegInfoEClass().getEAllStructuralFeatures()
				.get(CARREGINFO_COLOR_FEATURE_ID);
	}
	...
	public EAttribute getCarRegInfo_Series() {
		return (EAttribute) getCarRegInfoEClass().getEAllStructuralFeatures()
				.get(CARREGINFO_SERIES_FEATURE_ID);
	}
	...
	public EAttribute getCarRegInfo_Number() {
		return (EAttribute) getCarRegInfoEClass().getEAllStructuralFeatures()
				.get(CARREGINFO_NUMBER_FEATURE_ID);
	}
	...
	public EAttribute getCarRegInfo_IssueDate() {
		return (EAttribute) getCarRegInfoEClass().getEAllStructuralFeatures()
				.get(CARREGINFO_ISSUEDATE_FEATURE_ID);
	}
	...
	public EAttribute getCarRegInfo_Issued() {
		return (EAttribute) getCarRegInfoEClass().getEAllStructuralFeatures()
				.get(CARREGINFO_ISSUED_FEATURE_ID);
	}
	...
	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Document.series</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getDocument_Series() {
		return (EAttribute) getDocumentEClass().getEAllStructuralFeatures()
				.get(DOCUMENT_SERIES_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Document.number</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getDocument_Number() {
		return (EAttribute) getDocumentEClass().getEAllStructuralFeatures()
				.get(DOCUMENT_NUMBER_FEATURE_ID);
	}
	...
	public EAttribute getDocument_IssueDate() {
		return (EAttribute) getDocumentEClass().getEAllStructuralFeatures()
				.get(DOCUMENT_ISSUEDATE_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Document.issued</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getDocument_Issued() {
		return (EAttribute) getDocumentEClass().getEAllStructuralFeatures()
				.get(DOCUMENT_ISSUED_FEATURE_ID);
	}
	...
	public EClass getPersonEClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				PERSON_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Person.surname</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getPerson_Surname() {
		return (EAttribute) getPersonEClass().getEAllStructuralFeatures().get(
				PERSON_SURNAME_FEATURE_ID);
	}
	...
	public EAttribute getPerson_Patronimic() {
		return (EAttribute) getPersonEClass().getEAllStructuralFeatures().get(
				PERSON_PATRONIMIC_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Person.birthday</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EReference getPerson_RegistrationAddress() {
		return (EReference) getPersonEClass().getEAllStructuralFeatures().get(
				PERSON_REGISTRATIONADDRESS_FEATURE_ID);
	}
	...
	public EReference getPerson_FactAddress() {
		return (EReference) getPersonEClass().getEAllStructuralFeatures().get(
				PERSON_FACTADDRESS_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Person.passport</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EReference getPerson_DrivingLicense() {
		return (EReference) getPersonEClass().getEAllStructuralFeatures().get(
				PERSON_DRIVINGLICENSE_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Person.phones</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EReference getCar_Model() {
		return (EReference) getCarEClass().getEAllStructuralFeatures().get(
				CAR_MODEL_FEATURE_ID);
	}
	...
	public EReference getCar_RegInfo() {
		return (EReference) getCarEClass().getEAllStructuralFeatures().get(
				CAR_REGINFO_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Car.carPassport</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getCarPassport_Series() {
		return (EAttribute) getCarPassportEClass().getEAllStructuralFeatures()
				.get(CARPASSPORT_SERIES_FEATURE_ID);
	}
	...
	public EAttribute getCarPassport_Number() {
		return (EAttribute) getCarPassportEClass().getEAllStructuralFeatures()
				.get(CARPASSPORT_NUMBER_FEATURE_ID);
	}
	...
	public EAttribute getCarPassport_IssueDate() {
		return (EAttribute) getCarPassportEClass().getEAllStructuralFeatures()
				.get(CARPASSPORT_ISSUEDATE_FEATURE_ID);
	}
	...
	public EAttribute getCarPassport_Issued() {
		return (EAttribute) getCarPassportEClass().getEAllStructuralFeatures()
				.get(CARPASSPORT_ISSUED_FEATURE_ID);
	}
	...
	public EClass getPhoneEClass() {
		return (EClass) getEPackage().getEClassifiers()
				.get(PHONE_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Phone.number</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getPhone_Number() {
		return (EAttribute) getPhoneEClass().getEAllStructuralFeatures().get(
				PHONE_NUMBER_FEATURE_ID);
	}
	...
	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Address.zipCode</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getAddress_ZipCode() {
		return (EAttribute) getAddressEClass().getEAllStructuralFeatures().get(
				ADDRESS_ZIPCODE_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Address.country</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getAddress_Country() {
		return (EAttribute) getAddressEClass().getEAllStructuralFeatures().get(
				ADDRESS_COUNTRY_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Address.region</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getAddress_Building() {
		return (EAttribute) getAddressEClass().getEAllStructuralFeatures().get(
				ADDRESS_BUILDING_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Address.flat</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EClass getPassportEClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				PASSPORT_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Passport.series</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getPassport_Series() {
		return (EAttribute) getPassportEClass().getEAllStructuralFeatures()
				.get(PASSPORT_SERIES_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Passport.number</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getPassport_Number() {
		return (EAttribute) getPassportEClass().getEAllStructuralFeatures()
				.get(PASSPORT_NUMBER_FEATURE_ID);
	}
	...
	public EAttribute getPassport_IssueDate() {
		return (EAttribute) getPassportEClass().getEAllStructuralFeatures()
				.get(PASSPORT_ISSUEDATE_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Passport.issued</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getPassport_Issued() {
		return (EAttribute) getPassportEClass().getEAllStructuralFeatures()
				.get(PASSPORT_ISSUED_FEATURE_ID);
	}
	...
	public EAttribute getDrivingLicense_Series() {
		return (EAttribute) getDrivingLicenseEClass()
				.getEAllStructuralFeatures().get(
						DRIVINGLICENSE_SERIES_FEATURE_ID);
	}
	...
	public EAttribute getDrivingLicense_Number() {
		return (EAttribute) getDrivingLicenseEClass()
				.getEAllStructuralFeatures().get(
						DRIVINGLICENSE_NUMBER_FEATURE_ID);
	}
	...
	public EAttribute getDrivingLicense_IssueDate() {
		return (EAttribute) getDrivingLicenseEClass()
				.getEAllStructuralFeatures().get(
						DRIVINGLICENSE_ISSUEDATE_FEATURE_ID);
	}
	...
	public EAttribute getDrivingLicense_Issued() {
		return (EAttribute) getDrivingLicenseEClass()
				.getEAllStructuralFeatures().get(
						DRIVINGLICENSE_ISSUED_FEATURE_ID);
	}
	...
	public EAttribute getContract_SignDate() {
		return (EAttribute) getContractEClass().getEAllStructuralFeatures()
				.get(CONTRACT_SIGNDATE_FEATURE_ID);
	}
	...
	public EReference getContract_SimCard() {
		return (EReference) getContractEClass().getEAllStructuralFeatures()
				.get(CONTRACT_SIMCARD_FEATURE_ID);
	}
	...
	public EReference getContract_PaymentInfo() {
		return (EReference) getContractEClass().getEAllStructuralFeatures()
				.get(CONTRACT_PAYMENTINFO_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Contract.car</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EReference getContract_SecretQuestions() {
		return (EReference) getContractEClass().getEAllStructuralFeatures()
				.get(CONTRACT_SECRETQUESTIONS_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Contract.number</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getContract_Number() {
		return (EAttribute) getContractEClass().getEAllStructuralFeatures()
				.get(CONTRACT_NUMBER_FEATURE_ID);
	}
	...
	public EAttribute getSecretQuestion_Question() {
		return (EAttribute) getSecretQuestionEClass()
				.getEAllStructuralFeatures().get(
						SECRETQUESTION_QUESTION_FEATURE_ID);
	}
	...
	public EAttribute getSecretQuestion_AlarmAnswer() {
		return (EAttribute) getSecretQuestionEClass()
				.getEAllStructuralFeatures().get(
						SECRETQUESTION_ALARMANSWER_FEATURE_ID);
	}
	...
	public EAttribute getSecretQuestion_Active() {
		return (EAttribute) getSecretQuestionEClass()
				.getEAllStructuralFeatures().get(
						SECRETQUESTION_ACTIVE_FEATURE_ID);
	}
	...
	public EAttribute getSecretQuestion_Type() {
		return (EAttribute) getSecretQuestionEClass()
				.getEAllStructuralFeatures()
				.get(SECRETQUESTION_TYPE_FEATURE_ID);
	}
	...
	public EAttribute getClientTariff_Name() {
		return (EAttribute) getClientTariffEClass().getEAllStructuralFeatures()
				.get(CLIENTTARIFF_NAME_FEATURE_ID);
	}
	...
	public EAttribute getClientTariff_Active() {
		return (EAttribute) getClientTariffEClass().getEAllStructuralFeatures()
				.get(CLIENTTARIFF_ACTIVE_FEATURE_ID);
	}
	...
	public EReference getClientTariff_VolumePayments() {
		return (EReference) getClientTariffEClass().getEAllStructuralFeatures()
				.get(CLIENTTARIFF_VOLUMEPAYMENTS_FEATURE_ID);
	}
	...
	public EReference getClientTariff_PeriodicalPayments() {
		return (EReference) getClientTariffEClass().getEAllStructuralFeatures()
				.get(CLIENTTARIFF_PERIODICALPAYMENTS_FEATURE_ID);
	}
	...
	public EReference getClientTariff_InitialPayment() {
		return (EReference) getClientTariffEClass().getEAllStructuralFeatures()
				.get(CLIENTTARIFF_INITIALPAYMENT_FEATURE_ID);
	}
	...
	public EReference getClientTariff_Services() {
		return (EReference) getClientTariffEClass().getEAllStructuralFeatures()
				.get(CLIENTTARIFF_SERVICES_FEATURE_ID);
	}
	...
	public EReference getContractPackage_Client() {
		return (EReference) getContractPackageEClass()
				.getEAllStructuralFeatures().get(
						CONTRACTPACKAGE_CLIENT_FEATURE_ID);
	}
	...
	public EReference getContractPackage_User() {
		return (EReference) getContractPackageEClass()
				.getEAllStructuralFeatures().get(
						CONTRACTPACKAGE_USER_FEATURE_ID);
	}
	...
	public EReference getContractPackage_Contracts() {
		return (EReference) getContractPackageEClass()
				.getEAllStructuralFeatures().get(
						CONTRACTPACKAGE_CONTRACTS_FEATURE_ID);
	}
	...
	public EAttribute getUser_Login() {
		return (EAttribute) getUserEClass().getEAllStructuralFeatures().get(
				USER_LOGIN_FEATURE_ID);
	}
	...
	public EReference getUser_Group() {
		return (EReference) getUserEClass().getEAllStructuralFeatures().get(
				USER_GROUP_FEATURE_ID);
	}
	...
	public EClass getMessageEClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				MESSAGE_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Message.text</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getMessage_Text() {
		return (EAttribute) getMessageEClass().getEAllStructuralFeatures().get(
				MESSAGE_TEXT_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Message.type</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getMessage_Type() {
		return (EAttribute) getMessageEClass().getEAllStructuralFeatures().get(
				MESSAGE_TYPE_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Message.from</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EReference getMessage_From() {
		return (EReference) getMessageEClass().getEAllStructuralFeatures().get(
				MESSAGE_FROM_FEATURE_ID);
	}
	...
	public EClass getEventEClass() {
		return (EClass) getEPackage().getEClassifiers()
				.get(EVENT_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Event.eventType</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getEvent_EventType() {
		return (EAttribute) getEventEClass().getEAllStructuralFeatures().get(
				EVENT_EVENTTYPE_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Event.message</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EReference getEvent_Message() {
		return (EReference) getEventEClass().getEAllStructuralFeatures().get(
				EVENT_MESSAGE_FEATURE_ID);
	}
	...
	public EClass getCoordinatesEClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				COORDINATES_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Coordinates.x</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getCoordinates_X() {
		return (EAttribute) getCoordinatesEClass().getEAllStructuralFeatures()
				.get(COORDINATES_X_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>Coordinates.y</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EEnum getSecretQuestionTypeEEnum() {
		return (EEnum) getEPackage().getEClassifiers().get(
				SECRETQUESTIONTYPE_CLASSIFIER_ID);
	}
