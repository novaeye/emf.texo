...
/** 
 * A representation of the model object '<em><b>SimTariff</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Тариф оператора сотовой связи
 * <!-- end-model-doc -->
 * @generated 
 */
public class SimTariff implements Tariff {
	 ...
	 * Название
	 * <!-- end-model-doc -->
	 * @param the new value of the '{@link SimTariff#getName() name}' feature.
	 * @generated
	 */
	 ...
	 * Активен ли
	 * <!-- end-model-doc -->
	 * @param the new value of the '{@link SimTariff#isActive() active}' feature.
	 * @generated
	 */
	...
	public String toString() {
		return "SimTariff " + " [name: " + getName() + "]" + " [active: "
				+ isActive() + "]";
	}
}
