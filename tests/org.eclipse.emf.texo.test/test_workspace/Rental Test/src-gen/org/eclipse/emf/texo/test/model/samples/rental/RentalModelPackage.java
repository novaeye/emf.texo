...
public class RentalModelPackage extends ModelPackage {
	 ...
	 * @generated
	 */
	public static final int DATE_CLASSIFIER_ID = 0;
	 ...
	 * @generated
	 */
	public static final int RENTALBICYCLETYPE_CLASSIFIER_ID = 2;
	 ...
	 * @generated
	 */
	public static final int RENTALBICYCLETYPEOBJECT_CLASSIFIER_ID = 3;
	 ...
	 * @generated
	 */
	public static final int RENTALCARSIZE_CLASSIFIER_ID = 6;
	 ...
	 * @generated
	 */
	public static final int RENTALCARSIZEOBJECT_CLASSIFIER_ID = 7;
	 ...
	 * @generated
	 */
	public static final int RENTALBICYCLE_CLASSIFIER_ID = 1;
	 ...
	 * @generated
	 */
	public static final int RENTALBICYCLE_TYPE_FEATURE_ID = 1;
	 ...
	 * @generated
	 */
	public static final int RENTALBICYCLE_RENTALCAR_FEATURE_ID = 2;
	 ...
	 * @generated
	 */
	public static final int RENTALUNIT_CLASSIFIER_ID = 9;
	 ...
	 * @generated
	 */
	public static final int RENTALUNIT_DESCRIPTION_FEATURE_ID = 0;
	 ...
	 * @generated
	 */
	public static final int RENTALBUSINESS_CLASSIFIER_ID = 4;
	 ...
	 * @generated
	 */
	public static final int RENTALBUSINESS_NAME_FEATURE_ID = 0;
	 ...
	 * @generated
	 */
	public static final int RENTALCARDRIVER_CLASSIFIER_ID = 11;
	 ...
	 * @generated
	 */
	public static final int RENTALCARDRIVER_NAME_FEATURE_ID = 0;
	 ...
	 * @generated
	 */
	public static final int RENTALCARDRIVER_CURRENTRENTALCAR_FEATURE_ID = 1;
	 ...
	 * @generated
	 */
	public static final int RENTALCAR_CLASSIFIER_ID = 5;
	 ...
	 * @generated
	 */
	public static final int RENTALCAR_SIZE_FEATURE_ID = 1;
	 ...
	 * @generated
	 */
	public static final int RENTALCAR_CURRENTDRIVER_FEATURE_ID = 2;
	 ...
	 * @generated
	 */
	public static final int RENTALCONTRACTLINE_CLASSIFIER_ID = 10;
	 ...
	 * @generated
	 */
	public static final int RENTALCONTRACTLINE_RENTALCONTRACT_FEATURE_ID = 0;
	 ...
	 * @generated
	 */
	public static final int RENTALCONTRACTLINE_NUMBER_FEATURE_ID = 1;
	 ...
	 * @generated
	 */
	public static final int RENTALCONTRACTLINE_RENTALUNIT_FEATURE_ID = 2;
	 ...
	 * @generated
	 */
	public static final int RENTALCONTRACT_CLASSIFIER_ID = 8;
	 ...
	 * @generated
	 */
	public static final int RENTALCONTRACT_RENTTOBUSINESSPARTNER_FEATURE_ID = 0;
	 ...
	 * @generated
	 */
	public static final int RENTALCONTRACT_STARTDATE_FEATURE_ID = 1;
	 ...
	 * @generated
	 */
	public static final int RENTALCONTRACT_ENDDATE_FEATURE_ID = 2;
	 ...
	 * @generated
	 */
	public static final int RENTALCONTRACT_COST_FEATURE_ID = 3;
	 ...
	 * @generated
	 */
	public static final int RENTALCONTRACT_RENTALCONTRACTLINES_FEATURE_ID = 4;
	...
	public static RentalModelPackage initialize() {
		...
		if (isInitialized) {
			return (RentalModelPackage) ModelResolver.getInstance()
		...
		ModelResolver.getInstance().registerClassModelMapping(
				RentalContract.class, modelPackage.getRentalContractEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				RentalBicycle.class, modelPackage.getRentalBicycleEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(RentalUnit.class,
				modelPackage.getRentalUnitEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(RentalCar.class,
				modelPackage.getRentalCarEClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				RentalBusiness.class, modelPackage.getRentalBusinessEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				RentalCarDriver.class, modelPackage.getRentalCarDriverEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				RentalContractLine.class,
				modelPackage.getRentalContractLineEClass(), modelPackage);

		ModelResolver.getInstance().registerClassModelMapping(
				RentalBicycleType.class,
				modelPackage.getRentalBicycleTypeEEnum(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				RentalCarSize.class, modelPackage.getRentalCarSizeEEnum(),
				modelPackage);
	...
	public EAttribute getRentalBicycle_Type() {
		return (EAttribute) getRentalBicycleEClass()
				.getEAllStructuralFeatures().get(RENTALBICYCLE_TYPE_FEATURE_ID);
	}
	...
	public EReference getRentalBicycle_RentalCar() {
		return (EReference) getRentalBicycleEClass()
				.getEAllStructuralFeatures().get(
						RENTALBICYCLE_RENTALCAR_FEATURE_ID);
	}
	...
	public EAttribute getRentalUnit_Description() {
		return (EAttribute) getRentalUnitEClass().getEAllStructuralFeatures()
				.get(RENTALUNIT_DESCRIPTION_FEATURE_ID);
	}
	...
	public EAttribute getRentalBusiness_Name() {
		return (EAttribute) getRentalBusinessEClass()
				.getEAllStructuralFeatures()
				.get(RENTALBUSINESS_NAME_FEATURE_ID);
	}
	...
	public EAttribute getRentalCarDriver_Name() {
		return (EAttribute) getRentalCarDriverEClass()
				.getEAllStructuralFeatures().get(
						RENTALCARDRIVER_NAME_FEATURE_ID);
	}
	...
	public EReference getRentalCarDriver_CurrentRentalCar() {
		return (EReference) getRentalCarDriverEClass()
				.getEAllStructuralFeatures().get(
	...
	public EClass getRentalCarEClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				RENTALCAR_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '<em><b>RentalCar.size</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EAttribute getRentalCar_Size() {
		return (EAttribute) getRentalCarEClass().getEAllStructuralFeatures()
				.get(RENTALCAR_SIZE_FEATURE_ID);
	}
	...
	public EReference getRentalCar_CurrentDriver() {
		return (EReference) getRentalCarEClass().getEAllStructuralFeatures()
				.get(RENTALCAR_CURRENTDRIVER_FEATURE_ID);
	}
	...
	public EClass getRentalContractLineEClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				RENTALCONTRACTLINE_CLASSIFIER_ID);
	}
	...
	public EReference getRentalContractLine_RentalContract() {
		return (EReference) getRentalContractLineEClass()
				.getEAllStructuralFeatures().get(
	...
	public EAttribute getRentalContractLine_Number() {
		return (EAttribute) getRentalContractLineEClass()
				.getEAllStructuralFeatures().get(
	...
	public EAttribute getRentalContract_RentToBusinessPartner() {
		return (EAttribute) getRentalContractEClass()
				.getEAllStructuralFeatures().get(
	...
	public EAttribute getRentalContract_StartDate() {
		return (EAttribute) getRentalContractEClass()
				.getEAllStructuralFeatures().get(
						RENTALCONTRACT_STARTDATE_FEATURE_ID);
	}
	...
	public EAttribute getRentalContract_EndDate() {
		return (EAttribute) getRentalContractEClass()
				.getEAllStructuralFeatures().get(
						RENTALCONTRACT_ENDDATE_FEATURE_ID);
	}
	...
	public EAttribute getRentalContract_Cost() {
		return (EAttribute) getRentalContractEClass()
				.getEAllStructuralFeatures()
				.get(RENTALCONTRACT_COST_FEATURE_ID);
	}
	...
	public EReference getRentalContract_RentalContractLines() {
		return (EReference) getRentalContractEClass()
				.getEAllStructuralFeatures().get(
	...
	public EEnum getRentalBicycleTypeEEnum() {
		return (EEnum) getEPackage().getEClassifiers().get(
				RENTALBICYCLETYPE_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EDataType} '<em><b>RentalBicycleTypeObject</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EDataType getRentalBicycleTypeObjectEDataType() {
		return (EDataType) getEPackage().getEClassifiers().get(
				RENTALBICYCLETYPEOBJECT_CLASSIFIER_ID);
	}
	...
	public EDataType getRentalCarSizeObjectEDataType() {
		return (EDataType) getEPackage().getEClassifiers().get(
				RENTALCARSIZEOBJECT_CLASSIFIER_ID);
	}
