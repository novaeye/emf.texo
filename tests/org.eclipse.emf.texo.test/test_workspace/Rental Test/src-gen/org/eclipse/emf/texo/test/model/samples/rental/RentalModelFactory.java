...
public class RentalModelFactory implements ModelFactory {
	 ...
	 * @generated 
	 */
	public static class RentalCarDriverModelObject<E extends RentalCarDriver>
			extends AbstractModelObject<E> {
		/**
		 * @generated
		 */
	...
	/** 
	 * The adapter/wrapper for the EClass '<em><b>RentalContractLine</b></em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated 
	 */
	public static class RentalContractLineModelObject<E extends RentalContractLine>
			extends AbstractModelObject<E> {
		/**
		 * @generated
		 */
	...
	public static class RentalContractModelObject<E extends RentalContract>
		...
		public void eSet(EStructuralFeature eStructuralFeature, Object value) {
			...
			case RentalModelPackage.RENTALCONTRACT_COST_FEATURE_ID:
				...
				return;
			case RentalModelPackage.RENTALCONTRACT_RENTALCONTRACTLINES_FEATURE_ID:
				getTarget().setRentalContractLines(
						(Set<RentalContractLine>) value);
				return;
			}
			super.eSet(eStructuralFeature, value);
		}
		...
		public void eAddTo(EStructuralFeature eStructuralFeature, Object value) {
			...
			case RentalModelPackage.RENTALCONTRACT_RENTALCONTRACTLINES_FEATURE_ID:
				getTarget()
						.addToRentalContractLines((RentalContractLine) value);
				return;
			}
			super.eAddTo(eStructuralFeature, value);
		}
		...
		public void eRemoveFrom(EStructuralFeature eStructuralFeature,
			...
			case RentalModelPackage.RENTALCONTRACT_RENTALCONTRACTLINES_FEATURE_ID:
				getTarget().removeFromRentalContractLines(
						(RentalContractLine) value);
				return;
			}
			super.eAddTo(eStructuralFeature, value);
		}
