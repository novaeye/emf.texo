...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtBankStatementType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtBankStatementTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtBankStatementTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtBankStatementTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtBankStatementTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtBankStatementTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtBankStatementTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtBankStatementTypeAnyAttributeFeatureGroup group = new FinancialMgmtBankStatementTypeAnyAttributeFeatureGroup();
