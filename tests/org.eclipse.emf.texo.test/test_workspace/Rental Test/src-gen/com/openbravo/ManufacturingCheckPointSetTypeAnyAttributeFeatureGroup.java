...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingCheckPointSetType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingCheckPointSetTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingCheckPointSetTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingCheckPointSetTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingCheckPointSetTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingCheckPointSetTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingCheckPointSetTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingCheckPointSetTypeAnyAttributeFeatureGroup group = new ManufacturingCheckPointSetTypeAnyAttributeFeatureGroup();
