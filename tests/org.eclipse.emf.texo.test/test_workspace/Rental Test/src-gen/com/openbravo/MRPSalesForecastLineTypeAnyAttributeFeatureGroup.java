...
/** 
 * A representation for the Feature Group '<em><b>MRPSalesForecastLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MRPSalesForecastLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MRPSalesForecastLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MRPSalesForecastLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MRPSalesForecastLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MRPSalesForecastLineTypeAnyAttributeFeatureGroup> result = new ArrayList<MRPSalesForecastLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MRPSalesForecastLineTypeAnyAttributeFeatureGroup group = new MRPSalesForecastLineTypeAnyAttributeFeatureGroup();
