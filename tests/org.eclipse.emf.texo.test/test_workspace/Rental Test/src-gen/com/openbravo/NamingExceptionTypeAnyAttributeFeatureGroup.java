...
/** 
 * A representation for the Feature Group '<em><b>NamingExceptionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class NamingExceptionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<NamingExceptionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final NamingExceptionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<NamingExceptionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<NamingExceptionTypeAnyAttributeFeatureGroup> result = new ArrayList<NamingExceptionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final NamingExceptionTypeAnyAttributeFeatureGroup group = new NamingExceptionTypeAnyAttributeFeatureGroup();
