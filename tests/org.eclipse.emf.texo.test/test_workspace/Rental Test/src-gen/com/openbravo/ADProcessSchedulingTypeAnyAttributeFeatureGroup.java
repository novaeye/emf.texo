...
/** 
 * A representation for the Feature Group '<em><b>ADProcessSchedulingType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADProcessSchedulingTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADProcessSchedulingTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADProcessSchedulingTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADProcessSchedulingTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADProcessSchedulingTypeAnyAttributeFeatureGroup> result = new ArrayList<ADProcessSchedulingTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADProcessSchedulingTypeAnyAttributeFeatureGroup group = new ADProcessSchedulingTypeAnyAttributeFeatureGroup();
