...
/** 
 * A representation for the Feature Group '<em><b>OBUISELSelectorFieldTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUISELSelectorFieldTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUISELSelectorFieldTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUISELSelectorFieldTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUISELSelectorFieldTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUISELSelectorFieldTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUISELSelectorFieldTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUISELSelectorFieldTrlTypeAnyAttributeFeatureGroup group = new OBUISELSelectorFieldTrlTypeAnyAttributeFeatureGroup();
