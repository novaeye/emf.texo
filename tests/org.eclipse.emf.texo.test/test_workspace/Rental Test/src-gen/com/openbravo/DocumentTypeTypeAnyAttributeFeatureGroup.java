...
/** 
 * A representation for the Feature Group '<em><b>DocumentTypeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class DocumentTypeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<DocumentTypeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final DocumentTypeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<DocumentTypeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<DocumentTypeTypeAnyAttributeFeatureGroup> result = new ArrayList<DocumentTypeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final DocumentTypeTypeAnyAttributeFeatureGroup group = new DocumentTypeTypeAnyAttributeFeatureGroup();
