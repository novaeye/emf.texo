...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingWorkEffortIncidenceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingWorkEffortIncidenceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingWorkEffortIncidenceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingWorkEffortIncidenceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingWorkEffortIncidenceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingWorkEffortIncidenceTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingWorkEffortIncidenceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingWorkEffortIncidenceTypeAnyAttributeFeatureGroup group = new ManufacturingWorkEffortIncidenceTypeAnyAttributeFeatureGroup();
