...
/** 
 * A representation for the Feature Group '<em><b>ADMessageTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADMessageTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADMessageTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADMessageTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADMessageTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADMessageTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADMessageTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADMessageTrlTypeAnyAttributeFeatureGroup group = new ADMessageTrlTypeAnyAttributeFeatureGroup();
