...
/** 
 * A representation for the Feature Group '<em><b>AttributeSetInstanceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class AttributeSetInstanceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<AttributeSetInstanceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final AttributeSetInstanceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<AttributeSetInstanceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<AttributeSetInstanceTypeAnyAttributeFeatureGroup> result = new ArrayList<AttributeSetInstanceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final AttributeSetInstanceTypeAnyAttributeFeatureGroup group = new AttributeSetInstanceTypeAnyAttributeFeatureGroup();
