...
/** 
 * A representation for the Feature Group '<em><b>ADReferenceTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADReferenceTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADReferenceTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADReferenceTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADReferenceTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADReferenceTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADReferenceTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADReferenceTrlTypeAnyAttributeFeatureGroup group = new ADReferenceTrlTypeAnyAttributeFeatureGroup();
