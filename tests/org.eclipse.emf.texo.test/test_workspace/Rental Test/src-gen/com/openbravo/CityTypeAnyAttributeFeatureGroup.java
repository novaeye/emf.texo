...
/** 
 * A representation for the Feature Group '<em><b>CityType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class CityTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<CityTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final CityTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<CityTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<CityTypeAnyAttributeFeatureGroup> result = new ArrayList<CityTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final CityTypeAnyAttributeFeatureGroup group = new CityTypeAnyAttributeFeatureGroup();
