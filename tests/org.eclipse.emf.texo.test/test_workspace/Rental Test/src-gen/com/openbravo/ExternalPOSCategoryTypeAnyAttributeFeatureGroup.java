...
/** 
 * A representation for the Feature Group '<em><b>ExternalPOSCategoryType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ExternalPOSCategoryTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ExternalPOSCategoryTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ExternalPOSCategoryTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ExternalPOSCategoryTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ExternalPOSCategoryTypeAnyAttributeFeatureGroup> result = new ArrayList<ExternalPOSCategoryTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ExternalPOSCategoryTypeAnyAttributeFeatureGroup group = new ExternalPOSCategoryTypeAnyAttributeFeatureGroup();
