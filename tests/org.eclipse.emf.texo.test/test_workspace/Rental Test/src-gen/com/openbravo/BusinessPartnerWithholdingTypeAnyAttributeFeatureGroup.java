...
/** 
 * A representation for the Feature Group '<em><b>BusinessPartnerWithholdingType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class BusinessPartnerWithholdingTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<BusinessPartnerWithholdingTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final BusinessPartnerWithholdingTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<BusinessPartnerWithholdingTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<BusinessPartnerWithholdingTypeAnyAttributeFeatureGroup> result = new ArrayList<BusinessPartnerWithholdingTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final BusinessPartnerWithholdingTypeAnyAttributeFeatureGroup group = new BusinessPartnerWithholdingTypeAnyAttributeFeatureGroup();
