...
/** 
 * A representation for the Feature Group '<em><b>ADRegistrationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADRegistrationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADRegistrationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADRegistrationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADRegistrationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADRegistrationTypeAnyAttributeFeatureGroup> result = new ArrayList<ADRegistrationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADRegistrationTypeAnyAttributeFeatureGroup group = new ADRegistrationTypeAnyAttributeFeatureGroup();
