...
/** 
 * A representation for the Feature Group '<em><b>FINFinancialAccountAcctType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINFinancialAccountAcctTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINFinancialAccountAcctTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINFinancialAccountAcctTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINFinancialAccountAcctTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINFinancialAccountAcctTypeAnyAttributeFeatureGroup> result = new ArrayList<FINFinancialAccountAcctTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINFinancialAccountAcctTypeAnyAttributeFeatureGroup group = new FINFinancialAccountAcctTypeAnyAttributeFeatureGroup();
