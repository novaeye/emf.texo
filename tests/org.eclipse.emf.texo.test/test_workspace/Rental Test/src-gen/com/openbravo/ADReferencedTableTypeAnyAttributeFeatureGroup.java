...
/** 
 * A representation for the Feature Group '<em><b>ADReferencedTableType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADReferencedTableTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADReferencedTableTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADReferencedTableTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADReferencedTableTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADReferencedTableTypeAnyAttributeFeatureGroup> result = new ArrayList<ADReferencedTableTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADReferencedTableTypeAnyAttributeFeatureGroup group = new ADReferencedTableTypeAnyAttributeFeatureGroup();
