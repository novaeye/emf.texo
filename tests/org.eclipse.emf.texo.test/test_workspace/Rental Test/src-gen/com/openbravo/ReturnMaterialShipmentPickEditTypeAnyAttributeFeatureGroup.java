...
/** 
 * A representation for the Feature Group '<em><b>ReturnMaterialShipmentPickEditType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ReturnMaterialShipmentPickEditTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ReturnMaterialShipmentPickEditTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ReturnMaterialShipmentPickEditTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ReturnMaterialShipmentPickEditTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ReturnMaterialShipmentPickEditTypeAnyAttributeFeatureGroup> result = new ArrayList<ReturnMaterialShipmentPickEditTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ReturnMaterialShipmentPickEditTypeAnyAttributeFeatureGroup group = new ReturnMaterialShipmentPickEditTypeAnyAttributeFeatureGroup();
