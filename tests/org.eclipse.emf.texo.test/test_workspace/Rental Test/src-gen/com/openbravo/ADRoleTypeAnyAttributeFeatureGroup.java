...
/** 
 * A representation for the Feature Group '<em><b>ADRoleType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADRoleTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADRoleTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADRoleTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADRoleTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADRoleTypeAnyAttributeFeatureGroup> result = new ArrayList<ADRoleTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADRoleTypeAnyAttributeFeatureGroup group = new ADRoleTypeAnyAttributeFeatureGroup();
