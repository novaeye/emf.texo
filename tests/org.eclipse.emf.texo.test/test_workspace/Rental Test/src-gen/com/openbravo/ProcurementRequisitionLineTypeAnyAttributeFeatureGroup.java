...
/** 
 * A representation for the Feature Group '<em><b>ProcurementRequisitionLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProcurementRequisitionLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProcurementRequisitionLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProcurementRequisitionLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProcurementRequisitionLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProcurementRequisitionLineTypeAnyAttributeFeatureGroup> result = new ArrayList<ProcurementRequisitionLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProcurementRequisitionLineTypeAnyAttributeFeatureGroup group = new ProcurementRequisitionLineTypeAnyAttributeFeatureGroup();
