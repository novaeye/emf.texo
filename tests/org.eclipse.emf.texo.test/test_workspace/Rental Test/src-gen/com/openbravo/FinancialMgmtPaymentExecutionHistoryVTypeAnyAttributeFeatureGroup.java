...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtPaymentExecutionHistoryVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtPaymentExecutionHistoryVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtPaymentExecutionHistoryVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtPaymentExecutionHistoryVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtPaymentExecutionHistoryVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtPaymentExecutionHistoryVTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtPaymentExecutionHistoryVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtPaymentExecutionHistoryVTypeAnyAttributeFeatureGroup group = new FinancialMgmtPaymentExecutionHistoryVTypeAnyAttributeFeatureGroup();
