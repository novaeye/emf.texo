...
/** 
 * A representation for the Feature Group '<em><b>UOMConversionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class UOMConversionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<UOMConversionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final UOMConversionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<UOMConversionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<UOMConversionTypeAnyAttributeFeatureGroup> result = new ArrayList<UOMConversionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final UOMConversionTypeAnyAttributeFeatureGroup group = new UOMConversionTypeAnyAttributeFeatureGroup();
