...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtProductionPlanType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtProductionPlanTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtProductionPlanTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtProductionPlanTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtProductionPlanTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtProductionPlanTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtProductionPlanTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtProductionPlanTypeAnyAttributeFeatureGroup group = new MaterialMgmtProductionPlanTypeAnyAttributeFeatureGroup();
