...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAcctSchemaElementType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAcctSchemaElementTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAcctSchemaElementTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAcctSchemaElementTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAcctSchemaElementTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAcctSchemaElementTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAcctSchemaElementTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAcctSchemaElementTypeAnyAttributeFeatureGroup group = new FinancialMgmtAcctSchemaElementTypeAnyAttributeFeatureGroup();
