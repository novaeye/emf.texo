...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingWorkRequirementType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingWorkRequirementTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingWorkRequirementTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingWorkRequirementTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingWorkRequirementTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingWorkRequirementTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingWorkRequirementTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingWorkRequirementTypeAnyAttributeFeatureGroup group = new ManufacturingWorkRequirementTypeAnyAttributeFeatureGroup();
