...
/** 
 * A representation for the Feature Group '<em><b>ADFieldType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADFieldTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADFieldTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADFieldTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADFieldTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADFieldTypeAnyAttributeFeatureGroup> result = new ArrayList<ADFieldTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADFieldTypeAnyAttributeFeatureGroup group = new ADFieldTypeAnyAttributeFeatureGroup();
