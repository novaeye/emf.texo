...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtWithholdingAccountsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtWithholdingAccountsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtWithholdingAccountsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtWithholdingAccountsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtWithholdingAccountsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtWithholdingAccountsTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtWithholdingAccountsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtWithholdingAccountsTypeAnyAttributeFeatureGroup group = new FinancialMgmtWithholdingAccountsTypeAnyAttributeFeatureGroup();
