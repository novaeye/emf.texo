...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingValueType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingValueTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingValueTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingValueTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingValueTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingValueTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingValueTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingValueTypeAnyAttributeFeatureGroup group = new ManufacturingValueTypeAnyAttributeFeatureGroup();
