...
/** 
 * A representation for the Feature Group '<em><b>ADAuxiliaryInputType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADAuxiliaryInputTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADAuxiliaryInputTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADAuxiliaryInputTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADAuxiliaryInputTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADAuxiliaryInputTypeAnyAttributeFeatureGroup> result = new ArrayList<ADAuxiliaryInputTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADAuxiliaryInputTypeAnyAttributeFeatureGroup group = new ADAuxiliaryInputTypeAnyAttributeFeatureGroup();
