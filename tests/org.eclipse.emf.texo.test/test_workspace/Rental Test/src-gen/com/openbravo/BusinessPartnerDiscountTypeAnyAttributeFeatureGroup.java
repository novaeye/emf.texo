...
/** 
 * A representation for the Feature Group '<em><b>BusinessPartnerDiscountType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class BusinessPartnerDiscountTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<BusinessPartnerDiscountTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final BusinessPartnerDiscountTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<BusinessPartnerDiscountTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<BusinessPartnerDiscountTypeAnyAttributeFeatureGroup> result = new ArrayList<BusinessPartnerDiscountTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final BusinessPartnerDiscountTypeAnyAttributeFeatureGroup group = new BusinessPartnerDiscountTypeAnyAttributeFeatureGroup();
