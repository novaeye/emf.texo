...
/** 
 * A representation for the Feature Group '<em><b>CurrencyType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class CurrencyTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<CurrencyTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final CurrencyTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<CurrencyTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<CurrencyTypeAnyAttributeFeatureGroup> result = new ArrayList<CurrencyTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final CurrencyTypeAnyAttributeFeatureGroup group = new CurrencyTypeAnyAttributeFeatureGroup();
