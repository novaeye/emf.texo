...
/** 
 * A representation for the Feature Group '<em><b>OBUIAPPProcessType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUIAPPProcessTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUIAPPProcessTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUIAPPProcessTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUIAPPProcessTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUIAPPProcessTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUIAPPProcessTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUIAPPProcessTypeAnyAttributeFeatureGroup group = new OBUIAPPProcessTypeAnyAttributeFeatureGroup();
