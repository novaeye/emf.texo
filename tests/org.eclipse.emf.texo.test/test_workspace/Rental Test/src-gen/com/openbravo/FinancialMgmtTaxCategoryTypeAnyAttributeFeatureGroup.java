...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtTaxCategoryType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtTaxCategoryTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtTaxCategoryTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtTaxCategoryTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtTaxCategoryTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtTaxCategoryTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtTaxCategoryTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtTaxCategoryTypeAnyAttributeFeatureGroup group = new FinancialMgmtTaxCategoryTypeAnyAttributeFeatureGroup();
