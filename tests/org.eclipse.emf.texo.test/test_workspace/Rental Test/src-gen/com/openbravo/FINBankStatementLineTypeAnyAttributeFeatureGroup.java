...
/** 
 * A representation for the Feature Group '<em><b>FINBankStatementLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINBankStatementLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINBankStatementLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINBankStatementLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINBankStatementLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINBankStatementLineTypeAnyAttributeFeatureGroup> result = new ArrayList<FINBankStatementLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINBankStatementLineTypeAnyAttributeFeatureGroup group = new FINBankStatementLineTypeAnyAttributeFeatureGroup();
