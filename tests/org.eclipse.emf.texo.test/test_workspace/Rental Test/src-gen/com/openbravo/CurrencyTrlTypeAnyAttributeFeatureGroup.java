...
/** 
 * A representation for the Feature Group '<em><b>CurrencyTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class CurrencyTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<CurrencyTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final CurrencyTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<CurrencyTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<CurrencyTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<CurrencyTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final CurrencyTrlTypeAnyAttributeFeatureGroup group = new CurrencyTrlTypeAnyAttributeFeatureGroup();
