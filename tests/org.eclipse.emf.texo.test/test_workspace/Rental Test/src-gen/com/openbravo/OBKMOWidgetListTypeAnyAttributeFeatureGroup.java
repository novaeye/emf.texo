...
/** 
 * A representation for the Feature Group '<em><b>OBKMOWidgetListType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBKMOWidgetListTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBKMOWidgetListTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBKMOWidgetListTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBKMOWidgetListTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBKMOWidgetListTypeAnyAttributeFeatureGroup> result = new ArrayList<OBKMOWidgetListTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBKMOWidgetListTypeAnyAttributeFeatureGroup group = new OBKMOWidgetListTypeAnyAttributeFeatureGroup();
