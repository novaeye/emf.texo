...
/** 
 * A representation for the Feature Group '<em><b>ReturnMaterialOrderPickEditLinesType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ReturnMaterialOrderPickEditLinesTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ReturnMaterialOrderPickEditLinesTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ReturnMaterialOrderPickEditLinesTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ReturnMaterialOrderPickEditLinesTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ReturnMaterialOrderPickEditLinesTypeAnyAttributeFeatureGroup> result = new ArrayList<ReturnMaterialOrderPickEditLinesTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ReturnMaterialOrderPickEditLinesTypeAnyAttributeFeatureGroup group = new ReturnMaterialOrderPickEditLinesTypeAnyAttributeFeatureGroup();
