...
/** 
 * A representation for the Feature Group '<em><b>ReferenceDataStoreType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ReferenceDataStoreTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ReferenceDataStoreTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ReferenceDataStoreTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ReferenceDataStoreTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ReferenceDataStoreTypeAnyAttributeFeatureGroup> result = new ArrayList<ReferenceDataStoreTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ReferenceDataStoreTypeAnyAttributeFeatureGroup group = new ReferenceDataStoreTypeAnyAttributeFeatureGroup();
