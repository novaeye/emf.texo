...
/** 
 * A representation for the Feature Group '<em><b>ADEPInstanceParaType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADEPInstanceParaTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADEPInstanceParaTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADEPInstanceParaTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADEPInstanceParaTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADEPInstanceParaTypeAnyAttributeFeatureGroup> result = new ArrayList<ADEPInstanceParaTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADEPInstanceParaTypeAnyAttributeFeatureGroup group = new ADEPInstanceParaTypeAnyAttributeFeatureGroup();
