...
/** 
 * A representation for the Feature Group '<em><b>ADSessionUsageAuditType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADSessionUsageAuditTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADSessionUsageAuditTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADSessionUsageAuditTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADSessionUsageAuditTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADSessionUsageAuditTypeAnyAttributeFeatureGroup> result = new ArrayList<ADSessionUsageAuditTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADSessionUsageAuditTypeAnyAttributeFeatureGroup group = new ADSessionUsageAuditTypeAnyAttributeFeatureGroup();
