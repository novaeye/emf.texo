...
/** 
 * A representation for the Feature Group '<em><b>ADTreeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADTreeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADTreeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADTreeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADTreeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADTreeTypeAnyAttributeFeatureGroup> result = new ArrayList<ADTreeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADTreeTypeAnyAttributeFeatureGroup group = new ADTreeTypeAnyAttributeFeatureGroup();
