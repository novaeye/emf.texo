...
/** 
 * A representation for the Feature Group '<em><b>OBUIAPPMenuParametersType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUIAPPMenuParametersTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUIAPPMenuParametersTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUIAPPMenuParametersTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUIAPPMenuParametersTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUIAPPMenuParametersTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUIAPPMenuParametersTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUIAPPMenuParametersTypeAnyAttributeFeatureGroup group = new OBUIAPPMenuParametersTypeAnyAttributeFeatureGroup();
