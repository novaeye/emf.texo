...
/** 
 * A representation for the Feature Group '<em><b>ProcessRequestType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProcessRequestTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProcessRequestTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProcessRequestTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProcessRequestTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProcessRequestTypeAnyAttributeFeatureGroup> result = new ArrayList<ProcessRequestTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProcessRequestTypeAnyAttributeFeatureGroup group = new ProcessRequestTypeAnyAttributeFeatureGroup();
