...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtStoragePendingType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtStoragePendingTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtStoragePendingTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtStoragePendingTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtStoragePendingTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtStoragePendingTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtStoragePendingTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtStoragePendingTypeAnyAttributeFeatureGroup group = new MaterialMgmtStoragePendingTypeAnyAttributeFeatureGroup();
