...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtGLItemType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtGLItemTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtGLItemTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtGLItemTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtGLItemTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtGLItemTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtGLItemTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtGLItemTypeAnyAttributeFeatureGroup group = new FinancialMgmtGLItemTypeAnyAttributeFeatureGroup();
