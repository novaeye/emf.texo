...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingCostcenterEmployeeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingCostcenterEmployeeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingCostcenterEmployeeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingCostcenterEmployeeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingCostcenterEmployeeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingCostcenterEmployeeTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingCostcenterEmployeeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingCostcenterEmployeeTypeAnyAttributeFeatureGroup group = new ManufacturingCostcenterEmployeeTypeAnyAttributeFeatureGroup();
