...
/** 
 * A representation for the Feature Group '<em><b>ResourceTypeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ResourceTypeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ResourceTypeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ResourceTypeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ResourceTypeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ResourceTypeTypeAnyAttributeFeatureGroup> result = new ArrayList<ResourceTypeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ResourceTypeTypeAnyAttributeFeatureGroup group = new ResourceTypeTypeAnyAttributeFeatureGroup();
