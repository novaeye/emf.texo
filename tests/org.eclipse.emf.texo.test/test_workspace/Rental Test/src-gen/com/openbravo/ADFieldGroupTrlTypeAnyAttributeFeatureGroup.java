...
/** 
 * A representation for the Feature Group '<em><b>ADFieldGroupTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADFieldGroupTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADFieldGroupTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADFieldGroupTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADFieldGroupTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADFieldGroupTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADFieldGroupTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADFieldGroupTrlTypeAnyAttributeFeatureGroup group = new ADFieldGroupTrlTypeAnyAttributeFeatureGroup();
