...
/** 
 * A representation for the Feature Group '<em><b>OBUIAPPNavigationBarComponentType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUIAPPNavigationBarComponentTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUIAPPNavigationBarComponentTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUIAPPNavigationBarComponentTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUIAPPNavigationBarComponentTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUIAPPNavigationBarComponentTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUIAPPNavigationBarComponentTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUIAPPNavigationBarComponentTypeAnyAttributeFeatureGroup group = new OBUIAPPNavigationBarComponentTypeAnyAttributeFeatureGroup();
