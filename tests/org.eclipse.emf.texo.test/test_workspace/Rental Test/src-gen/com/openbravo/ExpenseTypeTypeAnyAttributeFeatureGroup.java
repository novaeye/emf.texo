...
/** 
 * A representation for the Feature Group '<em><b>ExpenseTypeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ExpenseTypeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ExpenseTypeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ExpenseTypeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ExpenseTypeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ExpenseTypeTypeAnyAttributeFeatureGroup> result = new ArrayList<ExpenseTypeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ExpenseTypeTypeAnyAttributeFeatureGroup group = new ExpenseTypeTypeAnyAttributeFeatureGroup();
