...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingProcessPlanType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingProcessPlanTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingProcessPlanTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingProcessPlanTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingProcessPlanTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingProcessPlanTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingProcessPlanTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingProcessPlanTypeAnyAttributeFeatureGroup group = new ManufacturingProcessPlanTypeAnyAttributeFeatureGroup();
