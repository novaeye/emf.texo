...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingProductionRunMachineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingProductionRunMachineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingProductionRunMachineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingProductionRunMachineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingProductionRunMachineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingProductionRunMachineTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingProductionRunMachineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingProductionRunMachineTypeAnyAttributeFeatureGroup group = new ManufacturingProductionRunMachineTypeAnyAttributeFeatureGroup();
