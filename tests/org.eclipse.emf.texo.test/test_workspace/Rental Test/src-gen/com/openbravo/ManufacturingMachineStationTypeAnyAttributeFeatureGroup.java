...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingMachineStationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingMachineStationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingMachineStationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingMachineStationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingMachineStationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingMachineStationTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingMachineStationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingMachineStationTypeAnyAttributeFeatureGroup group = new ManufacturingMachineStationTypeAnyAttributeFeatureGroup();
