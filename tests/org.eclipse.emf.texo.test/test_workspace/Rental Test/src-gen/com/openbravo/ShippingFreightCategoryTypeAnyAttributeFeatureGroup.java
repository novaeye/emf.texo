...
/** 
 * A representation for the Feature Group '<em><b>ShippingFreightCategoryType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ShippingFreightCategoryTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ShippingFreightCategoryTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ShippingFreightCategoryTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ShippingFreightCategoryTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ShippingFreightCategoryTypeAnyAttributeFeatureGroup> result = new ArrayList<ShippingFreightCategoryTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ShippingFreightCategoryTypeAnyAttributeFeatureGroup group = new ShippingFreightCategoryTypeAnyAttributeFeatureGroup();
