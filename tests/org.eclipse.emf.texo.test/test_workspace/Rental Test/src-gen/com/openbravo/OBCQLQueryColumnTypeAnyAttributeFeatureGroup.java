...
/** 
 * A representation for the Feature Group '<em><b>OBCQLQueryColumnType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBCQLQueryColumnTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBCQLQueryColumnTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBCQLQueryColumnTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBCQLQueryColumnTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBCQLQueryColumnTypeAnyAttributeFeatureGroup> result = new ArrayList<OBCQLQueryColumnTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBCQLQueryColumnTypeAnyAttributeFeatureGroup group = new OBCQLQueryColumnTypeAnyAttributeFeatureGroup();
