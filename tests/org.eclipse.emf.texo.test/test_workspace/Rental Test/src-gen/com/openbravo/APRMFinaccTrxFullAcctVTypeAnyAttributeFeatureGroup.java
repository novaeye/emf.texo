...
/** 
 * A representation for the Feature Group '<em><b>APRMFinaccTrxFullAcctVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class APRMFinaccTrxFullAcctVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<APRMFinaccTrxFullAcctVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final APRMFinaccTrxFullAcctVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<APRMFinaccTrxFullAcctVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<APRMFinaccTrxFullAcctVTypeAnyAttributeFeatureGroup> result = new ArrayList<APRMFinaccTrxFullAcctVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final APRMFinaccTrxFullAcctVTypeAnyAttributeFeatureGroup group = new APRMFinaccTrxFullAcctVTypeAnyAttributeFeatureGroup();
