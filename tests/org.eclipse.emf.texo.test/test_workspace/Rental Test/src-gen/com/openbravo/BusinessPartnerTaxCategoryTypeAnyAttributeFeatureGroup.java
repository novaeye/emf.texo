...
/** 
 * A representation for the Feature Group '<em><b>BusinessPartnerTaxCategoryType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class BusinessPartnerTaxCategoryTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<BusinessPartnerTaxCategoryTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final BusinessPartnerTaxCategoryTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<BusinessPartnerTaxCategoryTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<BusinessPartnerTaxCategoryTypeAnyAttributeFeatureGroup> result = new ArrayList<BusinessPartnerTaxCategoryTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final BusinessPartnerTaxCategoryTypeAnyAttributeFeatureGroup group = new BusinessPartnerTaxCategoryTypeAnyAttributeFeatureGroup();
