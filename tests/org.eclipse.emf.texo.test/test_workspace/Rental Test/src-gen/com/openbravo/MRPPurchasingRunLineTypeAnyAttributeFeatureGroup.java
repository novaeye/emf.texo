...
/** 
 * A representation for the Feature Group '<em><b>MRPPurchasingRunLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MRPPurchasingRunLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MRPPurchasingRunLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MRPPurchasingRunLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MRPPurchasingRunLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MRPPurchasingRunLineTypeAnyAttributeFeatureGroup> result = new ArrayList<MRPPurchasingRunLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MRPPurchasingRunLineTypeAnyAttributeFeatureGroup group = new MRPPurchasingRunLineTypeAnyAttributeFeatureGroup();
