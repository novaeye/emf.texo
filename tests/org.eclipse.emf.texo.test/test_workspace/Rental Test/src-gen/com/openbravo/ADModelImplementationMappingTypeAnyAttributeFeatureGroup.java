...
/** 
 * A representation for the Feature Group '<em><b>ADModelImplementationMappingType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADModelImplementationMappingTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADModelImplementationMappingTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADModelImplementationMappingTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADModelImplementationMappingTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADModelImplementationMappingTypeAnyAttributeFeatureGroup> result = new ArrayList<ADModelImplementationMappingTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADModelImplementationMappingTypeAnyAttributeFeatureGroup group = new ADModelImplementationMappingTypeAnyAttributeFeatureGroup();
