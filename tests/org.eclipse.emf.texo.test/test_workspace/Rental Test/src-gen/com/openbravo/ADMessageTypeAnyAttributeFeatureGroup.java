...
/** 
 * A representation for the Feature Group '<em><b>ADMessageType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADMessageTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADMessageTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADMessageTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADMessageTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADMessageTypeAnyAttributeFeatureGroup> result = new ArrayList<ADMessageTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADMessageTypeAnyAttributeFeatureGroup group = new ADMessageTypeAnyAttributeFeatureGroup();
