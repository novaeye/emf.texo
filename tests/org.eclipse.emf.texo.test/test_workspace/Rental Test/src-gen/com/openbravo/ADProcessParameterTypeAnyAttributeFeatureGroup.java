...
/** 
 * A representation for the Feature Group '<em><b>ADProcessParameterType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADProcessParameterTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADProcessParameterTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADProcessParameterTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADProcessParameterTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADProcessParameterTypeAnyAttributeFeatureGroup> result = new ArrayList<ADProcessParameterTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADProcessParameterTypeAnyAttributeFeatureGroup group = new ADProcessParameterTypeAnyAttributeFeatureGroup();
