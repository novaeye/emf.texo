...
/** 
 * A representation for the Feature Group '<em><b>PricingDiscountType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingDiscountTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingDiscountTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingDiscountTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingDiscountTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingDiscountTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingDiscountTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingDiscountTypeAnyAttributeFeatureGroup group = new PricingDiscountTypeAnyAttributeFeatureGroup();
