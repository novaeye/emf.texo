...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingPeriodicControlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingPeriodicControlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingPeriodicControlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingPeriodicControlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingPeriodicControlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingPeriodicControlTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingPeriodicControlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingPeriodicControlTypeAnyAttributeFeatureGroup group = new ManufacturingPeriodicControlTypeAnyAttributeFeatureGroup();
