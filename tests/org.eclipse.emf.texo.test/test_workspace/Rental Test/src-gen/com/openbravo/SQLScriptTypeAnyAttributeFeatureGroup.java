...
/** 
 * A representation for the Feature Group '<em><b>SQLScriptType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class SQLScriptTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<SQLScriptTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final SQLScriptTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<SQLScriptTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<SQLScriptTypeAnyAttributeFeatureGroup> result = new ArrayList<SQLScriptTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final SQLScriptTypeAnyAttributeFeatureGroup group = new SQLScriptTypeAnyAttributeFeatureGroup();
