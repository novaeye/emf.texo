...
/** 
 * A representation for the Feature Group '<em><b>ADTreeNodeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADTreeNodeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADTreeNodeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADTreeNodeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADTreeNodeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADTreeNodeTypeAnyAttributeFeatureGroup> result = new ArrayList<ADTreeNodeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADTreeNodeTypeAnyAttributeFeatureGroup group = new ADTreeNodeTypeAnyAttributeFeatureGroup();
