...
/** 
 * A representation for the Feature Group '<em><b>ProductStockViewType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProductStockViewTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProductStockViewTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProductStockViewTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProductStockViewTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProductStockViewTypeAnyAttributeFeatureGroup> result = new ArrayList<ProductStockViewTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProductStockViewTypeAnyAttributeFeatureGroup group = new ProductStockViewTypeAnyAttributeFeatureGroup();
