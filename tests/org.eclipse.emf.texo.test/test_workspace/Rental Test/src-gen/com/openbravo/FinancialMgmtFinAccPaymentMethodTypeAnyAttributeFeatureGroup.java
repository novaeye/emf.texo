...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtFinAccPaymentMethodType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtFinAccPaymentMethodTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtFinAccPaymentMethodTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtFinAccPaymentMethodTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtFinAccPaymentMethodTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtFinAccPaymentMethodTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtFinAccPaymentMethodTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtFinAccPaymentMethodTypeAnyAttributeFeatureGroup group = new FinancialMgmtFinAccPaymentMethodTypeAnyAttributeFeatureGroup();
