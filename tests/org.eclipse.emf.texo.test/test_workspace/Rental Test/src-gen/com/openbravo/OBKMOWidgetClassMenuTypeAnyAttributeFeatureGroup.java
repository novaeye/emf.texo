...
/** 
 * A representation for the Feature Group '<em><b>OBKMOWidgetClassMenuType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBKMOWidgetClassMenuTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBKMOWidgetClassMenuTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBKMOWidgetClassMenuTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBKMOWidgetClassMenuTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBKMOWidgetClassMenuTypeAnyAttributeFeatureGroup> result = new ArrayList<OBKMOWidgetClassMenuTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBKMOWidgetClassMenuTypeAnyAttributeFeatureGroup group = new OBKMOWidgetClassMenuTypeAnyAttributeFeatureGroup();
