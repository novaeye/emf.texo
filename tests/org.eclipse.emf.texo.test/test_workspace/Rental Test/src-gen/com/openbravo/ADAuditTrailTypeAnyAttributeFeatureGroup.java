...
/** 
 * A representation for the Feature Group '<em><b>ADAuditTrailType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADAuditTrailTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADAuditTrailTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADAuditTrailTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADAuditTrailTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADAuditTrailTypeAnyAttributeFeatureGroup> result = new ArrayList<ADAuditTrailTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADAuditTrailTypeAnyAttributeFeatureGroup group = new ADAuditTrailTypeAnyAttributeFeatureGroup();
