...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtPromissoryFormatType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtPromissoryFormatTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtPromissoryFormatTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtPromissoryFormatTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtPromissoryFormatTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtPromissoryFormatTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtPromissoryFormatTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtPromissoryFormatTypeAnyAttributeFeatureGroup group = new FinancialMgmtPromissoryFormatTypeAnyAttributeFeatureGroup();
