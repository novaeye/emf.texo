...
/** 
 * A representation for the Feature Group '<em><b>SalaryCategoryCostType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class SalaryCategoryCostTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<SalaryCategoryCostTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final SalaryCategoryCostTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<SalaryCategoryCostTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<SalaryCategoryCostTypeAnyAttributeFeatureGroup> result = new ArrayList<SalaryCategoryCostTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final SalaryCategoryCostTypeAnyAttributeFeatureGroup group = new SalaryCategoryCostTypeAnyAttributeFeatureGroup();
