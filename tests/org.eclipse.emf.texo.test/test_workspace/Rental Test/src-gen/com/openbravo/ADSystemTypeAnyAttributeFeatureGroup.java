...
/** 
 * A representation for the Feature Group '<em><b>ADSystemType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADSystemTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADSystemTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADSystemTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADSystemTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADSystemTypeAnyAttributeFeatureGroup> result = new ArrayList<ADSystemTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADSystemTypeAnyAttributeFeatureGroup group = new ADSystemTypeAnyAttributeFeatureGroup();
