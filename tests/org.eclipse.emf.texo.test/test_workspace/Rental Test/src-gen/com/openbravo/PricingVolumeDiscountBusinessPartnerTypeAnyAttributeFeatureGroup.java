...
/** 
 * A representation for the Feature Group '<em><b>PricingVolumeDiscountBusinessPartnerType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingVolumeDiscountBusinessPartnerTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingVolumeDiscountBusinessPartnerTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingVolumeDiscountBusinessPartnerTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingVolumeDiscountBusinessPartnerTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingVolumeDiscountBusinessPartnerTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingVolumeDiscountBusinessPartnerTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingVolumeDiscountBusinessPartnerTypeAnyAttributeFeatureGroup group = new PricingVolumeDiscountBusinessPartnerTypeAnyAttributeFeatureGroup();
