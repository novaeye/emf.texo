...
/** 
 * A representation for the Feature Group '<em><b>ModuleTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ModuleTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ModuleTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ModuleTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ModuleTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ModuleTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ModuleTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ModuleTrlTypeAnyAttributeFeatureGroup group = new ModuleTrlTypeAnyAttributeFeatureGroup();
