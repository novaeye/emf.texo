...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingMainteanceOrderType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingMainteanceOrderTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingMainteanceOrderTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingMainteanceOrderTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingMainteanceOrderTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingMainteanceOrderTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingMainteanceOrderTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingMainteanceOrderTypeAnyAttributeFeatureGroup group = new ManufacturingMainteanceOrderTypeAnyAttributeFeatureGroup();
