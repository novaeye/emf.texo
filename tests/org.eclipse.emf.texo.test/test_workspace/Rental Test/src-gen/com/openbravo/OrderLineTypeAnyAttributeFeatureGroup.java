...
/** 
 * A representation for the Feature Group '<em><b>OrderLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OrderLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OrderLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OrderLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OrderLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OrderLineTypeAnyAttributeFeatureGroup> result = new ArrayList<OrderLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OrderLineTypeAnyAttributeFeatureGroup group = new OrderLineTypeAnyAttributeFeatureGroup();
