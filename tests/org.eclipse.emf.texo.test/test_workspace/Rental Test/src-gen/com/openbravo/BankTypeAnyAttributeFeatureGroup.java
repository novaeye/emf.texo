...
/** 
 * A representation for the Feature Group '<em><b>BankType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class BankTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<BankTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final BankTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<BankTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<BankTypeAnyAttributeFeatureGroup> result = new ArrayList<BankTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final BankTypeAnyAttributeFeatureGroup group = new BankTypeAnyAttributeFeatureGroup();
