...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAccountingCombinationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAccountingCombinationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAccountingCombinationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAccountingCombinationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAccountingCombinationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAccountingCombinationTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAccountingCombinationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAccountingCombinationTypeAnyAttributeFeatureGroup group = new FinancialMgmtAccountingCombinationTypeAnyAttributeFeatureGroup();
