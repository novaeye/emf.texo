...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtBudgetType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtBudgetTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtBudgetTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtBudgetTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtBudgetTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtBudgetTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtBudgetTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtBudgetTypeAnyAttributeFeatureGroup group = new FinancialMgmtBudgetTypeAnyAttributeFeatureGroup();
