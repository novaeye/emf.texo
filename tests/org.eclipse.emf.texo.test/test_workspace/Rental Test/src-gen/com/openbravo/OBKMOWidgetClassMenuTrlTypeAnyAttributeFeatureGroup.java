...
/** 
 * A representation for the Feature Group '<em><b>OBKMOWidgetClassMenuTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBKMOWidgetClassMenuTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBKMOWidgetClassMenuTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBKMOWidgetClassMenuTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBKMOWidgetClassMenuTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBKMOWidgetClassMenuTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<OBKMOWidgetClassMenuTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBKMOWidgetClassMenuTrlTypeAnyAttributeFeatureGroup group = new OBKMOWidgetClassMenuTrlTypeAnyAttributeFeatureGroup();
