...
/** 
 * A representation for the Feature Group '<em><b>ApprovedVendorType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ApprovedVendorTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ApprovedVendorTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ApprovedVendorTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ApprovedVendorTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ApprovedVendorTypeAnyAttributeFeatureGroup> result = new ArrayList<ApprovedVendorTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ApprovedVendorTypeAnyAttributeFeatureGroup group = new ApprovedVendorTypeAnyAttributeFeatureGroup();
