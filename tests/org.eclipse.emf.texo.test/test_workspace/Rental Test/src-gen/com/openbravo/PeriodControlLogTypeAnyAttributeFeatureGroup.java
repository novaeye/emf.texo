...
/** 
 * A representation for the Feature Group '<em><b>PeriodControlLogType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PeriodControlLogTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PeriodControlLogTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PeriodControlLogTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PeriodControlLogTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PeriodControlLogTypeAnyAttributeFeatureGroup> result = new ArrayList<PeriodControlLogTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PeriodControlLogTypeAnyAttributeFeatureGroup group = new PeriodControlLogTypeAnyAttributeFeatureGroup();
