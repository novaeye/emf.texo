...
/** 
 * A representation for the Feature Group '<em><b>ADElementType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADElementTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADElementTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADElementTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADElementTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADElementTypeAnyAttributeFeatureGroup> result = new ArrayList<ADElementTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADElementTypeAnyAttributeFeatureGroup group = new ADElementTypeAnyAttributeFeatureGroup();
