...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingCheckPointShiftType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingCheckPointShiftTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingCheckPointShiftTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingCheckPointShiftTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingCheckPointShiftTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingCheckPointShiftTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingCheckPointShiftTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingCheckPointShiftTypeAnyAttributeFeatureGroup group = new ManufacturingCheckPointShiftTypeAnyAttributeFeatureGroup();
