...
/** 
 * A representation for the Feature Group '<em><b>MRPProductionRunType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MRPProductionRunTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MRPProductionRunTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MRPProductionRunTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MRPProductionRunTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MRPProductionRunTypeAnyAttributeFeatureGroup> result = new ArrayList<MRPProductionRunTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MRPProductionRunTypeAnyAttributeFeatureGroup group = new MRPProductionRunTypeAnyAttributeFeatureGroup();
