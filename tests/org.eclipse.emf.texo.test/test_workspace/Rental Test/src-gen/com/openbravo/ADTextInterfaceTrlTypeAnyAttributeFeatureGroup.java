...
/** 
 * A representation for the Feature Group '<em><b>ADTextInterfaceTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADTextInterfaceTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADTextInterfaceTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADTextInterfaceTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADTextInterfaceTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADTextInterfaceTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADTextInterfaceTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADTextInterfaceTrlTypeAnyAttributeFeatureGroup group = new ADTextInterfaceTrlTypeAnyAttributeFeatureGroup();
