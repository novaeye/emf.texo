...
/** 
 * A representation for the Feature Group '<em><b>RegionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class RegionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<RegionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final RegionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<RegionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<RegionTypeAnyAttributeFeatureGroup> result = new ArrayList<RegionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final RegionTypeAnyAttributeFeatureGroup group = new RegionTypeAnyAttributeFeatureGroup();
