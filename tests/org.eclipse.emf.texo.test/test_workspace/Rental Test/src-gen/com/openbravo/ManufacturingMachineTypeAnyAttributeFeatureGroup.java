...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingMachineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingMachineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingMachineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingMachineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingMachineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingMachineTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingMachineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingMachineTypeAnyAttributeFeatureGroup group = new ManufacturingMachineTypeAnyAttributeFeatureGroup();
