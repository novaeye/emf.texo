...
/** 
 * A representation for the Feature Group '<em><b>OBUIAPPRefWindowType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUIAPPRefWindowTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUIAPPRefWindowTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUIAPPRefWindowTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUIAPPRefWindowTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUIAPPRefWindowTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUIAPPRefWindowTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUIAPPRefWindowTypeAnyAttributeFeatureGroup group = new OBUIAPPRefWindowTypeAnyAttributeFeatureGroup();
