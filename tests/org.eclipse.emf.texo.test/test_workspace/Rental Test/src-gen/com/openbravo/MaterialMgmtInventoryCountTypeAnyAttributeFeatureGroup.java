...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtInventoryCountType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtInventoryCountTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtInventoryCountTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtInventoryCountTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtInventoryCountTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtInventoryCountTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtInventoryCountTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtInventoryCountTypeAnyAttributeFeatureGroup group = new MaterialMgmtInventoryCountTypeAnyAttributeFeatureGroup();
