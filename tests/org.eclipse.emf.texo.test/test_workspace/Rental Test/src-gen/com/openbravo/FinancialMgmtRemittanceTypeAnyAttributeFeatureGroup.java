...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtRemittanceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtRemittanceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtRemittanceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtRemittanceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtRemittanceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtRemittanceTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtRemittanceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtRemittanceTypeAnyAttributeFeatureGroup group = new FinancialMgmtRemittanceTypeAnyAttributeFeatureGroup();
