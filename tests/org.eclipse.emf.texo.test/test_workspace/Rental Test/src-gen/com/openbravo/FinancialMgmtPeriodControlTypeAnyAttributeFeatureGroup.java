...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtPeriodControlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtPeriodControlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtPeriodControlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtPeriodControlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtPeriodControlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtPeriodControlTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtPeriodControlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtPeriodControlTypeAnyAttributeFeatureGroup group = new FinancialMgmtPeriodControlTypeAnyAttributeFeatureGroup();
