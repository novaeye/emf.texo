...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtTaxCategoryTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtTaxCategoryTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtTaxCategoryTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtTaxCategoryTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtTaxCategoryTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtTaxCategoryTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtTaxCategoryTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtTaxCategoryTrlTypeAnyAttributeFeatureGroup group = new FinancialMgmtTaxCategoryTrlTypeAnyAttributeFeatureGroup();
