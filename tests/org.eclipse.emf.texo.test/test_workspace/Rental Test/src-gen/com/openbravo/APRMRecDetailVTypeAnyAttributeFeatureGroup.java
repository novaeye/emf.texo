...
/** 
 * A representation for the Feature Group '<em><b>APRMRecDetailVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class APRMRecDetailVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<APRMRecDetailVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final APRMRecDetailVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<APRMRecDetailVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<APRMRecDetailVTypeAnyAttributeFeatureGroup> result = new ArrayList<APRMRecDetailVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final APRMRecDetailVTypeAnyAttributeFeatureGroup group = new APRMRecDetailVTypeAnyAttributeFeatureGroup();
