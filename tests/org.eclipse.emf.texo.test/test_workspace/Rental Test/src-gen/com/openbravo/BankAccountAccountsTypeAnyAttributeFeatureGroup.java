...
/** 
 * A representation for the Feature Group '<em><b>BankAccountAccountsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class BankAccountAccountsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<BankAccountAccountsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final BankAccountAccountsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<BankAccountAccountsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<BankAccountAccountsTypeAnyAttributeFeatureGroup> result = new ArrayList<BankAccountAccountsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final BankAccountAccountsTypeAnyAttributeFeatureGroup group = new BankAccountAccountsTypeAnyAttributeFeatureGroup();
