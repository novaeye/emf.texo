...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingOperationMachineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingOperationMachineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingOperationMachineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingOperationMachineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingOperationMachineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingOperationMachineTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingOperationMachineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingOperationMachineTypeAnyAttributeFeatureGroup group = new ManufacturingOperationMachineTypeAnyAttributeFeatureGroup();
