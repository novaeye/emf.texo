...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingProductionLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingProductionLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingProductionLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingProductionLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingProductionLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingProductionLineTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingProductionLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingProductionLineTypeAnyAttributeFeatureGroup group = new ManufacturingProductionLineTypeAnyAttributeFeatureGroup();
