...
/** 
 * A representation for the Feature Group '<em><b>SalaryCategoryType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class SalaryCategoryTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<SalaryCategoryTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final SalaryCategoryTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<SalaryCategoryTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<SalaryCategoryTypeAnyAttributeFeatureGroup> result = new ArrayList<SalaryCategoryTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final SalaryCategoryTypeAnyAttributeFeatureGroup group = new SalaryCategoryTypeAnyAttributeFeatureGroup();
