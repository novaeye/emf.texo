...
/** 
 * A representation for the Feature Group '<em><b>ADSelectorType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADSelectorTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADSelectorTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADSelectorTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADSelectorTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADSelectorTypeAnyAttributeFeatureGroup> result = new ArrayList<ADSelectorTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADSelectorTypeAnyAttributeFeatureGroup group = new ADSelectorTypeAnyAttributeFeatureGroup();
