...
/** 
 * A representation for the Feature Group '<em><b>ADFormType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADFormTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADFormTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADFormTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADFormTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADFormTypeAnyAttributeFeatureGroup> result = new ArrayList<ADFormTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADFormTypeAnyAttributeFeatureGroup group = new ADFormTypeAnyAttributeFeatureGroup();
