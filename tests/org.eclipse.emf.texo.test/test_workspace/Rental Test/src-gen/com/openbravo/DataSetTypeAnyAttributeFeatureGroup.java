...
/** 
 * A representation for the Feature Group '<em><b>DataSetType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class DataSetTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<DataSetTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final DataSetTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<DataSetTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<DataSetTypeAnyAttributeFeatureGroup> result = new ArrayList<DataSetTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final DataSetTypeAnyAttributeFeatureGroup group = new DataSetTypeAnyAttributeFeatureGroup();
