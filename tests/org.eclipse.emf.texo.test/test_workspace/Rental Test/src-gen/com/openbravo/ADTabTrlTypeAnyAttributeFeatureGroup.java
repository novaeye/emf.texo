...
/** 
 * A representation for the Feature Group '<em><b>ADTabTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADTabTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADTabTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADTabTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADTabTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADTabTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADTabTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADTabTrlTypeAnyAttributeFeatureGroup group = new ADTabTrlTypeAnyAttributeFeatureGroup();
