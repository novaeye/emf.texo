...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAssetGroupType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAssetGroupTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAssetGroupTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAssetGroupTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAssetGroupTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAssetGroupTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAssetGroupTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAssetGroupTypeAnyAttributeFeatureGroup group = new FinancialMgmtAssetGroupTypeAnyAttributeFeatureGroup();
