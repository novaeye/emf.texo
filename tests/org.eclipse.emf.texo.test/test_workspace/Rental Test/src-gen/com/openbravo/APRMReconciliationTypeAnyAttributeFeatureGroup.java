...
/** 
 * A representation for the Feature Group '<em><b>APRMReconciliationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class APRMReconciliationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<APRMReconciliationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final APRMReconciliationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<APRMReconciliationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<APRMReconciliationTypeAnyAttributeFeatureGroup> result = new ArrayList<APRMReconciliationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final APRMReconciliationTypeAnyAttributeFeatureGroup group = new APRMReconciliationTypeAnyAttributeFeatureGroup();
