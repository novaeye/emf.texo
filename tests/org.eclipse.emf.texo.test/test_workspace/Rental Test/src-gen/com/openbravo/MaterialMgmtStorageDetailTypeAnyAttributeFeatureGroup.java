...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtStorageDetailType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtStorageDetailTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtStorageDetailTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtStorageDetailTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtStorageDetailTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtStorageDetailTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtStorageDetailTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtStorageDetailTypeAnyAttributeFeatureGroup group = new MaterialMgmtStorageDetailTypeAnyAttributeFeatureGroup();
