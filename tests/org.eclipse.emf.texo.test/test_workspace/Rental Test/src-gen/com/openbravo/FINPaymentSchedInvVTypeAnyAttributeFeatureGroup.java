...
/** 
 * A representation for the Feature Group '<em><b>FINPaymentSchedInvVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINPaymentSchedInvVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINPaymentSchedInvVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINPaymentSchedInvVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINPaymentSchedInvVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINPaymentSchedInvVTypeAnyAttributeFeatureGroup> result = new ArrayList<FINPaymentSchedInvVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINPaymentSchedInvVTypeAnyAttributeFeatureGroup group = new FINPaymentSchedInvVTypeAnyAttributeFeatureGroup();
