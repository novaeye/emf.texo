...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingWorkRequirementOperationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingWorkRequirementOperationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingWorkRequirementOperationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingWorkRequirementOperationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingWorkRequirementOperationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingWorkRequirementOperationTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingWorkRequirementOperationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingWorkRequirementOperationTypeAnyAttributeFeatureGroup group = new ManufacturingWorkRequirementOperationTypeAnyAttributeFeatureGroup();
