...
/** 
 * A representation for the Feature Group '<em><b>ADErrorLogType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADErrorLogTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADErrorLogTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADErrorLogTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADErrorLogTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADErrorLogTypeAnyAttributeFeatureGroup> result = new ArrayList<ADErrorLogTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADErrorLogTypeAnyAttributeFeatureGroup group = new ADErrorLogTypeAnyAttributeFeatureGroup();
