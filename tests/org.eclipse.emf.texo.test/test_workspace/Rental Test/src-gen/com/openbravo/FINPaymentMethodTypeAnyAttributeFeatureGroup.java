...
/** 
 * A representation for the Feature Group '<em><b>FINPaymentMethodType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINPaymentMethodTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINPaymentMethodTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINPaymentMethodTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINPaymentMethodTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINPaymentMethodTypeAnyAttributeFeatureGroup> result = new ArrayList<FINPaymentMethodTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINPaymentMethodTypeAnyAttributeFeatureGroup group = new FINPaymentMethodTypeAnyAttributeFeatureGroup();
