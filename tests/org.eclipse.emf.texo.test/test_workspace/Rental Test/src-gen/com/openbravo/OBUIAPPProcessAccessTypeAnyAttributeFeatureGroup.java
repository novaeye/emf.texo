...
/** 
 * A representation for the Feature Group '<em><b>OBUIAPPProcessAccessType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUIAPPProcessAccessTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUIAPPProcessAccessTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUIAPPProcessAccessTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUIAPPProcessAccessTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUIAPPProcessAccessTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUIAPPProcessAccessTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUIAPPProcessAccessTypeAnyAttributeFeatureGroup group = new OBUIAPPProcessAccessTypeAnyAttributeFeatureGroup();
