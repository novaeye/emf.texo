...
/** 
 * A representation for the Feature Group '<em><b>ProjectPhaseType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProjectPhaseTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProjectPhaseTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProjectPhaseTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProjectPhaseTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProjectPhaseTypeAnyAttributeFeatureGroup> result = new ArrayList<ProjectPhaseTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProjectPhaseTypeAnyAttributeFeatureGroup group = new ProjectPhaseTypeAnyAttributeFeatureGroup();
