...
/** 
 * A representation for the Feature Group '<em><b>ADColumnType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADColumnTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADColumnTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADColumnTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADColumnTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADColumnTypeAnyAttributeFeatureGroup> result = new ArrayList<ADColumnTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADColumnTypeAnyAttributeFeatureGroup group = new ADColumnTypeAnyAttributeFeatureGroup();
