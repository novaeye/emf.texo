...
/** 
 * A representation for the Feature Group '<em><b>SalesCommissionLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class SalesCommissionLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<SalesCommissionLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final SalesCommissionLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<SalesCommissionLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<SalesCommissionLineTypeAnyAttributeFeatureGroup> result = new ArrayList<SalesCommissionLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final SalesCommissionLineTypeAnyAttributeFeatureGroup group = new SalesCommissionLineTypeAnyAttributeFeatureGroup();
