...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingProductionRunToolsetType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingProductionRunToolsetTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingProductionRunToolsetTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingProductionRunToolsetTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingProductionRunToolsetTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingProductionRunToolsetTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingProductionRunToolsetTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingProductionRunToolsetTypeAnyAttributeFeatureGroup group = new ManufacturingProductionRunToolsetTypeAnyAttributeFeatureGroup();
