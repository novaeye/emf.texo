...
/** 
 * A representation for the Feature Group '<em><b>DataSetColumnType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class DataSetColumnTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<DataSetColumnTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final DataSetColumnTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<DataSetColumnTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<DataSetColumnTypeAnyAttributeFeatureGroup> result = new ArrayList<DataSetColumnTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final DataSetColumnTypeAnyAttributeFeatureGroup group = new DataSetColumnTypeAnyAttributeFeatureGroup();
