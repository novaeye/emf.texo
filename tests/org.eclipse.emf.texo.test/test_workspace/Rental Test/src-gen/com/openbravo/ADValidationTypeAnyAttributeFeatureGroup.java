...
/** 
 * A representation for the Feature Group '<em><b>ADValidationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADValidationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADValidationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADValidationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADValidationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADValidationTypeAnyAttributeFeatureGroup> result = new ArrayList<ADValidationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADValidationTypeAnyAttributeFeatureGroup group = new ADValidationTypeAnyAttributeFeatureGroup();
