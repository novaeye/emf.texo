...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtBankFileFormatType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtBankFileFormatTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtBankFileFormatTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtBankFileFormatTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtBankFileFormatTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtBankFileFormatTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtBankFileFormatTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtBankFileFormatTypeAnyAttributeFeatureGroup group = new FinancialMgmtBankFileFormatTypeAnyAttributeFeatureGroup();
