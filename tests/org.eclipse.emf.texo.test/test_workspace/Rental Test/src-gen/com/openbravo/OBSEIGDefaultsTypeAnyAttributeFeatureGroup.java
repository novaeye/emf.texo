...
/** 
 * A representation for the Feature Group '<em><b>OBSEIGDefaultsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBSEIGDefaultsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBSEIGDefaultsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBSEIGDefaultsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBSEIGDefaultsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBSEIGDefaultsTypeAnyAttributeFeatureGroup> result = new ArrayList<OBSEIGDefaultsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBSEIGDefaultsTypeAnyAttributeFeatureGroup group = new OBSEIGDefaultsTypeAnyAttributeFeatureGroup();
