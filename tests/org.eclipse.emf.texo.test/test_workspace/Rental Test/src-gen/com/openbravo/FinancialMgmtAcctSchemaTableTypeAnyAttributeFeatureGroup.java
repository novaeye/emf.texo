...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAcctSchemaTableType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAcctSchemaTableTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAcctSchemaTableTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAcctSchemaTableTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAcctSchemaTableTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAcctSchemaTableTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAcctSchemaTableTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAcctSchemaTableTypeAnyAttributeFeatureGroup group = new FinancialMgmtAcctSchemaTableTypeAnyAttributeFeatureGroup();
