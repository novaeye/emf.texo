...
/** 
 * A representation for the Feature Group '<em><b>CustomerAccountsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class CustomerAccountsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<CustomerAccountsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final CustomerAccountsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<CustomerAccountsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<CustomerAccountsTypeAnyAttributeFeatureGroup> result = new ArrayList<CustomerAccountsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final CustomerAccountsTypeAnyAttributeFeatureGroup group = new CustomerAccountsTypeAnyAttributeFeatureGroup();
