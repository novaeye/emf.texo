...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtInternalConsumptionLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtInternalConsumptionLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtInternalConsumptionLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtInternalConsumptionLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtInternalConsumptionLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtInternalConsumptionLineTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtInternalConsumptionLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtInternalConsumptionLineTypeAnyAttributeFeatureGroup group = new MaterialMgmtInternalConsumptionLineTypeAnyAttributeFeatureGroup();
