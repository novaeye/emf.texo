...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtYearType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtYearTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtYearTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtYearTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtYearTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtYearTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtYearTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtYearTypeAnyAttributeFeatureGroup group = new FinancialMgmtYearTypeAnyAttributeFeatureGroup();
