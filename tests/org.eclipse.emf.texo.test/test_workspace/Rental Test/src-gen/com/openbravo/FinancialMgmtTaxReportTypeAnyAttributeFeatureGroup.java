...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtTaxReportType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtTaxReportTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtTaxReportTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtTaxReportTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtTaxReportTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtTaxReportTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtTaxReportTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtTaxReportTypeAnyAttributeFeatureGroup group = new FinancialMgmtTaxReportTypeAnyAttributeFeatureGroup();
