...
/** 
 * A representation for the Feature Group '<em><b>LocatorType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class LocatorTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<LocatorTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final LocatorTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<LocatorTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<LocatorTypeAnyAttributeFeatureGroup> result = new ArrayList<LocatorTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final LocatorTypeAnyAttributeFeatureGroup group = new LocatorTypeAnyAttributeFeatureGroup();
