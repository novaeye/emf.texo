...
/** 
 * A representation for the Feature Group '<em><b>ProjectProposalLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProjectProposalLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProjectProposalLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProjectProposalLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProjectProposalLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProjectProposalLineTypeAnyAttributeFeatureGroup> result = new ArrayList<ProjectProposalLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProjectProposalLineTypeAnyAttributeFeatureGroup group = new ProjectProposalLineTypeAnyAttributeFeatureGroup();
