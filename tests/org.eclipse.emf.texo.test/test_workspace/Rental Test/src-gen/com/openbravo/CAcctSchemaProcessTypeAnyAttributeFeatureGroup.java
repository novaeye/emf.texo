...
/** 
 * A representation for the Feature Group '<em><b>CAcctSchemaProcessType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class CAcctSchemaProcessTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<CAcctSchemaProcessTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final CAcctSchemaProcessTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<CAcctSchemaProcessTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<CAcctSchemaProcessTypeAnyAttributeFeatureGroup> result = new ArrayList<CAcctSchemaProcessTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final CAcctSchemaProcessTypeAnyAttributeFeatureGroup group = new CAcctSchemaProcessTypeAnyAttributeFeatureGroup();
