...
/** 
 * A representation for the Feature Group '<em><b>ADReferenceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADReferenceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADReferenceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADReferenceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADReferenceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADReferenceTypeAnyAttributeFeatureGroup> result = new ArrayList<ADReferenceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADReferenceTypeAnyAttributeFeatureGroup group = new ADReferenceTypeAnyAttributeFeatureGroup();
