...
/** 
 * A representation for the Feature Group '<em><b>GreetingType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class GreetingTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<GreetingTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final GreetingTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<GreetingTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<GreetingTypeAnyAttributeFeatureGroup> result = new ArrayList<GreetingTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final GreetingTypeAnyAttributeFeatureGroup group = new GreetingTypeAnyAttributeFeatureGroup();
