...
/** 
 * A representation for the Feature Group '<em><b>InvoiceLineOfferType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class InvoiceLineOfferTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<InvoiceLineOfferTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final InvoiceLineOfferTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<InvoiceLineOfferTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<InvoiceLineOfferTypeAnyAttributeFeatureGroup> result = new ArrayList<InvoiceLineOfferTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final InvoiceLineOfferTypeAnyAttributeFeatureGroup group = new InvoiceLineOfferTypeAnyAttributeFeatureGroup();
