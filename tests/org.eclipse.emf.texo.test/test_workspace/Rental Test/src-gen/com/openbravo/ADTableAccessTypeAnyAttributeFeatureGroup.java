...
/** 
 * A representation for the Feature Group '<em><b>ADTableAccessType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADTableAccessTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADTableAccessTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADTableAccessTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADTableAccessTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADTableAccessTypeAnyAttributeFeatureGroup> result = new ArrayList<ADTableAccessTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADTableAccessTypeAnyAttributeFeatureGroup group = new ADTableAccessTypeAnyAttributeFeatureGroup();
