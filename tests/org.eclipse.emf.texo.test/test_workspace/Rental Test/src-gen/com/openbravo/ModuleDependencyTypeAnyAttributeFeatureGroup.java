...
/** 
 * A representation for the Feature Group '<em><b>ModuleDependencyType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ModuleDependencyTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ModuleDependencyTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ModuleDependencyTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ModuleDependencyTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ModuleDependencyTypeAnyAttributeFeatureGroup> result = new ArrayList<ModuleDependencyTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ModuleDependencyTypeAnyAttributeFeatureGroup group = new ModuleDependencyTypeAnyAttributeFeatureGroup();
