...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtTaxRegisterTypeLinesType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtTaxRegisterTypeLinesTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtTaxRegisterTypeLinesTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtTaxRegisterTypeLinesTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtTaxRegisterTypeLinesTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtTaxRegisterTypeLinesTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtTaxRegisterTypeLinesTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtTaxRegisterTypeLinesTypeAnyAttributeFeatureGroup group = new FinancialMgmtTaxRegisterTypeLinesTypeAnyAttributeFeatureGroup();
