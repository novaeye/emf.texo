...
/** 
 * A representation for the Feature Group '<em><b>OBKMOWidgetClassType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBKMOWidgetClassTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBKMOWidgetClassTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBKMOWidgetClassTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBKMOWidgetClassTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBKMOWidgetClassTypeAnyAttributeFeatureGroup> result = new ArrayList<OBKMOWidgetClassTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBKMOWidgetClassTypeAnyAttributeFeatureGroup group = new OBKMOWidgetClassTypeAnyAttributeFeatureGroup();
