...
/** 
 * A representation for the Feature Group '<em><b>FINReconciliationLineVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINReconciliationLineVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINReconciliationLineVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINReconciliationLineVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINReconciliationLineVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINReconciliationLineVTypeAnyAttributeFeatureGroup> result = new ArrayList<FINReconciliationLineVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINReconciliationLineVTypeAnyAttributeFeatureGroup group = new FINReconciliationLineVTypeAnyAttributeFeatureGroup();
