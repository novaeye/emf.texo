...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingIncidenceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingIncidenceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingIncidenceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingIncidenceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingIncidenceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingIncidenceTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingIncidenceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingIncidenceTypeAnyAttributeFeatureGroup group = new ManufacturingIncidenceTypeAnyAttributeFeatureGroup();
