...
/** 
 * A representation for the Feature Group '<em><b>MRPPlanningMethodType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MRPPlanningMethodTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MRPPlanningMethodTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MRPPlanningMethodTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MRPPlanningMethodTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MRPPlanningMethodTypeAnyAttributeFeatureGroup> result = new ArrayList<MRPPlanningMethodTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MRPPlanningMethodTypeAnyAttributeFeatureGroup group = new MRPPlanningMethodTypeAnyAttributeFeatureGroup();
