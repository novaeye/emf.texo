...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtTaxRegisterTypeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtTaxRegisterTypeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtTaxRegisterTypeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtTaxRegisterTypeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtTaxRegisterTypeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtTaxRegisterTypeTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtTaxRegisterTypeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtTaxRegisterTypeTypeAnyAttributeFeatureGroup group = new FinancialMgmtTaxRegisterTypeTypeAnyAttributeFeatureGroup();
