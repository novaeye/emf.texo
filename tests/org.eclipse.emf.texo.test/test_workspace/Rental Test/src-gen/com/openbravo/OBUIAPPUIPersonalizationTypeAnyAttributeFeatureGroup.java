...
/** 
 * A representation for the Feature Group '<em><b>OBUIAPPUIPersonalizationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUIAPPUIPersonalizationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUIAPPUIPersonalizationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUIAPPUIPersonalizationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUIAPPUIPersonalizationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUIAPPUIPersonalizationTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUIAPPUIPersonalizationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUIAPPUIPersonalizationTypeAnyAttributeFeatureGroup group = new OBUIAPPUIPersonalizationTypeAnyAttributeFeatureGroup();
