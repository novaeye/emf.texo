...
/** 
 * A representation for the Feature Group '<em><b>UOMType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class UOMTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<UOMTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final UOMTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<UOMTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<UOMTypeAnyAttributeFeatureGroup> result = new ArrayList<UOMTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final UOMTypeAnyAttributeFeatureGroup group = new UOMTypeAnyAttributeFeatureGroup();
