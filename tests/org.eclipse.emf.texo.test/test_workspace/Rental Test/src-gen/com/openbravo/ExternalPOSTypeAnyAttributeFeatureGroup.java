...
/** 
 * A representation for the Feature Group '<em><b>ExternalPOSType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ExternalPOSTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ExternalPOSTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ExternalPOSTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ExternalPOSTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ExternalPOSTypeAnyAttributeFeatureGroup> result = new ArrayList<ExternalPOSTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ExternalPOSTypeAnyAttributeFeatureGroup group = new ExternalPOSTypeAnyAttributeFeatureGroup();
