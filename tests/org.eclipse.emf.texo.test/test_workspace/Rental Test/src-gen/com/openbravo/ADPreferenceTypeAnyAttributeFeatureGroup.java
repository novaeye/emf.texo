...
/** 
 * A representation for the Feature Group '<em><b>ADPreferenceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADPreferenceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADPreferenceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADPreferenceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADPreferenceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADPreferenceTypeAnyAttributeFeatureGroup> result = new ArrayList<ADPreferenceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADPreferenceTypeAnyAttributeFeatureGroup group = new ADPreferenceTypeAnyAttributeFeatureGroup();
