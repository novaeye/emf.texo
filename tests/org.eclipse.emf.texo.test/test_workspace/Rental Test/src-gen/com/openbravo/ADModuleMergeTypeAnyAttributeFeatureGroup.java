...
/** 
 * A representation for the Feature Group '<em><b>ADModuleMergeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADModuleMergeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADModuleMergeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADModuleMergeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADModuleMergeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADModuleMergeTypeAnyAttributeFeatureGroup> result = new ArrayList<ADModuleMergeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADModuleMergeTypeAnyAttributeFeatureGroup group = new ADModuleMergeTypeAnyAttributeFeatureGroup();
