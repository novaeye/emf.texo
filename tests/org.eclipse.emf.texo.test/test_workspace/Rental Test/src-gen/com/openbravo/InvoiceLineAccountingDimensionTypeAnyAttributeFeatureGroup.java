...
/** 
 * A representation for the Feature Group '<em><b>InvoiceLineAccountingDimensionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class InvoiceLineAccountingDimensionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<InvoiceLineAccountingDimensionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final InvoiceLineAccountingDimensionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<InvoiceLineAccountingDimensionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<InvoiceLineAccountingDimensionTypeAnyAttributeFeatureGroup> result = new ArrayList<InvoiceLineAccountingDimensionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final InvoiceLineAccountingDimensionTypeAnyAttributeFeatureGroup group = new InvoiceLineAccountingDimensionTypeAnyAttributeFeatureGroup();
