...
/** 
 * A representation for the Feature Group '<em><b>ProjectTaskType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProjectTaskTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProjectTaskTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProjectTaskTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProjectTaskTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProjectTaskTypeAnyAttributeFeatureGroup> result = new ArrayList<ProjectTaskTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProjectTaskTypeAnyAttributeFeatureGroup group = new ProjectTaskTypeAnyAttributeFeatureGroup();
