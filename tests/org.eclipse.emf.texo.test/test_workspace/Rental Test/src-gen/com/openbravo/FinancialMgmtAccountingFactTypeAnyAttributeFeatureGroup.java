...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAccountingFactType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAccountingFactTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAccountingFactTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAccountingFactTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAccountingFactTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAccountingFactTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAccountingFactTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAccountingFactTypeAnyAttributeFeatureGroup group = new FinancialMgmtAccountingFactTypeAnyAttributeFeatureGroup();
