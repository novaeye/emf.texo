...
/** 
 * A representation for the Feature Group '<em><b>DataPackageType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class DataPackageTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<DataPackageTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final DataPackageTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<DataPackageTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<DataPackageTypeAnyAttributeFeatureGroup> result = new ArrayList<DataPackageTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final DataPackageTypeAnyAttributeFeatureGroup group = new DataPackageTypeAnyAttributeFeatureGroup();
