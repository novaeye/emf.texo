...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingMaintenanceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingMaintenanceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingMaintenanceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingMaintenanceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingMaintenanceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingMaintenanceTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingMaintenanceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingMaintenanceTypeAnyAttributeFeatureGroup group = new ManufacturingMaintenanceTypeAnyAttributeFeatureGroup();
