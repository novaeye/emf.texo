...
/** 
 * A representation for the Feature Group '<em><b>FINReconciliationLineTempType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINReconciliationLineTempTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINReconciliationLineTempTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINReconciliationLineTempTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINReconciliationLineTempTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINReconciliationLineTempTypeAnyAttributeFeatureGroup> result = new ArrayList<FINReconciliationLineTempTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINReconciliationLineTempTypeAnyAttributeFeatureGroup group = new FINReconciliationLineTempTypeAnyAttributeFeatureGroup();
