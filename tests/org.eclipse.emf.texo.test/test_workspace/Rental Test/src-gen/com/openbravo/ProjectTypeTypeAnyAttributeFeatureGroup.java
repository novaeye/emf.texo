...
/** 
 * A representation for the Feature Group '<em><b>ProjectTypeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProjectTypeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProjectTypeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProjectTypeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProjectTypeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProjectTypeTypeAnyAttributeFeatureGroup> result = new ArrayList<ProjectTypeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProjectTypeTypeAnyAttributeFeatureGroup group = new ProjectTypeTypeAnyAttributeFeatureGroup();
