...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtGLJournalType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtGLJournalTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtGLJournalTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtGLJournalTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtGLJournalTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtGLJournalTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtGLJournalTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtGLJournalTypeAnyAttributeFeatureGroup group = new FinancialMgmtGLJournalTypeAnyAttributeFeatureGroup();
