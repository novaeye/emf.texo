...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAcctSchemaGLType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAcctSchemaGLTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAcctSchemaGLTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAcctSchemaGLTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAcctSchemaGLTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAcctSchemaGLTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAcctSchemaGLTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAcctSchemaGLTypeAnyAttributeFeatureGroup group = new FinancialMgmtAcctSchemaGLTypeAnyAttributeFeatureGroup();
