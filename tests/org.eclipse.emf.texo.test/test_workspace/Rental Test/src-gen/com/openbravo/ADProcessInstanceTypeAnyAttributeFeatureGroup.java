...
/** 
 * A representation for the Feature Group '<em><b>ADProcessInstanceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADProcessInstanceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADProcessInstanceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADProcessInstanceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADProcessInstanceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADProcessInstanceTypeAnyAttributeFeatureGroup> result = new ArrayList<ADProcessInstanceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADProcessInstanceTypeAnyAttributeFeatureGroup group = new ADProcessInstanceTypeAnyAttributeFeatureGroup();
