...
/** 
 * A representation for the Feature Group '<em><b>ADAlertRuleTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADAlertRuleTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADAlertRuleTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADAlertRuleTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADAlertRuleTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADAlertRuleTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADAlertRuleTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADAlertRuleTrlTypeAnyAttributeFeatureGroup group = new ADAlertRuleTrlTypeAnyAttributeFeatureGroup();
