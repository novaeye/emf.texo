...
/** 
 * A representation for the Feature Group '<em><b>OBCLKERTemplateType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBCLKERTemplateTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBCLKERTemplateTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBCLKERTemplateTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBCLKERTemplateTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBCLKERTemplateTypeAnyAttributeFeatureGroup> result = new ArrayList<OBCLKERTemplateTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBCLKERTemplateTypeAnyAttributeFeatureGroup group = new OBCLKERTemplateTypeAnyAttributeFeatureGroup();
