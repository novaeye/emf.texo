...
/** 
 * A representation for the Feature Group '<em><b>ADTextInterfaceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADTextInterfaceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADTextInterfaceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADTextInterfaceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADTextInterfaceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADTextInterfaceTypeAnyAttributeFeatureGroup> result = new ArrayList<ADTextInterfaceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADTextInterfaceTypeAnyAttributeFeatureGroup group = new ADTextInterfaceTypeAnyAttributeFeatureGroup();
