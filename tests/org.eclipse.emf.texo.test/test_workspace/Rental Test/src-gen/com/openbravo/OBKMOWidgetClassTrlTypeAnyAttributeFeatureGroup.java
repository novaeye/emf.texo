...
/** 
 * A representation for the Feature Group '<em><b>OBKMOWidgetClassTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBKMOWidgetClassTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBKMOWidgetClassTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBKMOWidgetClassTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBKMOWidgetClassTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBKMOWidgetClassTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<OBKMOWidgetClassTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBKMOWidgetClassTrlTypeAnyAttributeFeatureGroup group = new OBKMOWidgetClassTrlTypeAnyAttributeFeatureGroup();
