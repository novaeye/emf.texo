...
/** 
 * A representation for the Feature Group '<em><b>OBKMOWidgetClassAccessType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBKMOWidgetClassAccessTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBKMOWidgetClassAccessTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBKMOWidgetClassAccessTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBKMOWidgetClassAccessTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBKMOWidgetClassAccessTypeAnyAttributeFeatureGroup> result = new ArrayList<OBKMOWidgetClassAccessTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBKMOWidgetClassAccessTypeAnyAttributeFeatureGroup group = new OBKMOWidgetClassAccessTypeAnyAttributeFeatureGroup();
