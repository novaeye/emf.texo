...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingSectionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingSectionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingSectionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingSectionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingSectionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingSectionTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingSectionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingSectionTypeAnyAttributeFeatureGroup group = new ManufacturingSectionTypeAnyAttributeFeatureGroup();
