...
/** 
 * A representation for the Feature Group '<em><b>PricingAdjustmentProductType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingAdjustmentProductTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingAdjustmentProductTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingAdjustmentProductTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingAdjustmentProductTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingAdjustmentProductTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingAdjustmentProductTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingAdjustmentProductTypeAnyAttributeFeatureGroup group = new PricingAdjustmentProductTypeAnyAttributeFeatureGroup();
