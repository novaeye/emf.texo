...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtBudgetLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtBudgetLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtBudgetLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtBudgetLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtBudgetLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtBudgetLineTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtBudgetLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtBudgetLineTypeAnyAttributeFeatureGroup group = new FinancialMgmtBudgetLineTypeAnyAttributeFeatureGroup();
