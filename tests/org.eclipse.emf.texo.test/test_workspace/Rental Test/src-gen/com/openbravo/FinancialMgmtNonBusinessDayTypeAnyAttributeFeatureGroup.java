...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtNonBusinessDayType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtNonBusinessDayTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtNonBusinessDayTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtNonBusinessDayTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtNonBusinessDayTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtNonBusinessDayTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtNonBusinessDayTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtNonBusinessDayTypeAnyAttributeFeatureGroup group = new FinancialMgmtNonBusinessDayTypeAnyAttributeFeatureGroup();
