...
/** 
 * A representation for the Feature Group '<em><b>PricingVolumeDiscountInvoiceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingVolumeDiscountInvoiceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingVolumeDiscountInvoiceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingVolumeDiscountInvoiceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingVolumeDiscountInvoiceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingVolumeDiscountInvoiceTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingVolumeDiscountInvoiceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingVolumeDiscountInvoiceTypeAnyAttributeFeatureGroup group = new PricingVolumeDiscountInvoiceTypeAnyAttributeFeatureGroup();
