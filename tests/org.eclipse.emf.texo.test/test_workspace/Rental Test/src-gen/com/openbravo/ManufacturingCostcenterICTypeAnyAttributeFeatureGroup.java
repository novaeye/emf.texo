...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingCostcenterICType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingCostcenterICTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingCostcenterICTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingCostcenterICTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingCostcenterICTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingCostcenterICTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingCostcenterICTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingCostcenterICTypeAnyAttributeFeatureGroup group = new ManufacturingCostcenterICTypeAnyAttributeFeatureGroup();
