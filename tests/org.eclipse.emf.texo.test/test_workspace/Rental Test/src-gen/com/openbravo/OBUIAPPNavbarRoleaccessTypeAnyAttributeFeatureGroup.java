...
/** 
 * A representation for the Feature Group '<em><b>OBUIAPPNavbarRoleaccessType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUIAPPNavbarRoleaccessTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUIAPPNavbarRoleaccessTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUIAPPNavbarRoleaccessTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUIAPPNavbarRoleaccessTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUIAPPNavbarRoleaccessTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUIAPPNavbarRoleaccessTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUIAPPNavbarRoleaccessTypeAnyAttributeFeatureGroup group = new OBUIAPPNavbarRoleaccessTypeAnyAttributeFeatureGroup();
