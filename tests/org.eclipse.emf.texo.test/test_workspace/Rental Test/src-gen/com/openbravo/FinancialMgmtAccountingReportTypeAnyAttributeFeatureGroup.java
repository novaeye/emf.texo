...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAccountingReportType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAccountingReportTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAccountingReportTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAccountingReportTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAccountingReportTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAccountingReportTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAccountingReportTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAccountingReportTypeAnyAttributeFeatureGroup group = new FinancialMgmtAccountingReportTypeAnyAttributeFeatureGroup();
