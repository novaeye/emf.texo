...
/** 
 * A representation for the Feature Group '<em><b>OrganizationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OrganizationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OrganizationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OrganizationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OrganizationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OrganizationTypeAnyAttributeFeatureGroup> result = new ArrayList<OrganizationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OrganizationTypeAnyAttributeFeatureGroup group = new OrganizationTypeAnyAttributeFeatureGroup();
