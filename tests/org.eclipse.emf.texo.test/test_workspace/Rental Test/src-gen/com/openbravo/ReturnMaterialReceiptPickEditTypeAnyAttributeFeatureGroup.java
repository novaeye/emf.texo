...
/** 
 * A representation for the Feature Group '<em><b>ReturnMaterialReceiptPickEditType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ReturnMaterialReceiptPickEditTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ReturnMaterialReceiptPickEditTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ReturnMaterialReceiptPickEditTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ReturnMaterialReceiptPickEditTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ReturnMaterialReceiptPickEditTypeAnyAttributeFeatureGroup> result = new ArrayList<ReturnMaterialReceiptPickEditTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ReturnMaterialReceiptPickEditTypeAnyAttributeFeatureGroup group = new ReturnMaterialReceiptPickEditTypeAnyAttributeFeatureGroup();
