...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtDebtPaymentType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtDebtPaymentTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtDebtPaymentTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtDebtPaymentTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtDebtPaymentTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtDebtPaymentTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtDebtPaymentTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtDebtPaymentTypeAnyAttributeFeatureGroup group = new FinancialMgmtDebtPaymentTypeAnyAttributeFeatureGroup();
