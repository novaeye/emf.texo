...
/** 
 * A representation for the Feature Group '<em><b>FINPaymentDetailType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINPaymentDetailTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINPaymentDetailTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINPaymentDetailTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINPaymentDetailTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINPaymentDetailTypeAnyAttributeFeatureGroup> result = new ArrayList<FINPaymentDetailTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINPaymentDetailTypeAnyAttributeFeatureGroup group = new FINPaymentDetailTypeAnyAttributeFeatureGroup();
