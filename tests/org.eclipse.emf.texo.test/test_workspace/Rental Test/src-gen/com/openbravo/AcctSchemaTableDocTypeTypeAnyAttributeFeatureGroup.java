...
/** 
 * A representation for the Feature Group '<em><b>AcctSchemaTableDocTypeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class AcctSchemaTableDocTypeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<AcctSchemaTableDocTypeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final AcctSchemaTableDocTypeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<AcctSchemaTableDocTypeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<AcctSchemaTableDocTypeTypeAnyAttributeFeatureGroup> result = new ArrayList<AcctSchemaTableDocTypeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final AcctSchemaTableDocTypeTypeAnyAttributeFeatureGroup group = new AcctSchemaTableDocTypeTypeAnyAttributeFeatureGroup();
