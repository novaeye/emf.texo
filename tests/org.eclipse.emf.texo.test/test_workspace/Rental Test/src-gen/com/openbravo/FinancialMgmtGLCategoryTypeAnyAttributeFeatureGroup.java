...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtGLCategoryType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtGLCategoryTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtGLCategoryTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtGLCategoryTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtGLCategoryTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtGLCategoryTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtGLCategoryTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtGLCategoryTypeAnyAttributeFeatureGroup group = new FinancialMgmtGLCategoryTypeAnyAttributeFeatureGroup();
