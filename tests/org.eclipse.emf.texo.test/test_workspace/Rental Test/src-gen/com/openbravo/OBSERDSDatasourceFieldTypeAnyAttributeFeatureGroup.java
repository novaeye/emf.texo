...
/** 
 * A representation for the Feature Group '<em><b>OBSERDSDatasourceFieldType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBSERDSDatasourceFieldTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBSERDSDatasourceFieldTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBSERDSDatasourceFieldTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBSERDSDatasourceFieldTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBSERDSDatasourceFieldTypeAnyAttributeFeatureGroup> result = new ArrayList<OBSERDSDatasourceFieldTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBSERDSDatasourceFieldTypeAnyAttributeFeatureGroup group = new OBSERDSDatasourceFieldTypeAnyAttributeFeatureGroup();
