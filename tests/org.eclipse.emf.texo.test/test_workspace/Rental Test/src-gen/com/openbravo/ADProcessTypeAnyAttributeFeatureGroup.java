...
/** 
 * A representation for the Feature Group '<em><b>ADProcessType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADProcessTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADProcessTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADProcessTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADProcessTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADProcessTypeAnyAttributeFeatureGroup> result = new ArrayList<ADProcessTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADProcessTypeAnyAttributeFeatureGroup group = new ADProcessTypeAnyAttributeFeatureGroup();
