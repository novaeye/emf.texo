...
/** 
 * A representation for the Feature Group '<em><b>EmailTemplateType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class EmailTemplateTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<EmailTemplateTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final EmailTemplateTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<EmailTemplateTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<EmailTemplateTypeAnyAttributeFeatureGroup> result = new ArrayList<EmailTemplateTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final EmailTemplateTypeAnyAttributeFeatureGroup group = new EmailTemplateTypeAnyAttributeFeatureGroup();
