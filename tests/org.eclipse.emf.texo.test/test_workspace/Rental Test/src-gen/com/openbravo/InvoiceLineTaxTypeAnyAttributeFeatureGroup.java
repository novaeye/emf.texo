...
/** 
 * A representation for the Feature Group '<em><b>InvoiceLineTaxType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class InvoiceLineTaxTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<InvoiceLineTaxTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final InvoiceLineTaxTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<InvoiceLineTaxTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<InvoiceLineTaxTypeAnyAttributeFeatureGroup> result = new ArrayList<InvoiceLineTaxTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final InvoiceLineTaxTypeAnyAttributeFeatureGroup group = new InvoiceLineTaxTypeAnyAttributeFeatureGroup();
