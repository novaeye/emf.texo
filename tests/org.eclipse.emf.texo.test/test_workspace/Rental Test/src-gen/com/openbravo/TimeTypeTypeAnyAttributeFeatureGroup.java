...
/** 
 * A representation for the Feature Group '<em><b>TimeTypeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class TimeTypeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<TimeTypeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final TimeTypeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<TimeTypeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<TimeTypeTypeAnyAttributeFeatureGroup> result = new ArrayList<TimeTypeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final TimeTypeTypeAnyAttributeFeatureGroup group = new TimeTypeTypeAnyAttributeFeatureGroup();
