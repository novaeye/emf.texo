...
/** 
 * A representation for the Feature Group '<em><b>ADFormTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADFormTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADFormTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADFormTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADFormTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADFormTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADFormTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADFormTrlTypeAnyAttributeFeatureGroup group = new ADFormTrlTypeAnyAttributeFeatureGroup();
