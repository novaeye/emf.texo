...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtGLJournalLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtGLJournalLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtGLJournalLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtGLJournalLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtGLJournalLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtGLJournalLineTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtGLJournalLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtGLJournalLineTypeAnyAttributeFeatureGroup group = new FinancialMgmtGLJournalLineTypeAnyAttributeFeatureGroup();
