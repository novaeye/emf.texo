...
/** 
 * A representation for the Feature Group '<em><b>ADFieldTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADFieldTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADFieldTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADFieldTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADFieldTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADFieldTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADFieldTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADFieldTrlTypeAnyAttributeFeatureGroup group = new ADFieldTrlTypeAnyAttributeFeatureGroup();
