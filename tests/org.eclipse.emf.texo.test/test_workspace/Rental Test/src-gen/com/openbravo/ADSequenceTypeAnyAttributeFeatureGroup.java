...
/** 
 * A representation for the Feature Group '<em><b>ADSequenceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADSequenceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADSequenceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADSequenceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADSequenceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADSequenceTypeAnyAttributeFeatureGroup> result = new ArrayList<ADSequenceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADSequenceTypeAnyAttributeFeatureGroup group = new ADSequenceTypeAnyAttributeFeatureGroup();
