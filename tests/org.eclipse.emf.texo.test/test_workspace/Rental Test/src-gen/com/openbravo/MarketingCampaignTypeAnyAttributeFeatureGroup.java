...
/** 
 * A representation for the Feature Group '<em><b>MarketingCampaignType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MarketingCampaignTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MarketingCampaignTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MarketingCampaignTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MarketingCampaignTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MarketingCampaignTypeAnyAttributeFeatureGroup> result = new ArrayList<MarketingCampaignTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MarketingCampaignTypeAnyAttributeFeatureGroup group = new MarketingCampaignTypeAnyAttributeFeatureGroup();
