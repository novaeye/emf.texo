...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAcctSchemaDefaultType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAcctSchemaDefaultTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAcctSchemaDefaultTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAcctSchemaDefaultTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAcctSchemaDefaultTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAcctSchemaDefaultTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAcctSchemaDefaultTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAcctSchemaDefaultTypeAnyAttributeFeatureGroup group = new FinancialMgmtAcctSchemaDefaultTypeAnyAttributeFeatureGroup();
