...
/** 
 * A representation for the Feature Group '<em><b>ProductCategoryAccountsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProductCategoryAccountsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProductCategoryAccountsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProductCategoryAccountsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProductCategoryAccountsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProductCategoryAccountsTypeAnyAttributeFeatureGroup> result = new ArrayList<ProductCategoryAccountsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProductCategoryAccountsTypeAnyAttributeFeatureGroup group = new ProductCategoryAccountsTypeAnyAttributeFeatureGroup();
