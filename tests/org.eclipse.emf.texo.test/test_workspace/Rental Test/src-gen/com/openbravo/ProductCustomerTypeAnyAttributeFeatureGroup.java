...
/** 
 * A representation for the Feature Group '<em><b>ProductCustomerType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProductCustomerTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProductCustomerTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProductCustomerTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProductCustomerTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProductCustomerTypeAnyAttributeFeatureGroup> result = new ArrayList<ProductCustomerTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProductCustomerTypeAnyAttributeFeatureGroup group = new ProductCustomerTypeAnyAttributeFeatureGroup();
