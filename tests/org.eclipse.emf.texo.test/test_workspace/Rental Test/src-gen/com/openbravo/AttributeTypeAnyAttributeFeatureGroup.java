...
/** 
 * A representation for the Feature Group '<em><b>AttributeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class AttributeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<AttributeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final AttributeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<AttributeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<AttributeTypeAnyAttributeFeatureGroup> result = new ArrayList<AttributeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final AttributeTypeAnyAttributeFeatureGroup group = new AttributeTypeAnyAttributeFeatureGroup();
