...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAmortizationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAmortizationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAmortizationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAmortizationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAmortizationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAmortizationTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAmortizationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAmortizationTypeAnyAttributeFeatureGroup group = new FinancialMgmtAmortizationTypeAnyAttributeFeatureGroup();
