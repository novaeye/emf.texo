...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtGLChargeAccountsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtGLChargeAccountsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtGLChargeAccountsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtGLChargeAccountsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtGLChargeAccountsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtGLChargeAccountsTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtGLChargeAccountsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtGLChargeAccountsTypeAnyAttributeFeatureGroup group = new FinancialMgmtGLChargeAccountsTypeAnyAttributeFeatureGroup();
