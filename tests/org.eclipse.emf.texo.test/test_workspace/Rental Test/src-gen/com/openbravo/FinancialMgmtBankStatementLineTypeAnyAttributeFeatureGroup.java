...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtBankStatementLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtBankStatementLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtBankStatementLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtBankStatementLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtBankStatementLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtBankStatementLineTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtBankStatementLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtBankStatementLineTypeAnyAttributeFeatureGroup group = new FinancialMgmtBankStatementLineTypeAnyAttributeFeatureGroup();
