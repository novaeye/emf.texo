...
/** 
 * A representation for the Feature Group '<em><b>SalesCommissionAmountType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class SalesCommissionAmountTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<SalesCommissionAmountTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final SalesCommissionAmountTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<SalesCommissionAmountTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<SalesCommissionAmountTypeAnyAttributeFeatureGroup> result = new ArrayList<SalesCommissionAmountTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final SalesCommissionAmountTypeAnyAttributeFeatureGroup group = new SalesCommissionAmountTypeAnyAttributeFeatureGroup();
