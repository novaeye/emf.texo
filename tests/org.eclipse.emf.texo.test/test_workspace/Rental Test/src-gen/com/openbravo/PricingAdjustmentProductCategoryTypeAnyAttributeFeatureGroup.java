...
/** 
 * A representation for the Feature Group '<em><b>PricingAdjustmentProductCategoryType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingAdjustmentProductCategoryTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingAdjustmentProductCategoryTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingAdjustmentProductCategoryTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingAdjustmentProductCategoryTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingAdjustmentProductCategoryTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingAdjustmentProductCategoryTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingAdjustmentProductCategoryTypeAnyAttributeFeatureGroup group = new PricingAdjustmentProductCategoryTypeAnyAttributeFeatureGroup();
