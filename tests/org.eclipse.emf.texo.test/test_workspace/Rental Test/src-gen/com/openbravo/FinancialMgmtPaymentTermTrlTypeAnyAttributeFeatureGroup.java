...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtPaymentTermTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtPaymentTermTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtPaymentTermTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtPaymentTermTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtPaymentTermTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtPaymentTermTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtPaymentTermTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtPaymentTermTrlTypeAnyAttributeFeatureGroup group = new FinancialMgmtPaymentTermTrlTypeAnyAttributeFeatureGroup();
