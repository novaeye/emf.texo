...
/** 
 * A representation for the Feature Group '<em><b>ProductBOMType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProductBOMTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProductBOMTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProductBOMTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProductBOMTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProductBOMTypeAnyAttributeFeatureGroup> result = new ArrayList<ProductBOMTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProductBOMTypeAnyAttributeFeatureGroup group = new ProductBOMTypeAnyAttributeFeatureGroup();
