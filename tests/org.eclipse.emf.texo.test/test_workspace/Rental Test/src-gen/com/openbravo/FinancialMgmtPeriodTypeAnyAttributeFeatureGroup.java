...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtPeriodType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtPeriodTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtPeriodTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtPeriodTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtPeriodTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtPeriodTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtPeriodTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtPeriodTypeAnyAttributeFeatureGroup group = new FinancialMgmtPeriodTypeAnyAttributeFeatureGroup();
