...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingActivityType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingActivityTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingActivityTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingActivityTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingActivityTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingActivityTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingActivityTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingActivityTypeAnyAttributeFeatureGroup group = new ManufacturingActivityTypeAnyAttributeFeatureGroup();
