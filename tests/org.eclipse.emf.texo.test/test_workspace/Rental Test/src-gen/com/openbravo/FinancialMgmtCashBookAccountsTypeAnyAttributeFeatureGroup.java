...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtCashBookAccountsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtCashBookAccountsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtCashBookAccountsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtCashBookAccountsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtCashBookAccountsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtCashBookAccountsTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtCashBookAccountsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtCashBookAccountsTypeAnyAttributeFeatureGroup group = new FinancialMgmtCashBookAccountsTypeAnyAttributeFeatureGroup();
