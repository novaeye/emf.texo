...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtTaxRegisterlineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtTaxRegisterlineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtTaxRegisterlineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtTaxRegisterlineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtTaxRegisterlineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtTaxRegisterlineTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtTaxRegisterlineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtTaxRegisterlineTypeAnyAttributeFeatureGroup group = new FinancialMgmtTaxRegisterlineTypeAnyAttributeFeatureGroup();
