...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtElementValueOperandType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtElementValueOperandTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtElementValueOperandTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtElementValueOperandTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtElementValueOperandTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtElementValueOperandTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtElementValueOperandTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtElementValueOperandTypeAnyAttributeFeatureGroup group = new FinancialMgmtElementValueOperandTypeAnyAttributeFeatureGroup();
