...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtABCActivityType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtABCActivityTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtABCActivityTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtABCActivityTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtABCActivityTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtABCActivityTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtABCActivityTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtABCActivityTypeAnyAttributeFeatureGroup group = new MaterialMgmtABCActivityTypeAnyAttributeFeatureGroup();
