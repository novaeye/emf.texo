...
/** 
 * A representation for the Feature Group '<em><b>FINPaymentDetailVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINPaymentDetailVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINPaymentDetailVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINPaymentDetailVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINPaymentDetailVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINPaymentDetailVTypeAnyAttributeFeatureGroup> result = new ArrayList<FINPaymentDetailVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINPaymentDetailVTypeAnyAttributeFeatureGroup group = new FINPaymentDetailVTypeAnyAttributeFeatureGroup();
