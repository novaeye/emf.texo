...
/** 
 * A representation for the Feature Group '<em><b>ADElementTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADElementTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADElementTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADElementTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADElementTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADElementTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADElementTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADElementTrlTypeAnyAttributeFeatureGroup group = new ADElementTrlTypeAnyAttributeFeatureGroup();
