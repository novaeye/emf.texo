...
/** 
 * A representation for the Feature Group '<em><b>ProductTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProductTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProductTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProductTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProductTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProductTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ProductTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProductTrlTypeAnyAttributeFeatureGroup group = new ProductTrlTypeAnyAttributeFeatureGroup();
