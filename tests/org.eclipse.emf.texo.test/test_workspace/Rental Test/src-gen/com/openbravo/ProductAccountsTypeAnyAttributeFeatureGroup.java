...
/** 
 * A representation for the Feature Group '<em><b>ProductAccountsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProductAccountsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProductAccountsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProductAccountsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProductAccountsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProductAccountsTypeAnyAttributeFeatureGroup> result = new ArrayList<ProductAccountsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProductAccountsTypeAnyAttributeFeatureGroup group = new ProductAccountsTypeAnyAttributeFeatureGroup();
