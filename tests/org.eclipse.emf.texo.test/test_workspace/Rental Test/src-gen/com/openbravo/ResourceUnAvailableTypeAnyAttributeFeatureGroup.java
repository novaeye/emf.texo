...
/** 
 * A representation for the Feature Group '<em><b>ResourceUnAvailableType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ResourceUnAvailableTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ResourceUnAvailableTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ResourceUnAvailableTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ResourceUnAvailableTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ResourceUnAvailableTypeAnyAttributeFeatureGroup> result = new ArrayList<ResourceUnAvailableTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ResourceUnAvailableTypeAnyAttributeFeatureGroup group = new ResourceUnAvailableTypeAnyAttributeFeatureGroup();
