...
/** 
 * A representation for the Feature Group '<em><b>InvoiceTaxType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class InvoiceTaxTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<InvoiceTaxTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final InvoiceTaxTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<InvoiceTaxTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<InvoiceTaxTypeAnyAttributeFeatureGroup> result = new ArrayList<InvoiceTaxTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final InvoiceTaxTypeAnyAttributeFeatureGroup group = new InvoiceTaxTypeAnyAttributeFeatureGroup();
