...
/** 
 * A representation for the Feature Group '<em><b>InvoiceScheduleType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class InvoiceScheduleTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<InvoiceScheduleTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final InvoiceScheduleTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<InvoiceScheduleTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<InvoiceScheduleTypeAnyAttributeFeatureGroup> result = new ArrayList<InvoiceScheduleTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final InvoiceScheduleTypeAnyAttributeFeatureGroup group = new InvoiceScheduleTypeAnyAttributeFeatureGroup();
