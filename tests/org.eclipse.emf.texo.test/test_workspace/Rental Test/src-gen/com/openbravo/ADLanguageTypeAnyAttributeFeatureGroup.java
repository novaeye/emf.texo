...
/** 
 * A representation for the Feature Group '<em><b>ADLanguageType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADLanguageTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADLanguageTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADLanguageTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADLanguageTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADLanguageTypeAnyAttributeFeatureGroup> result = new ArrayList<ADLanguageTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADLanguageTypeAnyAttributeFeatureGroup group = new ADLanguageTypeAnyAttributeFeatureGroup();
