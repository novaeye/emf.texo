...
/** 
 * A representation for the Feature Group '<em><b>TimeAndExpenseSheetLineVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class TimeAndExpenseSheetLineVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<TimeAndExpenseSheetLineVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final TimeAndExpenseSheetLineVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<TimeAndExpenseSheetLineVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<TimeAndExpenseSheetLineVTypeAnyAttributeFeatureGroup> result = new ArrayList<TimeAndExpenseSheetLineVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final TimeAndExpenseSheetLineVTypeAnyAttributeFeatureGroup group = new TimeAndExpenseSheetLineVTypeAnyAttributeFeatureGroup();
