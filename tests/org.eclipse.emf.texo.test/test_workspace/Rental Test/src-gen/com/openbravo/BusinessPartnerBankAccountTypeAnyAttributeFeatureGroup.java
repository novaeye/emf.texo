...
/** 
 * A representation for the Feature Group '<em><b>BusinessPartnerBankAccountType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class BusinessPartnerBankAccountTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<BusinessPartnerBankAccountTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final BusinessPartnerBankAccountTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<BusinessPartnerBankAccountTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<BusinessPartnerBankAccountTypeAnyAttributeFeatureGroup> result = new ArrayList<BusinessPartnerBankAccountTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final BusinessPartnerBankAccountTypeAnyAttributeFeatureGroup group = new BusinessPartnerBankAccountTypeAnyAttributeFeatureGroup();
