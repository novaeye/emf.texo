...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingMachineCostType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingMachineCostTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingMachineCostTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingMachineCostTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingMachineCostTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingMachineCostTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingMachineCostTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingMachineCostTypeAnyAttributeFeatureGroup group = new ManufacturingMachineCostTypeAnyAttributeFeatureGroup();
