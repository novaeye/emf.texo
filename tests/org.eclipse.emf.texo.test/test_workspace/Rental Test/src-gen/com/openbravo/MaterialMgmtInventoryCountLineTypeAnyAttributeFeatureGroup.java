...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtInventoryCountLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtInventoryCountLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtInventoryCountLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtInventoryCountLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtInventoryCountLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtInventoryCountLineTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtInventoryCountLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtInventoryCountLineTypeAnyAttributeFeatureGroup group = new MaterialMgmtInventoryCountLineTypeAnyAttributeFeatureGroup();
