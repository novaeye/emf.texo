...
/** 
 * A representation for the Feature Group '<em><b>ADMonthTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADMonthTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADMonthTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADMonthTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADMonthTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADMonthTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADMonthTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADMonthTrlTypeAnyAttributeFeatureGroup group = new ADMonthTrlTypeAnyAttributeFeatureGroup();
