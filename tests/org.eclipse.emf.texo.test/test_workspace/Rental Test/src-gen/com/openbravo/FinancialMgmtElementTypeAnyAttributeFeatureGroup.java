...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtElementType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtElementTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtElementTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtElementTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtElementTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtElementTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtElementTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtElementTypeAnyAttributeFeatureGroup group = new FinancialMgmtElementTypeAnyAttributeFeatureGroup();
