...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingMeasureShiftType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingMeasureShiftTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingMeasureShiftTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingMeasureShiftTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingMeasureShiftTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingMeasureShiftTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingMeasureShiftTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingMeasureShiftTypeAnyAttributeFeatureGroup group = new ManufacturingMeasureShiftTypeAnyAttributeFeatureGroup();
