...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingGlobalUseType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingGlobalUseTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingGlobalUseTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingGlobalUseTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingGlobalUseTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingGlobalUseTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingGlobalUseTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingGlobalUseTypeAnyAttributeFeatureGroup group = new ManufacturingGlobalUseTypeAnyAttributeFeatureGroup();
