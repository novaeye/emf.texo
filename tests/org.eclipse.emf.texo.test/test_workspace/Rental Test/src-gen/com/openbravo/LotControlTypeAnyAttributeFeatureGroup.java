...
/** 
 * A representation for the Feature Group '<em><b>LotControlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class LotControlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<LotControlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final LotControlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<LotControlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<LotControlTypeAnyAttributeFeatureGroup> result = new ArrayList<LotControlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final LotControlTypeAnyAttributeFeatureGroup group = new LotControlTypeAnyAttributeFeatureGroup();
