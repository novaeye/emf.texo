...
/** 
 * A representation for the Feature Group '<em><b>ADWindowTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADWindowTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADWindowTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADWindowTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADWindowTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADWindowTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADWindowTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADWindowTrlTypeAnyAttributeFeatureGroup group = new ADWindowTrlTypeAnyAttributeFeatureGroup();
