...
/** 
 * A representation for the Feature Group '<em><b>ProductCategoryType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProductCategoryTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProductCategoryTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProductCategoryTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProductCategoryTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProductCategoryTypeAnyAttributeFeatureGroup> result = new ArrayList<ProductCategoryTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProductCategoryTypeAnyAttributeFeatureGroup group = new ProductCategoryTypeAnyAttributeFeatureGroup();
