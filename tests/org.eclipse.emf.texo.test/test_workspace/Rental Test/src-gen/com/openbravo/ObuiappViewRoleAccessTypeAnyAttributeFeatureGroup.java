...
/** 
 * A representation for the Feature Group '<em><b>ObuiappViewRoleAccessType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ObuiappViewRoleAccessTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ObuiappViewRoleAccessTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ObuiappViewRoleAccessTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ObuiappViewRoleAccessTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ObuiappViewRoleAccessTypeAnyAttributeFeatureGroup> result = new ArrayList<ObuiappViewRoleAccessTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ObuiappViewRoleAccessTypeAnyAttributeFeatureGroup group = new ObuiappViewRoleAccessTypeAnyAttributeFeatureGroup();
