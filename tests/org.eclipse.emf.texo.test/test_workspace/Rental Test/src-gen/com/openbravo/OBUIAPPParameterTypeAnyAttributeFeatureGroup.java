...
/** 
 * A representation for the Feature Group '<em><b>OBUIAPPParameterType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUIAPPParameterTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUIAPPParameterTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUIAPPParameterTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUIAPPParameterTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUIAPPParameterTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUIAPPParameterTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUIAPPParameterTypeAnyAttributeFeatureGroup group = new OBUIAPPParameterTypeAnyAttributeFeatureGroup();
