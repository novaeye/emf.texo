...
/** 
 * A representation for the Feature Group '<em><b>ADWindowAccessType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADWindowAccessTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADWindowAccessTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADWindowAccessTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADWindowAccessTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADWindowAccessTypeAnyAttributeFeatureGroup> result = new ArrayList<ADWindowAccessTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADWindowAccessTypeAnyAttributeFeatureGroup group = new ADWindowAccessTypeAnyAttributeFeatureGroup();
