...
/** 
 * A representation for the Feature Group '<em><b>ADModuleDBPrefixInstallType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADModuleDBPrefixInstallTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADModuleDBPrefixInstallTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADModuleDBPrefixInstallTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADModuleDBPrefixInstallTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADModuleDBPrefixInstallTypeAnyAttributeFeatureGroup> result = new ArrayList<ADModuleDBPrefixInstallTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADModuleDBPrefixInstallTypeAnyAttributeFeatureGroup group = new ADModuleDBPrefixInstallTypeAnyAttributeFeatureGroup();
