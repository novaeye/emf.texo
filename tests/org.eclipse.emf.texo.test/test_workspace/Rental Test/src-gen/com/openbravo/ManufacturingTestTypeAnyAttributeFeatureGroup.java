...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingTestType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingTestTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingTestTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingTestTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingTestTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingTestTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingTestTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingTestTypeAnyAttributeFeatureGroup group = new ManufacturingTestTypeAnyAttributeFeatureGroup();
