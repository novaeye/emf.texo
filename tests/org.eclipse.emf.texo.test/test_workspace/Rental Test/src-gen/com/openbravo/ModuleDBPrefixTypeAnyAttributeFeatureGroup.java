...
/** 
 * A representation for the Feature Group '<em><b>ModuleDBPrefixType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ModuleDBPrefixTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ModuleDBPrefixTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ModuleDBPrefixTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ModuleDBPrefixTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ModuleDBPrefixTypeAnyAttributeFeatureGroup> result = new ArrayList<ModuleDBPrefixTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ModuleDBPrefixTypeAnyAttributeFeatureGroup group = new ModuleDBPrefixTypeAnyAttributeFeatureGroup();
