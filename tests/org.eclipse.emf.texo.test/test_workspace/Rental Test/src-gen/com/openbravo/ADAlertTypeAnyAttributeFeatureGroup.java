...
/** 
 * A representation for the Feature Group '<em><b>ADAlertType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADAlertTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADAlertTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADAlertTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADAlertTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADAlertTypeAnyAttributeFeatureGroup> result = new ArrayList<ADAlertTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADAlertTypeAnyAttributeFeatureGroup group = new ADAlertTypeAnyAttributeFeatureGroup();
