...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingMeasureValuesType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingMeasureValuesTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingMeasureValuesTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingMeasureValuesTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingMeasureValuesTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingMeasureValuesTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingMeasureValuesTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingMeasureValuesTypeAnyAttributeFeatureGroup group = new ManufacturingMeasureValuesTypeAnyAttributeFeatureGroup();
