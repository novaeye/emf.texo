...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtPaymentRunParameterType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtPaymentRunParameterTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtPaymentRunParameterTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtPaymentRunParameterTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtPaymentRunParameterTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtPaymentRunParameterTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtPaymentRunParameterTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtPaymentRunParameterTypeAnyAttributeFeatureGroup group = new FinancialMgmtPaymentRunParameterTypeAnyAttributeFeatureGroup();
