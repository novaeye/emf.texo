...
/** 
 * A representation for the Feature Group '<em><b>BankAccountType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class BankAccountTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<BankAccountTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final BankAccountTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<BankAccountTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<BankAccountTypeAnyAttributeFeatureGroup> result = new ArrayList<BankAccountTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final BankAccountTypeAnyAttributeFeatureGroup group = new BankAccountTypeAnyAttributeFeatureGroup();
