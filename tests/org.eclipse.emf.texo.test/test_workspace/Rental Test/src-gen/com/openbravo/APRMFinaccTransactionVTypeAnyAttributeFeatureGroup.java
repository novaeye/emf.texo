...
/** 
 * A representation for the Feature Group '<em><b>APRMFinaccTransactionVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class APRMFinaccTransactionVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<APRMFinaccTransactionVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final APRMFinaccTransactionVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<APRMFinaccTransactionVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<APRMFinaccTransactionVTypeAnyAttributeFeatureGroup> result = new ArrayList<APRMFinaccTransactionVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final APRMFinaccTransactionVTypeAnyAttributeFeatureGroup group = new APRMFinaccTransactionVTypeAnyAttributeFeatureGroup();
