...
/** 
 * A representation for the Feature Group '<em><b>CurrencyConversionRateDocType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class CurrencyConversionRateDocTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<CurrencyConversionRateDocTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final CurrencyConversionRateDocTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<CurrencyConversionRateDocTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<CurrencyConversionRateDocTypeAnyAttributeFeatureGroup> result = new ArrayList<CurrencyConversionRateDocTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final CurrencyConversionRateDocTypeAnyAttributeFeatureGroup group = new CurrencyConversionRateDocTypeAnyAttributeFeatureGroup();
