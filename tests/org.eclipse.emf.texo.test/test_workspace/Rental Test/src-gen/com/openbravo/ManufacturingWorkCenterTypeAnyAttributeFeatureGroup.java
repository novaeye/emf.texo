...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingWorkCenterType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingWorkCenterTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingWorkCenterTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingWorkCenterTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingWorkCenterTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingWorkCenterTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingWorkCenterTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingWorkCenterTypeAnyAttributeFeatureGroup group = new ManufacturingWorkCenterTypeAnyAttributeFeatureGroup();
