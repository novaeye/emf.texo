...
/** 
 * A representation for the Feature Group '<em><b>ProductSubstituteType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProductSubstituteTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProductSubstituteTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProductSubstituteTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProductSubstituteTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProductSubstituteTypeAnyAttributeFeatureGroup> result = new ArrayList<ProductSubstituteTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProductSubstituteTypeAnyAttributeFeatureGroup group = new ProductSubstituteTypeAnyAttributeFeatureGroup();
