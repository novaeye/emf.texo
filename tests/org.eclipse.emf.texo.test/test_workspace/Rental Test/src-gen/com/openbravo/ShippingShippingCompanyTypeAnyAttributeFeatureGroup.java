...
/** 
 * A representation for the Feature Group '<em><b>ShippingShippingCompanyType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ShippingShippingCompanyTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ShippingShippingCompanyTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ShippingShippingCompanyTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ShippingShippingCompanyTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ShippingShippingCompanyTypeAnyAttributeFeatureGroup> result = new ArrayList<ShippingShippingCompanyTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ShippingShippingCompanyTypeAnyAttributeFeatureGroup group = new ShippingShippingCompanyTypeAnyAttributeFeatureGroup();
