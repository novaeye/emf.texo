...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtTaxRegisterType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtTaxRegisterTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtTaxRegisterTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtTaxRegisterTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtTaxRegisterTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtTaxRegisterTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtTaxRegisterTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtTaxRegisterTypeAnyAttributeFeatureGroup group = new FinancialMgmtTaxRegisterTypeAnyAttributeFeatureGroup();
