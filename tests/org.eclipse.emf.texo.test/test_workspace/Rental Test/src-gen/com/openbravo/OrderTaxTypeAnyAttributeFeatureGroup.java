...
/** 
 * A representation for the Feature Group '<em><b>OrderTaxType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OrderTaxTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OrderTaxTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OrderTaxTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OrderTaxTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OrderTaxTypeAnyAttributeFeatureGroup> result = new ArrayList<OrderTaxTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OrderTaxTypeAnyAttributeFeatureGroup group = new OrderTaxTypeAnyAttributeFeatureGroup();
