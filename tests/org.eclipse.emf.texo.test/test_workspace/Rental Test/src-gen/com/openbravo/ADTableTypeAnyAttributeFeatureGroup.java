...
/** 
 * A representation for the Feature Group '<em><b>ADTableType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADTableTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADTableTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADTableTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADTableTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADTableTypeAnyAttributeFeatureGroup> result = new ArrayList<ADTableTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADTableTypeAnyAttributeFeatureGroup group = new ADTableTypeAnyAttributeFeatureGroup();
