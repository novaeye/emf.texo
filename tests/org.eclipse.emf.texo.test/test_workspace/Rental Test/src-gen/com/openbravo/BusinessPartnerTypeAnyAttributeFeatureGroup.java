...
/** 
 * A representation for the Feature Group '<em><b>BusinessPartnerType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class BusinessPartnerTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<BusinessPartnerTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final BusinessPartnerTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<BusinessPartnerTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<BusinessPartnerTypeAnyAttributeFeatureGroup> result = new ArrayList<BusinessPartnerTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final BusinessPartnerTypeAnyAttributeFeatureGroup group = new BusinessPartnerTypeAnyAttributeFeatureGroup();
