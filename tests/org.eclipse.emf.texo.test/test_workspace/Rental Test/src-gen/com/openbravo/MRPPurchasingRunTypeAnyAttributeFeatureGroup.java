...
/** 
 * A representation for the Feature Group '<em><b>MRPPurchasingRunType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MRPPurchasingRunTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MRPPurchasingRunTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MRPPurchasingRunTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MRPPurchasingRunTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MRPPurchasingRunTypeAnyAttributeFeatureGroup> result = new ArrayList<MRPPurchasingRunTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MRPPurchasingRunTypeAnyAttributeFeatureGroup group = new MRPPurchasingRunTypeAnyAttributeFeatureGroup();
