...
/** 
 * A representation for the Feature Group '<em><b>ADMenuType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADMenuTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADMenuTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADMenuTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADMenuTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADMenuTypeAnyAttributeFeatureGroup> result = new ArrayList<ADMenuTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADMenuTypeAnyAttributeFeatureGroup group = new ADMenuTypeAnyAttributeFeatureGroup();
