...
/** 
 * A representation for the Feature Group '<em><b>MRPSalesForecastType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MRPSalesForecastTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MRPSalesForecastTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MRPSalesForecastTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MRPSalesForecastTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MRPSalesForecastTypeAnyAttributeFeatureGroup> result = new ArrayList<MRPSalesForecastTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MRPSalesForecastTypeAnyAttributeFeatureGroup group = new MRPSalesForecastTypeAnyAttributeFeatureGroup();
