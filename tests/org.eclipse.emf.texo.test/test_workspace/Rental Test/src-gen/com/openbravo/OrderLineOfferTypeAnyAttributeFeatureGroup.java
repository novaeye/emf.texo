...
/** 
 * A representation for the Feature Group '<em><b>OrderLineOfferType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OrderLineOfferTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OrderLineOfferTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OrderLineOfferTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OrderLineOfferTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OrderLineOfferTypeAnyAttributeFeatureGroup> result = new ArrayList<OrderLineOfferTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OrderLineOfferTypeAnyAttributeFeatureGroup group = new OrderLineOfferTypeAnyAttributeFeatureGroup();
