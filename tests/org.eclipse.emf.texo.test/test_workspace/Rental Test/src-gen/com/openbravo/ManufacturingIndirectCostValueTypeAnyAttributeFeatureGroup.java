...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingIndirectCostValueType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingIndirectCostValueTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingIndirectCostValueTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingIndirectCostValueTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingIndirectCostValueTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingIndirectCostValueTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingIndirectCostValueTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingIndirectCostValueTypeAnyAttributeFeatureGroup group = new ManufacturingIndirectCostValueTypeAnyAttributeFeatureGroup();
