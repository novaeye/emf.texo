...
/** 
 * A representation for the Feature Group '<em><b>BusinessPartnerCategoryAccountType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class BusinessPartnerCategoryAccountTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<BusinessPartnerCategoryAccountTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final BusinessPartnerCategoryAccountTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<BusinessPartnerCategoryAccountTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<BusinessPartnerCategoryAccountTypeAnyAttributeFeatureGroup> result = new ArrayList<BusinessPartnerCategoryAccountTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final BusinessPartnerCategoryAccountTypeAnyAttributeFeatureGroup group = new BusinessPartnerCategoryAccountTypeAnyAttributeFeatureGroup();
