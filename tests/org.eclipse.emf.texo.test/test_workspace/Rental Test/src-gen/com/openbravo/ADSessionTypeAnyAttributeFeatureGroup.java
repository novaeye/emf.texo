...
/** 
 * A representation for the Feature Group '<em><b>ADSessionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADSessionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADSessionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADSessionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADSessionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADSessionTypeAnyAttributeFeatureGroup> result = new ArrayList<ADSessionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADSessionTypeAnyAttributeFeatureGroup group = new ADSessionTypeAnyAttributeFeatureGroup();
