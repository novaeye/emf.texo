...
/** 
 * A representation for the Feature Group '<em><b>ADAlertRecipientType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADAlertRecipientTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADAlertRecipientTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADAlertRecipientTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADAlertRecipientTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADAlertRecipientTypeAnyAttributeFeatureGroup> result = new ArrayList<ADAlertRecipientTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADAlertRecipientTypeAnyAttributeFeatureGroup group = new ADAlertRecipientTypeAnyAttributeFeatureGroup();
