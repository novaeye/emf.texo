...
/** 
 * A representation for the Feature Group '<em><b>OrganizationInformationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OrganizationInformationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OrganizationInformationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OrganizationInformationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OrganizationInformationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OrganizationInformationTypeAnyAttributeFeatureGroup> result = new ArrayList<OrganizationInformationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OrganizationInformationTypeAnyAttributeFeatureGroup group = new OrganizationInformationTypeAnyAttributeFeatureGroup();
