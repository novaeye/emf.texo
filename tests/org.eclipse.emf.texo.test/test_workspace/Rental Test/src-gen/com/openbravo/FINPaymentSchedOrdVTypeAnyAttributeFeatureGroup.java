...
/** 
 * A representation for the Feature Group '<em><b>FINPaymentSchedOrdVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINPaymentSchedOrdVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINPaymentSchedOrdVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINPaymentSchedOrdVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINPaymentSchedOrdVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINPaymentSchedOrdVTypeAnyAttributeFeatureGroup> result = new ArrayList<FINPaymentSchedOrdVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINPaymentSchedOrdVTypeAnyAttributeFeatureGroup group = new FINPaymentSchedOrdVTypeAnyAttributeFeatureGroup();
