...
/** 
 * A representation for the Feature Group '<em><b>AttributeUseType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class AttributeUseTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<AttributeUseTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final AttributeUseTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<AttributeUseTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<AttributeUseTypeAnyAttributeFeatureGroup> result = new ArrayList<AttributeUseTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final AttributeUseTypeAnyAttributeFeatureGroup group = new AttributeUseTypeAnyAttributeFeatureGroup();
