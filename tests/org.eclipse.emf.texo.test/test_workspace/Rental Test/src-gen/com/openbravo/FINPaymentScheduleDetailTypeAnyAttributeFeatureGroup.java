...
/** 
 * A representation for the Feature Group '<em><b>FINPaymentScheduleDetailType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINPaymentScheduleDetailTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINPaymentScheduleDetailTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINPaymentScheduleDetailTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINPaymentScheduleDetailTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINPaymentScheduleDetailTypeAnyAttributeFeatureGroup> result = new ArrayList<FINPaymentScheduleDetailTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINPaymentScheduleDetailTypeAnyAttributeFeatureGroup group = new FINPaymentScheduleDetailTypeAnyAttributeFeatureGroup();
