...
/** 
 * A representation for the Feature Group '<em><b>FINPaymentScheduleType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINPaymentScheduleTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINPaymentScheduleTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINPaymentScheduleTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINPaymentScheduleTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINPaymentScheduleTypeAnyAttributeFeatureGroup> result = new ArrayList<FINPaymentScheduleTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINPaymentScheduleTypeAnyAttributeFeatureGroup group = new FINPaymentScheduleTypeAnyAttributeFeatureGroup();
