...
/** 
 * A representation for the Feature Group '<em><b>PricingAdjustmentPriceListType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingAdjustmentPriceListTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingAdjustmentPriceListTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingAdjustmentPriceListTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingAdjustmentPriceListTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingAdjustmentPriceListTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingAdjustmentPriceListTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingAdjustmentPriceListTypeAnyAttributeFeatureGroup group = new PricingAdjustmentPriceListTypeAnyAttributeFeatureGroup();
