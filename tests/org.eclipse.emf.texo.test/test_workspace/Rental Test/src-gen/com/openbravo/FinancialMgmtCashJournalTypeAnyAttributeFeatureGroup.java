...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtCashJournalType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtCashJournalTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtCashJournalTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtCashJournalTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtCashJournalTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtCashJournalTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtCashJournalTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtCashJournalTypeAnyAttributeFeatureGroup group = new FinancialMgmtCashJournalTypeAnyAttributeFeatureGroup();
