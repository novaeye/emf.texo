...
/** 
 * A representation for the Feature Group '<em><b>PricingAdjustmentBusinessPartnerGroupType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingAdjustmentBusinessPartnerGroupTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingAdjustmentBusinessPartnerGroupTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingAdjustmentBusinessPartnerGroupTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingAdjustmentBusinessPartnerGroupTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingAdjustmentBusinessPartnerGroupTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingAdjustmentBusinessPartnerGroupTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingAdjustmentBusinessPartnerGroupTypeAnyAttributeFeatureGroup group = new PricingAdjustmentBusinessPartnerGroupTypeAnyAttributeFeatureGroup();
