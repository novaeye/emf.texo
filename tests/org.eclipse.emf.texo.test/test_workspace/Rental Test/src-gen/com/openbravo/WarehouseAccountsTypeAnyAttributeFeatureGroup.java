...
/** 
 * A representation for the Feature Group '<em><b>WarehouseAccountsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class WarehouseAccountsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<WarehouseAccountsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final WarehouseAccountsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<WarehouseAccountsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<WarehouseAccountsTypeAnyAttributeFeatureGroup> result = new ArrayList<WarehouseAccountsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final WarehouseAccountsTypeAnyAttributeFeatureGroup group = new WarehouseAccountsTypeAnyAttributeFeatureGroup();
