...
/** 
 * A representation for the Feature Group '<em><b>BusinessPartnerCategoryType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class BusinessPartnerCategoryTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<BusinessPartnerCategoryTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final BusinessPartnerCategoryTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<BusinessPartnerCategoryTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<BusinessPartnerCategoryTypeAnyAttributeFeatureGroup> result = new ArrayList<BusinessPartnerCategoryTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final BusinessPartnerCategoryTypeAnyAttributeFeatureGroup group = new BusinessPartnerCategoryTypeAnyAttributeFeatureGroup();
