...
/** 
 * A representation for the Feature Group '<em><b>ADModuleInstallType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADModuleInstallTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADModuleInstallTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADModuleInstallTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADModuleInstallTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADModuleInstallTypeAnyAttributeFeatureGroup> result = new ArrayList<ADModuleInstallTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADModuleInstallTypeAnyAttributeFeatureGroup group = new ADModuleInstallTypeAnyAttributeFeatureGroup();
