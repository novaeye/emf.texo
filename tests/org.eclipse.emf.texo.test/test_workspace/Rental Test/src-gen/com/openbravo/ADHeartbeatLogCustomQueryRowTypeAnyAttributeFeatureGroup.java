...
/** 
 * A representation for the Feature Group '<em><b>ADHeartbeatLogCustomQueryRowType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADHeartbeatLogCustomQueryRowTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADHeartbeatLogCustomQueryRowTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADHeartbeatLogCustomQueryRowTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADHeartbeatLogCustomQueryRowTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADHeartbeatLogCustomQueryRowTypeAnyAttributeFeatureGroup> result = new ArrayList<ADHeartbeatLogCustomQueryRowTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADHeartbeatLogCustomQueryRowTypeAnyAttributeFeatureGroup group = new ADHeartbeatLogCustomQueryRowTypeAnyAttributeFeatureGroup();
