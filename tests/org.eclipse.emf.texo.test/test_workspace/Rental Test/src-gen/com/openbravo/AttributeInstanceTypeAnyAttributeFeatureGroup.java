...
/** 
 * A representation for the Feature Group '<em><b>AttributeInstanceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class AttributeInstanceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<AttributeInstanceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final AttributeInstanceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<AttributeInstanceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<AttributeInstanceTypeAnyAttributeFeatureGroup> result = new ArrayList<AttributeInstanceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final AttributeInstanceTypeAnyAttributeFeatureGroup group = new AttributeInstanceTypeAnyAttributeFeatureGroup();
