...
/** 
 * A representation for the Feature Group '<em><b>ProcurementRequisitionPOMatchType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProcurementRequisitionPOMatchTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProcurementRequisitionPOMatchTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProcurementRequisitionPOMatchTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProcurementRequisitionPOMatchTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProcurementRequisitionPOMatchTypeAnyAttributeFeatureGroup> result = new ArrayList<ProcurementRequisitionPOMatchTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProcurementRequisitionPOMatchTypeAnyAttributeFeatureGroup group = new ProcurementRequisitionPOMatchTypeAnyAttributeFeatureGroup();
