...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtSettlementType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtSettlementTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtSettlementTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtSettlementTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtSettlementTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtSettlementTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtSettlementTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtSettlementTypeAnyAttributeFeatureGroup group = new FinancialMgmtSettlementTypeAnyAttributeFeatureGroup();
