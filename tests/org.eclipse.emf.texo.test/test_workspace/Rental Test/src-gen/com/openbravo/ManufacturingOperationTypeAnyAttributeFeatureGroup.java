...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingOperationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingOperationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingOperationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingOperationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingOperationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingOperationTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingOperationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingOperationTypeAnyAttributeFeatureGroup group = new ManufacturingOperationTypeAnyAttributeFeatureGroup();
