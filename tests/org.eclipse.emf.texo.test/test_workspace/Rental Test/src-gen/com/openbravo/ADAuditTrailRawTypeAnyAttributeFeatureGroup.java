...
/** 
 * A representation for the Feature Group '<em><b>ADAuditTrailRawType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADAuditTrailRawTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADAuditTrailRawTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADAuditTrailRawTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADAuditTrailRawTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADAuditTrailRawTypeAnyAttributeFeatureGroup> result = new ArrayList<ADAuditTrailRawTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADAuditTrailRawTypeAnyAttributeFeatureGroup group = new ADAuditTrailRawTypeAnyAttributeFeatureGroup();
