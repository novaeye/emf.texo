...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAcctRptGroupType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAcctRptGroupTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAcctRptGroupTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAcctRptGroupTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAcctRptGroupTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAcctRptGroupTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAcctRptGroupTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAcctRptGroupTypeAnyAttributeFeatureGroup group = new FinancialMgmtAcctRptGroupTypeAnyAttributeFeatureGroup();
