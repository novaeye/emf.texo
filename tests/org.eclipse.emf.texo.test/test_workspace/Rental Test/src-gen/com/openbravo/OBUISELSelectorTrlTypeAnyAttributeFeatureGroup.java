...
/** 
 * A representation for the Feature Group '<em><b>OBUISELSelectorTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUISELSelectorTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUISELSelectorTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUISELSelectorTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUISELSelectorTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUISELSelectorTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUISELSelectorTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUISELSelectorTrlTypeAnyAttributeFeatureGroup group = new OBUISELSelectorTrlTypeAnyAttributeFeatureGroup();
