...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtWithholdingType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtWithholdingTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtWithholdingTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtWithholdingTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtWithholdingTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtWithholdingTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtWithholdingTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtWithholdingTypeAnyAttributeFeatureGroup group = new FinancialMgmtWithholdingTypeAnyAttributeFeatureGroup();
