...
/** 
 * A representation for the Feature Group '<em><b>OrganizationAcctSchemaType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OrganizationAcctSchemaTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OrganizationAcctSchemaTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OrganizationAcctSchemaTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OrganizationAcctSchemaTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OrganizationAcctSchemaTypeAnyAttributeFeatureGroup> result = new ArrayList<OrganizationAcctSchemaTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OrganizationAcctSchemaTypeAnyAttributeFeatureGroup group = new OrganizationAcctSchemaTypeAnyAttributeFeatureGroup();
