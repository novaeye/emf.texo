...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtShipmentInOutLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtShipmentInOutLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtShipmentInOutLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtShipmentInOutLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtShipmentInOutLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtShipmentInOutLineTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtShipmentInOutLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtShipmentInOutLineTypeAnyAttributeFeatureGroup group = new MaterialMgmtShipmentInOutLineTypeAnyAttributeFeatureGroup();
