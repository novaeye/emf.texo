...
/** 
 * A representation for the Feature Group '<em><b>FINFinaccTransactionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINFinaccTransactionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINFinaccTransactionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINFinaccTransactionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINFinaccTransactionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINFinaccTransactionTypeAnyAttributeFeatureGroup> result = new ArrayList<FINFinaccTransactionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINFinaccTransactionTypeAnyAttributeFeatureGroup group = new FINFinaccTransactionTypeAnyAttributeFeatureGroup();
