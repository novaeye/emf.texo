...
/** 
 * A representation for the Feature Group '<em><b>PricingVolumeDiscountType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingVolumeDiscountTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingVolumeDiscountTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingVolumeDiscountTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingVolumeDiscountTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingVolumeDiscountTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingVolumeDiscountTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingVolumeDiscountTypeAnyAttributeFeatureGroup group = new PricingVolumeDiscountTypeAnyAttributeFeatureGroup();
