...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtGLChargeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtGLChargeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtGLChargeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtGLChargeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtGLChargeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtGLChargeTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtGLChargeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtGLChargeTypeAnyAttributeFeatureGroup group = new FinancialMgmtGLChargeTypeAnyAttributeFeatureGroup();
