...
/** 
 * A representation for the Feature Group '<em><b>ADListType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADListTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADListTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADListTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADListTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADListTypeAnyAttributeFeatureGroup> result = new ArrayList<ADListTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADListTypeAnyAttributeFeatureGroup group = new ADListTypeAnyAttributeFeatureGroup();
