...
/** 
 * A representation for the Feature Group '<em><b>ProcessExecutionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProcessExecutionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProcessExecutionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProcessExecutionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProcessExecutionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProcessExecutionTypeAnyAttributeFeatureGroup> result = new ArrayList<ProcessExecutionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProcessExecutionTypeAnyAttributeFeatureGroup group = new ProcessExecutionTypeAnyAttributeFeatureGroup();
