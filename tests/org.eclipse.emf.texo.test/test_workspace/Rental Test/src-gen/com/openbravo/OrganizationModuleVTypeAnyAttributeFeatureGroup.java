...
/** 
 * A representation for the Feature Group '<em><b>OrganizationModuleVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OrganizationModuleVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OrganizationModuleVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OrganizationModuleVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OrganizationModuleVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OrganizationModuleVTypeAnyAttributeFeatureGroup> result = new ArrayList<OrganizationModuleVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OrganizationModuleVTypeAnyAttributeFeatureGroup group = new OrganizationModuleVTypeAnyAttributeFeatureGroup();
