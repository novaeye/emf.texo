...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtPaymentRunPaymentType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtPaymentRunPaymentTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtPaymentRunPaymentTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtPaymentRunPaymentTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtPaymentRunPaymentTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtPaymentRunPaymentTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtPaymentRunPaymentTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtPaymentRunPaymentTypeAnyAttributeFeatureGroup group = new FinancialMgmtPaymentRunPaymentTypeAnyAttributeFeatureGroup();
