...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingCostCenterMachineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingCostCenterMachineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingCostCenterMachineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingCostCenterMachineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingCostCenterMachineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingCostCenterMachineTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingCostCenterMachineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingCostCenterMachineTypeAnyAttributeFeatureGroup group = new ManufacturingCostCenterMachineTypeAnyAttributeFeatureGroup();
