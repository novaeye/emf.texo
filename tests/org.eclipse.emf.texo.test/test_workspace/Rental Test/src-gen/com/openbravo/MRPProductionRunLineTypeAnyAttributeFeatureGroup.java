...
/** 
 * A representation for the Feature Group '<em><b>MRPProductionRunLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MRPProductionRunLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MRPProductionRunLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MRPProductionRunLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MRPProductionRunLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MRPProductionRunLineTypeAnyAttributeFeatureGroup> result = new ArrayList<MRPProductionRunLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MRPProductionRunLineTypeAnyAttributeFeatureGroup group = new MRPProductionRunLineTypeAnyAttributeFeatureGroup();
