...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingMaintenanceScheduleType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingMaintenanceScheduleTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingMaintenanceScheduleTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingMaintenanceScheduleTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingMaintenanceScheduleTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingMaintenanceScheduleTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingMaintenanceScheduleTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingMaintenanceScheduleTypeAnyAttributeFeatureGroup group = new ManufacturingMaintenanceScheduleTypeAnyAttributeFeatureGroup();
