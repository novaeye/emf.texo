...
/** 
 * A representation for the Feature Group '<em><b>SerialNumberControlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class SerialNumberControlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<SerialNumberControlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final SerialNumberControlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<SerialNumberControlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<SerialNumberControlTypeAnyAttributeFeatureGroup> result = new ArrayList<SerialNumberControlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final SerialNumberControlTypeAnyAttributeFeatureGroup group = new SerialNumberControlTypeAnyAttributeFeatureGroup();
