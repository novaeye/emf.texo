...
/** 
 * A representation for the Feature Group '<em><b>ADClientModuleType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADClientModuleTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADClientModuleTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADClientModuleTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADClientModuleTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADClientModuleTypeAnyAttributeFeatureGroup> result = new ArrayList<ADClientModuleTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADClientModuleTypeAnyAttributeFeatureGroup group = new ADClientModuleTypeAnyAttributeFeatureGroup();
