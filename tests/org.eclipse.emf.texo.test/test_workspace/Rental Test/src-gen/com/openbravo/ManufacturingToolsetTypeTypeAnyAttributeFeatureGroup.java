...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingToolsetTypeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingToolsetTypeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingToolsetTypeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingToolsetTypeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingToolsetTypeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingToolsetTypeTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingToolsetTypeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingToolsetTypeTypeAnyAttributeFeatureGroup group = new ManufacturingToolsetTypeTypeAnyAttributeFeatureGroup();
