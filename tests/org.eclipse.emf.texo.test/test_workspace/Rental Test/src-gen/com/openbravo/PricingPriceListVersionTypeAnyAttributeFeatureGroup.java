...
/** 
 * A representation for the Feature Group '<em><b>PricingPriceListVersionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingPriceListVersionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingPriceListVersionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingPriceListVersionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingPriceListVersionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingPriceListVersionTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingPriceListVersionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingPriceListVersionTypeAnyAttributeFeatureGroup group = new PricingPriceListVersionTypeAnyAttributeFeatureGroup();
