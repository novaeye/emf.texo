...
/** 
 * A representation for the Feature Group '<em><b>ProductOrgType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProductOrgTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProductOrgTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProductOrgTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProductOrgTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProductOrgTypeAnyAttributeFeatureGroup> result = new ArrayList<ProductOrgTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProductOrgTypeAnyAttributeFeatureGroup group = new ProductOrgTypeAnyAttributeFeatureGroup();
