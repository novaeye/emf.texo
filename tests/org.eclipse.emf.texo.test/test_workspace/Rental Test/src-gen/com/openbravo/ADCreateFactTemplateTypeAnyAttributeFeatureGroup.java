...
/** 
 * A representation for the Feature Group '<em><b>ADCreateFactTemplateType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADCreateFactTemplateTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADCreateFactTemplateTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADCreateFactTemplateTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADCreateFactTemplateTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADCreateFactTemplateTypeAnyAttributeFeatureGroup> result = new ArrayList<ADCreateFactTemplateTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADCreateFactTemplateTypeAnyAttributeFeatureGroup group = new ADCreateFactTemplateTypeAnyAttributeFeatureGroup();
