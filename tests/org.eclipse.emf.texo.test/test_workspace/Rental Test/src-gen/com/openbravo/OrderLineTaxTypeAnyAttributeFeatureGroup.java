...
/** 
 * A representation for the Feature Group '<em><b>OrderLineTaxType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OrderLineTaxTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OrderLineTaxTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OrderLineTaxTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OrderLineTaxTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OrderLineTaxTypeAnyAttributeFeatureGroup> result = new ArrayList<OrderLineTaxTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OrderLineTaxTypeAnyAttributeFeatureGroup group = new OrderLineTaxTypeAnyAttributeFeatureGroup();
