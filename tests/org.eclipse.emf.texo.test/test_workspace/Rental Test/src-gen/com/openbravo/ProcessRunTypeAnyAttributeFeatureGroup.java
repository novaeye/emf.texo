...
/** 
 * A representation for the Feature Group '<em><b>ProcessRunType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProcessRunTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProcessRunTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProcessRunTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProcessRunTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProcessRunTypeAnyAttributeFeatureGroup> result = new ArrayList<ProcessRunTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProcessRunTypeAnyAttributeFeatureGroup group = new ProcessRunTypeAnyAttributeFeatureGroup();
