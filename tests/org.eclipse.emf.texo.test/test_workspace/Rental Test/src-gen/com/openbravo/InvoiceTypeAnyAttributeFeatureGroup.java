...
/** 
 * A representation for the Feature Group '<em><b>InvoiceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class InvoiceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<InvoiceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final InvoiceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<InvoiceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<InvoiceTypeAnyAttributeFeatureGroup> result = new ArrayList<InvoiceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final InvoiceTypeAnyAttributeFeatureGroup group = new InvoiceTypeAnyAttributeFeatureGroup();
