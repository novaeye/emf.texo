...
/** 
 * A representation for the Feature Group '<em><b>ProjectProposalType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProjectProposalTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProjectProposalTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProjectProposalTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProjectProposalTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProjectProposalTypeAnyAttributeFeatureGroup> result = new ArrayList<ProjectProposalTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProjectProposalTypeAnyAttributeFeatureGroup group = new ProjectProposalTypeAnyAttributeFeatureGroup();
