...
/** 
 * A representation for the Feature Group '<em><b>OrderDiscountType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OrderDiscountTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OrderDiscountTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OrderDiscountTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OrderDiscountTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OrderDiscountTypeAnyAttributeFeatureGroup> result = new ArrayList<OrderDiscountTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OrderDiscountTypeAnyAttributeFeatureGroup group = new OrderDiscountTypeAnyAttributeFeatureGroup();
