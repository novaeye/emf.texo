...
/** 
 * A representation for the Feature Group '<em><b>ADEPProceduresType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADEPProceduresTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADEPProceduresTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADEPProceduresTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADEPProceduresTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADEPProceduresTypeAnyAttributeFeatureGroup> result = new ArrayList<ADEPProceduresTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADEPProceduresTypeAnyAttributeFeatureGroup group = new ADEPProceduresTypeAnyAttributeFeatureGroup();
