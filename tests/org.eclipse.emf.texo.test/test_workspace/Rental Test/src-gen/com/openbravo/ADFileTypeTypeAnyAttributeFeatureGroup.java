...
/** 
 * A representation for the Feature Group '<em><b>ADFileTypeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADFileTypeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADFileTypeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADFileTypeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADFileTypeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADFileTypeTypeAnyAttributeFeatureGroup> result = new ArrayList<ADFileTypeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADFileTypeTypeAnyAttributeFeatureGroup group = new ADFileTypeTypeAnyAttributeFeatureGroup();
