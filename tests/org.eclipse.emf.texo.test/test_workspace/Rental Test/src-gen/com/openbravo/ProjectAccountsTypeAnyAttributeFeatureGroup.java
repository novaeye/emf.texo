...
/** 
 * A representation for the Feature Group '<em><b>ProjectAccountsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProjectAccountsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProjectAccountsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProjectAccountsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProjectAccountsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProjectAccountsTypeAnyAttributeFeatureGroup> result = new ArrayList<ProjectAccountsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProjectAccountsTypeAnyAttributeFeatureGroup group = new ProjectAccountsTypeAnyAttributeFeatureGroup();
