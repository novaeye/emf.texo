...
/** 
 * A representation for the Feature Group '<em><b>ADCalloutType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADCalloutTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADCalloutTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADCalloutTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADCalloutTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADCalloutTypeAnyAttributeFeatureGroup> result = new ArrayList<ADCalloutTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADCalloutTypeAnyAttributeFeatureGroup group = new ADCalloutTypeAnyAttributeFeatureGroup();
