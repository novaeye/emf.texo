...
/** 
 * A representation for the Feature Group '<em><b>FINPaymentProposalType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINPaymentProposalTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINPaymentProposalTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINPaymentProposalTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINPaymentProposalTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINPaymentProposalTypeAnyAttributeFeatureGroup> result = new ArrayList<FINPaymentProposalTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINPaymentProposalTypeAnyAttributeFeatureGroup group = new FINPaymentProposalTypeAnyAttributeFeatureGroup();
