...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtInternalMovementLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtInternalMovementLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtInternalMovementLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtInternalMovementLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtInternalMovementLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtInternalMovementLineTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtInternalMovementLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtInternalMovementLineTypeAnyAttributeFeatureGroup group = new MaterialMgmtInternalMovementLineTypeAnyAttributeFeatureGroup();
