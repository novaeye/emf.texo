...
/** 
 * A representation for the Feature Group '<em><b>ResourceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ResourceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ResourceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ResourceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ResourceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ResourceTypeAnyAttributeFeatureGroup> result = new ArrayList<ResourceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ResourceTypeAnyAttributeFeatureGroup group = new ResourceTypeAnyAttributeFeatureGroup();
