...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAmortizationLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAmortizationLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAmortizationLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAmortizationLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAmortizationLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAmortizationLineTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAmortizationLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAmortizationLineTypeAnyAttributeFeatureGroup group = new FinancialMgmtAmortizationLineTypeAnyAttributeFeatureGroup();
