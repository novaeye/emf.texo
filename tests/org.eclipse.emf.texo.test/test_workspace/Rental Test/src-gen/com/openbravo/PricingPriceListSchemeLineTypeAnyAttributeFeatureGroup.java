...
/** 
 * A representation for the Feature Group '<em><b>PricingPriceListSchemeLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingPriceListSchemeLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingPriceListSchemeLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingPriceListSchemeLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingPriceListSchemeLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingPriceListSchemeLineTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingPriceListSchemeLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingPriceListSchemeLineTypeAnyAttributeFeatureGroup group = new PricingPriceListSchemeLineTypeAnyAttributeFeatureGroup();
