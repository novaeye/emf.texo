...
/** 
 * A representation for the Feature Group '<em><b>ADUserType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADUserTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADUserTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADUserTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADUserTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADUserTypeAnyAttributeFeatureGroup> result = new ArrayList<ADUserTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADUserTypeAnyAttributeFeatureGroup group = new ADUserTypeAnyAttributeFeatureGroup();
