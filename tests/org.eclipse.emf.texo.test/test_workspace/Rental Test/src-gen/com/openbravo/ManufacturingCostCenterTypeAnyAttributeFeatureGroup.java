...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingCostCenterType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingCostCenterTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingCostCenterTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingCostCenterTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingCostCenterTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingCostCenterTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingCostCenterTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingCostCenterTypeAnyAttributeFeatureGroup group = new ManufacturingCostCenterTypeAnyAttributeFeatureGroup();
