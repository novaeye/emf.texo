...
/** 
 * A representation for the Feature Group '<em><b>PricingProductPriceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingProductPriceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingProductPriceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingProductPriceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingProductPriceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingProductPriceTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingProductPriceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingProductPriceTypeAnyAttributeFeatureGroup group = new PricingProductPriceTypeAnyAttributeFeatureGroup();
