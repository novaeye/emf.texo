...
/** 
 * A representation for the Feature Group '<em><b>PricingAdjustmentType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingAdjustmentTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingAdjustmentTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingAdjustmentTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingAdjustmentTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingAdjustmentTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingAdjustmentTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingAdjustmentTypeAnyAttributeFeatureGroup group = new PricingAdjustmentTypeAnyAttributeFeatureGroup();
