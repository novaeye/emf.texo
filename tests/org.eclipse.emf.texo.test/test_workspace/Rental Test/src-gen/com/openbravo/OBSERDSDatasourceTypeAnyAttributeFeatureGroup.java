...
/** 
 * A representation for the Feature Group '<em><b>OBSERDSDatasourceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBSERDSDatasourceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBSERDSDatasourceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBSERDSDatasourceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBSERDSDatasourceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBSERDSDatasourceTypeAnyAttributeFeatureGroup> result = new ArrayList<OBSERDSDatasourceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBSERDSDatasourceTypeAnyAttributeFeatureGroup group = new OBSERDSDatasourceTypeAnyAttributeFeatureGroup();
