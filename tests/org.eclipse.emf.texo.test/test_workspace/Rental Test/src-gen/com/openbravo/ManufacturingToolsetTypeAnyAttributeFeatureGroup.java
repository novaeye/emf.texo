...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingToolsetType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingToolsetTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingToolsetTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingToolsetTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingToolsetTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingToolsetTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingToolsetTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingToolsetTypeAnyAttributeFeatureGroup group = new ManufacturingToolsetTypeAnyAttributeFeatureGroup();
