...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAssetType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAssetTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAssetTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAssetTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAssetTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAssetTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAssetTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAssetTypeAnyAttributeFeatureGroup group = new FinancialMgmtAssetTypeAnyAttributeFeatureGroup();
