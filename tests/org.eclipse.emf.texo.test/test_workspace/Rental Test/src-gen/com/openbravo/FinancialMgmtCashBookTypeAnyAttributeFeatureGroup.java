...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtCashBookType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtCashBookTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtCashBookTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtCashBookTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtCashBookTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtCashBookTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtCashBookTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtCashBookTypeAnyAttributeFeatureGroup group = new FinancialMgmtCashBookTypeAnyAttributeFeatureGroup();
