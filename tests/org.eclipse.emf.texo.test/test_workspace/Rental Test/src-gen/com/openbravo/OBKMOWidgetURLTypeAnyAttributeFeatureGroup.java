...
/** 
 * A representation for the Feature Group '<em><b>OBKMOWidgetURLType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBKMOWidgetURLTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBKMOWidgetURLTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBKMOWidgetURLTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBKMOWidgetURLTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBKMOWidgetURLTypeAnyAttributeFeatureGroup> result = new ArrayList<OBKMOWidgetURLTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBKMOWidgetURLTypeAnyAttributeFeatureGroup group = new OBKMOWidgetURLTypeAnyAttributeFeatureGroup();
