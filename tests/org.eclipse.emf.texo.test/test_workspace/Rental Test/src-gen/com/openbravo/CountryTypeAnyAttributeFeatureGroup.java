...
/** 
 * A representation for the Feature Group '<em><b>CountryType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class CountryTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<CountryTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final CountryTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<CountryTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<CountryTypeAnyAttributeFeatureGroup> result = new ArrayList<CountryTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final CountryTypeAnyAttributeFeatureGroup group = new CountryTypeAnyAttributeFeatureGroup();
