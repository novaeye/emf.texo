...
/** 
 * A representation for the Feature Group '<em><b>ProjectIssueType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProjectIssueTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProjectIssueTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProjectIssueTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProjectIssueTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProjectIssueTypeAnyAttributeFeatureGroup> result = new ArrayList<ProjectIssueTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProjectIssueTypeAnyAttributeFeatureGroup group = new ProjectIssueTypeAnyAttributeFeatureGroup();
