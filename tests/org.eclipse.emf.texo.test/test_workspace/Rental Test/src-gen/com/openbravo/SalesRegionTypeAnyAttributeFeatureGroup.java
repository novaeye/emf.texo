...
/** 
 * A representation for the Feature Group '<em><b>SalesRegionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class SalesRegionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<SalesRegionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final SalesRegionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<SalesRegionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<SalesRegionTypeAnyAttributeFeatureGroup> result = new ArrayList<SalesRegionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final SalesRegionTypeAnyAttributeFeatureGroup group = new SalesRegionTypeAnyAttributeFeatureGroup();
