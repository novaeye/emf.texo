...
/** 
 * A representation for the Feature Group '<em><b>ProjectProjectProposalTaskType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProjectProjectProposalTaskTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProjectProjectProposalTaskTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProjectProjectProposalTaskTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProjectProjectProposalTaskTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProjectProjectProposalTaskTypeAnyAttributeFeatureGroup> result = new ArrayList<ProjectProjectProposalTaskTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProjectProjectProposalTaskTypeAnyAttributeFeatureGroup group = new ProjectProjectProposalTaskTypeAnyAttributeFeatureGroup();
