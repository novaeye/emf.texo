...
/** 
 * A representation for the Feature Group '<em><b>OBCLKERUIDefinitionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBCLKERUIDefinitionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBCLKERUIDefinitionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBCLKERUIDefinitionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBCLKERUIDefinitionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBCLKERUIDefinitionTypeAnyAttributeFeatureGroup> result = new ArrayList<OBCLKERUIDefinitionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBCLKERUIDefinitionTypeAnyAttributeFeatureGroup group = new OBCLKERUIDefinitionTypeAnyAttributeFeatureGroup();
