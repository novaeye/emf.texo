...
/** 
 * A representation for the Feature Group '<em><b>ADAttachmentType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADAttachmentTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADAttachmentTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADAttachmentTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADAttachmentTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADAttachmentTypeAnyAttributeFeatureGroup> result = new ArrayList<ADAttachmentTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADAttachmentTypeAnyAttributeFeatureGroup group = new ADAttachmentTypeAnyAttributeFeatureGroup();
