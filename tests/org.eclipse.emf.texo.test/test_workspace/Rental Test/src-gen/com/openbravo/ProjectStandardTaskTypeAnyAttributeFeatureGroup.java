...
/** 
 * A representation for the Feature Group '<em><b>ProjectStandardTaskType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProjectStandardTaskTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProjectStandardTaskTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProjectStandardTaskTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProjectStandardTaskTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProjectStandardTaskTypeAnyAttributeFeatureGroup> result = new ArrayList<ProjectStandardTaskTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProjectStandardTaskTypeAnyAttributeFeatureGroup group = new ProjectStandardTaskTypeAnyAttributeFeatureGroup();
