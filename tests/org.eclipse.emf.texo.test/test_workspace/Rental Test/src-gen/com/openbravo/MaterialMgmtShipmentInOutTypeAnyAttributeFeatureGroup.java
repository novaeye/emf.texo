...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtShipmentInOutType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtShipmentInOutTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtShipmentInOutTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtShipmentInOutTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtShipmentInOutTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtShipmentInOutTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtShipmentInOutTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtShipmentInOutTypeAnyAttributeFeatureGroup group = new MaterialMgmtShipmentInOutTypeAnyAttributeFeatureGroup();
