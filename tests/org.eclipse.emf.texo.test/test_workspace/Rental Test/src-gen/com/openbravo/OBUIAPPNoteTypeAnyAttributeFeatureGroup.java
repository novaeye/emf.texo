...
/** 
 * A representation for the Feature Group '<em><b>OBUIAPPNoteType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUIAPPNoteTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUIAPPNoteTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUIAPPNoteTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUIAPPNoteTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUIAPPNoteTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUIAPPNoteTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUIAPPNoteTypeAnyAttributeFeatureGroup group = new OBUIAPPNoteTypeAnyAttributeFeatureGroup();
