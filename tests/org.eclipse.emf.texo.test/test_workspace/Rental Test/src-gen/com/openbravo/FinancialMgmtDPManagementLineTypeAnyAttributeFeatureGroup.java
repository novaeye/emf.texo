...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtDPManagementLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtDPManagementLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtDPManagementLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtDPManagementLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtDPManagementLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtDPManagementLineTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtDPManagementLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtDPManagementLineTypeAnyAttributeFeatureGroup group = new FinancialMgmtDPManagementLineTypeAnyAttributeFeatureGroup();
