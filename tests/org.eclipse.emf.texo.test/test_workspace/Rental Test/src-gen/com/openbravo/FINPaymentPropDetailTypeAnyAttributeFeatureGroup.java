...
/** 
 * A representation for the Feature Group '<em><b>FINPaymentPropDetailType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINPaymentPropDetailTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINPaymentPropDetailTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINPaymentPropDetailTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINPaymentPropDetailTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINPaymentPropDetailTypeAnyAttributeFeatureGroup> result = new ArrayList<FINPaymentPropDetailTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINPaymentPropDetailTypeAnyAttributeFeatureGroup group = new FINPaymentPropDetailTypeAnyAttributeFeatureGroup();
