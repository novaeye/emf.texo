...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtInternalConsumptionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtInternalConsumptionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtInternalConsumptionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtInternalConsumptionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtInternalConsumptionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtInternalConsumptionTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtInternalConsumptionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtInternalConsumptionTypeAnyAttributeFeatureGroup group = new MaterialMgmtInternalConsumptionTypeAnyAttributeFeatureGroup();
