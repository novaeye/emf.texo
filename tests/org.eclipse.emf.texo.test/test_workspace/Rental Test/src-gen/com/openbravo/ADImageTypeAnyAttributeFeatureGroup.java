...
/** 
 * A representation for the Feature Group '<em><b>ADImageType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADImageTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADImageTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADImageTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADImageTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADImageTypeAnyAttributeFeatureGroup> result = new ArrayList<ADImageTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADImageTypeAnyAttributeFeatureGroup group = new ADImageTypeAnyAttributeFeatureGroup();
