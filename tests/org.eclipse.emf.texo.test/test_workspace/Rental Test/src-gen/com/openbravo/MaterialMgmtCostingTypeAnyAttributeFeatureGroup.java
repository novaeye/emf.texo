...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtCostingType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtCostingTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtCostingTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtCostingTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtCostingTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtCostingTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtCostingTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtCostingTypeAnyAttributeFeatureGroup group = new MaterialMgmtCostingTypeAnyAttributeFeatureGroup();
