...
/** 
 * A representation for the Feature Group '<em><b>ConditionGoodsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ConditionGoodsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ConditionGoodsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ConditionGoodsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ConditionGoodsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ConditionGoodsTypeAnyAttributeFeatureGroup> result = new ArrayList<ConditionGoodsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ConditionGoodsTypeAnyAttributeFeatureGroup group = new ConditionGoodsTypeAnyAttributeFeatureGroup();
