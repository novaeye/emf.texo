...
/** 
 * A representation for the Feature Group '<em><b>FINFinancialAccountType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINFinancialAccountTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINFinancialAccountTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINFinancialAccountTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINFinancialAccountTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINFinancialAccountTypeAnyAttributeFeatureGroup> result = new ArrayList<FINFinancialAccountTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINFinancialAccountTypeAnyAttributeFeatureGroup group = new FINFinancialAccountTypeAnyAttributeFeatureGroup();
