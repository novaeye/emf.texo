...
/** 
 * A representation for the Feature Group '<em><b>OrderType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OrderTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OrderTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OrderTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OrderTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OrderTypeAnyAttributeFeatureGroup> result = new ArrayList<OrderTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OrderTypeAnyAttributeFeatureGroup group = new OrderTypeAnyAttributeFeatureGroup();
