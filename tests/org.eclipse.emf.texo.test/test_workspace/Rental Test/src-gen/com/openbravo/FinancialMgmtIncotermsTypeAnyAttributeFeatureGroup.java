...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtIncotermsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtIncotermsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtIncotermsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtIncotermsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtIncotermsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtIncotermsTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtIncotermsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtIncotermsTypeAnyAttributeFeatureGroup group = new FinancialMgmtIncotermsTypeAnyAttributeFeatureGroup();
