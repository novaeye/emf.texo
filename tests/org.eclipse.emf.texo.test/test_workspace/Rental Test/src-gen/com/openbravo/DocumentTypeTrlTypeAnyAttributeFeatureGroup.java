...
/** 
 * A representation for the Feature Group '<em><b>DocumentTypeTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class DocumentTypeTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<DocumentTypeTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final DocumentTypeTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<DocumentTypeTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<DocumentTypeTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<DocumentTypeTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final DocumentTypeTrlTypeAnyAttributeFeatureGroup group = new DocumentTypeTrlTypeAnyAttributeFeatureGroup();
