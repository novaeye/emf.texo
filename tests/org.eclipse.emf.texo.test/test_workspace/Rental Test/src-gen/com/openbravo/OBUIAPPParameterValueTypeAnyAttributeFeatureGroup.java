...
/** 
 * A representation for the Feature Group '<em><b>OBUIAPPParameterValueType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUIAPPParameterValueTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUIAPPParameterValueTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUIAPPParameterValueTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUIAPPParameterValueTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUIAPPParameterValueTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUIAPPParameterValueTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUIAPPParameterValueTypeAnyAttributeFeatureGroup group = new OBUIAPPParameterValueTypeAnyAttributeFeatureGroup();
