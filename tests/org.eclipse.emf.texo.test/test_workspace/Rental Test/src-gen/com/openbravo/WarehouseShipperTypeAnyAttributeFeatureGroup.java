...
/** 
 * A representation for the Feature Group '<em><b>WarehouseShipperType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class WarehouseShipperTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<WarehouseShipperTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final WarehouseShipperTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<WarehouseShipperTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<WarehouseShipperTypeAnyAttributeFeatureGroup> result = new ArrayList<WarehouseShipperTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final WarehouseShipperTypeAnyAttributeFeatureGroup group = new WarehouseShipperTypeAnyAttributeFeatureGroup();
