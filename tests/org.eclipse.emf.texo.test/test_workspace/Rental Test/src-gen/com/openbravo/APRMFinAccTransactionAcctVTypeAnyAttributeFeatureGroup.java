...
/** 
 * A representation for the Feature Group '<em><b>APRMFinAccTransactionAcctVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class APRMFinAccTransactionAcctVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<APRMFinAccTransactionAcctVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final APRMFinAccTransactionAcctVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<APRMFinAccTransactionAcctVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<APRMFinAccTransactionAcctVTypeAnyAttributeFeatureGroup> result = new ArrayList<APRMFinAccTransactionAcctVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final APRMFinAccTransactionAcctVTypeAnyAttributeFeatureGroup group = new APRMFinAccTransactionAcctVTypeAnyAttributeFeatureGroup();
