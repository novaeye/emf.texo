...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtDimensionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtDimensionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtDimensionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtDimensionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtDimensionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtDimensionTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtDimensionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtDimensionTypeAnyAttributeFeatureGroup group = new FinancialMgmtDimensionTypeAnyAttributeFeatureGroup();
