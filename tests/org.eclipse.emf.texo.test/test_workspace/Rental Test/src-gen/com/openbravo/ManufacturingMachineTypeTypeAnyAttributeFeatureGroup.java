...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingMachineTypeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingMachineTypeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingMachineTypeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingMachineTypeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingMachineTypeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingMachineTypeTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingMachineTypeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingMachineTypeTypeAnyAttributeFeatureGroup group = new ManufacturingMachineTypeTypeAnyAttributeFeatureGroup();
