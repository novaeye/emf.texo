...
/** 
 * A representation for the Feature Group '<em><b>ADFormAccessType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADFormAccessTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADFormAccessTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADFormAccessTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADFormAccessTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADFormAccessTypeAnyAttributeFeatureGroup> result = new ArrayList<ADFormAccessTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADFormAccessTypeAnyAttributeFeatureGroup group = new ADFormAccessTypeAnyAttributeFeatureGroup();
