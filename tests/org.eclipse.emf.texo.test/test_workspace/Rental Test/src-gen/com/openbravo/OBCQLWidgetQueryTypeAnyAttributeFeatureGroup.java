...
/** 
 * A representation for the Feature Group '<em><b>OBCQLWidgetQueryType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBCQLWidgetQueryTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBCQLWidgetQueryTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBCQLWidgetQueryTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBCQLWidgetQueryTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBCQLWidgetQueryTypeAnyAttributeFeatureGroup> result = new ArrayList<OBCQLWidgetQueryTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBCQLWidgetQueryTypeAnyAttributeFeatureGroup group = new OBCQLWidgetQueryTypeAnyAttributeFeatureGroup();
