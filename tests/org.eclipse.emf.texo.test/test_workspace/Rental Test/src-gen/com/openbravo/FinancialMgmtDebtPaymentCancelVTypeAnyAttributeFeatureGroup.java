...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtDebtPaymentCancelVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtDebtPaymentCancelVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtDebtPaymentCancelVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtDebtPaymentCancelVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtDebtPaymentCancelVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtDebtPaymentCancelVTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtDebtPaymentCancelVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtDebtPaymentCancelVTypeAnyAttributeFeatureGroup group = new FinancialMgmtDebtPaymentCancelVTypeAnyAttributeFeatureGroup();
