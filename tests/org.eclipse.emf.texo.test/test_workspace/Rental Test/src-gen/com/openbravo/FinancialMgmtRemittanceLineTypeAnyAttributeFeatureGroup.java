...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtRemittanceLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtRemittanceLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtRemittanceLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtRemittanceLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtRemittanceLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtRemittanceLineTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtRemittanceLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtRemittanceLineTypeAnyAttributeFeatureGroup group = new FinancialMgmtRemittanceLineTypeAnyAttributeFeatureGroup();
