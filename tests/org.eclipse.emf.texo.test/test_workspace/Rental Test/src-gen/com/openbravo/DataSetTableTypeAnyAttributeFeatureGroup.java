...
/** 
 * A representation for the Feature Group '<em><b>DataSetTableType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class DataSetTableTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<DataSetTableTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final DataSetTableTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<DataSetTableTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<DataSetTableTypeAnyAttributeFeatureGroup> result = new ArrayList<DataSetTableTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final DataSetTableTypeAnyAttributeFeatureGroup group = new DataSetTableTypeAnyAttributeFeatureGroup();
