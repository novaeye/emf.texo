...
/** 
 * A representation for the Feature Group '<em><b>OBUIAPPParameterTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUIAPPParameterTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUIAPPParameterTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUIAPPParameterTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUIAPPParameterTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUIAPPParameterTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUIAPPParameterTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUIAPPParameterTrlTypeAnyAttributeFeatureGroup group = new OBUIAPPParameterTrlTypeAnyAttributeFeatureGroup();
