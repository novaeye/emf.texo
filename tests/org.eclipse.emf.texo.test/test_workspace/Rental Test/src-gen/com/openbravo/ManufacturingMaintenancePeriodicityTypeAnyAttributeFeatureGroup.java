...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingMaintenancePeriodicityType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingMaintenancePeriodicityTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingMaintenancePeriodicityTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingMaintenancePeriodicityTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingMaintenancePeriodicityTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingMaintenancePeriodicityTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingMaintenancePeriodicityTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingMaintenancePeriodicityTypeAnyAttributeFeatureGroup group = new ManufacturingMaintenancePeriodicityTypeAnyAttributeFeatureGroup();
