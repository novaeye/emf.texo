...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingMeasureGroupType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingMeasureGroupTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingMeasureGroupTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingMeasureGroupTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingMeasureGroupTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingMeasureGroupTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingMeasureGroupTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingMeasureGroupTypeAnyAttributeFeatureGroup group = new ManufacturingMeasureGroupTypeAnyAttributeFeatureGroup();
