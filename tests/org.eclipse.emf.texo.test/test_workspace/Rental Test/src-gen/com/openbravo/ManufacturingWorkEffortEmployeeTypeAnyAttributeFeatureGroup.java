...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingWorkEffortEmployeeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingWorkEffortEmployeeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingWorkEffortEmployeeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingWorkEffortEmployeeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingWorkEffortEmployeeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingWorkEffortEmployeeTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingWorkEffortEmployeeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingWorkEffortEmployeeTypeAnyAttributeFeatureGroup group = new ManufacturingWorkEffortEmployeeTypeAnyAttributeFeatureGroup();
