...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingOperationIndirectCostType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingOperationIndirectCostTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingOperationIndirectCostTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingOperationIndirectCostTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingOperationIndirectCostTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingOperationIndirectCostTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingOperationIndirectCostTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingOperationIndirectCostTypeAnyAttributeFeatureGroup group = new ManufacturingOperationIndirectCostTypeAnyAttributeFeatureGroup();
