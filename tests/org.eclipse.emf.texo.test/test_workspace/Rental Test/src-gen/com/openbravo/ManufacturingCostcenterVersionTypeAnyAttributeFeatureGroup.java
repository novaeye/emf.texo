...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingCostcenterVersionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingCostcenterVersionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingCostcenterVersionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingCostcenterVersionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingCostcenterVersionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingCostcenterVersionTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingCostcenterVersionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingCostcenterVersionTypeAnyAttributeFeatureGroup group = new ManufacturingCostcenterVersionTypeAnyAttributeFeatureGroup();
