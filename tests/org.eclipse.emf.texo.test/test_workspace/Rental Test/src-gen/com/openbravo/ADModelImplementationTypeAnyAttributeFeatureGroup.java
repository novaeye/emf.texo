...
/** 
 * A representation for the Feature Group '<em><b>ADModelImplementationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADModelImplementationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADModelImplementationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADModelImplementationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADModelImplementationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADModelImplementationTypeAnyAttributeFeatureGroup> result = new ArrayList<ADModelImplementationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADModelImplementationTypeAnyAttributeFeatureGroup group = new ADModelImplementationTypeAnyAttributeFeatureGroup();
