...
/** 
 * A representation for the Feature Group '<em><b>PricingPriceListSchemaType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingPriceListSchemaTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingPriceListSchemaTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingPriceListSchemaTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingPriceListSchemaTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingPriceListSchemaTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingPriceListSchemaTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingPriceListSchemaTypeAnyAttributeFeatureGroup group = new PricingPriceListSchemaTypeAnyAttributeFeatureGroup();
