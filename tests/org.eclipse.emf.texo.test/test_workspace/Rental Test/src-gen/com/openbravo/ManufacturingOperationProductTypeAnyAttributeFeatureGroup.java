...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingOperationProductType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingOperationProductTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingOperationProductTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingOperationProductTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingOperationProductTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingOperationProductTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingOperationProductTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingOperationProductTypeAnyAttributeFeatureGroup group = new ManufacturingOperationProductTypeAnyAttributeFeatureGroup();
