...
/** 
 * A representation for the Feature Group '<em><b>APRMPendingPaymentInvoiceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class APRMPendingPaymentInvoiceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<APRMPendingPaymentInvoiceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final APRMPendingPaymentInvoiceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<APRMPendingPaymentInvoiceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<APRMPendingPaymentInvoiceTypeAnyAttributeFeatureGroup> result = new ArrayList<APRMPendingPaymentInvoiceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final APRMPendingPaymentInvoiceTypeAnyAttributeFeatureGroup group = new APRMPendingPaymentInvoiceTypeAnyAttributeFeatureGroup();
