...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtGLBatchType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtGLBatchTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtGLBatchTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtGLBatchTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtGLBatchTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtGLBatchTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtGLBatchTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtGLBatchTypeAnyAttributeFeatureGroup group = new FinancialMgmtGLBatchTypeAnyAttributeFeatureGroup();
