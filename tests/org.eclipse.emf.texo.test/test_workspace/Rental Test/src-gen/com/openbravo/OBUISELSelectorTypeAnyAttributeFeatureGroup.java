...
/** 
 * A representation for the Feature Group '<em><b>OBUISELSelectorType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUISELSelectorTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUISELSelectorTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUISELSelectorTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUISELSelectorTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUISELSelectorTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUISELSelectorTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUISELSelectorTypeAnyAttributeFeatureGroup group = new OBUISELSelectorTypeAnyAttributeFeatureGroup();
