...
/** 
 * A representation for the Feature Group '<em><b>ADAlertRuleType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADAlertRuleTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADAlertRuleTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADAlertRuleTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADAlertRuleTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADAlertRuleTypeAnyAttributeFeatureGroup> result = new ArrayList<ADAlertRuleTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADAlertRuleTypeAnyAttributeFeatureGroup group = new ADAlertRuleTypeAnyAttributeFeatureGroup();
