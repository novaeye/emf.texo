...
/** 
 * A representation for the Feature Group '<em><b>ADOrgModuleType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADOrgModuleTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADOrgModuleTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADOrgModuleTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADOrgModuleTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADOrgModuleTypeAnyAttributeFeatureGroup> result = new ArrayList<ADOrgModuleTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADOrgModuleTypeAnyAttributeFeatureGroup group = new ADOrgModuleTypeAnyAttributeFeatureGroup();
