...
/** 
 * A representation for the Feature Group '<em><b>PricingVolumeDiscountProductType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingVolumeDiscountProductTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingVolumeDiscountProductTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingVolumeDiscountProductTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingVolumeDiscountProductTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingVolumeDiscountProductTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingVolumeDiscountProductTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingVolumeDiscountProductTypeAnyAttributeFeatureGroup group = new PricingVolumeDiscountProductTypeAnyAttributeFeatureGroup();
