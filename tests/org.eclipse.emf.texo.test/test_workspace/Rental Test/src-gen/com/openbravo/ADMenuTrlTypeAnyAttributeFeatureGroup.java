...
/** 
 * A representation for the Feature Group '<em><b>ADMenuTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADMenuTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADMenuTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADMenuTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADMenuTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADMenuTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADMenuTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADMenuTrlTypeAnyAttributeFeatureGroup group = new ADMenuTrlTypeAnyAttributeFeatureGroup();
