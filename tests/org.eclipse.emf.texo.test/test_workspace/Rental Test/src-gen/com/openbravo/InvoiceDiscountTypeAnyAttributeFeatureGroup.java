...
/** 
 * A representation for the Feature Group '<em><b>InvoiceDiscountType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class InvoiceDiscountTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<InvoiceDiscountTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final InvoiceDiscountTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<InvoiceDiscountTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<InvoiceDiscountTypeAnyAttributeFeatureGroup> result = new ArrayList<InvoiceDiscountTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final InvoiceDiscountTypeAnyAttributeFeatureGroup group = new InvoiceDiscountTypeAnyAttributeFeatureGroup();
