...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingCheckPointType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingCheckPointTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingCheckPointTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingCheckPointTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingCheckPointTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingCheckPointTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingCheckPointTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingCheckPointTypeAnyAttributeFeatureGroup group = new ManufacturingCheckPointTypeAnyAttributeFeatureGroup();
