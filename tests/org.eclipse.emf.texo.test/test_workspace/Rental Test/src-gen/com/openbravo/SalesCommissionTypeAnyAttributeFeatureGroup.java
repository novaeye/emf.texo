...
/** 
 * A representation for the Feature Group '<em><b>SalesCommissionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class SalesCommissionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<SalesCommissionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final SalesCommissionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<SalesCommissionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<SalesCommissionTypeAnyAttributeFeatureGroup> result = new ArrayList<SalesCommissionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final SalesCommissionTypeAnyAttributeFeatureGroup group = new SalesCommissionTypeAnyAttributeFeatureGroup();
