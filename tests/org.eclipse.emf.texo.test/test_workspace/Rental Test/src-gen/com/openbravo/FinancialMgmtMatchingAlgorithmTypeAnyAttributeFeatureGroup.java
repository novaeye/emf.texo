...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtMatchingAlgorithmType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtMatchingAlgorithmTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtMatchingAlgorithmTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtMatchingAlgorithmTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtMatchingAlgorithmTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtMatchingAlgorithmTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtMatchingAlgorithmTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtMatchingAlgorithmTypeAnyAttributeFeatureGroup group = new FinancialMgmtMatchingAlgorithmTypeAnyAttributeFeatureGroup();
