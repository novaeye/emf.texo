...
/** 
 * A representation for the Feature Group '<em><b>OBCLKERTemplateDependencyType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBCLKERTemplateDependencyTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBCLKERTemplateDependencyTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBCLKERTemplateDependencyTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBCLKERTemplateDependencyTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBCLKERTemplateDependencyTypeAnyAttributeFeatureGroup> result = new ArrayList<OBCLKERTemplateDependencyTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBCLKERTemplateDependencyTypeAnyAttributeFeatureGroup group = new OBCLKERTemplateDependencyTypeAnyAttributeFeatureGroup();
