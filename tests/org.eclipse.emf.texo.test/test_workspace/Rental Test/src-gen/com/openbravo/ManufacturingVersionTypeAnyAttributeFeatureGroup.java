...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingVersionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingVersionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingVersionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingVersionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingVersionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingVersionTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingVersionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingVersionTypeAnyAttributeFeatureGroup group = new ManufacturingVersionTypeAnyAttributeFeatureGroup();
