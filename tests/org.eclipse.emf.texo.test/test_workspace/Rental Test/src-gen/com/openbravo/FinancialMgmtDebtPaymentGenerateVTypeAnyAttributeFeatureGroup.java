...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtDebtPaymentGenerateVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtDebtPaymentGenerateVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtDebtPaymentGenerateVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtDebtPaymentGenerateVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtDebtPaymentGenerateVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtDebtPaymentGenerateVTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtDebtPaymentGenerateVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtDebtPaymentGenerateVTypeAnyAttributeFeatureGroup group = new FinancialMgmtDebtPaymentGenerateVTypeAnyAttributeFeatureGroup();
