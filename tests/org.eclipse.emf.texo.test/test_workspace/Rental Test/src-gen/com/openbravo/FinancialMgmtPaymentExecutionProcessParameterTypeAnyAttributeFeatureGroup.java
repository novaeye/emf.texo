...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtPaymentExecutionProcessParameterType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtPaymentExecutionProcessParameterTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtPaymentExecutionProcessParameterTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtPaymentExecutionProcessParameterTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtPaymentExecutionProcessParameterTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtPaymentExecutionProcessParameterTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtPaymentExecutionProcessParameterTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtPaymentExecutionProcessParameterTypeAnyAttributeFeatureGroup group = new FinancialMgmtPaymentExecutionProcessParameterTypeAnyAttributeFeatureGroup();
