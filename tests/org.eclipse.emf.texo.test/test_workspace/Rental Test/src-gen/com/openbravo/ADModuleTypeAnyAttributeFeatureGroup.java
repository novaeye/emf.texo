...
/** 
 * A representation for the Feature Group '<em><b>ADModuleType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADModuleTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADModuleTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADModuleTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADModuleTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADModuleTypeAnyAttributeFeatureGroup> result = new ArrayList<ADModuleTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADModuleTypeAnyAttributeFeatureGroup group = new ADModuleTypeAnyAttributeFeatureGroup();
