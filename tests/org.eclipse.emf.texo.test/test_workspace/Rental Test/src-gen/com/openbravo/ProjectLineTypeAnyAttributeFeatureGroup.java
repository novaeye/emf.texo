...
/** 
 * A representation for the Feature Group '<em><b>ProjectLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProjectLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProjectLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProjectLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProjectLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProjectLineTypeAnyAttributeFeatureGroup> result = new ArrayList<ProjectLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProjectLineTypeAnyAttributeFeatureGroup group = new ProjectLineTypeAnyAttributeFeatureGroup();
