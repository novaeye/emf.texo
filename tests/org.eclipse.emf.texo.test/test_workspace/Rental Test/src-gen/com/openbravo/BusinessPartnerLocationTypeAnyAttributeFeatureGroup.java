...
/** 
 * A representation for the Feature Group '<em><b>BusinessPartnerLocationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class BusinessPartnerLocationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<BusinessPartnerLocationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final BusinessPartnerLocationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<BusinessPartnerLocationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<BusinessPartnerLocationTypeAnyAttributeFeatureGroup> result = new ArrayList<BusinessPartnerLocationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final BusinessPartnerLocationTypeAnyAttributeFeatureGroup group = new BusinessPartnerLocationTypeAnyAttributeFeatureGroup();
