...
/** 
 * A representation for the Feature Group '<em><b>ADHeartbeatLogType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADHeartbeatLogTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADHeartbeatLogTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADHeartbeatLogTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADHeartbeatLogTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADHeartbeatLogTypeAnyAttributeFeatureGroup> result = new ArrayList<ADHeartbeatLogTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADHeartbeatLogTypeAnyAttributeFeatureGroup group = new ADHeartbeatLogTypeAnyAttributeFeatureGroup();
