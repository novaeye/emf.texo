...
/** 
 * A representation for the Feature Group '<em><b>ADProcessTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADProcessTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADProcessTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADProcessTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADProcessTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADProcessTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADProcessTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADProcessTrlTypeAnyAttributeFeatureGroup group = new ADProcessTrlTypeAnyAttributeFeatureGroup();
