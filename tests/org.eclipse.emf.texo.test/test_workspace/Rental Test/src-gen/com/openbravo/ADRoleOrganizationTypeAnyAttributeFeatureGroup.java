...
/** 
 * A representation for the Feature Group '<em><b>ADRoleOrganizationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADRoleOrganizationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADRoleOrganizationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADRoleOrganizationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADRoleOrganizationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADRoleOrganizationTypeAnyAttributeFeatureGroup> result = new ArrayList<ADRoleOrganizationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADRoleOrganizationTypeAnyAttributeFeatureGroup group = new ADRoleOrganizationTypeAnyAttributeFeatureGroup();
