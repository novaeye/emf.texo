...
/** 
 * A representation for the Feature Group '<em><b>ProductType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProductTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProductTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProductTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProductTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProductTypeAnyAttributeFeatureGroup> result = new ArrayList<ProductTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProductTypeAnyAttributeFeatureGroup group = new ProductTypeAnyAttributeFeatureGroup();
