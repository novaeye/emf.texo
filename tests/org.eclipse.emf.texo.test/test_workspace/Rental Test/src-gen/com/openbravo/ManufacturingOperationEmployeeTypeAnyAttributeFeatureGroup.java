...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingOperationEmployeeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingOperationEmployeeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingOperationEmployeeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingOperationEmployeeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingOperationEmployeeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingOperationEmployeeTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingOperationEmployeeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingOperationEmployeeTypeAnyAttributeFeatureGroup group = new ManufacturingOperationEmployeeTypeAnyAttributeFeatureGroup();
