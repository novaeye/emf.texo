...
/** 
 * A representation for the Feature Group '<em><b>ADAcctProcessType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADAcctProcessTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADAcctProcessTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADAcctProcessTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADAcctProcessTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADAcctProcessTypeAnyAttributeFeatureGroup> result = new ArrayList<ADAcctProcessTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADAcctProcessTypeAnyAttributeFeatureGroup group = new ADAcctProcessTypeAnyAttributeFeatureGroup();
