...
/** 
 * A representation for the Feature Group '<em><b>ProductUOMType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProductUOMTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProductUOMTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProductUOMTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProductUOMTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProductUOMTypeAnyAttributeFeatureGroup> result = new ArrayList<ProductUOMTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProductUOMTypeAnyAttributeFeatureGroup group = new ProductUOMTypeAnyAttributeFeatureGroup();
