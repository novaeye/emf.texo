...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAccountingRptElementType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAccountingRptElementTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAccountingRptElementTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAccountingRptElementTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAccountingRptElementTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAccountingRptElementTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAccountingRptElementTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAccountingRptElementTypeAnyAttributeFeatureGroup group = new FinancialMgmtAccountingRptElementTypeAnyAttributeFeatureGroup();
