...
/** 
 * A representation for the Feature Group '<em><b>ADParameterType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADParameterTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADParameterTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADParameterTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADParameterTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADParameterTypeAnyAttributeFeatureGroup> result = new ArrayList<ADParameterTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADParameterTypeAnyAttributeFeatureGroup group = new ADParameterTypeAnyAttributeFeatureGroup();
