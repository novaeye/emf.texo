...
/** 
 * A representation for the Feature Group '<em><b>ActiveProposalVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ActiveProposalVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ActiveProposalVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ActiveProposalVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ActiveProposalVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ActiveProposalVTypeAnyAttributeFeatureGroup> result = new ArrayList<ActiveProposalVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ActiveProposalVTypeAnyAttributeFeatureGroup group = new ActiveProposalVTypeAnyAttributeFeatureGroup();
