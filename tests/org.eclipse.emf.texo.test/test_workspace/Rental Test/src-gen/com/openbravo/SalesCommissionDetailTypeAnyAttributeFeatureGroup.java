...
/** 
 * A representation for the Feature Group '<em><b>SalesCommissionDetailType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class SalesCommissionDetailTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<SalesCommissionDetailTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final SalesCommissionDetailTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<SalesCommissionDetailTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<SalesCommissionDetailTypeAnyAttributeFeatureGroup> result = new ArrayList<SalesCommissionDetailTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final SalesCommissionDetailTypeAnyAttributeFeatureGroup group = new SalesCommissionDetailTypeAnyAttributeFeatureGroup();
