...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtDPManagementType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtDPManagementTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtDPManagementTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtDPManagementTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtDPManagementTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtDPManagementTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtDPManagementTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtDPManagementTypeAnyAttributeFeatureGroup group = new FinancialMgmtDPManagementTypeAnyAttributeFeatureGroup();
