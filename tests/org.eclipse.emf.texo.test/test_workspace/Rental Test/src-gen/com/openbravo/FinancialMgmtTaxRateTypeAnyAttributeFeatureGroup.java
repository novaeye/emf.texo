...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtTaxRateType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtTaxRateTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtTaxRateTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtTaxRateTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtTaxRateTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtTaxRateTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtTaxRateTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtTaxRateTypeAnyAttributeFeatureGroup group = new FinancialMgmtTaxRateTypeAnyAttributeFeatureGroup();
