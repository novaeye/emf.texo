...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingProductionRunIndirectCostsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingProductionRunIndirectCostsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingProductionRunIndirectCostsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingProductionRunIndirectCostsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingProductionRunIndirectCostsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingProductionRunIndirectCostsTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingProductionRunIndirectCostsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingProductionRunIndirectCostsTypeAnyAttributeFeatureGroup group = new ManufacturingProductionRunIndirectCostsTypeAnyAttributeFeatureGroup();
