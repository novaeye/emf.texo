...
/** 
 * A representation for the Feature Group '<em><b>ADSessionStatusType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADSessionStatusTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADSessionStatusTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADSessionStatusTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADSessionStatusTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADSessionStatusTypeAnyAttributeFeatureGroup> result = new ArrayList<ADSessionStatusTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADSessionStatusTypeAnyAttributeFeatureGroup group = new ADSessionStatusTypeAnyAttributeFeatureGroup();
