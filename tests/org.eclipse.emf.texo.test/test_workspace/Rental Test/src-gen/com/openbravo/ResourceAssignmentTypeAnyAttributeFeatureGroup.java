...
/** 
 * A representation for the Feature Group '<em><b>ResourceAssignmentType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ResourceAssignmentTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ResourceAssignmentTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ResourceAssignmentTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ResourceAssignmentTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ResourceAssignmentTypeAnyAttributeFeatureGroup> result = new ArrayList<ResourceAssignmentTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ResourceAssignmentTypeAnyAttributeFeatureGroup group = new ResourceAssignmentTypeAnyAttributeFeatureGroup();
