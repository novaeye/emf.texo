...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtDebtPaymentBalReplaceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtDebtPaymentBalReplaceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtDebtPaymentBalReplaceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtDebtPaymentBalReplaceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtDebtPaymentBalReplaceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtDebtPaymentBalReplaceTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtDebtPaymentBalReplaceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtDebtPaymentBalReplaceTypeAnyAttributeFeatureGroup group = new FinancialMgmtDebtPaymentBalReplaceTypeAnyAttributeFeatureGroup();
