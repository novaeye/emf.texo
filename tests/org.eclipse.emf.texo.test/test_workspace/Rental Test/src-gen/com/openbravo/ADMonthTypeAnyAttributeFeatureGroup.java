...
/** 
 * A representation for the Feature Group '<em><b>ADMonthType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADMonthTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADMonthTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADMonthTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADMonthTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADMonthTypeAnyAttributeFeatureGroup> result = new ArrayList<ADMonthTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADMonthTypeAnyAttributeFeatureGroup group = new ADMonthTypeAnyAttributeFeatureGroup();
