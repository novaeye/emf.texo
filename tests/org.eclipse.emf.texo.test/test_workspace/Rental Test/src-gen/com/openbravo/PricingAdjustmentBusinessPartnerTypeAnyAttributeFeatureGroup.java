...
/** 
 * A representation for the Feature Group '<em><b>PricingAdjustmentBusinessPartnerType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingAdjustmentBusinessPartnerTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingAdjustmentBusinessPartnerTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingAdjustmentBusinessPartnerTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingAdjustmentBusinessPartnerTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingAdjustmentBusinessPartnerTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingAdjustmentBusinessPartnerTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingAdjustmentBusinessPartnerTypeAnyAttributeFeatureGroup group = new PricingAdjustmentBusinessPartnerTypeAnyAttributeFeatureGroup();
