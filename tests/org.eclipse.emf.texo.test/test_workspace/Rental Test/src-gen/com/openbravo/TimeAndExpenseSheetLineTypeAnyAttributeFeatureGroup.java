...
/** 
 * A representation for the Feature Group '<em><b>TimeAndExpenseSheetLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class TimeAndExpenseSheetLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<TimeAndExpenseSheetLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final TimeAndExpenseSheetLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<TimeAndExpenseSheetLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<TimeAndExpenseSheetLineTypeAnyAttributeFeatureGroup> result = new ArrayList<TimeAndExpenseSheetLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final TimeAndExpenseSheetLineTypeAnyAttributeFeatureGroup group = new TimeAndExpenseSheetLineTypeAnyAttributeFeatureGroup();
