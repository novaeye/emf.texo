...
/** 
 * A representation for the Feature Group '<em><b>OBUIAPPViewImplementationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUIAPPViewImplementationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUIAPPViewImplementationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUIAPPViewImplementationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUIAPPViewImplementationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUIAPPViewImplementationTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUIAPPViewImplementationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUIAPPViewImplementationTypeAnyAttributeFeatureGroup group = new OBUIAPPViewImplementationTypeAnyAttributeFeatureGroup();
