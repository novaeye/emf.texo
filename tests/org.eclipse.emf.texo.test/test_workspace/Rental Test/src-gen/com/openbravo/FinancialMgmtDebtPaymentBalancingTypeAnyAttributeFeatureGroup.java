...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtDebtPaymentBalancingType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtDebtPaymentBalancingTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtDebtPaymentBalancingTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtDebtPaymentBalancingTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtDebtPaymentBalancingTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtDebtPaymentBalancingTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtDebtPaymentBalancingTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtDebtPaymentBalancingTypeAnyAttributeFeatureGroup group = new FinancialMgmtDebtPaymentBalancingTypeAnyAttributeFeatureGroup();
