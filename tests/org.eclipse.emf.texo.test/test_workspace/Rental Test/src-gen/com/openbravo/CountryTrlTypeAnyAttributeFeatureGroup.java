...
/** 
 * A representation for the Feature Group '<em><b>CountryTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class CountryTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<CountryTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final CountryTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<CountryTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<CountryTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<CountryTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final CountryTrlTypeAnyAttributeFeatureGroup group = new CountryTrlTypeAnyAttributeFeatureGroup();
