...
/** 
 * A representation for the Feature Group '<em><b>VendorAccountsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class VendorAccountsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<VendorAccountsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final VendorAccountsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<VendorAccountsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<VendorAccountsTypeAnyAttributeFeatureGroup> result = new ArrayList<VendorAccountsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final VendorAccountsTypeAnyAttributeFeatureGroup group = new VendorAccountsTypeAnyAttributeFeatureGroup();
