...
/** 
 * A representation for the Feature Group '<em><b>EmployeeAccountsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class EmployeeAccountsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<EmployeeAccountsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final EmployeeAccountsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<EmployeeAccountsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<EmployeeAccountsTypeAnyAttributeFeatureGroup> result = new ArrayList<EmployeeAccountsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final EmployeeAccountsTypeAnyAttributeFeatureGroup group = new EmployeeAccountsTypeAnyAttributeFeatureGroup();
