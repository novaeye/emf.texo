...
/** 
 * A representation for the Feature Group '<em><b>FINPaymentCreditType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINPaymentCreditTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINPaymentCreditTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINPaymentCreditTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINPaymentCreditTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINPaymentCreditTypeAnyAttributeFeatureGroup> result = new ArrayList<FINPaymentCreditTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINPaymentCreditTypeAnyAttributeFeatureGroup group = new FINPaymentCreditTypeAnyAttributeFeatureGroup();
