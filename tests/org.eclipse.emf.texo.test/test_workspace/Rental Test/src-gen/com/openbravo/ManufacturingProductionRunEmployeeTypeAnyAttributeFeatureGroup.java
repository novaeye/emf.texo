...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingProductionRunEmployeeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingProductionRunEmployeeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingProductionRunEmployeeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingProductionRunEmployeeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingProductionRunEmployeeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingProductionRunEmployeeTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingProductionRunEmployeeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingProductionRunEmployeeTypeAnyAttributeFeatureGroup group = new ManufacturingProductionRunEmployeeTypeAnyAttributeFeatureGroup();
