...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtInternalMovementType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtInternalMovementTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtInternalMovementTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtInternalMovementTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtInternalMovementTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtInternalMovementTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtInternalMovementTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtInternalMovementTypeAnyAttributeFeatureGroup group = new MaterialMgmtInternalMovementTypeAnyAttributeFeatureGroup();
