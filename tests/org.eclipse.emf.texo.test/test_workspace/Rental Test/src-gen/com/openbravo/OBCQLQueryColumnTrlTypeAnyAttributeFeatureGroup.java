...
/** 
 * A representation for the Feature Group '<em><b>OBCQLQueryColumnTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBCQLQueryColumnTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBCQLQueryColumnTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBCQLQueryColumnTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBCQLQueryColumnTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBCQLQueryColumnTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<OBCQLQueryColumnTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBCQLQueryColumnTrlTypeAnyAttributeFeatureGroup group = new OBCQLQueryColumnTrlTypeAnyAttributeFeatureGroup();
