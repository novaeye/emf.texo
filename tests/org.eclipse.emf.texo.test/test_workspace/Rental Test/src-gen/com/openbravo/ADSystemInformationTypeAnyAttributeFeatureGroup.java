...
/** 
 * A representation for the Feature Group '<em><b>ADSystemInformationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADSystemInformationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADSystemInformationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADSystemInformationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADSystemInformationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADSystemInformationTypeAnyAttributeFeatureGroup> result = new ArrayList<ADSystemInformationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADSystemInformationTypeAnyAttributeFeatureGroup group = new ADSystemInformationTypeAnyAttributeFeatureGroup();
