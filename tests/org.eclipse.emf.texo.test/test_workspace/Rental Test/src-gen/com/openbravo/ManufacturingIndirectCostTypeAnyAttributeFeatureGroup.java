...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingIndirectCostType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingIndirectCostTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingIndirectCostTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingIndirectCostTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingIndirectCostTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingIndirectCostTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingIndirectCostTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingIndirectCostTypeAnyAttributeFeatureGroup group = new ManufacturingIndirectCostTypeAnyAttributeFeatureGroup();
