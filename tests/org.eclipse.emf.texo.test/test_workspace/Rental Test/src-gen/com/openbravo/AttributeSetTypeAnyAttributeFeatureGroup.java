...
/** 
 * A representation for the Feature Group '<em><b>AttributeSetType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class AttributeSetTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<AttributeSetTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final AttributeSetTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<AttributeSetTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<AttributeSetTypeAnyAttributeFeatureGroup> result = new ArrayList<AttributeSetTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final AttributeSetTypeAnyAttributeFeatureGroup group = new AttributeSetTypeAnyAttributeFeatureGroup();
