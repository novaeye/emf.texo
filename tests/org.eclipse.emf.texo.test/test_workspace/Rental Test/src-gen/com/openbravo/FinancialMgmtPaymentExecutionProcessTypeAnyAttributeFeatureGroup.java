...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtPaymentExecutionProcessType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtPaymentExecutionProcessTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtPaymentExecutionProcessTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtPaymentExecutionProcessTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtPaymentExecutionProcessTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtPaymentExecutionProcessTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtPaymentExecutionProcessTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtPaymentExecutionProcessTypeAnyAttributeFeatureGroup group = new FinancialMgmtPaymentExecutionProcessTypeAnyAttributeFeatureGroup();
