...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtElementValueTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtElementValueTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtElementValueTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtElementValueTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtElementValueTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtElementValueTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtElementValueTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtElementValueTrlTypeAnyAttributeFeatureGroup group = new FinancialMgmtElementValueTrlTypeAnyAttributeFeatureGroup();
