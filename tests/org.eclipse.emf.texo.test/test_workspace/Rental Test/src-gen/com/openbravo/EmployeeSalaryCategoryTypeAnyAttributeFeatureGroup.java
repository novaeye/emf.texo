...
/** 
 * A representation for the Feature Group '<em><b>EmployeeSalaryCategoryType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class EmployeeSalaryCategoryTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<EmployeeSalaryCategoryTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final EmployeeSalaryCategoryTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<EmployeeSalaryCategoryTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<EmployeeSalaryCategoryTypeAnyAttributeFeatureGroup> result = new ArrayList<EmployeeSalaryCategoryTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final EmployeeSalaryCategoryTypeAnyAttributeFeatureGroup group = new EmployeeSalaryCategoryTypeAnyAttributeFeatureGroup();
