...
/** 
 * A representation for the Feature Group '<em><b>GreetingTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class GreetingTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<GreetingTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final GreetingTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<GreetingTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<GreetingTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<GreetingTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final GreetingTrlTypeAnyAttributeFeatureGroup group = new GreetingTrlTypeAnyAttributeFeatureGroup();
