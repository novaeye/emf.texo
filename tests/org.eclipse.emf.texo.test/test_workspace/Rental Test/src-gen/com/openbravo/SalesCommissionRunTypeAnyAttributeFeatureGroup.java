...
/** 
 * A representation for the Feature Group '<em><b>SalesCommissionRunType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class SalesCommissionRunTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<SalesCommissionRunTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final SalesCommissionRunTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<SalesCommissionRunTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<SalesCommissionRunTypeAnyAttributeFeatureGroup> result = new ArrayList<SalesCommissionRunTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final SalesCommissionRunTypeAnyAttributeFeatureGroup group = new SalesCommissionRunTypeAnyAttributeFeatureGroup();
