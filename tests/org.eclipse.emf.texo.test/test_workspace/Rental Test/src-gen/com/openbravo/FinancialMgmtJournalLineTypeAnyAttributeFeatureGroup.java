...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtJournalLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtJournalLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtJournalLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtJournalLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtJournalLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtJournalLineTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtJournalLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtJournalLineTypeAnyAttributeFeatureGroup group = new FinancialMgmtJournalLineTypeAnyAttributeFeatureGroup();
