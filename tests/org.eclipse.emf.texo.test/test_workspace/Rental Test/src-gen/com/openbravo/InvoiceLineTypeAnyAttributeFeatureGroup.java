...
/** 
 * A representation for the Feature Group '<em><b>InvoiceLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class InvoiceLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<InvoiceLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final InvoiceLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<InvoiceLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<InvoiceLineTypeAnyAttributeFeatureGroup> result = new ArrayList<InvoiceLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final InvoiceLineTypeAnyAttributeFeatureGroup group = new InvoiceLineTypeAnyAttributeFeatureGroup();
