...
/** 
 * A representation for the Feature Group '<em><b>ProjectStandardPhaseType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProjectStandardPhaseTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProjectStandardPhaseTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProjectStandardPhaseTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProjectStandardPhaseTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProjectStandardPhaseTypeAnyAttributeFeatureGroup> result = new ArrayList<ProjectStandardPhaseTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProjectStandardPhaseTypeAnyAttributeFeatureGroup group = new ProjectStandardPhaseTypeAnyAttributeFeatureGroup();
