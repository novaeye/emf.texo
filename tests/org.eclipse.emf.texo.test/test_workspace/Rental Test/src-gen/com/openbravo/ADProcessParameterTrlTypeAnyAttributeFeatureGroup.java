...
/** 
 * A representation for the Feature Group '<em><b>ADProcessParameterTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADProcessParameterTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADProcessParameterTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADProcessParameterTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADProcessParameterTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADProcessParameterTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADProcessParameterTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADProcessParameterTrlTypeAnyAttributeFeatureGroup group = new ADProcessParameterTrlTypeAnyAttributeFeatureGroup();
