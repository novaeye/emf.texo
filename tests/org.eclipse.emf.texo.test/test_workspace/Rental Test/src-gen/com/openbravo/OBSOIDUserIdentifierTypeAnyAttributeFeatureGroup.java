...
/** 
 * A representation for the Feature Group '<em><b>OBSOIDUserIdentifierType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBSOIDUserIdentifierTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBSOIDUserIdentifierTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBSOIDUserIdentifierTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBSOIDUserIdentifierTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBSOIDUserIdentifierTypeAnyAttributeFeatureGroup> result = new ArrayList<OBSOIDUserIdentifierTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBSOIDUserIdentifierTypeAnyAttributeFeatureGroup group = new OBSOIDUserIdentifierTypeAnyAttributeFeatureGroup();
