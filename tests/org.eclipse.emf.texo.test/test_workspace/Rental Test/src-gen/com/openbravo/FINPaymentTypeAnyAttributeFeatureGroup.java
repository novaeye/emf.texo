...
/** 
 * A representation for the Feature Group '<em><b>FINPaymentType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINPaymentTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINPaymentTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINPaymentTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINPaymentTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINPaymentTypeAnyAttributeFeatureGroup> result = new ArrayList<FINPaymentTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINPaymentTypeAnyAttributeFeatureGroup group = new FINPaymentTypeAnyAttributeFeatureGroup();
