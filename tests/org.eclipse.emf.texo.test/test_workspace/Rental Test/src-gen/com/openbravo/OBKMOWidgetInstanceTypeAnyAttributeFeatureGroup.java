...
/** 
 * A representation for the Feature Group '<em><b>OBKMOWidgetInstanceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBKMOWidgetInstanceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBKMOWidgetInstanceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBKMOWidgetInstanceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBKMOWidgetInstanceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBKMOWidgetInstanceTypeAnyAttributeFeatureGroup> result = new ArrayList<OBKMOWidgetInstanceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBKMOWidgetInstanceTypeAnyAttributeFeatureGroup group = new OBKMOWidgetInstanceTypeAnyAttributeFeatureGroup();
