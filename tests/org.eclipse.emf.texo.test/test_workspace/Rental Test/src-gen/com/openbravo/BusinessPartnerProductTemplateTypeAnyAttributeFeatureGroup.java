...
/** 
 * A representation for the Feature Group '<em><b>BusinessPartnerProductTemplateType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class BusinessPartnerProductTemplateTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<BusinessPartnerProductTemplateTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final BusinessPartnerProductTemplateTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<BusinessPartnerProductTemplateTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<BusinessPartnerProductTemplateTypeAnyAttributeFeatureGroup> result = new ArrayList<BusinessPartnerProductTemplateTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final BusinessPartnerProductTemplateTypeAnyAttributeFeatureGroup group = new BusinessPartnerProductTemplateTypeAnyAttributeFeatureGroup();
