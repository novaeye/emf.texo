...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtElementValueType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtElementValueTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtElementValueTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtElementValueTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtElementValueTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtElementValueTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtElementValueTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtElementValueTypeAnyAttributeFeatureGroup group = new FinancialMgmtElementValueTypeAnyAttributeFeatureGroup();
