...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtCalendarType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtCalendarTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtCalendarTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtCalendarTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtCalendarTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtCalendarTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtCalendarTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtCalendarTypeAnyAttributeFeatureGroup group = new FinancialMgmtCalendarTypeAnyAttributeFeatureGroup();
