...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtPeriodControlVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtPeriodControlVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtPeriodControlVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtPeriodControlVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtPeriodControlVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtPeriodControlVTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtPeriodControlVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtPeriodControlVTypeAnyAttributeFeatureGroup group = new FinancialMgmtPeriodControlVTypeAnyAttributeFeatureGroup();
