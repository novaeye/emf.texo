...
/** 
 * A representation for the Feature Group '<em><b>ModuleLogType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ModuleLogTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ModuleLogTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ModuleLogTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ModuleLogTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ModuleLogTypeAnyAttributeFeatureGroup> result = new ArrayList<ModuleLogTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ModuleLogTypeAnyAttributeFeatureGroup group = new ModuleLogTypeAnyAttributeFeatureGroup();
