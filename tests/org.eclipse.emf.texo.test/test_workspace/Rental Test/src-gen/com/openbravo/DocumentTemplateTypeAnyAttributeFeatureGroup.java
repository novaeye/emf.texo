...
/** 
 * A representation for the Feature Group '<em><b>DocumentTemplateType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class DocumentTemplateTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<DocumentTemplateTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final DocumentTemplateTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<DocumentTemplateTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<DocumentTemplateTypeAnyAttributeFeatureGroup> result = new ArrayList<DocumentTemplateTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final DocumentTemplateTypeAnyAttributeFeatureGroup group = new DocumentTemplateTypeAnyAttributeFeatureGroup();
