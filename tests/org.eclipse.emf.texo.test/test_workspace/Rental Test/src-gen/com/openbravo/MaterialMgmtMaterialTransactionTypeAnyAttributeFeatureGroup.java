...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtMaterialTransactionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtMaterialTransactionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtMaterialTransactionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtMaterialTransactionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtMaterialTransactionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtMaterialTransactionTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtMaterialTransactionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtMaterialTransactionTypeAnyAttributeFeatureGroup group = new MaterialMgmtMaterialTransactionTypeAnyAttributeFeatureGroup();
