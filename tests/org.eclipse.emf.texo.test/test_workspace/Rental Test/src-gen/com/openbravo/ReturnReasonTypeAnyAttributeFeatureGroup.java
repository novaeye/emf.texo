...
/** 
 * A representation for the Feature Group '<em><b>ReturnReasonType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ReturnReasonTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ReturnReasonTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ReturnReasonTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ReturnReasonTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ReturnReasonTypeAnyAttributeFeatureGroup> result = new ArrayList<ReturnReasonTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ReturnReasonTypeAnyAttributeFeatureGroup group = new ReturnReasonTypeAnyAttributeFeatureGroup();
