...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtRemittanceTypeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtRemittanceTypeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtRemittanceTypeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtRemittanceTypeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtRemittanceTypeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtRemittanceTypeTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtRemittanceTypeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtRemittanceTypeTypeAnyAttributeFeatureGroup group = new FinancialMgmtRemittanceTypeTypeAnyAttributeFeatureGroup();
