...
/** 
 * A representation for the Feature Group '<em><b>MRPPlanningMethodLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MRPPlanningMethodLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MRPPlanningMethodLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MRPPlanningMethodLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MRPPlanningMethodLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MRPPlanningMethodLineTypeAnyAttributeFeatureGroup> result = new ArrayList<MRPPlanningMethodLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MRPPlanningMethodLineTypeAnyAttributeFeatureGroup group = new MRPPlanningMethodLineTypeAnyAttributeFeatureGroup();
