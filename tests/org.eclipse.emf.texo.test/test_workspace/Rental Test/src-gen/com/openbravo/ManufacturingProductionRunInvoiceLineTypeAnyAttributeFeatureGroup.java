...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingProductionRunInvoiceLineType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingProductionRunInvoiceLineTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingProductionRunInvoiceLineTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingProductionRunInvoiceLineTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingProductionRunInvoiceLineTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingProductionRunInvoiceLineTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingProductionRunInvoiceLineTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingProductionRunInvoiceLineTypeAnyAttributeFeatureGroup group = new ManufacturingProductionRunInvoiceLineTypeAnyAttributeFeatureGroup();
