...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtTaxTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtTaxTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtTaxTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtTaxTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtTaxTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtTaxTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtTaxTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtTaxTrlTypeAnyAttributeFeatureGroup group = new FinancialMgmtTaxTrlTypeAnyAttributeFeatureGroup();
