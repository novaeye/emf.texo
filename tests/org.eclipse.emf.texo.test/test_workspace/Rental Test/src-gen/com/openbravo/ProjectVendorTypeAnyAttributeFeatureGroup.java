...
/** 
 * A representation for the Feature Group '<em><b>ProjectVendorType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProjectVendorTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProjectVendorTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProjectVendorTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProjectVendorTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProjectVendorTypeAnyAttributeFeatureGroup> result = new ArrayList<ProjectVendorTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProjectVendorTypeAnyAttributeFeatureGroup group = new ProjectVendorTypeAnyAttributeFeatureGroup();
