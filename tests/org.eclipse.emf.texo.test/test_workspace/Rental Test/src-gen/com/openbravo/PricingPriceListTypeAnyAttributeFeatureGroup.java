...
/** 
 * A representation for the Feature Group '<em><b>PricingPriceListType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingPriceListTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingPriceListTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingPriceListTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingPriceListTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingPriceListTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingPriceListTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingPriceListTypeAnyAttributeFeatureGroup group = new PricingPriceListTypeAnyAttributeFeatureGroup();
