...
/** 
 * A representation for the Feature Group '<em><b>OBUISELSelectorFieldType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBUISELSelectorFieldTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBUISELSelectorFieldTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBUISELSelectorFieldTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBUISELSelectorFieldTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBUISELSelectorFieldTypeAnyAttributeFeatureGroup> result = new ArrayList<OBUISELSelectorFieldTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBUISELSelectorFieldTypeAnyAttributeFeatureGroup group = new OBUISELSelectorFieldTypeAnyAttributeFeatureGroup();
