...
/** 
 * A representation for the Feature Group '<em><b>FINBankStatementType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINBankStatementTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINBankStatementTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINBankStatementTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINBankStatementTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINBankStatementTypeAnyAttributeFeatureGroup> result = new ArrayList<FINBankStatementTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINBankStatementTypeAnyAttributeFeatureGroup group = new FINBankStatementTypeAnyAttributeFeatureGroup();
