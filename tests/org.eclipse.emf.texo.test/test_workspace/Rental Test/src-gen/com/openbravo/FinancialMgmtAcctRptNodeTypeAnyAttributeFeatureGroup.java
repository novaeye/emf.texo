...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAcctRptNodeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAcctRptNodeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAcctRptNodeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAcctRptNodeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAcctRptNodeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAcctRptNodeTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAcctRptNodeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAcctRptNodeTypeAnyAttributeFeatureGroup group = new FinancialMgmtAcctRptNodeTypeAnyAttributeFeatureGroup();
