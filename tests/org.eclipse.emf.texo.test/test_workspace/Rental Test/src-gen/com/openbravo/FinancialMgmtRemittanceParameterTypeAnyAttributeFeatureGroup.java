...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtRemittanceParameterType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtRemittanceParameterTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtRemittanceParameterTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtRemittanceParameterTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtRemittanceParameterTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtRemittanceParameterTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtRemittanceParameterTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtRemittanceParameterTypeAnyAttributeFeatureGroup group = new FinancialMgmtRemittanceParameterTypeAnyAttributeFeatureGroup();
