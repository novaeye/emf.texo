...
/** 
 * A representation for the Feature Group '<em><b>ProcurementRequisitionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProcurementRequisitionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProcurementRequisitionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProcurementRequisitionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProcurementRequisitionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProcurementRequisitionTypeAnyAttributeFeatureGroup> result = new ArrayList<ProcurementRequisitionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProcurementRequisitionTypeAnyAttributeFeatureGroup group = new ProcurementRequisitionTypeAnyAttributeFeatureGroup();
