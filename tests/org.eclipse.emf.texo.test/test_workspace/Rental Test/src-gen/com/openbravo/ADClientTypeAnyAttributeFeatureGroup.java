...
/** 
 * A representation for the Feature Group '<em><b>ADClientType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADClientTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADClientTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADClientTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADClientTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADClientTypeAnyAttributeFeatureGroup> result = new ArrayList<ADClientTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADClientTypeAnyAttributeFeatureGroup group = new ADClientTypeAnyAttributeFeatureGroup();
