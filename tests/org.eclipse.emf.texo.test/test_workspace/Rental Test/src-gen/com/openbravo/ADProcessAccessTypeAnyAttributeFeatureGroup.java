...
/** 
 * A representation for the Feature Group '<em><b>ADProcessAccessType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADProcessAccessTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADProcessAccessTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADProcessAccessTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADProcessAccessTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADProcessAccessTypeAnyAttributeFeatureGroup> result = new ArrayList<ADProcessAccessTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADProcessAccessTypeAnyAttributeFeatureGroup group = new ADProcessAccessTypeAnyAttributeFeatureGroup();
