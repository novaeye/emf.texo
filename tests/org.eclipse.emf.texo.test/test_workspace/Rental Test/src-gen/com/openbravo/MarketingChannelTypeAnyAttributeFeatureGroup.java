...
/** 
 * A representation for the Feature Group '<em><b>MarketingChannelType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MarketingChannelTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MarketingChannelTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MarketingChannelTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MarketingChannelTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MarketingChannelTypeAnyAttributeFeatureGroup> result = new ArrayList<MarketingChannelTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MarketingChannelTypeAnyAttributeFeatureGroup group = new MarketingChannelTypeAnyAttributeFeatureGroup();
