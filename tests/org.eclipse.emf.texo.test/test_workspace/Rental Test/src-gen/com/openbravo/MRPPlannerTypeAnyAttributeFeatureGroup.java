...
/** 
 * A representation for the Feature Group '<em><b>MRPPlannerType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MRPPlannerTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MRPPlannerTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MRPPlannerTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MRPPlannerTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MRPPlannerTypeAnyAttributeFeatureGroup> result = new ArrayList<MRPPlannerTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MRPPlannerTypeAnyAttributeFeatureGroup group = new MRPPlannerTypeAnyAttributeFeatureGroup();
