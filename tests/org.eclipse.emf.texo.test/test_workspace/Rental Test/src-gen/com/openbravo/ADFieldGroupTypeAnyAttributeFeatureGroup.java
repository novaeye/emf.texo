...
/** 
 * A representation for the Feature Group '<em><b>ADFieldGroupType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADFieldGroupTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADFieldGroupTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADFieldGroupTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADFieldGroupTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADFieldGroupTypeAnyAttributeFeatureGroup> result = new ArrayList<ADFieldGroupTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADFieldGroupTypeAnyAttributeFeatureGroup group = new ADFieldGroupTypeAnyAttributeFeatureGroup();
