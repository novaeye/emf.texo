...
/** 
 * A representation for the Feature Group '<em><b>ProjectType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProjectTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProjectTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProjectTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProjectTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProjectTypeAnyAttributeFeatureGroup> result = new ArrayList<ProjectTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProjectTypeAnyAttributeFeatureGroup group = new ProjectTypeAnyAttributeFeatureGroup();
