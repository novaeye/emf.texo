...
/** 
 * A representation for the Feature Group '<em><b>AttributeValueType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class AttributeValueTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<AttributeValueTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final AttributeValueTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<AttributeValueTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<AttributeValueTypeAnyAttributeFeatureGroup> result = new ArrayList<AttributeValueTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final AttributeValueTypeAnyAttributeFeatureGroup group = new AttributeValueTypeAnyAttributeFeatureGroup();
