...
/** 
 * A representation for the Feature Group '<em><b>CurrencyConversionRateType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class CurrencyConversionRateTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<CurrencyConversionRateTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final CurrencyConversionRateTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<CurrencyConversionRateTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<CurrencyConversionRateTypeAnyAttributeFeatureGroup> result = new ArrayList<CurrencyConversionRateTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final CurrencyConversionRateTypeAnyAttributeFeatureGroup group = new CurrencyConversionRateTypeAnyAttributeFeatureGroup();
