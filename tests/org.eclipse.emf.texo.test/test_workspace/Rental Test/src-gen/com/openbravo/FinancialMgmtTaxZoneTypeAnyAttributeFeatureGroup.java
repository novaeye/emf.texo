...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtTaxZoneType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtTaxZoneTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtTaxZoneTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtTaxZoneTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtTaxZoneTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtTaxZoneTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtTaxZoneTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtTaxZoneTypeAnyAttributeFeatureGroup group = new FinancialMgmtTaxZoneTypeAnyAttributeFeatureGroup();
