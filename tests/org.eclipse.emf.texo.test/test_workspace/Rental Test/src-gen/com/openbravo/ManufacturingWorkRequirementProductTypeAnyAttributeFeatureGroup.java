...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingWorkRequirementProductType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingWorkRequirementProductTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingWorkRequirementProductTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingWorkRequirementProductTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingWorkRequirementProductTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingWorkRequirementProductTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingWorkRequirementProductTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingWorkRequirementProductTypeAnyAttributeFeatureGroup group = new ManufacturingWorkRequirementProductTypeAnyAttributeFeatureGroup();
