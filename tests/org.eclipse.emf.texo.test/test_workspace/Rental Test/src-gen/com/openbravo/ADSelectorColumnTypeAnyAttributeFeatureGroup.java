...
/** 
 * A representation for the Feature Group '<em><b>ADSelectorColumnType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADSelectorColumnTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADSelectorColumnTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADSelectorColumnTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADSelectorColumnTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADSelectorColumnTypeAnyAttributeFeatureGroup> result = new ArrayList<ADSelectorColumnTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADSelectorColumnTypeAnyAttributeFeatureGroup group = new ADSelectorColumnTypeAnyAttributeFeatureGroup();
