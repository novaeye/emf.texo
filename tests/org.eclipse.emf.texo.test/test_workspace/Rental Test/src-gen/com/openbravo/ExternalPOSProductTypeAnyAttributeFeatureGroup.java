...
/** 
 * A representation for the Feature Group '<em><b>ExternalPOSProductType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ExternalPOSProductTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ExternalPOSProductTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ExternalPOSProductTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ExternalPOSProductTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ExternalPOSProductTypeAnyAttributeFeatureGroup> result = new ArrayList<ExternalPOSProductTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ExternalPOSProductTypeAnyAttributeFeatureGroup group = new ExternalPOSProductTypeAnyAttributeFeatureGroup();
