...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAcctSchemaType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAcctSchemaTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAcctSchemaTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAcctSchemaTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAcctSchemaTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAcctSchemaTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAcctSchemaTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAcctSchemaTypeAnyAttributeFeatureGroup group = new FinancialMgmtAcctSchemaTypeAnyAttributeFeatureGroup();
