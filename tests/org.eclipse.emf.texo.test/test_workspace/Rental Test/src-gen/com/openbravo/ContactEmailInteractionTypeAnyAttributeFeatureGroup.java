...
/** 
 * A representation for the Feature Group '<em><b>ContactEmailInteractionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ContactEmailInteractionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ContactEmailInteractionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ContactEmailInteractionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ContactEmailInteractionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ContactEmailInteractionTypeAnyAttributeFeatureGroup> result = new ArrayList<ContactEmailInteractionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ContactEmailInteractionTypeAnyAttributeFeatureGroup group = new ContactEmailInteractionTypeAnyAttributeFeatureGroup();
