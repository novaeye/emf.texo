...
/** 
 * A representation for the Feature Group '<em><b>ADWindowType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADWindowTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADWindowTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADWindowTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADWindowTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADWindowTypeAnyAttributeFeatureGroup> result = new ArrayList<ADWindowTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADWindowTypeAnyAttributeFeatureGroup group = new ADWindowTypeAnyAttributeFeatureGroup();
