...
/** 
 * A representation for the Feature Group '<em><b>ModelImplementationParameterType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ModelImplementationParameterTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ModelImplementationParameterTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ModelImplementationParameterTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ModelImplementationParameterTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ModelImplementationParameterTypeAnyAttributeFeatureGroup> result = new ArrayList<ModelImplementationParameterTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ModelImplementationParameterTypeAnyAttributeFeatureGroup group = new ModelImplementationParameterTypeAnyAttributeFeatureGroup();
