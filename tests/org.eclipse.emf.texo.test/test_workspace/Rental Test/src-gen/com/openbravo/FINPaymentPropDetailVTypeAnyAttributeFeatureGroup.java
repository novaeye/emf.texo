...
/** 
 * A representation for the Feature Group '<em><b>FINPaymentPropDetailVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINPaymentPropDetailVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINPaymentPropDetailVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINPaymentPropDetailVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINPaymentPropDetailVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINPaymentPropDetailVTypeAnyAttributeFeatureGroup> result = new ArrayList<FINPaymentPropDetailVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINPaymentPropDetailVTypeAnyAttributeFeatureGroup group = new FINPaymentPropDetailVTypeAnyAttributeFeatureGroup();
