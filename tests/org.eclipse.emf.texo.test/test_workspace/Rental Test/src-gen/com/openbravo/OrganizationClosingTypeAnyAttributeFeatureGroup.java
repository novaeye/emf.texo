...
/** 
 * A representation for the Feature Group '<em><b>OrganizationClosingType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OrganizationClosingTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OrganizationClosingTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OrganizationClosingTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OrganizationClosingTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OrganizationClosingTypeAnyAttributeFeatureGroup> result = new ArrayList<OrganizationClosingTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OrganizationClosingTypeAnyAttributeFeatureGroup group = new OrganizationClosingTypeAnyAttributeFeatureGroup();
