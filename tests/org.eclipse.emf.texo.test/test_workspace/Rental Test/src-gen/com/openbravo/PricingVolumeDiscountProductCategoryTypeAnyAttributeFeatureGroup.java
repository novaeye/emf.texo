...
/** 
 * A representation for the Feature Group '<em><b>PricingVolumeDiscountProductCategoryType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class PricingVolumeDiscountProductCategoryTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<PricingVolumeDiscountProductCategoryTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final PricingVolumeDiscountProductCategoryTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<PricingVolumeDiscountProductCategoryTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<PricingVolumeDiscountProductCategoryTypeAnyAttributeFeatureGroup> result = new ArrayList<PricingVolumeDiscountProductCategoryTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final PricingVolumeDiscountProductCategoryTypeAnyAttributeFeatureGroup group = new PricingVolumeDiscountProductCategoryTypeAnyAttributeFeatureGroup();
