...
/** 
 * A representation for the Feature Group '<em><b>TimeAndExpenseSheetType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class TimeAndExpenseSheetTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<TimeAndExpenseSheetTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final TimeAndExpenseSheetTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<TimeAndExpenseSheetTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<TimeAndExpenseSheetTypeAnyAttributeFeatureGroup> result = new ArrayList<TimeAndExpenseSheetTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final TimeAndExpenseSheetTypeAnyAttributeFeatureGroup group = new TimeAndExpenseSheetTypeAnyAttributeFeatureGroup();
