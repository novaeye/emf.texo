...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtGLItemAccountsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtGLItemAccountsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtGLItemAccountsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtGLItemAccountsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtGLItemAccountsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtGLItemAccountsTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtGLItemAccountsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtGLItemAccountsTypeAnyAttributeFeatureGroup group = new FinancialMgmtGLItemAccountsTypeAnyAttributeFeatureGroup();
