...
/** 
 * A representation for the Feature Group '<em><b>ADTabType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADTabTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADTabTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADTabTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADTabTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADTabTypeAnyAttributeFeatureGroup> result = new ArrayList<ADTabTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADTabTypeAnyAttributeFeatureGroup group = new ADTabTypeAnyAttributeFeatureGroup();
