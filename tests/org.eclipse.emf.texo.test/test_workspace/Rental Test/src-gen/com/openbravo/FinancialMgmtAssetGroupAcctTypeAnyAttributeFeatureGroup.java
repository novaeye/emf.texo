...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAssetGroupAcctType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAssetGroupAcctTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAssetGroupAcctTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAssetGroupAcctTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAssetGroupAcctTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAssetGroupAcctTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAssetGroupAcctTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAssetGroupAcctTypeAnyAttributeFeatureGroup group = new FinancialMgmtAssetGroupAcctTypeAnyAttributeFeatureGroup();
