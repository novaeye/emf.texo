...
/** 
 * A representation for the Feature Group '<em><b>ShippingShippingCompanyFreightType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ShippingShippingCompanyFreightTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ShippingShippingCompanyFreightTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ShippingShippingCompanyFreightTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ShippingShippingCompanyFreightTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ShippingShippingCompanyFreightTypeAnyAttributeFeatureGroup> result = new ArrayList<ShippingShippingCompanyFreightTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ShippingShippingCompanyFreightTypeAnyAttributeFeatureGroup group = new ShippingShippingCompanyFreightTypeAnyAttributeFeatureGroup();
