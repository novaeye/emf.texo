...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingMeasureTimeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingMeasureTimeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingMeasureTimeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingMeasureTimeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingMeasureTimeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingMeasureTimeTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingMeasureTimeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingMeasureTimeTypeAnyAttributeFeatureGroup group = new ManufacturingMeasureTimeTypeAnyAttributeFeatureGroup();
