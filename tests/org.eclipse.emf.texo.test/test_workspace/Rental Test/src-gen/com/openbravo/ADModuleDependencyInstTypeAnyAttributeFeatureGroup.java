...
/** 
 * A representation for the Feature Group '<em><b>ADModuleDependencyInstType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADModuleDependencyInstTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADModuleDependencyInstTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADModuleDependencyInstTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADModuleDependencyInstTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADModuleDependencyInstTypeAnyAttributeFeatureGroup> result = new ArrayList<ADModuleDependencyInstTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADModuleDependencyInstTypeAnyAttributeFeatureGroup group = new ADModuleDependencyInstTypeAnyAttributeFeatureGroup();
