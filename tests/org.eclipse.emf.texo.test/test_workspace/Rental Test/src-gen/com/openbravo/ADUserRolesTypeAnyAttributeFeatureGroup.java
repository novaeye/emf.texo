...
/** 
 * A representation for the Feature Group '<em><b>ADUserRolesType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADUserRolesTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADUserRolesTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADUserRolesTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADUserRolesTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADUserRolesTypeAnyAttributeFeatureGroup> result = new ArrayList<ADUserRolesTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADUserRolesTypeAnyAttributeFeatureGroup group = new ADUserRolesTypeAnyAttributeFeatureGroup();
