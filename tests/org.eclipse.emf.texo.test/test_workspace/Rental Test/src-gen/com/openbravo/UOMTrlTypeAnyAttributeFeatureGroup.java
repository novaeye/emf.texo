...
/** 
 * A representation for the Feature Group '<em><b>UOMTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class UOMTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<UOMTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final UOMTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<UOMTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<UOMTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<UOMTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final UOMTrlTypeAnyAttributeFeatureGroup group = new UOMTrlTypeAnyAttributeFeatureGroup();
