...
/** 
 * A representation for the Feature Group '<em><b>OrganizationTypeType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OrganizationTypeTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OrganizationTypeTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OrganizationTypeTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OrganizationTypeTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OrganizationTypeTypeAnyAttributeFeatureGroup> result = new ArrayList<OrganizationTypeTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OrganizationTypeTypeAnyAttributeFeatureGroup group = new OrganizationTypeTypeAnyAttributeFeatureGroup();
