...
/** 
 * A representation for the Feature Group '<em><b>EmailServerConfigurationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class EmailServerConfigurationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<EmailServerConfigurationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final EmailServerConfigurationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<EmailServerConfigurationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<EmailServerConfigurationTypeAnyAttributeFeatureGroup> result = new ArrayList<EmailServerConfigurationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final EmailServerConfigurationTypeAnyAttributeFeatureGroup group = new EmailServerConfigurationTypeAnyAttributeFeatureGroup();
