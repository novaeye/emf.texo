...
/** 
 * A representation for the Feature Group '<em><b>FINPaymentPriorityType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINPaymentPriorityTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINPaymentPriorityTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINPaymentPriorityTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINPaymentPriorityTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINPaymentPriorityTypeAnyAttributeFeatureGroup> result = new ArrayList<FINPaymentPriorityTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINPaymentPriorityTypeAnyAttributeFeatureGroup group = new FINPaymentPriorityTypeAnyAttributeFeatureGroup();
