...
/** 
 * A representation for the Feature Group '<em><b>ADHeartbeatLogCustomQueryType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADHeartbeatLogCustomQueryTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADHeartbeatLogCustomQueryTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADHeartbeatLogCustomQueryTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADHeartbeatLogCustomQueryTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADHeartbeatLogCustomQueryTypeAnyAttributeFeatureGroup> result = new ArrayList<ADHeartbeatLogCustomQueryTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADHeartbeatLogCustomQueryTypeAnyAttributeFeatureGroup group = new ADHeartbeatLogCustomQueryTypeAnyAttributeFeatureGroup();
