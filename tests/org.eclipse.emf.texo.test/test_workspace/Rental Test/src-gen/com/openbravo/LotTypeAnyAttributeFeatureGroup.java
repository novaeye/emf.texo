...
/** 
 * A representation for the Feature Group '<em><b>LotType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class LotTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<LotTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final LotTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<LotTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<LotTypeAnyAttributeFeatureGroup> result = new ArrayList<LotTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final LotTypeAnyAttributeFeatureGroup group = new LotTypeAnyAttributeFeatureGroup();
