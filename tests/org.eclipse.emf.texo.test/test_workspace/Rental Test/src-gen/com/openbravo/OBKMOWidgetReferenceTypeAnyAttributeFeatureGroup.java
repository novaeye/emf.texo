...
/** 
 * A representation for the Feature Group '<em><b>OBKMOWidgetReferenceType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class OBKMOWidgetReferenceTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<OBKMOWidgetReferenceTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final OBKMOWidgetReferenceTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<OBKMOWidgetReferenceTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<OBKMOWidgetReferenceTypeAnyAttributeFeatureGroup> result = new ArrayList<OBKMOWidgetReferenceTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final OBKMOWidgetReferenceTypeAnyAttributeFeatureGroup group = new OBKMOWidgetReferenceTypeAnyAttributeFeatureGroup();
