...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAcctCFSType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAcctCFSTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAcctCFSTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAcctCFSTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAcctCFSTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAcctCFSTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAcctCFSTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAcctCFSTypeAnyAttributeFeatureGroup group = new FinancialMgmtAcctCFSTypeAnyAttributeFeatureGroup();
