...
/** 
 * A representation for the Feature Group '<em><b>MaterialMgmtProductionTransactionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class MaterialMgmtProductionTransactionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<MaterialMgmtProductionTransactionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final MaterialMgmtProductionTransactionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<MaterialMgmtProductionTransactionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<MaterialMgmtProductionTransactionTypeAnyAttributeFeatureGroup> result = new ArrayList<MaterialMgmtProductionTransactionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final MaterialMgmtProductionTransactionTypeAnyAttributeFeatureGroup group = new MaterialMgmtProductionTransactionTypeAnyAttributeFeatureGroup();
