...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtAssetAccountsType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtAssetAccountsTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtAssetAccountsTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtAssetAccountsTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtAssetAccountsTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtAssetAccountsTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtAssetAccountsTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtAssetAccountsTypeAnyAttributeFeatureGroup group = new FinancialMgmtAssetAccountsTypeAnyAttributeFeatureGroup();
