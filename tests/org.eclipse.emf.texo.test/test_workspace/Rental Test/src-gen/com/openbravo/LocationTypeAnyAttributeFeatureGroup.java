...
/** 
 * A representation for the Feature Group '<em><b>LocationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class LocationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<LocationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final LocationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<LocationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<LocationTypeAnyAttributeFeatureGroup> result = new ArrayList<LocationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final LocationTypeAnyAttributeFeatureGroup group = new LocationTypeAnyAttributeFeatureGroup();
