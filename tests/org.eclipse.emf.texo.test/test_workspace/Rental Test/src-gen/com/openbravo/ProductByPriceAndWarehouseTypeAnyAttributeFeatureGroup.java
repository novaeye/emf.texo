...
/** 
 * A representation for the Feature Group '<em><b>ProductByPriceAndWarehouseType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProductByPriceAndWarehouseTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProductByPriceAndWarehouseTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProductByPriceAndWarehouseTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProductByPriceAndWarehouseTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProductByPriceAndWarehouseTypeAnyAttributeFeatureGroup> result = new ArrayList<ProductByPriceAndWarehouseTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProductByPriceAndWarehouseTypeAnyAttributeFeatureGroup group = new ProductByPriceAndWarehouseTypeAnyAttributeFeatureGroup();
