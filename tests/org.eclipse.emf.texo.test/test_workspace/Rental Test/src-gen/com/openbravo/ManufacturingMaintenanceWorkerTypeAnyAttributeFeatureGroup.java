...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingMaintenanceWorkerType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingMaintenanceWorkerTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingMaintenanceWorkerTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingMaintenanceWorkerTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingMaintenanceWorkerTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingMaintenanceWorkerTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingMaintenanceWorkerTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingMaintenanceWorkerTypeAnyAttributeFeatureGroup group = new ManufacturingMaintenanceWorkerTypeAnyAttributeFeatureGroup();
