...
/** 
 * A representation for the Feature Group '<em><b>ADListTrlType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADListTrlTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADListTrlTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADListTrlTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADListTrlTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADListTrlTypeAnyAttributeFeatureGroup> result = new ArrayList<ADListTrlTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADListTrlTypeAnyAttributeFeatureGroup group = new ADListTrlTypeAnyAttributeFeatureGroup();
