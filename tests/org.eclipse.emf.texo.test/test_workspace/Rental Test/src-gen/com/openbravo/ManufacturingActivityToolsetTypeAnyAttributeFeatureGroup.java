...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingActivityToolsetType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingActivityToolsetTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingActivityToolsetTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingActivityToolsetTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingActivityToolsetTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingActivityToolsetTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingActivityToolsetTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingActivityToolsetTypeAnyAttributeFeatureGroup group = new ManufacturingActivityToolsetTypeAnyAttributeFeatureGroup();
