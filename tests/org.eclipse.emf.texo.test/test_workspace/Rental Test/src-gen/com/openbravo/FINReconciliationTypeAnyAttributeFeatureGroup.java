...
/** 
 * A representation for the Feature Group '<em><b>FINReconciliationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FINReconciliationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FINReconciliationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FINReconciliationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FINReconciliationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FINReconciliationTypeAnyAttributeFeatureGroup> result = new ArrayList<FINReconciliationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FINReconciliationTypeAnyAttributeFeatureGroup group = new FINReconciliationTypeAnyAttributeFeatureGroup();
