...
/** 
 * A representation for the Feature Group '<em><b>EmailInteractionType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class EmailInteractionTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<EmailInteractionTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final EmailInteractionTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<EmailInteractionTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<EmailInteractionTypeAnyAttributeFeatureGroup> result = new ArrayList<EmailInteractionTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final EmailInteractionTypeAnyAttributeFeatureGroup group = new EmailInteractionTypeAnyAttributeFeatureGroup();
