...
/** 
 * A representation for the Feature Group '<em><b>ProcurementPOInvoiceMatchType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ProcurementPOInvoiceMatchTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ProcurementPOInvoiceMatchTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ProcurementPOInvoiceMatchTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ProcurementPOInvoiceMatchTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ProcurementPOInvoiceMatchTypeAnyAttributeFeatureGroup> result = new ArrayList<ProcurementPOInvoiceMatchTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ProcurementPOInvoiceMatchTypeAnyAttributeFeatureGroup group = new ProcurementPOInvoiceMatchTypeAnyAttributeFeatureGroup();
