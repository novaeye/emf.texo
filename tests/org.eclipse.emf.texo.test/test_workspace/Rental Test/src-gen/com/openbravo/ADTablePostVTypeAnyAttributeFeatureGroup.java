...
/** 
 * A representation for the Feature Group '<em><b>ADTablePostVType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ADTablePostVTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ADTablePostVTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ADTablePostVTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ADTablePostVTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ADTablePostVTypeAnyAttributeFeatureGroup> result = new ArrayList<ADTablePostVTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ADTablePostVTypeAnyAttributeFeatureGroup group = new ADTablePostVTypeAnyAttributeFeatureGroup();
