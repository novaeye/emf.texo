...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingCaseType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingCaseTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingCaseTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingCaseTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingCaseTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingCaseTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingCaseTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingCaseTypeAnyAttributeFeatureGroup group = new ManufacturingCaseTypeAnyAttributeFeatureGroup();
