...
/** 
 * A representation for the Feature Group '<em><b>ManufacturingMaintenanceTaskType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ManufacturingMaintenanceTaskTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ManufacturingMaintenanceTaskTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ManufacturingMaintenanceTaskTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ManufacturingMaintenanceTaskTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ManufacturingMaintenanceTaskTypeAnyAttributeFeatureGroup> result = new ArrayList<ManufacturingMaintenanceTaskTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ManufacturingMaintenanceTaskTypeAnyAttributeFeatureGroup group = new ManufacturingMaintenanceTaskTypeAnyAttributeFeatureGroup();
