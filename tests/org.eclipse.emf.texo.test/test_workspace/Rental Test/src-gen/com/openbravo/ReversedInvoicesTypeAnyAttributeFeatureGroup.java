...
/** 
 * A representation for the Feature Group '<em><b>ReversedInvoicesType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ReversedInvoicesTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ReversedInvoicesTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ReversedInvoicesTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ReversedInvoicesTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ReversedInvoicesTypeAnyAttributeFeatureGroup> result = new ArrayList<ReversedInvoicesTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ReversedInvoicesTypeAnyAttributeFeatureGroup group = new ReversedInvoicesTypeAnyAttributeFeatureGroup();
