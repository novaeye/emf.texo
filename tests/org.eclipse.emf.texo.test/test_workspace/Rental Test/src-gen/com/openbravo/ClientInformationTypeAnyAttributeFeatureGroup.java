...
/** 
 * A representation for the Feature Group '<em><b>ClientInformationType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class ClientInformationTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<ClientInformationTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final ClientInformationTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<ClientInformationTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<ClientInformationTypeAnyAttributeFeatureGroup> result = new ArrayList<ClientInformationTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final ClientInformationTypeAnyAttributeFeatureGroup group = new ClientInformationTypeAnyAttributeFeatureGroup();
