...
/** 
 * A representation for the Feature Group '<em><b>WarehouseType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class WarehouseTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<WarehouseTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final WarehouseTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<WarehouseTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<WarehouseTypeAnyAttributeFeatureGroup> result = new ArrayList<WarehouseTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final WarehouseTypeAnyAttributeFeatureGroup group = new WarehouseTypeAnyAttributeFeatureGroup();
