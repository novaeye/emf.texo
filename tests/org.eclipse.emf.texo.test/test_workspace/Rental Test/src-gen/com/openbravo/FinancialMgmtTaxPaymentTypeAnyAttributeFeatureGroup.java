...
/** 
 * A representation for the Feature Group '<em><b>FinancialMgmtTaxPaymentType.anyAttribute</b></em>'.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated 
 */
public class FinancialMgmtTaxPaymentTypeAnyAttributeFeatureGroup {
	...
	public static <T> List<T> createUnmodifiableValueList(
			List<FinancialMgmtTaxPaymentTypeAnyAttributeFeatureGroup> featureGroup,
			Feature filterByFeature) {
		final List<Object> result = new ArrayList<Object>();
		for (final FinancialMgmtTaxPaymentTypeAnyAttributeFeatureGroup group : featureGroup) {
	 ...
	 * @generated 
	 */
	public static List<FinancialMgmtTaxPaymentTypeAnyAttributeFeatureGroup> createFeatureGroupList(
			Feature feature, List<?> values) {
		final List<FinancialMgmtTaxPaymentTypeAnyAttributeFeatureGroup> result = new ArrayList<FinancialMgmtTaxPaymentTypeAnyAttributeFeatureGroup>();
		for (Object value : values) {
			final FinancialMgmtTaxPaymentTypeAnyAttributeFeatureGroup group = new FinancialMgmtTaxPaymentTypeAnyAttributeFeatureGroup();
