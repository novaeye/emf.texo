...
public abstract class XMLBaseTest extends TestCase {

  private List<EPackage> ePackages;
  private List<EClass> eClasses;
  private boolean doXMI = false;

  public XMLBaseTest() {
  }

  public XMLBaseTest(String name) {
    super(name);
  }
  ...
  public boolean isDoXMI() {
    return doXMI;
  }

  public void setDoXMI(boolean doXMI) {
    this.doXMI = doXMI;
  }
