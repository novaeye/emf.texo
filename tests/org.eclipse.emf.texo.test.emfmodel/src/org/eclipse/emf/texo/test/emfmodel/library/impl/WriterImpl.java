 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.texo.test.emfmodel.library.impl.WriterImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.emf.texo.test.emfmodel.library.impl.WriterImpl#getBooks <em>Books</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WriterImpl extends IdentifiableImpl implements Writer {
	...
	public EList<Book> getBooks() {
		if (books == null) {
			books = new EObjectWithInverseEList<Book>(Book.class, this, LibraryPackage.WRITER__BOOKS, LibraryPackage.BOOK__AUTHOR);
		}
		return books;
	}
