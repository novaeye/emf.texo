 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.texo.test.emfmodel.bz391624.impl.AuthorImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AuthorImpl extends EObjectImpl implements Author {
	...
	protected EClass eStaticClass() {
		return Bz391624Package.Literals.AUTHOR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bz391624Package.AUTHOR__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bz391624Package.AUTHOR__NAME:
				return getName();
		}
