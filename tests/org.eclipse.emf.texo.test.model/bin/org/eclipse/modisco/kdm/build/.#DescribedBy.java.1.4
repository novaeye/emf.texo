...
/** 
 * A representation of the model object '<em><b>DescribedBy</b></em>'.
...
public class DescribedBy extends AbstractBuildRelationship {
   ...
   * @generated 
   */
  @ManyToOne(cascade = { CascadeType.ALL, CascadeType.PERSIST, CascadeType.REFRESH }, optional = false, targetEntity = BuildDescription.class)
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link DescribedBy#getTo() to}' feature.
   * @generated
   */
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link DescribedBy#getFrom() from}' feature.
   * @generated
   */
