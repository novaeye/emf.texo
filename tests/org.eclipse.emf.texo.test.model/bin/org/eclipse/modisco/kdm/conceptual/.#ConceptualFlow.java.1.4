...
/** 
 * A representation of the model object '<em><b>ConceptualFlow</b></em>'.
...
public class ConceptualFlow extends AbstractConceptualRelationship {
   ...
   * @generated 
   */
  @ManyToOne(cascade = { CascadeType.ALL, CascadeType.PERSIST, CascadeType.REFRESH }, optional = false, targetEntity = ConceptualContainer.class)
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link ConceptualFlow#getTo() to}' feature.
   * @generated
   */
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link ConceptualFlow#getFrom() from}' feature.
   * @generated
   */
