...
/** 
 * A representation of the model object '<em><b>WritesResource</b></em>'.
...
public class WritesResource extends AbstractActionRelationship {
  ...
  /**
   * Sets the '{@link WritesResource#getTo() <em>to</em>}' feature.
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link WritesResource#getTo() to}' feature.
   * @generated
   */
  ...
  /**
   * Sets the '{@link WritesResource#getFrom() <em>from</em>}' feature.
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link WritesResource#getFrom() from}' feature.
   * @generated
   */
