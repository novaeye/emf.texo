...
public interface IdentifiableInterface {
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param the new value of the '{@link IdentifiableInterface#getDb_Id() <em>db_Id</em>}' feature.
   * @generated
   */
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param the new value of the '{@link IdentifiableInterface#getDb_version() <em>db_version</em>}' feature.
   * @generated
   */
