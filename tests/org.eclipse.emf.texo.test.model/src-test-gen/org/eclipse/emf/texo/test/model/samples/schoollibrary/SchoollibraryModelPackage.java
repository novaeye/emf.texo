...
/**
 * The <b>Package</b> for the model '<em><b>schoollibrary</b></em>'.
...
public class SchoollibraryModelPackage extends ModelPackage {
  ...
  /**
   * Returns the {@link EClass} '<em><b>Asset</b></em>'.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Asset.value</b></em>'.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  /**
   * Returns the {@link EClass} '<em><b>SchoolBook</b></em>'.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>SchoolBook.value</b></em>'.
   * <!-- begin-user-doc --> <!--
   * end-user-doc -->
  ...
  /**
   * Returns the {@link EClass} '<em><b>SchoolLibrary</b></em>'.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>SchoolLibrary.location</b></em>'.
   * <!-- begin-user-doc --> <!--
   * end-user-doc -->
