...
/**
 * The <b>{@link ModelFactory}</b> for the types of this model: org.eclipse.emf.texo.test.model.schemaconstructs.substitutionzvon.
...
public class SubstitutionzvonModelFactory implements ModelFactory {
  ...
  /**
   * Converts the EDataType: AAA to a String.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  /**
   * Creates an instance of the EDataType: AAA from a String.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
