...
public class ElementTrueFeatureGroup {
  ...
  public static <T> List<T> createUnmodifiableValueList(List<ElementTrueFeatureGroup> featureGroup,
      Feature filterByFeature) {
    final List<Object> result = new ArrayList<Object>();
    for (final ElementTrueFeatureGroup group : featureGroup) {
   ...
   */
  @SuppressWarnings("unchecked")
  public static <T> T getSingleFeatureMapValue(List<ElementTrueFeatureGroup> featureGroup, Feature filterByFeature) {
    for (final ElementTrueFeatureGroup group : featureGroup) {
      if (group.getFeature() == filterByFeature) {
   ...
   * @generated
   */
  public static void setSingleFeatureMapValue(List<ElementTrueFeatureGroup> featureGroup, Feature feature, Object value) {
    for (final ElementTrueFeatureGroup group : featureGroup) {
    ...
    final ElementTrueFeatureGroup entry = new ElementTrueFeatureGroup();
   ...
   * @generated
   */
  public static List<ElementTrueFeatureGroup> createFeatureGroupList(Feature feature, List<?> values) {
    final List<ElementTrueFeatureGroup> result = new ArrayList<ElementTrueFeatureGroup>();
    for (Object value : values) {
      final ElementTrueFeatureGroup group = new ElementTrueFeatureGroup();
      group.setValue(feature, value);
      result.add(group);
    }
    return result;
