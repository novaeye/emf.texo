...
/**
 * The <b>Package</b> for the model '<em><b>music</b></em>'. It contains initialization code and access to the Factory
...
public class MusicModelPackage extends ModelPackage {
   ...
   * @generated
   */
  public static final int ARTIST_DB_ID_FEATURE_ID = 0;
   ...
   * @generated
   */
  public static final int ARTIST_DB_VERSION_FEATURE_ID = 1;
   ...
   * @generated
   */
  public static final int COUNTRY_DB_ID_FEATURE_ID = 0;
   ...
   * @generated
   */
  public static final int COUNTRY_DB_VERSION_FEATURE_ID = 1;
   ...
   * @generated
   */
  public static final int GENRE_DB_ID_FEATURE_ID = 0;
   ...
   * @generated
   */
  public static final int GENRE_DB_VERSION_FEATURE_ID = 1;
   ...
   * @generated
   */
  public static final int ALBUM_DB_ID_FEATURE_ID = 0;
   ...
   * @generated
   */
  public static final int ALBUM_DB_VERSION_FEATURE_ID = 1;
   ...
   * @generated
   */
  public static final int SONG_DB_ID_FEATURE_ID = 0;
   ...
   * @generated
   */
  public static final int SONG_DB_VERSION_FEATURE_ID = 1;
  ...
  public static MusicModelPackage initialize() {
    ...
    if (isInitialized) {
      return (MusicModelPackage) ModelResolver.getInstance().getModelPackage(NS_URI);
    }
    ...
    ModelResolver.getInstance().registerClassModelMapping(Country.class, modelPackage.getCountryEClass(), modelPackage);
    ModelResolver.getInstance().registerClassModelMapping(Genre.class, modelPackage.getGenreEClass(), modelPackage);
    ModelResolver.getInstance().registerClassModelMapping(Album.class, modelPackage.getAlbumEClass(), modelPackage);
    ModelResolver.getInstance().registerClassModelMapping(Song.class, modelPackage.getSongEClass(), modelPackage);
  ...
  /**
   * Returns the {@link EClass} '<em><b>Artist</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EClass} '<em><b>Artist</b></em>'
   * @generated
   */
  public EClass getArtistEClass() {
    return (EClass) getEPackage().getEClassifiers().get(ARTIST_CLASSIFIER_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Artist.id</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Artist.id</b></em>'.
   * @generated
   */
  public EAttribute getArtist_Id() {
    return (EAttribute) getArtistEClass().getEAllStructuralFeatures().get(ARTIST_ID_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Artist.version</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Artist.version</b></em>'.
   * @generated
   */
  public EAttribute getArtist_Version() {
    return (EAttribute) getArtistEClass().getEAllStructuralFeatures().get(ARTIST_VERSION_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Artist.firstName</b></em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Artist.firstName</b></em>'.
   * @generated
   */
  public EAttribute getArtist_FirstName() {
    return (EAttribute) getArtistEClass().getEAllStructuralFeatures().get(ARTIST_FIRSTNAME_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Artist.lastName</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Artist.lastName</b></em>'.
   * @generated
   */
  public EAttribute getArtist_LastName() {
    return (EAttribute) getArtistEClass().getEAllStructuralFeatures().get(ARTIST_LASTNAME_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Artist.birthDate</b></em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Artist.birthDate</b></em>'.
   * @generated
   */
  public EAttribute getArtist_BirthDate() {
    return (EAttribute) getArtistEClass().getEAllStructuralFeatures().get(ARTIST_BIRTHDATE_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Artist.country</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Artist.country</b></em>'.
   * @generated
   */
  public EReference getArtist_Country() {
    return (EReference) getArtistEClass().getEAllStructuralFeatures().get(ARTIST_COUNTRY_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Artist.genre</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Artist.genre</b></em>'.
   * @generated
   */
  public EReference getArtist_Genre() {
    return (EReference) getArtistEClass().getEAllStructuralFeatures().get(ARTIST_GENRE_FEATURE_ID);
  }
  ...
  public EClass getAlbumEClass() {
    return (EClass) getEPackage().getEClassifiers().get(ALBUM_CLASSIFIER_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Album.id</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Album.id</b></em>'.
   * @generated
   */
  public EAttribute getAlbum_Id() {
    return (EAttribute) getAlbumEClass().getEAllStructuralFeatures().get(ALBUM_ID_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Album.version</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Album.version</b></em>'.
   * @generated
   */
  public EAttribute getAlbum_Version() {
    return (EAttribute) getAlbumEClass().getEAllStructuralFeatures().get(ALBUM_VERSION_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Album.name</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Album.name</b></em>'.
   * @generated
   */
  public EAttribute getAlbum_Name() {
    return (EAttribute) getAlbumEClass().getEAllStructuralFeatures().get(ALBUM_NAME_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Album.artist</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Album.artist</b></em>'.
   * @generated
   */
  public EReference getAlbum_Artist() {
    return (EReference) getAlbumEClass().getEAllStructuralFeatures().get(ALBUM_ARTIST_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Album.releaseDate</b></em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Album.releaseDate</b></em>'.
   * @generated
   */
  public EAttribute getAlbum_ReleaseDate() {
    return (EAttribute) getAlbumEClass().getEAllStructuralFeatures().get(ALBUM_RELEASEDATE_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Album.genres</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Album.genres</b></em>'.
   * @generated
   */
  public EReference getAlbum_Genres() {
    return (EReference) getAlbumEClass().getEAllStructuralFeatures().get(ALBUM_GENRES_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Album.songs</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Album.songs</b></em>'.
   * @generated
   */
  public EReference getAlbum_Songs() {
    return (EReference) getAlbumEClass().getEAllStructuralFeatures().get(ALBUM_SONGS_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Album.ratings</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Album.ratings</b></em>'.
   * @generated
   */
  public EAttribute getAlbum_Ratings() {
    return (EAttribute) getAlbumEClass().getEAllStructuralFeatures().get(ALBUM_RATINGS_FEATURE_ID);
  }
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Song.id</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Song.id</b></em>'.
   * @generated
   */
  public EAttribute getSong_Id() {
    return (EAttribute) getSongEClass().getEAllStructuralFeatures().get(SONG_ID_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Song.version</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Song.version</b></em>'.
   * @generated
   */
  public EAttribute getSong_Version() {
    return (EAttribute) getSongEClass().getEAllStructuralFeatures().get(SONG_VERSION_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Song.track</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Song.track</b></em>'.
   * @generated
   */
  public EAttribute getSong_Track() {
    return (EAttribute) getSongEClass().getEAllStructuralFeatures().get(SONG_TRACK_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>Song.name</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>Song.name</b></em>'.
   * @generated
   */
