...
public class ClientTariff implements Tariff {
   ...
   * 
   * @param the
   *          new value of the '{@link ClientTariff#getName() name}' feature.
   * @generated
   */
   ...
   * 
   * @param the
   *          new value of the '{@link ClientTariff#isActive() active}' feature.
   * @generated
   */
  ...
  public String toString() {
    return "ClientTariff " + " [name: " + getName() + "]" + " [active: " + isActive() + "]";
  }
}
