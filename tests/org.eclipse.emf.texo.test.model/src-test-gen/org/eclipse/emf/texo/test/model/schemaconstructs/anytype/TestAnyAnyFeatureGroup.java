 ...
 * @generated
 */
@Entity(name = "anytype_TestAny_any")
public class TestAnyAnyFeatureGroup extends Identifiable {
  ...
  public static <T> List<T> createUnmodifiableValueList(List<TestAnyAnyFeatureGroup> featureGroup,
      Feature filterByFeature) {
    final List<Object> result = new ArrayList<Object>();
    for (final TestAnyAnyFeatureGroup group : featureGroup) {
   ...
   */
  @SuppressWarnings("unchecked")
  public static <T> T getSingleFeatureMapValue(List<TestAnyAnyFeatureGroup> featureGroup, Feature filterByFeature) {
    for (final TestAnyAnyFeatureGroup group : featureGroup) {
      if (group.getFeature() == filterByFeature) {
   ...
   * @generated
   */
  public static void setSingleFeatureMapValue(List<TestAnyAnyFeatureGroup> featureGroup, Feature feature, Object value) {
    for (final TestAnyAnyFeatureGroup group : featureGroup) {
    ...
    final TestAnyAnyFeatureGroup entry = new TestAnyAnyFeatureGroup();
   ...
   * @generated
   */
  public static List<TestAnyAnyFeatureGroup> createFeatureGroupList(Feature feature, List<?> values) {
    final List<TestAnyAnyFeatureGroup> result = new ArrayList<TestAnyAnyFeatureGroup>();
    for (Object value : values) {
      final TestAnyAnyFeatureGroup group = new TestAnyAnyFeatureGroup();
      group.setValue(feature, value);
      result.add(group);
    }
    return result;
