...
public class Bz325427ModelFactory implements ModelFactory {
  ...
  public Object create(EClass eClass) {
    ...
    case Bz325427ModelPackage.ECLASSB_CLASSIFIER_ID:
  ...
  public ModelObject createModelObject(EClass eClass, Object adaptee) {
    ...
    switch (eClass.getClassifierID()) {
    case Bz325427ModelPackage.ECLASSB_CLASSIFIER_ID:
      modelObject = new EClassBModelObject();
      break;
    case Bz325427ModelPackage.ECLASSA_CLASSIFIER_ID:
      modelObject = new EClassAModelObject();
      break;
    default:
  ...
  public Object createFromString(EDataType eDataType, String value) {
    ...
    case Bz325427ModelPackage.ENUMB_CLASSIFIER_ID:
   ...
   * @generated
   */
  public String convertEnumBToString(EnumB value) {
    if (value == null) {
      return null;
    }
   ...
   * @generated
   */
  public EnumB createEnumBFromString(String value) {
    if (value == null) {
      return null;
    }
    return EnumB.get(value);
  }
   ...
   * @generated
   */
  public String convertEnumAToString(EnumA value) {
    if (value == null) {
      return null;
    }
    return value.toString();
   ...
   * @generated
   */
  public EnumA createEnumAFromString(String value) {
    if (value == null) {
      return null;
    }
