...
/**
 * The <b>{@link ModelFactory}</b> for the types of this model: bz391624. It contains code to create instances
 * {@link ModelObject} wrappers and instances for EClasses and convert objects back and forth from their String (XML)
 * representation. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class Bz391624ModelFactory implements ModelFactory {
  ...
  public Object create(EClass eClass) {
    ...
    case Bz391624ModelPackage.BOOK_CLASSIFIER_ID:
      return createBook();
    case Bz391624ModelPackage.AUTHOR_CLASSIFIER_ID:
      return createAuthor();
    default:
  ...
  public static class BookModelObject<E extends Book> extends IdentifiableModelFactory.IdentifiableModelObject<E> {
    ...
    public Object eGet(EStructuralFeature eStructuralFeature) {
      ...
      switch (featureID) {
      case Bz391624ModelPackage.BOOK_DB_ID_FEATURE_ID:
        return getTarget().getDb_Id();
      case Bz391624ModelPackage.BOOK_DB_VERSION_FEATURE_ID:
    ...
    public void eSet(EStructuralFeature eStructuralFeature, Object value) {
      ...
      case Bz391624ModelPackage.BOOK_DB_VERSION_FEATURE_ID:
        ...
        return;
      case Bz391624ModelPackage.BOOK_AUTHORS_FEATURE_ID:
        getTarget().setAuthors((List<Author>) value);
        return;
      default:
    ...
    public void eAddTo(EStructuralFeature eStructuralFeature, Object value) {
      ...
      case Bz391624ModelPackage.BOOK_AUTHORS_FEATURE_ID:
        getTarget().getAuthors().add((Author) value);
        return;
      default:
    ...
    public void eRemoveFrom(EStructuralFeature eStructuralFeature, Object value) {
      ...
      case Bz391624ModelPackage.BOOK_AUTHORS_FEATURE_ID:
        getTarget().getAuthors().remove(value);
        return;
      default:
  ...
  public static class AuthorModelObject<E extends Author> extends
      IdentifiableModelFactory.NotIdentifiableModelObject<E> {
    /**
     * @generated
     */
    @Override
    ...
    public Object eGet(EStructuralFeature eStructuralFeature) {
      final int featureID = eClass().getFeatureID(eStructuralFeature);
      switch (featureID) {
      case Bz391624ModelPackage.AUTHOR_NAME_FEATURE_ID:
