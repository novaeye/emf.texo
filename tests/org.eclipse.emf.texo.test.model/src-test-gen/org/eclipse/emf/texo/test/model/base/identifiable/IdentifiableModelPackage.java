...
/**
 * The <b>Package</b> for the model '<em><b>identifiable</b></em>'. It contains initialization code and access to the
...
public class IdentifiableModelPackage extends ModelPackage {
  ...
  /**
   * Returns the {@link EClass} '<em><b>Identifiable</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Identifiable.db_Id</b></em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Identifiable.db_version</b></em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>IdentifiableInterface.db_Id</b></em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>IdentifiableInterface.db_Id</b></em>'.
   * @generated
   */
  public EAttribute getIdentifiableInterface_Db_Id() {
    return (EAttribute) getIdentifiableInterfaceEClass().getEAllStructuralFeatures().get(
        IDENTIFIABLEINTERFACE_DB_ID_FEATURE_ID);
  }

  /**
   * Returns the {@link EStructuralFeature} '<em><b>IdentifiableInterface.db_version</b></em>'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @return an instance of the {@link EStructuralFeature}: '<em><b>IdentifiableInterface.db_version</b></em>'.
   * @generated
   */
