...
public class Sub1ModelFactory implements ModelFactory {
  ...
  /**
   * The adapter/wrapper for the EClass '<em><b>Sub1Type</b></em>'.
   * 
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param <E>
  ...
  public static class Sub1TypeModelObject<E extends Sub1Type> extends
    ...
    public Object eGet(EStructuralFeature eStructuralFeature) {
      ...
      switch (featureID) {
      case Sub1ModelPackage.SUB1TYPE_DB_ID_FEATURE_ID:
        return getTarget().getDb_Id();
      case Sub1ModelPackage.SUB1TYPE_DB_VERSION_FEATURE_ID:
