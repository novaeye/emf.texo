...
/**
 * The <b>{@link ModelFactory}</b> for the types of this model: org.eclipse.emf.texo.test.model.schemaconstructs.substitution.
...
public class SubstitutionModelFactory implements ModelFactory {
  ...
  /**
   * Converts the EDataType: EvenTypeObject to a String.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param value the object to convert
   * @return the String representing the value, if value == null then null is returned
   * @generated
  ...
  /**
   * Creates an instance of the EDataType: EvenTypeObject from a String.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param value the string value to convert to an object
   * @return the instance of the data type, if value == null then null is returned
   * @generated
  ...
  /**
   * Converts the EDataType: OddType to a String.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param value the object to convert
   * @return the String representing the value, if value == null then null is returned
   * @generated
  ...
  /**
   * Creates an instance of the EDataType: OddType from a String.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param value the string value to convert to an object
   * @return the instance of the data type, if value == null then null is returned
   * @generated
  ...
  /**
   * Converts the EDataType: OddTypeObject to a String.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param value the object to convert
   * @return the String representing the value, if value == null then null is returned
   * @generated
  ...
  /**
   * Creates an instance of the EDataType: OddTypeObject from a String.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param value the string value to convert to an object
   * @return the instance of the data type, if value == null then null is returned
   * @generated
  ...
  /**
   * Converts the EDataType: SimpleNumber to a String.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param value the object to convert
   * @return the String representing the value, if value == null then null is returned
   * @generated
  ...
  /**
   * Creates an instance of the EDataType: SimpleNumber from a String.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param value the string value to convert to an object
   * @return the instance of the data type, if value == null then null is returned
   * @generated
   ...
   * @generated 
   */
  public static class ComplexNumberModelObject<E extends ComplexNumber> extends AbstractModelObject<E> {
    /**
     * @generated
     */
   ...
   * @generated 
   */
  public static class MultiNumberTypeModelObject<E extends MultiNumberType> extends AbstractModelObject<E> {
    /**
     * @generated
     */
    public EClass eClass() {
   ...
   * @generated 
   */
  public static class NumberTypeModelObject<E extends NumberType> extends AbstractModelObject<E> {
    /**
     * @generated
     */
    public EClass eClass() {
