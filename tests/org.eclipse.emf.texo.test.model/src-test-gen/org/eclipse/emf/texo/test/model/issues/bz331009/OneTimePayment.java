...
public class OneTimePayment implements PaymentItem {
   ...
   * 
   * @param the
   *          new value of the '{@link OneTimePayment#getSum() sum}' feature.
   * @generated
   */
   ...
   * 
   * @param the
   *          new value of the '{@link OneTimePayment#getDate() date}' feature.
   * @generated
   */
   ...
   * 
   * @param the
   *          new value of the '{@link OneTimePayment#getDescription() description}' feature.
   * @generated
   */
   ...
   * 
   * @param the
   *          new value of the '{@link OneTimePayment#getPaymentType() paymentType}' feature.
   * @generated
   */
  ...
  public String toString() {
    return "OneTimePayment " + " [sum: " + getSum() + "]" + " [currency: " + getCurrency() + "]" + " [date: "
        + getDate() + "]" + " [description: " + getDescription() + "]" + " [paymentType: " + getPaymentType() + "]";
  }
}
