...
/**
 * A representation of the model object '<em><b>Application</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
@Entity(name = "bz393240_Application")
...
public class Application extends Identifiable {
  ...
  /**
   * Sets the '{@link Application#getName() <em>name</em>}' feature.
   * 
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param newName
