...
import org.eclipse.emf.texo.test.model.samples.featuremaptest.dao.PurchaseOrderDao;
import org.eclipse.emf.texo.test.model.samples.featuremaptest.dao.SupplierDao;
import org.eclipse.emf.texo.utils.ModelUtils;

/**
 * The <b>Package</b> for the model '<em><b>featuremaptest</b></em>'.
 * It contains initialization code and access to the Factory to instantiate types of this package.
 * 
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class FeaturemaptestModelPackage extends ModelPackage {
   ...
   * @generated
   */
  public static final String NS_URI = "http://www.eclipse.org/emf/texo/test/model/samples/featuremaptest";
   ...
   * @generated
   */
  public static final FeaturemaptestModelFactory MODELFACTORY = new FeaturemaptestModelFactory();
   ...
   * @generated
   */
  public static final int PURCHASEORDER_NAME_FEATURE_ID = 0;
   ...
   * @generated
   */
  public static final int SUPPLIER_ORDERS_FEATURE_ID = 1;
   ...
   * @generated
   */
  public static final int SUPPLIER_HARDCOPYORDERREFERENCE_FEATURE_ID = 2;

  /**
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @generated
   */
  public static final int SUPPLIER_HARDCOPYORDERNUMBER_FEATURE_ID = 3;
   ...
   * @generated
   */
  public static final FeaturemaptestModelPackage INSTANCE = initialize();
   ...
   * @generated
   */
  public static FeaturemaptestModelPackage initialize() {

    if (isInitialized) {
      return (FeaturemaptestModelPackage) ModelResolver.getInstance().getModelPackage(NS_URI);
    }

    final FeaturemaptestModelPackage modelPackage = new FeaturemaptestModelPackage();
   ...
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the {@link FeaturemaptestModelFactory} instance.
   * @generated
   */
  @Override
  public FeaturemaptestModelFactory getModelFactory() {
    return MODELFACTORY;
  }
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>PurchaseOrder.name</b></em>'.
   * <!-- begin-user-doc --> <!--
   * end-user-doc -->
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Supplier.preferredOrders</b></em>'.
   * <!-- begin-user-doc --> <!--
   * end-user-doc -->
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Supplier.standardOrders</b></em>'.
   * <!-- begin-user-doc --> <!--
   * end-user-doc -->
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Supplier.hardCopyOrderReference</b></em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>Supplier.hardCopyOrderNumber</b></em>'.
   * <!-- begin-user-doc --> <!--
   * end-user-doc -->
