...
/**
 * The <b>{@link ModelFactory}</b> for the types of this model: org.eclipse.emf.texo.test.model.samples.forum.
...
public class ForumModelFactory implements ModelFactory {
  ...
  /**
   * Converts the EDataType: TopicCategory to a String.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  /**
   * Creates an instance of the EDataType: TopicCategory from a String.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  /**
   * Converts the EDataType: TopicCategoryObject to a String.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param value the object to convert
   * @return the String representing the value, if value == null then null is returned
   * @generated
