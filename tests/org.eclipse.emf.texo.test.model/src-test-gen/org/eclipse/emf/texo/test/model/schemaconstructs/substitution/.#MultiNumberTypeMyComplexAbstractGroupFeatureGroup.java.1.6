...
/** 
 * A representation for the Feature Group '<em><b>MultiNumberType.myComplexAbstractGroup</b></em>'.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated 
 */
public class MultiNumberTypeMyComplexAbstractGroupFeatureGroup {
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link MultiNumberType#getMyComplexAbstract() myComplexAbstract}' feature.
   * @generated
   */
