...
/**
 * The <b>{@link ModelFactory}</b> for the types of this model: identifiable. It contains code to create instances
...
public class IdentifiableModelFactory implements ModelFactory {
  ...
  /**
   * The adapter/wrapper for the EClass '<em><b>Identifiable</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  ...
  public static class IdentifiableInterfaceModelObject<E extends IdentifiableInterface> extends AbstractModelObject<E> {
    ...
    public Object eGet(EStructuralFeature eStructuralFeature) {
      final int featureID = eClass().getFeatureID(eStructuralFeature);
      switch (featureID) {
      case IdentifiableModelPackage.IDENTIFIABLEINTERFACE_DB_ID_FEATURE_ID:
        return getTarget().getDb_Id();
