...
public class PersonaeTypeGroupFeatureGroup {
  ...
  public static <T> List<T> createUnmodifiableValueList(List<PersonaeTypeGroupFeatureGroup> featureGroup,
      Feature filterByFeature) {
    final List<Object> result = new ArrayList<Object>();
    for (final PersonaeTypeGroupFeatureGroup group : featureGroup) {
   ...
   */
  @SuppressWarnings("unchecked")
  public static <T> T getSingleFeatureMapValue(List<PersonaeTypeGroupFeatureGroup> featureGroup, Feature filterByFeature) {
    for (final PersonaeTypeGroupFeatureGroup group : featureGroup) {
      if (group.getFeature() == filterByFeature) {
   ...
   * @generated
   */
  public static void setSingleFeatureMapValue(List<PersonaeTypeGroupFeatureGroup> featureGroup, Feature feature,
      Object value) {
    for (final PersonaeTypeGroupFeatureGroup group : featureGroup) {
    ...
    final PersonaeTypeGroupFeatureGroup entry = new PersonaeTypeGroupFeatureGroup();
   ...
   * @generated
   */
  public static List<PersonaeTypeGroupFeatureGroup> createFeatureGroupList(Feature feature, List<?> values) {
    final List<PersonaeTypeGroupFeatureGroup> result = new ArrayList<PersonaeTypeGroupFeatureGroup>();
    for (Object value : values) {
      final PersonaeTypeGroupFeatureGroup group = new PersonaeTypeGroupFeatureGroup();
      group.setValue(feature, value);
      result.add(group);
    }
    return result;
