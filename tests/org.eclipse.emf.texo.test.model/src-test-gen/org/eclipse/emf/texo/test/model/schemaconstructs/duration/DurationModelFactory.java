...
/**
 * The <b>{@link ModelFactory}</b> for the types of this model: duration.
 ...
 * @generated
 */
public class DurationModelFactory implements ModelFactory {
  ...
  public ModelObject createModelObject(EClass eClass, Object adaptee) {
    ...
    switch (eClass.getClassifierID()) {
    case DurationModelPackage.DURATIONTEST_CLASSIFIER_ID:
      modelObject = new DurationTestModelObject();
      break;
    default:
  ...
  /**
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @return an instance of the model object representing the EClass DurationTest
   * @generated
   */
  public DurationTest createDurationTest() {
    return new DurationTest();
  }
  ...
  /** 
   * The adapter/wrapper for the EClass '<em><b>DurationTest</b></em>'.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @generated 
   */
  public static class DurationTestModelObject<E extends DurationTest> extends AbstractModelObject<E> {
    ...
    public Object eGet(EStructuralFeature eStructuralFeature) {
      ...
      switch (featureID) {
      case DurationModelPackage.DURATIONTEST_NAME_FEATURE_ID:
        return getTarget().getName();
      case DurationModelPackage.DURATIONTEST_DURATION_FEATURE_ID:
    ...
    public void eSet(EStructuralFeature eStructuralFeature, Object value) {
      ...
      case DurationModelPackage.DURATIONTEST_NAME_FEATURE_ID:
        ...
        return;
      case DurationModelPackage.DURATIONTEST_DURATION_FEATURE_ID:
        getTarget().setDuration((Duration) value);
        return;
      case DurationModelPackage.DURATIONTEST_DURATIONS_FEATURE_ID:
