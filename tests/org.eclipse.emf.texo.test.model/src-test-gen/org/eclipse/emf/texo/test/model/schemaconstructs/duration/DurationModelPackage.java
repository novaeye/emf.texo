...
/**
 * The <b>Package</b> for the model '<em><b>duration</b></em>'.
...
public class DurationModelPackage extends ModelPackage {
   ...
   * @generated
   */
  public static final int DURATIONTEST_NAME_FEATURE_ID = 0;

  /**
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @generated
   */
  public static final int DURATIONTEST_DURATION_FEATURE_ID = 1;

  /**
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @generated
   */
  public static final int DURATIONTEST_DURATIONS_FEATURE_ID = 2;
  ...
  /**
   * Returns the {@link EClass} '<em><b>DurationTest</b></em>'.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>DurationTest.name</b></em>'.
   * <!-- begin-user-doc --> <!--
   * end-user-doc -->
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>DurationTest.duration</b></em>'.
   * <!-- begin-user-doc --> <!--
   * end-user-doc -->
  ...
  /**
   * Returns the {@link EStructuralFeature} '<em><b>DurationTest.durations</b></em>'.
   * <!-- begin-user-doc --> <!--
   * end-user-doc -->
