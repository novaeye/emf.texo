...
public class DocumentrootModelFactory implements ModelFactory {
  ...
  /**
   * The adapter/wrapper for the EClass '<em><b>ComplexType</b></em>'.
   * 
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param <E>
   ...
   * @generated
   */
  public static class ComplexTypeModelObject<E extends ComplexType> extends
    ...
    public Object eGet(EStructuralFeature eStructuralFeature) {
      ...
      switch (featureID) {
      case DocumentrootModelPackage.COMPLEXTYPE_DB_ID_FEATURE_ID:
        return getTarget().getDb_Id();
      case DocumentrootModelPackage.COMPLEXTYPE_DB_VERSION_FEATURE_ID:
  ...
  public static class DocumentRootModelObject<E extends DocumentRoot> extends
    ...
    public Object eGet(EStructuralFeature eStructuralFeature) {
      final int featureID = eClass().getFeatureID(eStructuralFeature);
      switch (featureID) {
      case DocumentrootModelPackage.DOCUMENTROOT_DB_ID_FEATURE_ID:
        return getTarget().getDb_Id();
      case DocumentrootModelPackage.DOCUMENTROOT_DB_VERSION_FEATURE_ID:
        return getTarget().getDb_version();
