 ...
 * @generated
 */
@Entity(name = "substitutionzvon_RootType_myComplexAbstractGroup")
public class RootTypeMyComplexAbstractGroupFeatureGroup extends Identifiable {
  ...
  public static <T> List<T> createUnmodifiableValueList(List<RootTypeMyComplexAbstractGroupFeatureGroup> featureGroup,
      Feature filterByFeature) {
    final List<Object> result = new ArrayList<Object>();
    for (final RootTypeMyComplexAbstractGroupFeatureGroup group : featureGroup) {
   ...
   */
  @SuppressWarnings("unchecked")
  public static <T> T getSingleFeatureMapValue(List<RootTypeMyComplexAbstractGroupFeatureGroup> featureGroup,
      Feature filterByFeature) {
    for (final RootTypeMyComplexAbstractGroupFeatureGroup group : featureGroup) {
      if (group.getFeature() == filterByFeature) {
   ...
   * @generated
   */
  public static void setSingleFeatureMapValue(List<RootTypeMyComplexAbstractGroupFeatureGroup> featureGroup,
    ...
    final RootTypeMyComplexAbstractGroupFeatureGroup entry = new RootTypeMyComplexAbstractGroupFeatureGroup();
   ...
   * @generated
   */
  public static List<RootTypeMyComplexAbstractGroupFeatureGroup> createFeatureGroupList(Feature feature, List<?> values) {
    final List<RootTypeMyComplexAbstractGroupFeatureGroup> result = new ArrayList<RootTypeMyComplexAbstractGroupFeatureGroup>();
    for (Object value : values) {
      final RootTypeMyComplexAbstractGroupFeatureGroup group = new RootTypeMyComplexAbstractGroupFeatureGroup();
      group.setValue(feature, value);
      result.add(group);
    }
    return result;
