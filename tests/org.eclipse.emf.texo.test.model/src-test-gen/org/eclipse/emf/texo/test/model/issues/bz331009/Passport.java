...
/**
 * A representation of the model object '<em><b>Passport</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
 * begin-model-doc --> Паспортные данные <!-- end-model-doc -->
 * 
 * @generated
 */
...
public class Passport extends Identifiable implements Document {
  ...
  public String toString() {
    return "Passport " + " [series: " + getSeries() + "]" + " [number: " + getNumber() + "]" + " [issueDate: "
