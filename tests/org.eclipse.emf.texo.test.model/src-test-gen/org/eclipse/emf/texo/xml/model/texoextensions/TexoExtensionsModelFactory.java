...
/**
 * The <b>{@link ModelFactory}</b> for the types of this model: org.eclipse.emf.texo.xml.model.texoExtensions. It
...
public class TexoExtensionsModelFactory implements ModelFactory {
  ...
  public static class DocumentRootModelObject<E extends DocumentRoot> extends
    ...
    public Object eGet(EStructuralFeature eStructuralFeature) {
      ...
      switch (featureID) {
      case TexoExtensionsModelPackage.DOCUMENTROOT_DB_ID_FEATURE_ID:
        return getTarget().getDb_Id();
      case TexoExtensionsModelPackage.DOCUMENTROOT_DB_VERSION_FEATURE_ID:
