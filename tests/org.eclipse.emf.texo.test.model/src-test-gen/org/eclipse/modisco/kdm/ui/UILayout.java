...
/** 
 * A representation of the model object '<em><b>UILayout</b></em>'.
...
public class UILayout extends AbstractUIRelationship {
  ...
  /**
   * Sets the '{@link UILayout#getTo() <em>to</em>}' feature.
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link UILayout#getTo() to}' feature.
   * @generated
   */
  ...
  /**
   * Sets the '{@link UILayout#getFrom() <em>from</em>}' feature.
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link UILayout#getFrom() from}' feature.
   * @generated
   */
