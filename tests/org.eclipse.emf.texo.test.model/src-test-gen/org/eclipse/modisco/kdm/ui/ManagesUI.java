...
/**
 * A representation of the model object '<em><b>ManagesUI</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
...
public class ManagesUI extends AbstractActionRelationship {
   ...
   * 
   * @param newTo
   *          the new value of the '{@link ManagesUI#getTo() to}' feature.
   * @generated
   */
   ...
   * 
   * @param newFrom
   *          the new value of the '{@link ManagesUI#getFrom() from}' feature.
   * @generated
   */
