...
/** 
 * A representation of the model object '<em><b>DisplaysImage</b></em>'.
...
public class DisplaysImage extends AbstractUIRelationship {
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link DisplaysImage#getTo() to}' feature.
   * @generated
   */
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link DisplaysImage#getFrom() from}' feature.
   * @generated
   */
