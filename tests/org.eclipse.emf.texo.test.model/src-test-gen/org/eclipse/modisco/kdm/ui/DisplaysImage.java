...
/**
 * A representation of the model object '<em><b>DisplaysImage</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
...
public class DisplaysImage extends AbstractUIRelationship {
   ...
   * @generated
   */
  @ManyToOne(cascade = { CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REFRESH }, optional = false, targetEntity = Image.class)
  @JoinColumns({ @JoinColumn() })
  private Image to = null;
  ...
  /**
   * Sets the '{@link DisplaysImage#getTo() <em>to</em>}' feature.
   * 
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param the
   *          new value of the '{@link DisplaysImage#getTo() to}' feature.
   * @generated
   */
  ...
  /**
   * Sets the '{@link DisplaysImage#getFrom() <em>from</em>}' feature.
   * 
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param the
   *          new value of the '{@link DisplaysImage#getFrom() from}' feature.
   * @generated
   */
