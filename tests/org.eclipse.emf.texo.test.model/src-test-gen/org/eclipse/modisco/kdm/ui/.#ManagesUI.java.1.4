...
/** 
 * A representation of the model object '<em><b>ManagesUI</b></em>'.
...
public class ManagesUI extends AbstractActionRelationship {
  ...
  /**
   * Sets the '{@link ManagesUI#getTo() <em>to</em>}' feature.
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link ManagesUI#getTo() to}' feature.
   * @generated
   */
  ...
  /**
   * Sets the '{@link ManagesUI#getFrom() <em>from</em>}' feature.
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link ManagesUI#getFrom() from}' feature.
   * @generated
   */
