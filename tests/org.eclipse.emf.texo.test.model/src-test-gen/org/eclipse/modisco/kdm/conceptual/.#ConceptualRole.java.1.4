...
/** 
 * A representation of the model object '<em><b>ConceptualRole</b></em>'.
...
public class ConceptualRole extends AbstractConceptualElement {
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link ConceptualRole#getConceptualElement() conceptualElement}' feature.
   * @generated
   */
