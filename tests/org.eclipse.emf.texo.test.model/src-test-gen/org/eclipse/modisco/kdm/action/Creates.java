...
/**
 * A representation of the model object '<em><b>Creates</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
...
public class Creates extends AbstractActionRelationship {
   ...
   * 
   * @param newTo
   *          the new value of the '{@link Creates#getTo() to}' feature.
   * @generated
   */
   ...
   * 
   * @param newFrom
   *          the new value of the '{@link Creates#getFrom() from}' feature.
   * @generated
   */
