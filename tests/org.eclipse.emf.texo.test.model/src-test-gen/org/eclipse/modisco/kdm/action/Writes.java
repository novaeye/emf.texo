...
/**
 * A representation of the model object '<em><b>Writes</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
@Entity(name = "action_Writes")
...
public class Writes extends AbstractActionRelationship {
   ...
   * 
   * @param newTo
   *          the new value of the '{@link Writes#getTo() to}' feature.
   * @generated
   */
   ...
   * 
   * @param newFrom
   *          the new value of the '{@link Writes#getFrom() from}' feature.
   * @generated
   */
