...
/** 
 * A representation of the model object '<em><b>ControlFlow</b></em>'.
...
public class ControlFlow extends AbstractActionRelationship {
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link ControlFlow#getTo() to}' feature.
   * @generated
   */
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link ControlFlow#getFrom() from}' feature.
   * @generated
   */
