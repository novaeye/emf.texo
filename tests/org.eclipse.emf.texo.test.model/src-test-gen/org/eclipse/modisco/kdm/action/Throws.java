...
/**
 * A representation of the model object '<em><b>Throws</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
@Entity(name = "action_Throws")
...
public class Throws extends AbstractActionRelationship {
   ...
   * 
   * @param newTo
   *          the new value of the '{@link Throws#getTo() to}' feature.
   * @generated
   */
   ...
   * 
   * @param newFrom
   *          the new value of the '{@link Throws#getFrom() from}' feature.
   * @generated
   */
