...
/** 
 * A representation of the model object '<em><b>CompliesTo</b></em>'.
...
public class CompliesTo extends AbstractActionRelationship {
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link CompliesTo#getTo() to}' feature.
   * @generated
   */
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link CompliesTo#getFrom() from}' feature.
   * @generated
   */
