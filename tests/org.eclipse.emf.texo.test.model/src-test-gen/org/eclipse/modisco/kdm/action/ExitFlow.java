...
/** 
 * A representation of the model object '<em><b>ExitFlow</b></em>'.
...
public class ExitFlow extends AbstractActionRelationship {
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link ExitFlow#getTo() to}' feature.
   * @generated
   */
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link ExitFlow#getFrom() from}' feature.
   * @generated
   */
