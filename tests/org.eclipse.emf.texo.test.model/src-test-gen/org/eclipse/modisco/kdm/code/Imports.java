...
/**
 * A representation of the model object '<em><b>Imports</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
@Entity(name = "code_Imports")
...
public class Imports extends AbstractCodeRelationship {
   ...
   * 
   * @param newTo
   *          the new value of the '{@link Imports#getTo() to}' feature.
   * @generated
   */
   ...
   * 
   * @param newFrom
   *          the new value of the '{@link Imports#getFrom() from}' feature.
   * @generated
   */
