...
/** 
 * A representation of the model object '<em><b>HasValue</b></em>'.
...
public class HasValue extends AbstractCodeRelationship {
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link HasValue#getTo() to}' feature.
   * @generated
   */
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link HasValue#getFrom() from}' feature.
   * @generated
   */
