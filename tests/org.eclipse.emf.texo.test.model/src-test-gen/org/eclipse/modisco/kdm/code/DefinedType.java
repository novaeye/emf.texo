...
/** 
 * A representation of the model object '<em><b>DefinedType</b></em>'.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated 
 */
@Entity(name = "DefinedType")
public abstract class DefinedType extends Datatype {
   ...
   * @generated 
   */
  @ManyToOne(cascade = { CascadeType.ALL }, optional = true, targetEntity = Datatype.class)
  @JoinColumns({ @JoinColumn() })
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link DefinedType#getType() type}' feature.
   * @generated
   */
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link DefinedType#getCodeElement() codeElement}' feature.
   * @generated
   */
