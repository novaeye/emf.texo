...
/**
 * A representation of the model object '<em><b>HasValue</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
@Entity(name = "code_HasValue")
@Converters({ @Converter(converterClass = TexoTestObjectConverter.class, name = "TexoTestObjectConverter"),
    @Converter(converterClass = TexoTestQNameConverter.class, name = "TexoTestQNameConverter") })
public class HasValue extends AbstractCodeRelationship {
   ...
   * 
   * @param newTo
   *          the new value of the '{@link HasValue#getTo() to}' feature.
   * @generated
   */
   ...
   * 
   * @param newFrom
   *          the new value of the '{@link HasValue#getFrom() from}' feature.
   * @generated
   */
