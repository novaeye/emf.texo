...
/** 
 * A representation of the model object '<em><b>WritesColumnSet</b></em>'.
...
public class WritesColumnSet extends AbstractActionRelationship {
  ...
  /**
   * Sets the '{@link WritesColumnSet#getTo() <em>to</em>}' feature.
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link WritesColumnSet#getTo() to}' feature.
   * @generated
   */
  ...
  /**
   * Sets the '{@link WritesColumnSet#getFrom() <em>from</em>}' feature.
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link WritesColumnSet#getFrom() from}' feature.
   * @generated
   */
