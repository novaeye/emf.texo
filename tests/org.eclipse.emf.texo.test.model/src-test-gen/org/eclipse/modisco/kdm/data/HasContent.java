...
/** 
 * A representation of the model object '<em><b>HasContent</b></em>'.
...
public class HasContent extends AbstractActionRelationship {
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link HasContent#getTo() to}' feature.
   * @generated
   */
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link HasContent#getFrom() from}' feature.
   * @generated
   */
