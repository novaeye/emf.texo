...
/** 
 * A representation of the model object '<em><b>KeyRelation</b></em>'.
...
public class KeyRelation extends AbstractDataRelationship {
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link KeyRelation#getTo() to}' feature.
   * @generated
   */
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link KeyRelation#getFrom() from}' feature.
   * @generated
   */
