...
/** 
 * A representation of the model object '<em><b>ExtensionTo</b></em>'.
...
public class ExtensionTo extends AbstractDataRelationship {
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link ExtensionTo#getTo() to}' feature.
   * @generated
   */
   ...
   *
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @param the new value of the '{@link ExtensionTo#getFrom() from}' feature.
   * @generated
   */
