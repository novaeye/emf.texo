...
/**
 * A representation of the model object '<em><b>BindsTo</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
...
public class BindsTo extends AbstractPlatformRelationship {
   ...
   * 
   * @param newTo
   *          the new value of the '{@link BindsTo#getTo() to}' feature.
   * @generated
   */
   ...
   * 
   * @param newFrom
   *          the new value of the '{@link BindsTo#getFrom() from}' feature.
   * @generated
   */
