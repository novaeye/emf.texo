...
/**
 * A representation of the model object '<em><b>HasState</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
...
public class HasState extends AbstractActionRelationship {
   ...
   * 
   * @param newTo
   *          the new value of the '{@link HasState#getTo() to}' feature.
   * @generated
   */
   ...
   * 
   * @param newFrom
   *          the new value of the '{@link HasState#getFrom() from}' feature.
   * @generated
   */
