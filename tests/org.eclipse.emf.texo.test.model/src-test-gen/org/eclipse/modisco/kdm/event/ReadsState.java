...
/**
 * A representation of the model object '<em><b>ReadsState</b></em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
...
public class ReadsState extends AbstractActionRelationship {
   ...
   * 
   * @param newTo
   *          the new value of the '{@link ReadsState#getTo() to}' feature.
   * @generated
   */
   ...
   * 
   * @param newFrom
   *          the new value of the '{@link ReadsState#getFrom() from}' feature.
   * @generated
   */
