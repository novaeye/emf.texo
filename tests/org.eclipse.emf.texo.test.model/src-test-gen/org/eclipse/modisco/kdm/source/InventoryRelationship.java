...
/**
 * A representation of the model object '<em><b>InventoryRelationship</b></em>'. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
...
public class InventoryRelationship extends AbstractInventoryRelationship {
   ...
   * 
   * @param newTo
   *          the new value of the '{@link InventoryRelationship#getTo() to}' feature.
   * @generated
   */
   ...
   * 
   * @param newFrom
   *          the new value of the '{@link InventoryRelationship#getFrom() from}' feature.
   * @generated
   */
