 ...
 * </copyright>
 *
 * $Id: Lendable.java,v 1.4 2011/08/25 14:34:33 mtaal Exp $
 */
package extlibrary;
...
public interface Lendable extends EObject {
   ...
   * <p>
   * If the meaning of the '<em>Copies</em>' attribute isn't clear, there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link extlibrary.Lendable#getCopies <em>Copies</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @param value
   ...
   * {@link extlibrary.Borrower}. It is bidirectional and its opposite is '{@link extlibrary.Borrower#getBorrowed
   * <em>Borrowed</em>}'. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Borrowers</em>' reference list isn't clear, there really should be more of a description
   * here...
   * </p>
   * <!-- end-user-doc -->
   * 
