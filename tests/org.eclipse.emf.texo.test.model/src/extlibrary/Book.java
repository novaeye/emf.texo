 ...
 * </copyright>
 *
 * $Id: Book.java,v 1.4 2011/08/25 14:34:33 mtaal Exp $
 */
package extlibrary;
...
public interface Book extends CirculatingItem {
  /**
   * Returns the value of the '<em><b>Title</b></em>' attribute. The default value is <code>"Book"</code>. <!--
   * begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link extlibrary.Book#getTitle <em>Title</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Pages</em>' attribute isn't clear, there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link extlibrary.Book#getPages <em>Pages</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value
   ...
   * {@link extlibrary.BookCategory}. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link extlibrary.Book#getCategory <em>Category</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @param value
  ...
  /**
   * Unsets the value of the '{@link extlibrary.Book#getCategory <em>Category</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #isSetCategory()
   * @see #getCategory()
   ...
   * {@link extlibrary.Writer#getBooks <em>Books</em>}'. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link extlibrary.Book#getAuthor <em>Author</em>}' reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value
