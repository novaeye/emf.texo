 ...
 * </copyright>
 *
 * $Id: Borrower.java,v 1.4 2011/08/25 14:34:33 mtaal Exp $
 */
package extlibrary;
...
public interface Borrower extends Person {
   ...
   * {@link extlibrary.Lendable}. It is bidirectional and its opposite is '{@link extlibrary.Lendable#getBorrowers
   * <em>Borrowers</em>}'. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Borrowed</em>' reference list isn't clear, there really should be more of a description
   * here...
   * </p>
   * <!-- end-user-doc -->
   * 
