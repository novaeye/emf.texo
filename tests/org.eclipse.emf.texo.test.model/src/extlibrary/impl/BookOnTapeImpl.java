 ...
 * </copyright>
 *
 * $Id: BookOnTapeImpl.java,v 1.4 2011/08/25 14:34:33 mtaal Exp $
 */
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Book On Tape</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link extlibrary.impl.BookOnTapeImpl#getReader <em>Reader</em>}</li>
 * <li>{@link extlibrary.impl.BookOnTapeImpl#getAuthor <em>Author</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class BookOnTapeImpl extends AudioVisualItemImpl implements BookOnTape {
  /**
   * The cached value of the '{@link #getReader() <em>Reader</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @see #getReader()
   * @generated
    ...
    if (reader != null && reader.eIsProxy()) {
      ...
      if (reader != oldReader) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExtlibraryPackage.BOOK_ON_TAPE__READER, oldReader,
              reader));
      }
    }
    return reader;
  ...
  public Writer getAuthor() {
    if (author != null && author.eIsProxy()) {
      ...
      if (author != oldAuthor) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExtlibraryPackage.BOOK_ON_TAPE__AUTHOR, oldAuthor,
              author));
      }
    }
    return author;
