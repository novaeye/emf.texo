 ...
 * </copyright>
 *
 * $Id: EmployeeImpl.java,v 1.4 2011/08/25 14:34:33 mtaal Exp $
 */
    ...
    if (manager != null && manager.eIsProxy()) {
      ...
      if (manager != oldManager) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExtlibraryPackage.EMPLOYEE__MANAGER, oldManager,
              manager));
      }
    }
    return manager;
