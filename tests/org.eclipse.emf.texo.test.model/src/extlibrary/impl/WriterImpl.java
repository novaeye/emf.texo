 ...
 * </copyright>
 *
 * $Id: WriterImpl.java,v 1.4 2011/08/25 14:34:33 mtaal Exp $
 */
...
public class WriterImpl extends PersonImpl implements Writer {
   ...
   * @ordered
   */
  protected static final String NAME_EDEFAULT = "Jim";
  ...
  public EList<Book> getBooks() {
    if (books == null) {
      books = new EObjectWithInverseResolvingEList<Book>(Book.class, this, ExtlibraryPackage.WRITER__BOOKS,
