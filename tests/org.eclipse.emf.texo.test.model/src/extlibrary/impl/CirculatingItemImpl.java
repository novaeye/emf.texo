 ...
 * </copyright>
 *
 * $Id: CirculatingItemImpl.java,v 1.4 2011/08/25 14:34:34 mtaal Exp $
 */
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Circulating Item</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public abstract class CirculatingItemImpl extends ItemImpl implements CirculatingItem {
  ...
  /**
   * The cached value of the '{@link #getCopies() <em>Copies</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @see #getCopies()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getBorrowers() <em>Borrowers</em>}' reference list. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getBorrowers()
   * @generated
  ...
  public void setCopies(int newCopies) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExtlibraryPackage.CIRCULATING_ITEM__COPIES, oldCopies,
          copies));
  }
