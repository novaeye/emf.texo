 ...
 * </copyright>
 *
 * $Id: BookImpl.java,v 1.4 2011/08/25 14:34:34 mtaal Exp $
 */
...
public class BookImpl extends CirculatingItemImpl implements Book {
   ...
   * @ordered
   */
  protected static final String TITLE_EDEFAULT = "Book";
  ...
  /**
   * The default value of the '{@link #getPages() <em>Pages</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @see #getPages()
   * @generated
  ...
  public void setCategory(BookCategory newCategory) {
    ...
    categoryESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExtlibraryPackage.BOOK__CATEGORY, oldCategory, category,
          !oldCategoryESet));
  }
  ...
  public void unsetCategory() {
    ...
    categoryESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ExtlibraryPackage.BOOK__CATEGORY, oldCategory,
          CATEGORY_EDEFAULT, oldCategoryESet));
  }
  ...
  public NotificationChain basicSetAuthor(Writer newAuthor, NotificationChain msgs) {
    ...
    author = newAuthor;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExtlibraryPackage.BOOK__AUTHOR,
          oldAuthor, newAuthor);
      if (msgs == null)
        msgs = notification;
      else
