 ...
 * </copyright>
 *
 * $Id: LibraryImpl.java,v 1.4 2011/08/25 14:34:34 mtaal Exp $
 */
...
public class LibraryImpl extends EObjectImpl implements Library {
  ...
  /**
   * The cached value of the '{@link #getStock() <em>Stock</em>}' containment reference list. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getStock()
   * @generated
  ...
  public void setParentBranch(Library newParentBranch) {
    if (newParentBranch != eInternalContainer()
      ...
      if (newParentBranch != null)
        msgs = ((InternalEObject) newParentBranch).eInverseAdd(this, ExtlibraryPackage.LIBRARY__BRANCHES,
            Library.class, msgs);
      msgs = basicSetParentBranch(newParentBranch, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExtlibraryPackage.LIBRARY__PARENT_BRANCH, newParentBranch,
          newParentBranch));
  }
