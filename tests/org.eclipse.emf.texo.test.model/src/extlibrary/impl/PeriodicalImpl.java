 ...
 * </copyright>
 *
 * $Id: PeriodicalImpl.java,v 1.4 2011/08/25 14:34:34 mtaal Exp $
 */
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Periodical</b></em>'. <!-- end-user-doc -->
 * <p>
...
public abstract class PeriodicalImpl extends ItemImpl implements Periodical {
  ...
  /**
   * The default value of the '{@link #getIssuesPerYear() <em>Issues Per Year</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getIssuesPerYear() <em>Issues Per Year</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getIssuesPerYear()
   * @generated
  ...
  public void setIssuesPerYear(int newIssuesPerYear) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExtlibraryPackage.PERIODICAL__ISSUES_PER_YEAR,
          oldIssuesPerYear, issuesPerYear));
  }
