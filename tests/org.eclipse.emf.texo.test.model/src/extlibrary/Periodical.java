 ...
 * </copyright>
 *
 * $Id: Periodical.java,v 1.4 2011/08/25 14:34:33 mtaal Exp $
 */
package extlibrary;

/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Periodical</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface Periodical extends Item {
  ...
  /**
   * Sets the value of the '{@link extlibrary.Periodical#getTitle <em>Title</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @param value
   ...
   * <p>
   * If the meaning of the '<em>Issues Per Year</em>' attribute isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
