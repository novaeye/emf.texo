 ...
 * </copyright>
 *
 * $Id: Library.java,v 1.4 2011/08/25 14:34:33 mtaal Exp $
 */
package extlibrary;
...
public interface Library extends Addressable {
  ...
  /**
   * Sets the value of the '{@link extlibrary.Library#getName <em>Name</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value
  ...
  /**
   * Returns the value of the '<em><b>Writers</b></em>' containment reference list. The list contents are of type
   * {@link extlibrary.Writer}. <!-- begin-user-doc -->
   * <p>
   ...
   * @model containment="true" transient="true" volatile="true" derived="true" extendedMetaData="group='#people'"
   * @generated
   */
   ...
   * {@link extlibrary.Employee}. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Returns the value of the '<em><b>Borrowers</b></em>' containment reference list. The list contents are of type
   * {@link extlibrary.Borrower}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Borrowers</em>' containment reference list isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Stock</b></em>' containment reference list. The list contents are of type
   * {@link extlibrary.Item}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Stock</em>' containment reference list isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Branches</b></em>' containment reference list. The list contents are of type
   * {@link extlibrary.Library}. It is bidirectional and its opposite is '{@link extlibrary.Library#getParentBranch
  ...
  /**
   * Returns the value of the '<em><b>Parent Branch</b></em>' container reference. It is bidirectional and its opposite
   * is '{@link extlibrary.Library#getBranches <em>Branches</em>}'. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Parent Branch</em>' container reference isn't clear, there really should be more of a
   * description here...
   * </p>
   * <!-- end-user-doc -->
   * 
