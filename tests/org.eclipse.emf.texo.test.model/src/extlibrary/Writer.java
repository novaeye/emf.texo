 ...
 * </copyright>
 *
 * $Id: Writer.java,v 1.4 2011/08/25 14:34:33 mtaal Exp $
 */
package extlibrary;
...
public interface Writer extends Person {
  /**
   * Returns the value of the '<em><b>Name</b></em>' attribute. The default value is <code>"Jim"</code>. <!--
   * begin-user-doc -->
   * <p>
   ...
   * @model default="Jim" transient="true" volatile="true"
   * @generated
   */
  String getName();

  /**
   * Sets the value of the '{@link extlibrary.Writer#getName <em>Name</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value
   ...
   * {@link extlibrary.Book}. It is bidirectional and its opposite is '{@link extlibrary.Book#getAuthor <em>Author</em>}
   * '. <!-- begin-user-doc -->
   * <p>
