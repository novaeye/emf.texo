 ...
 * </copyright>
 *
 * $Id: Person.java,v 1.4 2011/08/25 14:34:33 mtaal Exp $
 */
package extlibrary;
...
public interface Person extends Addressable {
  ...
  /**
   * Sets the value of the '{@link extlibrary.Person#getFirstName <em>First Name</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @param value
  ...
  /**
   * Sets the value of the '{@link extlibrary.Person#getLastName <em>Last Name</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @param value
