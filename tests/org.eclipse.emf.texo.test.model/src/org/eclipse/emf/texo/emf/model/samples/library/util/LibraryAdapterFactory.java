 ...
 * $Id$
 */
package org.eclipse.emf.texo.emf.model.samples.library.util;
 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.emf.texo.emf.model.samples.library.LibraryPackage
 * @generated
 */
public class LibraryAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.texo.emf.model.samples.library.Writer <em>Writer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
