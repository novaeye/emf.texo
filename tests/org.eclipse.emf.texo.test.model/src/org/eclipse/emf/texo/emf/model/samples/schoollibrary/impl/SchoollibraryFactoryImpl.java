...
public class SchoollibraryFactoryImpl extends EFactoryImpl implements SchoollibraryFactory {
	...
	public static SchoollibraryFactory init() {
		try {
			SchoollibraryFactory theSchoollibraryFactory = (SchoollibraryFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/emf/texo/test/model/samples/schoollibrary"); 
