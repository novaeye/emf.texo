...
public class RequestSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RequestPackage.ACTION_TYPE: {
				ActionType actionType = (ActionType)theEObject;
				T result = caseActionType(actionType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequestPackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequestPackage.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequestPackage.QUERY_REFERING_OBJECTS_TYPE: {
				QueryReferingObjectsType queryReferingObjectsType = (QueryReferingObjectsType)theEObject;
				T result = caseQueryReferingObjectsType(queryReferingObjectsType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequestPackage.QUERY_TYPE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Query Refering Objects Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Query Refering Objects Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseQueryReferingObjectsType(QueryReferingObjectsType object) {
		return null;
	}
